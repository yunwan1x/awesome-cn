...
- [Thread Group](http://threadgroup.org/) - 由来自 Nest、Samsung、ARM、Freescale、Silicon Labs、Big Ass Fans 和 Yale 的成员组成的 Thread Group 推动了 Thread 网络协议的发展.
...
- [Realizing the Potential of the Internet of Things](https://www.tiaonline.org/wp-content/uploads/2018/05/Realizing_the_Potential_of_the_Internet_of_Things_-_Recommendations_to_Policymakers.pdf) - 来自电信行业协会 (TIA) 的一份白皮书，以向政策制定者提供的一系列建议的形式编写，以利用和实现物联网市场的潜力.
