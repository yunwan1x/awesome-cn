...
- [autoupdate-antigen](https://github.com/unixorn/autoupdate-antigen.zshplugin)  - Antigen 不会像 oh-my-zsh 那样进行自动更新. 这个插件为抗原添加了自动更新，包括抗原和配置中加载的包.
...
- [fzshell](https://github.com/mnowotnik/fzshell) - 从用户预定义的源中获取完成的模糊命令行完成器.
