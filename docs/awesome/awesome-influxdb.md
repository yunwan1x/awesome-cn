...
该列表重点介绍支持InfluxDB 1.0版及更高版本的库，工具等.
...
* [C#](https://github.com/influxdata/influxdb-csharp) -一个.NET库，可有效地将点发送到InfluxDB
...
* [InfluxDB-Client-for-Arduino](https://github.com/tobiasschuerg/InfluxDB-Client-for-Arduino) -InfluxDB的Arduino客户端
...
* [grade](https://github.com/influxdata/grade) -通过将结果存储在InfluxDB中来跟踪随时间推移的Go基准性能
* [Influx-Capacitor](https://github.com/poxet/Influx-Capacitor)  -Influx-Capacitor使用Performance Counters从Windows机器收集指标. 数据发送到influxDB以供grafana查看
...
* [ntp_checker](https://github.com/fss1/ntp_checker) -比较内部NTP源并警告服务器之间的偏移量是否超过可定义的秒数
...
* [Graphios](https://github.com/shawn-sterling/graphios) -将nagios perf数据发送到石墨（carbon）/ statsd / librato / influxDB的程序
...
* [jmxtrans](https://github.com/jmxtrans/jmxtrans) -实际上，缺少了通过一端通过JMX与JVM对话以及您可以在另一端实现的任何日志记录/监视/图形包之间的连接器.
...
* [statsd-jvm-profiler](https://github.com/etsy/statsd-jvm-profiler) -使用StatsD的简单JVM Profiler
...
* [django-influxdb-metrics](https://github.com/bitlabstudio/django-influxdb-metrics) -可重复使用的Django应用，可将有关您的项目的指标发送到InfluxDB
...
* [logagent influx input plugin](https://sematext.com/docs/logagent/input-plugin-influxdb-http/) -Logagent插件通过Influx Line Protocol接收数据
