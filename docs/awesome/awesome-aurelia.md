...
&gt; Aurelia是适用于移动，桌面和网络的下一代JavaScript客户端框架，它利用简单的约定来增强您的创造力.
...
* [aurelia-binding-loader](https://github.com/bryanrsmith/aurelia-binding-loader) * Aurelia加载程序，可直接从视图模板使用任何模块
