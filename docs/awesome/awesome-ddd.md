...
&gt; 域驱动设计 (DDD)、命令查询职责分离 (CQRS)、事件溯源和事件风暴资源的精选列表.
...
- 基于领域模型的复杂设计
- 启动技术专家和领域专家之间的创造性合作，以迭代地改进解决特定领域问题的概念模型
...
- [CQRS](https://leanpub.com/cqrs)  - Mark Nijhof 从他从 Greg Young 那里学习 DDD 和 CQRS 的经验中得出的笔记. 本书随附了一个广泛的示例项目.
...
- [Domain Specific Languages](http://martinfowler.com/books/dsl.html) - 与 DDD 相关，描述了通用语言的重要性以及与领域专家合作的重要性，以及许多技术细节.
...
- [Microsoft .NET - Architecting Applications for the Enterprise (2nd Edition)](https://www.amazon.com/Microsoft-NET-Architecting-Applications-Enterprise/dp/0735685355/) - 一个软件架构师对核心实践的总结，实际应用.
...
- [Specification by Example](https://www.manning.com/books/specification-by-example)  - 本书从全球领先团队的经验中提炼出在短的迭代交付周期内指定、测试和交付软件的有效方法. 本书中的案例研究范围从小型网络初创公司到大型金融机构，在许多流程中工作，包括 XP、Scrum 和看板.
...
- [Writing Great Specifications](https://www.manning.com/books/writing-great-specifications) - Writing Great Specifications 是一个示例丰富的教程，教您如何编写良好的 Gherkin 规范文档，这些文档利用了 Specification by Example 的优势.
...
- [Domain-Driven Design: The First 15 Years](https://dddeurope.com/15years)  - 为庆祝周年纪念，我们邀请软件设计界的杰出作者贡献新旧文章. 由 Martin Fowler、James Coplien、Rebecca Wirfs-Brock、Mel Conway 等人贡献.
...
- [The Semantic JavaScript Backend for Event-Driven Development](https://docs.wolkenkit.io/1.1.0/downloads/brochure/) - 一本 68 页长的免费电子书，内容涉及 DDD、CQRS 和事件溯源是什么，以及它们如何相互配合.
...
- [Domain StoryTelling Slack](https://domainstorytelling.slack.com)  - 一个关于 Domain StoryTelling 的松懈团队. 目前仅限邀请，但您可以询问 [@hofstef](https://twitter.com/hofstef) 为邀请. 主页位于 [domainstorytelling.org](http://domainstorytelling.org/).
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/domain-driven-design) - 标记为 * 领域驱动设计 * 的堆栈溢出问题.
...
- [Daniel Whittaker](http://danielwhittaker.me)  - 想了解 CQRS 和事件溯源？ 这个博客包含了分步文章，让您有一个良好的开端.
...
- [Alberto Brandolini](https://ziobrando.blogspot.it)  - 事件风暴的发明者.  Alberto 断言问题不能用产生问题的相同心态来解决，他经常转换观点，假设架构师、导师、教练、经理或开发人员的观点.
...
### .NET (C#/F#)
- [Better code with DDD building blocks](https://github.com/asc-lab/better-code-with-ddd)  - 解决方案提出使用 DDD 战术模式来实现更好的代码可读性和表达性. 将 DDD 模式与无处不在的语言一起应用，可以缩小专家所说的语言与团队和代码中使用的语言之间的差距.
...
- [DDD-starter-dotnet](https://github.com/itlibrium/DDD-starter-dotnet)  - 构建 DDD 应用程序的各种方法的示例实现和比较. 作为快速启动 DDD .net 项目的基线很有用.
...
### Idris
- [OrderTaking](http://github.com/andorp/order-taking)  - Domain Modeling Made Functioncal 书的依赖类型实现. 一个如何用依赖类型形式化有界上下文和工作流图的示例项目.  NodeJS 可部署演示.

### JavaScript
- [wolkenkit Sample Applications](https://docs.wolkenkit.io/latest/media/sample-applications/wolkenkit-boards/) - 一系列 DDD 示例应用程序，例如 TodoMVC、寻宝应用程序、协作板等.
...
- [Eclipse CargoTracker](https://eclipse-ee4j.github.io/cargotracker/) - 该项目演示了如何使用领域驱动设计 (DDD) 等广泛采用的架构最佳实践，通过 Jakarta EE 平台开发应用程序. [The code](https://github.com/eclipse-ee4j/cargotracker/) 旨在反映开发人员在实际工作中会使用的非平凡应用程序. 它试图直接展示如何使用 Jakarta EE 有效地满足实际的企业问题，例如生产力、敏捷性、可测试性、灵活性、可维护性、可扩展性和安全性. 该项目直接基于众所周知的原创 [Java DDD sample application](https://github.com/citerus/dddsample-core) 由 DDD 先驱 Eric Evans 的 Domain Language 公司和瑞典软件咨询公司 Citerus 开发. 
...
- [Dolittle](https://dolittle.com)  - 使用 Dolittle 构建更好的应用程序. 一个基于事件源的微服务平台，面向 DDD，以开发人员的生产力和简单性为中心.
...
- [Axon Framework](http://www.axonframework.org/) - axon 框架专注于让希望基于 CQRS 原则创建 Java 应用程序的开发人员更轻松.
...
- [Lagom](https://www.lagomframework.com)  - Lagom 框架是 Java 虚拟机的微服务框架，具有适用于 Java 和 Scala 语言的 API. 它包括一个基于事件源/CQRS 的持久性模块.
