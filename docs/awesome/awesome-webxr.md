...
- [Fathom VR](https://www.letsfathom.com/vr/play) - 音乐发现应用程序 Fathom 的 WebXR 版本，可让您搜索和探索具有空间化音频的相关艺术家的云.
...
- [Exokit Avatars](https://github.com/exokitxr/avatars) - 基于网络的头像系统，可以加载多种不同模型格式的人形头像，并具有手臂+腿 IK、通过视位进行面部动画等功能.
- [ReadyPlayerMe](https://readyplayer.me/) - 让您可以快速轻松地在线创建可以以 glTF 格式下载的 3D 头像.
- [VRoid](https://vroid.com/en) - 让您可以创建导出为高度兼容的 .vrm 格式的动漫风格 3D 头像.
...
- [XR Foundation Discord](https://discord.gg/Tb4MT4TTjH) - XR 基金会官方服务器，负责 XREngine 和其他各种与元节相关的项目.
...
- [Dreamwave](https://dreamwave.tech/)  - 基于 Web 的平台，用于托管可扩展的虚拟事件. 为虚拟音乐节提供动力 [Secret Sky 2021](https://dreamwave.tech/secret-sky-2021).
