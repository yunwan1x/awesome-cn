 ...
 * [Clara](https://github.com/catchorg/Clara) <i>- A simple to use, composable, command line parser for C++ 11 and beyond.</i> <b>- 适用于 C++ 11 及更高版本的简单易用、可组合的命令行解析器。</b> <i>[BSL-1.0]</i> <b>[BSL-1.0]</b>
...
* [CUTE](http://cute-test.com) <i>- C++ Unit Testing Easier.</i> <b>- C++ 单元测试更容易。</b> <i>[LGPL3]</i> <b>[LGPL3]</b>
...
* [CTest](https://cmake.org/cmake/help/v2.8.8/ctest.html) <i>- The CMake test driver program.</i> <b>- CMake 测试驱动程序。</b> <i>[BSD]</i> <b>[BSD]</b>
...
* [OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) <i>- Pixar&#39;s library for evaluating and rendering subdivision surfaces on CPU and GPU.</i> <b>- Pixar 的库，用于在 CPU 和 GPU 上评估和渲染细分曲面。</b> <i>[Modified Apache2]</i> <b>[修改Apache2]</b>
...
* [jsoncons](https://github.com/danielaparker/jsoncons) <i>- A C++ header-only library for JSON and JSON-like binary formats with JSONPointer, JSONPatch, JSONPath and JMESPath.</i> <b>- 用于 JSON 和类似 JSON 的二进制格式的 C++ 标头库，带有 JSONPointer、JSONPatch、JSONPath 和 JMESPath。</b> <i>[Boost]</i> <b>[促进]</b>
...
* [log4cplus](https://github.com/log4cplus/log4cplus) <i>- A simple to use C++ logging API providing thread-safe, flexible, and arbitrarily granular control over log management and configuration.</i> <b>- 一个简单易用的 C++ 日志 API，提供线程安全、灵活和任意粒度的日志管理和配置控制。</b> <i>[BSD &amp; Apache2]</i> <b>[BSD 和 Apache2]</b>
...
* [sofia-ml](https://code.google.com/p/sofia-ml/) <i>- The suite of fast incremental algorithms for machine learning.</i> <b>- 一套用于机器学习的快速增量算法。</b> <i>[Apache2]</i> <b>[阿帕奇2]</b>
...
* [restclient-cpp](https://github.com/mrtazz/restclient-cpp) <i>- Simple REST client for C++.</i> <b>- C++ 的简单 REST 客户端。</b> <i>It wraps libcurl for HTTP requests.</i><b>它为 HTTP 请求包装 libcurl。</b> <i>[MIT]</i> <b>[麻省理工学院]</b>
...
* [Bullet](https://github.com/bulletphysics/bullet3) <i>- A 3D physics engine for games.</i> <b>- 用于游戏的 3D 物理引擎。</b> <i>[zlib]</i> <b>[zlib]</b> [website](http://bulletphysics.org)
