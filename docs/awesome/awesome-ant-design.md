...
- [Ant Design of React](http://react-component.github.io/badgeboard/) -基于React的开箱即用的优雅UI组件.
- [Ant Design SVG Icons](http://leungwensen.github.io/svg-icon/#ant) -将常规图标字体转换为SVG格式并支持Ant Design图标字体的项目.
...
这是可以帮助您自定义主题以及在浏览器中进行更改的实用程序

- [antd-theme-webpack-plugin](https://github.com/mzohaibqc/antd-theme-webpack-plugin) -一个webpack插件，用于生成您的自定义主题文件.
- [antd-theme-generator](https://github.com/mzohaibqc/antd-theme-generator) -一个简单的脚本，可生成主题特定的较少文件，可在任何环境中使用.
...
- [Grammar of Graphics](https://g2.alipay.com/) -纯粹的javascript，功能强大的大数据语义图生成工具，提供了一组图形语法，使用户可以使用简单的语法构建大量图表，并集成了大量统计工具，[Read more](https://github.com/antvis/feedback)).
...
- [Ant UX](http://ux.ant.design/) -使用制作用于UX设计的站点地图模板 [Omnigraffle](https://www.omnigroup.com/omnigraffle), [Sketch](https://www.sketchapp.com/) 或者 [Axure](http://www.axure.com/) . 这是一个库，可帮助设计人员定义，完善和最终确定其产品的页面间逻辑.
...
- [antd-group-slider](https://github.com/huyennbl/antd-group-slider)  -一组滑块，可帮助输入具有多个范围和说明的数据. 在滑块之间进行数据同步以改善UX，避免在输入范围数据时意外丢失范围.
...
- [antd-amplify-react](https://github.com/mzohaibqc/antd-amplify-react) -用于Aws Amplify进行身份验证的Ant设计组件的集合
...
- [Antizer](https://github.com/priornix/antizer) - Ant Design library for [ClojureScript](https://clojurescript.org/)，一种不可更改的功能语言，可以交叉编译为JavaScript.
