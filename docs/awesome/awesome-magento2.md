...
- [Documentation Search for Alfred](https://github.com/DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search) - 轻松将官方 Magento 2 搜索集成到您的 Alfred 工作流程中.
...
- [Masquerade](https://github.com/elgentos/masquerade) - 伪造者驱动、基于配置、平台无关、与地区兼容的数据伪造者工具
- [Magento 2 Composer patches helper](https://chrome.google.com/webstore/detail/magento-2-composer-patche/gfndadbceejgfjahpfaijcacnmdloiad) - Chrome 扩展为 vaimo/composer-patches 创建可复制粘贴的作曲家补丁定义.
...
- [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) - Magento2 部署配方 [deployer](https://deployer.org/).
...
- [Clean Checkout](https://github.com/danslo/CleanCheckout) - Magento 2 Checkout 替代方案的下降.
...
- [FastSimpleImport2](https://github.com/firegento/FireGento_FastSimpleImport2) - Magento 2 ImportExport 功能的包装器，它从数组中导入产品和客户.
...
- [MageSuite](https://github.com/magesuite/magesuite) - 开源（免费）PageBuilder 替代品
...
- [Magento 2 SEO](https://github.com/staempfli/magento2-module-seo) - Staempfli 的甜蜜和简单的 SEO 模块.
- [Google Tag Manager](https://github.com/magepal/magento2-google-tag-manager) - 带有 Magento2 数据层的 Google Tag Manager (GTM).
...
- [Preview Checkout Success Page](https://github.com/magepal/magento2-preview-checkout-success-page) - 快速轻松地预览和测试您的订单确认页面，无需每次都下新订单.
- [Firebear Import/Export](https://github.com/firebearstudio/importexport) - 标准 Magento 导入器的导入/导出改进.
- [FireGento Fast Simple Import](https://github.com/firegento/FireGento_FastSimpleImport2) - Magento 2 ImportExport 功能的包装器，从数组中导入产品和客户
- [Magento 2 Import Framework](https://github.com/techdivision/import) - 支持通用 Magento 2 导入功能的库
- [Image Resizer](https://github.com/staempfli/magento2-module-image-resizer) - Magento 2 模块在所有块和 .phtml 模板中添加简单的图像大小调整功能 [Staempfli](https://commercehero.io/staempfli).
...
- [Admin Auto Login](https://github.com/rogyar/magento2-autologin) - 自动登录 Magento 2 管理员，对演示非常有用
...
- [Clean Admin Menu](https://github.com/redchamps/clean-admin-menu) - 将第 3 方扩展合并到一个菜单.
- [auroraextensions/simplereturns](https://github.com/auroraextensions/simplereturns) - Magento2 的自助 RMA.
...
- [hivecommerce/magento2-content-fuzzyfyr](https://github.com/hivecommerce/magento2-content-fuzzyfyr)  - Magento2 的 Content Fuzzyfyr 模块将真实内容替换为虚拟内容. 这是出于开发目的，例如节省准备测试数据和匹配 GDPR 限制的时间.

### Security

- [Secure Password Hashing](https://bitbucket.org/creaminternet/module-securepasswords) - 改进了 Magento 2 的密码散列.
- [2FA](https://github.com/magespecialist/m2-MSP_TwoFactorAuth) - Magento 2 的两因素身份验证.
- [Maleware Scanner](https://github.com/gwillem/magento-malware-scanner) - 用于检测 Magento 恶意软件的规则和样本集合.
...
- [renatocason/magento2-module-mq](https://github.com/renatocason/magento2-module-mq) - Magento2 社区版消息队列的轻量级实现

### Mobile Application

- [Magento React Native REST](https://github.com/dimaportenko/magento-react-native) - 适用于 Magento 2 的 React Native 移动应用程序模板.
- [Magento React Native GraphQL](https://github.com/dimaportenko/magento-react-native-community) - 使用 GraphQL API 和用于 Magento 2 的 React Native 移动应用程序模板和 [YouTube tutorials](https://youtube.com/playlist?list=PL97fL9DAn9QyNAWAh-X-mFJdXKm96AqVM).
...
- [Magento 2 Architecture](https://github.com/magento/architecture) - 发生 Magento 架构讨论的地方.
...
- [magento-notes/magento2-exam-notes](https://github.com/magento-notes/magento2-exam-notes) - Magento 2 Certified Professional Developer 考试的备考说明
- [magento-notes/magento2-cloud-developer-notes](https://github.com/magento-notes/magento2-cloud-developer-notes) - Magento 2 Certified Professional Cloud Developer 考试的备考说明
...
- [Magento PHP CS Fixer](https://github.com/magento/marketplace-eqp) - 针对 Magento 2 的 CS Fixer.
...
- [Magento 2 DevBox](https://github.com/magento/magento2devbox-web) - Magento 构建的 Dockerbox.
- Magento 大师 2017
...
&gt; Magento 扩展开发者网络 (ExtDN) 是一个经过审查的扩展开发者网络，其核心业务是
 &gt; 开发和销售优质的 Magento 扩展. 我创建 ExtDN 是为了给 Magento 扩展带来责任感和信任
...
Thanks [MageTitans](http://www.magetitans.co.uk/) 在 YouTube 上分享讲座.
