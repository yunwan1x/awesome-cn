...
* [NiftyWindows](https://github.com/ahkscript/awesome-AutoHotkey/issues/180) - 控制所有基本的窗口交互，例如拖动、调整大小、最大化、最小化、关闭、对齐网格、“保持窗口纵横比”、将窗口滚动到其标题栏、透明度控制.
...
* [ActiveScript - Host VBScript and JScript in-process](https://autohotkey.com/boards/viewtopic.php?f=6&t=4555) - 为活动脚本语言（如 VBScript 和 JScript）提供接口，而不依赖 Microsoft 的 ScriptControl，后者不适用于 64 位程序.
