...
- [hivecommerce/magento2-content-fuzzyfyr](https://github.com/hivecommerce/magento2-content-fuzzyfyr)  - Magento2 的内容 Fuzzyfyr 模块用虚拟内容替换真实内容. 这是出于开发目的，例如节省准备测试数据和匹配 GDPR 限制的时间.
