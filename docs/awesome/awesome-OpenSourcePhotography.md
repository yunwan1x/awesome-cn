...
一个很棒的免费开源软件和摄影库列表. 还有视频工具. 更多精彩，请查看 [awesome](https://github.com/sindresorhus/awesome).
...
- [Magic Lantern](http://magiclantern.fm/) - *软件增强功能，可为佳能数​​码单反相机提供更多功能.*
...
- [Nikon Hacker](https://nikonhacker.com/wiki/Main_Page) - *Nikon Patch 和 Nikon Emulator，2 款适用于尼康相机的软件.*
- [Xiaomi Yi Autoexec](https://github.com/PJanisio/Xiaomi_Yi_autoexec) - *小米易相机的autoexec脚本和模组编译.*
...
### GoPro
- [GoPro](https://github.com/kschzt/gopro) - *用于从 Node.js 控制 GoPro Hero 3 摄像机的 API.*
- [GoPro](https://github.com/DenisCarriere/gopro) - *GoPro Hero 4 - Python API.*
- [GoPro](https://github.com/joshvillbrandt/goprohero) - *一个 Python 库和一个 CLI，可以通过 http 与 GoPro HERO3、HERO3+ 和 HERO4 摄像机交互.*
- [GoPro.Hero](https://github.com/r1pper/GoPro.Hero) - *a lightweight c# library to access and control GoPro HERO.*

### Sony

- [SonyPy](https://github.com/storborg/sonypy) - *用于索尼相机远程 API 的 Python 模块.*

## Utilities

- [Timelapse-sony](https://github.com/ThibaudM/timelapse-sony) - *用于通过“Ctrl with Smartphone”模式或通过 NFC 连接创建游戏中时光倒流的 Android 应用程序.*
...
- [Digitaltruth](https://www.digitaltruth.com/devchart.php) - *电影发展图表.*
...
- [Luminance](https://github.com/LuminanceHDR/LuminanceHDR) - *完整的HDR成像工作流程*
...
- [Lychee](http://lychee.electerious.com/) - *一款外观精美且易于使用的照片管理系统，您可以在您的服务器上运行，以管理和共享照片.*
...
- [Entangle](http://entangle-photo.org/) - *Entangle 提供了一个图形用户界面，用于使用完全由计算机控制的数码相机进行拍照.*
...
- [Cinepaint](http://sourceforge.net/projects/cinepaint/files/CinePaint/) - *基于GIMP的电影位图帧绘制和修饰程序.*

## Communities
- [Flickr Open Source Photography Group](https://www.flickr.com/groups/83823859@N00/)
- [/r/FOSSPhotography](http://reddit.com/r/fossphotography) - *关于 reddit 上免费开源摄影软件的社区.*
...
- [Pexels.com](https://pexels.com/) - *免版税的高分辨率库存照片， [licensed](https://www.pexels.com/photo-license/) 根据知识共享零 (CC0)*
...
- [Vid.stab](https://github.com/georgmartius/vid.stab) - *可以插入 Ffmpeg 和转码的视频稳定库*.
