...
作为经理，您对团队结构负有直接责任. 超过一定规模（大约 8 到 12 个，取决于来源），您不再有时间使用直接 IC，因此您需要重新组织团队.

在公司层面，重组主要是战略性的，你对他们的影响取决于你的政治敏锐度.
...
- [The SaaS Org Chart](https://sacks.substack.com/p/the-saas-org-chart) - 组织在其 50/125/400/1000 员工阶段的每个阶段的蓝图，以及典型的比率和 ARR.
...
- [An Alternative Approach to Re-Orgs At Your Company](https://caseyaccidental.com/alternative-approach-re-orgs/)  - “为了不重复重组错误，我们开始研究一种结构，使重组表现得像一个由团队而不是上级人员推动的反馈推动的进步.” 这是一种尝试从头开始提取指向结构不足的信号. 我的警示故事：这可能只能在一定程度上起作用，具体取决于公司的文化.
...
- [Speaking Truth to Power: Reflections on My Career at Microsoft](https://onezero.medium.com/speaking-truth-to-power-reflections-on-a-career-at-microsoft-90f80a449e36)  - 在一家存在严重缺陷的公司工作了 3 年之后，作者得出了一个谦虚的结论：领导者应该体现员工的价值. 不是反过来.  “高层的变化——而不是演讲、培训或标签——会产生最大的文化影响. 如果你想要真正持久的文化变革，就应该扫除在以前的文化下取得成功的白手起家的人，并提拔那些在外表、行为和思考上更像员工而不是经理的人.”
