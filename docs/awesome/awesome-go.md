 ...
 **Awesome Go 没有月费**_，但我们有员工 **努力工作** 来维持它的运行，筹集的资金可以回报每个人的努力！ 您可以看到我们如何计算我们的计费和分配，因为它对整个社区开放. 想成为项目的支持者点击 [here](https://github.com/avelino/awesome-go/blob/master/mailto:mailto:avelinorun+oss@gmail.com?subject=awesome-go%3A%20project%20support)._
...
- [asciigraph](https://github.com/guptarohit/asciigraph) - 在命令行应用程序中打包以制作轻量级 ASCII 线图╭┈╯，没有其他依赖项.
...
- [kong](https://github.com/alecthomas/kong) - 命令行解析器，支持任意复杂的命令行结构和其他配置源，如 YAML、JSON、TOML 等（“主销”的后继者）.
...
- [swap](https://github.com/oblq/swap)  - 基于构建环境递归地实例化/配置结构.  （YAML、TOML、JSON 和环境）.
...
- [nan](https://github.com/kak-tus/nan) - 一个库中的零分配可空结构，具有方便的转换功能、编组器和解组器.
...
- [gocache](https://github.com/eko/gocache) - 一个完整的 Go 缓存库，包含多个存储（内存、memcache、redis、...）、可链接、可加载、指标缓存等.
...
- [pREST](https://github.com/prest/prest) - 在任何 Postgres 应用程序（现有的或新的）上简化和加速开发，⚡ 即时、实时、高性能.
...
- [mpath](https://github.com/spacetab-io/mpath-go) - 用于 SQL 记录的 MPTT (Modified Preorder Tree Traversal) 包 - 物化路径实现.
- [ormlite](https://github.com/pupizoid/ormlite) - 轻量级的包，包含一些类似 ORM 的特性和 sqlite 数据库的助手.
...
- [errors](https://github.com/bnkamalesh/errors)  - 用于构建 Go 错误的直接替换. 这是一个最小的错误处理包，带有自定义错误类型、用户友好的消息、Unwrap &amp; Is. 具有非常易于使用和直接的辅助功能.
...
- [todotxt](https://github.com/1set/todotxt) - Gina Trapani 的图书馆 [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt).
...
- [go-astar](https://github.com/beefsack/go-astar) - 执行 A\* 寻路算法.
- [go-sdl2](https://github.com/veandco/go-sdl2) - 去绑定 [Simple DirectMedia Layer](https://www.libsdl.org/).
- [go3d](https://github.com/ungerik/go3d) - Go 的面向性能的 2D/3D 数学包.
...
- [copygen](https://github.com/switchupcb/copygen) - 无需反射即可生成类型到类型的代码.
...
- [go-linq](https://github.com/ahmetalpbalkan/go-linq) - Go 的.NET LINQ 类查询方法.
- [go-xray](https://github.com/pieterclaerhout/go-xray) - 帮助更轻松地使用反射.
- [goderive](https://github.com/awalterschulze/goderive) - 从输入类型派生函数.
- [gotype](https://github.com/wzshiming/gotype) - Golang 源码解析，使用类似反射包.
...
- [H3GeoDist](https://github.com/mmadfox/go-h3geo-dist) - 通过虚拟节点分配 Uber H3geo 单元.
...
- [artifex](https://github.com/borderstech/artifex) - 使用基于工作者的调度的 Golang 简单的内存中作业队列.
...
- [gowp](https://github.com/xxjwxc/gowp) - gowp 是限制并发的 goroutine 池.
- [gpool](https://github.com/Sherifabdlnaby/gpool) - 管理一个可调整大小的上下文感知 goroutine 池以绑定并发性.
...
- [Hunch](https://github.com/AaronJan/Hunch) - Hunch提供了`All`、`First`、`Retry`、`Waterfall`等功能，让异步流控更加直观.
- [kyoo](https://github.com/dirkaholic/kyoo) - 提供无限的作业队列和并发工作池.
- [neilotoole/errgroup](https://github.com/neilotoole/errgroup) - `sync/errgroup` 的替代方案，仅限于 N 个工作 goroutine 池.
- [nursery](https://github.com/arunsworld/nursery) - Go 中的结构化并发.
- [oversight](https://cirello.io/oversight) - Oversight 是 Erlang 监督树的完整实现.
...
- [queue](https://github.com/AnikHasibul/queue)  - 为您提供类似队列组可访问性的“sync.WaitGroup”. 帮助您限制和限制 goroutine，等待所有 goroutine 结束等等.
- [routine](https://github.com/x-mod/routine) - 带上下文的 go 例程控制，支持：Main、Go、Pool 和一些有用的 Executor.
...
- [mac-activity-tracker](https://github.com/prashantgupta24/activity-tracker) - OSX 库通知您机器上的任何（可插入）活动.
...
- [trayhost](https://github.com/shurcooL/trayhost) - 跨平台 Go 库在主机操作系统的任务栏中放置一个图标.
- [zenity](https://github.com/ncruces/zenity) - 跨平台的 Go 库和 CLI，用于创建与用户进行图形交互的简单对话框.
...
- [emgo](https://github.com/ziutek/emgo) - 用于编程嵌入式系统（例如 STM32 MCU）的 Go-like 语言.
- [ghw](https://github.com/jaypipes/ghw) - Golang 硬件发现/检查库.
- [go-osc](https://github.com/hypebeast/go-osc) - 为 Go 开放声音控制 (OSC) 绑定.
...
- [bimg](https://github.com/h2non/bimg) - 使用 libvips 快速高效地处理图像的小包.
- [cameron](https://github.com/aofei/cameron) - Go 的头像生成器.
- [canvas](https://github.com/tdewolff/canvas) - 将矢量图形转为 PDF、SVG 或光栅化图像.
...
- [go-cairo](https://github.com/ungerik/go-cairo) - 为 cairo 图形库绑定.
...
- [gocv](https://github.com/hybridgroup/gocv) - 使用 OpenCV 3.3+ 用于计算机视觉的 Go 软件包.
...
- [imaginary](https://github.com/h2non/imaginary) - 用于调整图像大小的快速简单的 HTTP 微服务.
...
- [smartcrop](https://github.com/muesli/smartcrop) - 为任意图像和作物尺寸找到好的作物.
- [steganography](https://github.com/auyer/steganography) - 用于 LSB 隐写术的纯 Go 库.
...
- [devices](https://github.com/goiot/devices) - 物联网设备库套件，对 x/exp/io 进行实验.
- [eywa](https://github.com/xcodersun/eywa) - Project Eywa 本质上是一个连接管理器，用于跟踪连接的设备.
- [flogo](https://github.com/tibcosoftware/flogo) - Flogo 项目是 IoT Edge 应用程序和集成的开源框架.
- [gatt](https://github.com/paypal/gatt) - Gatt 是一个用于构建低功耗蓝牙外围设备的 Go 包.
...
- [periph](https://periph.io/) - 外设 I/O 与底层板设备接口.
...
- [cheek](https://github.com/datarootsio/cheek) - 一个简单的类似 crontab 的调度程序，旨在为作业调度提供 KISS 方法.
- [clockwerk](https://github.com/onatm/clockwerk) - 使用简单、流畅的语法来安排定期作业.
- [cronticker](https://github.com/krayzpipes/cronticker) - 一个支持 cron 计划的股票代码实现.
...
- [gronx](https://github.com/adhocore/gronx) - Cron 表达式解析器、任务运行器和使用 crontab 的守护程序，如任务列表.
...
- [GJSON](https://github.com/tidwall/gjson) - 用一行代码获取一个 JSON 值.
...
- [jsongo](https://github.com/ricardolonga/jsongo) - 流利的 API 使创建 Json 对象变得更加容易.
...
- [OjG](https://github.com/ohler55/ojg) - 为 Go 优化的 JSON 是一种高性能解析器，具有包括 JSONPath 在内的各种附加 JSON 工具.
...
- [vjson](https://github.com/miladibra10/vjson) - 使用流式 API 声明 JSON 模式来验证 JSON 对象的 Go 包.
...
- [distillog](https://github.com/amoghe/distillog) - 蒸馏分级日志记录（将其视为标准库 + 日志级别）.
...
- [go-log](https://github.com/pieterclaerhout/go-log) - 带有 strack 跟踪、对象转储和可选时间戳的日志库.
...
- [gologger](https://github.com/sadlil/gologger) - 简单易用的日志库，用于登录彩色控制台、简单控制台、文件或 Elasticsearch.
- [gomol](https://github.com/aphistic/gomol) - 用于 Go 的多输出结构化日志记录，具有可扩展的日志记录输出.
- [gone/log](https://github.com/One-com/gone/tree/master/log) - 快速、可扩展、功能齐全、std-lib 源代码兼容的日志库.
...
- [log](https://github.com/teris-io/log) - Go 的结构化日志接口清晰地将日志记录外观与其实现分开.
...
- [mlog](https://github.com/jbrodriguez/mlog) - 简单的 go 日志模块，有 5 个级别，可选的旋转日志文件功能和 stdout/stderr 输出.
...
- [slf4g](https://github.com/echocat/slf4g)  - Golang 的简单日志外观：简单的结构化日志； 但功能强大、可扩展和可定制，从过去数十年的日志框架中汲取了大量经验.
- [spew](https://github.com/davecgh/go-spew) - 为 Go 数据结构实现一个深度漂亮的打印机以帮助调试.
- [sqldb-logger](https://github.com/simukti/sqldb-logger) - Go SQL 数据库驱动程序的记录器，无需修改现有的 *sql.DB 标准库使用.
- [stdlog](https://github.com/alexcesaro/log)  - Stdlog 是一个提供分级日志的面向对象的库. 它对 cron 作业非常有用.
...
- [xlog](https://github.com/rs/xlog) - 具有灵活调度的 `net/context` 感知 HTTP 处理程序的结构化记录器.
...
- [go-cluster](https://github.com/e-XpertSolutions/go-cluster) - 执行 k-modes 和 k-prototypes 聚类算法.
...
- [shield](https://github.com/eaigner/shield) - 带有灵活标记器和 Go 存储后端的贝叶斯文本分类器.
...
- [Beaver](https://github.com/Clivern/Beaver) - 实时消息服务器，用于构建可扩展的应用内通知、多人游戏、网络聊天应用和移动应用.
- [Benthos](https://github.com/Jeffail/benthos) - 一系列协议之间的消息流桥.
- [Bus](https://github.com/mustafaturan/bus) - 用于内部通信的简约消息总线实现.
...
- [Commander](https://github.com/jeroenrinzema/commander) - 支持各种“方言”（例如 Apache Kafka）的高级事件驱动的消费者/生产者.
- [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go 是 Confluent 的 Golang 客户端，用于 Apache Kafka 和 Confluent 平台.
...
- [go-socket.io](https://github.com/googollee/go-socket.io) - golang 的 socket.io 库，一个实时应用程序框架.
- [go-vitotrol](https://github.com/maxatome/go-vitotrol) - Viessmann Vitotrol 网络服务的客户端库.
...
- [guble](https://github.com/smancke/guble) - 消息服务器使用推送通知（Google Firebase 云消息传递、Apple 推送通知服务、SMS）以及 websockets，一个 REST API，具有分布式操作和消息持久性.
...
- [go-excel](https://github.com/szyhf/go-excel) - 一个简单而轻便的阅读器，可以将类似相关数据库的 excel 作为表格读取.
...
- [xlsx](https://github.com/plandem/xlsx) - 在 Go 程序中读取/更新现有 Microsoft Excel 文件的快速且安全的方式.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) - 一种 [starter kit](https://github.com/ardanlabs/service/wiki) 用于构建生产级可扩展 Web 服务应用程序.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  - Go 生态系统中一组常见的历史和新兴项目布局模式. 注意：尽管 org-name 不代表官方 golang 标准，请参阅 [this issue](https://github.com/golang-standards/project-layout/issues/117) 了解更多信息. 尽管如此，有些人可能会发现布局很有用.
...
- [pagoda](https://github.com/mikestefanello/pagoda) - Go 中内置的快速、简单的全栈 Web 开发入门工具包.
...
- [bexp](https://github.com/mkungla/bexp) - 执行大括号扩展机制以生成任意字符串.
...
- [anagent](https://github.com/mudler/anagent) - 具有依赖注入的简约、可插拔的 Golang evloop/timer 处理程序.
- [antch](https://github.com/antchfx/antch) - 一个快速、强大和可扩展的网络爬取和抓取框架.
- [archiver](https://github.com/mholt/archiver) - 用于制作和提取 .zip 和 .tar.gz 档案的库和命令.
- [autoflags](https://github.com/artyom/autoflags) - 转到包以从结构字段中自动定义命令行标志.
...
- [captcha](https://github.com/steambap/captcha) - 验证码包为验证码生成提供了一个易于使用、无偏见的 API.
- [conv](https://github.com/cstockton/go-conv) - 包 conv 提供跨 Go 类型的快速和直观的转换.
- [datacounter](https://github.com/miolini/datacounter) - 读者/作家/http.ResponseWriter 的计数器.
...
- [gosh](https://github.com/osamingo/gosh) - 提供 Go Statistics Handler、Struct、Measure Method.
- [gosms](https://github.com/haxpax/gosms) - 您自己的 Go 中的本地 SMS 网关，可用于发送 SMS.
...
- [metrics](https://github.com/pascaldekloe/metrics) - 度量仪器和普罗米修斯博览会的图书馆.
- [morse](https://github.com/alwindoss/morse) - 与莫尔斯电码相互转换的库.
- [numa](https://github.com/lrita/numa)  - NUMA 是一个实用程序库，它是用 go 编写的. 它可以帮助我们编写一些 NUMA-AWARED 代码.
...
- [govader-backend](https://github.com/PIMPfiction/govader_backend) - 微服务实现 [GoVader](https://github.com/jonreiter/govader).
...
- [spelling-corrector](https://github.com/jorelosorio/spellingcorrector) - 西班牙语拼写校正器或创建您自己的.
...
- [Slugify](https://github.com/avelino/slugify) - 去 slugify 处理字符串的应用程序.

### Tokenizers

- [gojieba](https://github.com/yanyiwu/gojieba) - 这是一个 Go 实现 [jieba](https://github.com/fxsjy/jieba) 这是一个中文分词算法.
...
- [MMSEGO](https://github.com/awsong/MMSEGO) - 这是一个 GO 实现 [MMSEG](http://technology.chtsai.org/mmseg/) 这是一个中文分词算法.
...
- [go-i18n](https://github.com/nicksnyder/go-i18n/) - 打包和附带的工具来处理本地化文本.
...
- [enca](https://github.com/endeveit/enca) - 最小的 cgo 绑定 [libenca](https://cihar.com/software/enca/)，它检测字符编码.
...
- [ethernet](https://github.com/mdlayher/ethernet) - 包以太网实现了 IEEE 802.3 以太网 II 帧和 IEEE 802.1Q VLAN 标签的编组和解组.
...
- [gldap](https://github.com/jimlambrt/gldap) - gldap 提供了一个 ldap 服务器实现，您为它的 ldap 操作提供了处理程序.
- [gmqtt](https://github.com/DrmagicE/gmqtt) - Gmqtt是一个灵活、高性能的MQTT代理库，完全实现了MQTT协议V3.1.1.
...
- [go-stun](https://github.com/ccding/go-stun) - 执行 STUN 客户端（RFC 3489 和 RFC 5389）.
...
- [goshark](https://github.com/sunwxg/goshark) - 打包 goshark 使用 tshark 解码 IP 数据包并创建数据结构来分析数据包.
...
- [iplib](https://github.com/c-robinson/iplib) - 受 python 启发的用于处理 IP 地址（net.IP、net.IPNet）的库 [ipaddress](https://docs.python.org/3/library/ipaddress.html) 和红宝石 [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html)
...
- [lhttp](https://github.com/fanux/lhttp) - 强大的websocket框架，构建你的IM服务器更轻松.
...
- [nbio](https://github.com/lesismal/nbio) - 纯Go 1000k+连接方案，支持tls/http1.x/websocket，基本兼容net/http，高性能低内存，非阻塞，事件驱动，简单易用.
...
- [peerdiscovery](https://github.com/schollz/peerdiscovery) - Pure Go 库，用于使用 UDP 多播的跨平台本地对等点发现.
- [portproxy](https://github.com/aybabtme/portproxy) - 简单的 TCP 代理向不支持它的 API 添加 CORS 支持.
...
- [sftp](https://github.com/pkg/sftp)  - 包 sftp 实现 SSH 文件传输协议，如中所述<https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt> .
...
- [gl](https://github.com/go-gl/gl) - OpenGL 的 Go 绑定（通过发光生成）.
...
- [cacheme](https://github.com/Yiling-J/cacheme-go) - 用于 Go 的基于模式的类型化 Redis 缓存/memoize 框架.
...
- [golobby/orm](https://github.com/golobby/orm) - 简单、快速、类型安全、通用的形式，让开发者快乐.
...
- [reform](https://github.com/go-reform/reform) - 基于非空接口和代码生成的 Go 更好的 ORM.
...
- [upper.io/db](https://github.com/upper/db) - 通过使用包含成熟数据库驱动程序的适配器与不同数据源进行交互的单一接口.
- [XORM](https://gitea.com/xorm/xorm)  - Go 的简单而强大的 ORM.  （支持：MySQL、MyMysql、PostgreSQL、Tidb、SQLite3、MsSql 和 Oracle）.
...
- [gom](https://github.com/mattn/gom) - 围棋经理 - 围棋捆绑.
...
- [govendor](https://github.com/kardianos/govendor)  - 去包管理器. 使用标准供应商文件的 Go 供应商工具.
...
- [mvn-golang](https://github.com/raydac/mvn-golang) - 在 Maven 项目基础设施中为 Golang SDK 的自动加载、依赖管理和启动构建环境提供方式的插件.
...
- [graphql-go](https://github.com/graphql-go/graphql) - 为 Go 实现 GraphQL.
...
- [esc](https://github.com/mjibson/esc) - 将文件嵌入到 Go 程序中，并为它们提供 http.FileSystem 接口.
- [fileb0x](https://github.com/UnnoTed/fileb0x) - 将文件嵌入到 go 中的简单工具，重点是“定制”和易用性.
- [go-resources](https://github.com/omeid/go-resources) - 用 Go 嵌入的奇怪资源.
...
- [go-dsp](https://github.com/mjibson/go-dsp) - 围棋数字信号处理.
...
- [gonum](https://github.com/gonum/gonum)  - Gonum 是一组用于 Go 编程语言的数值库. 它包含矩阵、统计、优化等库.
...
- [rootfinding](https://github.com/khezen/rootfinding) - 求根算法库，用于求二次函数的根.
...
- [BadActor](https://github.com/jaredfolkins/badactor) - 本着 fail2ban 的精神构建的内存中应用程序驱动的监狱器.
...
- [CertMagic](https://github.com/caddyserver/certmagic) - 成熟、强大且强大的 ACME 客户端集成，用于完全托管的 TLS 证书颁发和续订.
...
- [firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) - 在 linux 服务器上动态更新防火墙规则的 rest 应用程序.
...
- [go-password-validator](https://github.com/lane-c-wagner/go-password-validator) - 基于原始密码熵值的密码验证器.
...
- [optimus-go](https://github.com/pjebs/optimus-go) - 使用 Knuth 算法的 ID 散列和混淆.
- [passlib](https://github.com/hlandau/passlib) - 面向未来的密码哈希库.
- [secret](https://github.com/rsjethani/secret) - 防止您的秘密泄露到日志、std* 等中.
- [secure](https://github.com/unrolled/secure) - 用于 Go 的 HTTP 中间件有助于快速获得一些安全性胜利.
...
- [themis](https://github.com/cossacklabs/themis) - 用于解决典型数据安全任务（安全数据存储、安全消息传递、零知识证明认证）的高级加密库，可用于 14 种语言，最适合多平台应用程序.
...
- [cbor](https://github.com/fxamacker/cbor) - 小巧、安全、简单的 CBOR 编解码库.
- [colfer](https://github.com/pascaldekloe/colfer) - Colfer 二进制格式的代码生成.
- [csvutil](https://github.com/jszwec/csvutil) - 高性能、惯用的 CSV 记录编码和解码到原生 Go 结构.
- [elastic](https://github.com/epiclabs-io/elastic) - 无论如何，在运行时跨不同类型转换切片、映射或任何其他未知值.
...
- [jsoniter](https://github.com/json-iterator/go) - 高性能 100% 兼容的“encoding/json”替换.
...
- [structomap](https://github.com/tuvistavie/structomap) - 库可轻松动态地从静态结构生成地图.
...
- [dummy](https://github.com/neotoolkit/dummy) - 使用一个命令运行基于 API 合同的模拟服务器.
...
- [riemann-relay](https://github.com/blind-oracle/riemann-relay) - 中继以负载平衡黎曼事件和/或将它们转换为碳.
...
- [Wish](https://github.com/charmbracelet/wish) - 制作 SSH 应用程序，就这样！
...
- [extemplate](https://github.com/dannyvankooten/extemplate) - 围绕 html/template 的微小包装，以允许基于文件的简单模板继承.
- [fasttemplate](https://github.com/valyala/fasttemplate)  - 简单快速的模板引擎. 替换模板占位符的速度比以前快 10 倍 [text/template](https://golang.org/pkg/text/template/).
...
- [maroto](https://github.com/johnfercher/maroto)  - 一种创建 PDF 的 maroto 方式.  Maroto 受到 Bootstrap 的启发并使用 gofpdf. 快速简单.
...
- 测试框架
  ...
  - [cupaloy](https://github.com/bradleyjkemp/cupaloy) - 用于您的测试框架的简单快照测试插件.
  ...
  - [gnomock](https://github.com/orlangure/gnomock) - 与在 Docker 中运行的真实依赖项（数据库、缓存，甚至 Kubernetes 或 AWS）的集成测试，无需模拟.
  ...
  - [GoConvey](https://github.com/smartystreets/goconvey/) - 带有 Web UI 和实时重新加载的 BDD 样式框架.
  - [gocrest](https://github.com/corbym/gocrest) - 用于 Go 断言的可组合的 hamcrest 式匹配器.
  ...
  - [Hamcrest](https://github.com/rdrdr/hamcrest) - 用于声明性匹配器对象的流畅框架，当应用于输入值时，会产生自描述结果.
  - [httpexpect](https://github.com/gavv/httpexpect) - 简洁、声明性和易于使用的端到端 HTTP 和 REST API 测试.
  ...
  - [testfixtures](https://github.com/go-testfixtures/testfixtures) - Rails 的帮助工具，用于测试数据库应用程序.
  ...
  - [testza](https://github.com/MarvinJWendt/testza) - 功能齐全的测试框架，带有漂亮的彩色输出.
...
- 嘲笑
  ...
  - [timex](https://github.com/cabify/timex) - 对原生 `time` 包的测试友好的替代品.
...
- Selenium 和浏览器控制工具.
  ...
  - [playwright-go](https://github.com/mxschmitt/playwright-go) - 浏览器自动化库，通过单一 API 控制 Chromium、Firefox 和 WebKit.
...
- 注入失败
  - [failpoint](https://github.com/pingcap/failpoint) - 一个实施 [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) 对于 Golang.
...
- [textwrap](https://github.com/isbm/textwrap)  - 在行尾换行. 从 Python 实现 `textwrap` 模块.
...
- [go-output-format](https://github.com/drewstinnett/go-output-format) - 在您的命令行应用程序中将 go 结构输出为多种格式（YAML/JSON/等）.
...
- [xj2go](https://github.com/stackerzzq/xj2go) - 将 xml 或 json 转换为结构.

### Regular Expressions

- [genex](https://github.com/alixaxel/genex) - 将正则表达式计数并扩展为所有匹配的字符串.
...
- [gospider](https://github.com/zhshch2002/gospider)  - 一个简单的 golang 蜘蛛/爬虫框架，用 3 行构建一个蜘蛛. 迁移自 [goribot](https://github.com/zhshch2002/goribot)
...
- [kace](https://github.com/codemodus/kace) - 常见的大小写转换，涵盖常见的首字母缩写.
...
- [airtable](https://github.com/mehanizm/airtable) - Go 客户端库 [Airtable API](https://airtable.com/api).
- [amazon-product-advertising-api](https://github.com/ngs/go-amazon-product-advertising-api) - Go 客户端库 [Amazon Product Advertising API](https://affiliate-program.amazon.com/gp/advertising/api/detail/main.html).
...
- [bqwriter](https://github.com/OTA-Insight/bqwriter) - 将数据写入高级 Go 库 [Google BigQuery](https://cloud.google.com/bigquery) 全程处于高位.
...
- [clarifai](https://github.com/samuelcouch/clarifai) - 用于与 Clarifai API 交互的客户端库.
...
- [device-check-go](https://github.com/rinchsan/device-check-go) - 用于交互的 Go 客户端库 [iOS DeviceCheck API](https://developer.apple.com/documentation/devicecheck) v1.
...
- [go-aws-news](https://github.com/circa10a/go-aws-news) - 使用应用程序和库从 AWS 获取新功能.
...
- [go-openproject](https://github.com/manuelbcd/go-openproject) - 用于交互的 Go 客户端库 [OpenProject](https://docs.openproject.org/api/) API.
...
- [go-sophos](https://github.com/esurdam/go-sophos) - Go 客户端库 [Sophos UTM REST API](https://www.sophos.com/en-us/medialibrary/PDFs/documentation/UTMonAWS/Sophos-UTM-RESTful-API.pdf?la=en) 零依赖.
- [go-sptrans](https://github.com/sergioaugrod/go-sptrans) - 用于 SPTrans Olho Vivo API 的 Go 客户端库.
- [go-swagger-ui](https://github.com/esurdam/go-swagger-ui) - 包含预编译的 Go 库 [Swagger UI](https://swagger.io/tools/swagger-ui/) 用于服务招摇 json.
...
- [go-unsplash](https://github.com/hbagdi/go-unsplash) - Go 客户端库 [Unsplash.com](https://unsplash.com) API.
- [go-xkcd](https://github.com/nishanths/go-xkcd) - 用于 xkcd API 的客户端.
- [go-yapla](https://git.iglou.eu/Production/go-yapla) - 适用于 Yapla v2.0 API 的 Go 客户端库.
...
- [gopaapi5](https://github.com/utekaravinash/gopaapi5) - Go 客户端库 [Amazon Product Advertising API 5.0](https://webservices.amazon.com/paapi5/documentation/).
...
- [lastpass-go](https://github.com/ansd/lastpass-go) - Go 客户端库 [LastPass](https://www.lastpass.com/) API.
- [libgoffi](https://github.com/clevabit/libgoffi) - 本机的库适配器工具箱 [libffi](https://sourceware.org/libffi/) 一体化
...
- [newsapi-go](https://github.com/jellydator/newsapi-go) - 去客户 [NewsAPI](https://newsapi.org/).
...
- [simples3](https://github.com/rhnvrm/simples3) - 简单简洁的 AWS S3 库，使用 REST 和用 Go 编写的 V4 签名.
...
- [stripe](https://github.com/stripe/stripe-go) - 用于 Stripe API 的客户端.
- [textbelt](https://github.com/dietsche/textbelt) - 用于 textbelt.com txt 消息传递 API 的客户端.
...
- [wit-go](https://github.com/wit-ai/wit-go) - 使用 wit.ai HTTP API 的客户端.
- [ynab](https://github.com/brunomvsouza/ynab.go) - 为 YNAB API 封装.
- [zooz](https://github.com/gojuno/go-zooz) - Zooz API 的 Go 客户端.


## Utilities

_使您的生活更轻松的通用实用程序和工具._
...
- [beyond](https://github.com/wesovilabs/beyond) - 带您进入 AOP 世界的 Go 工具！
...
- [changie](https://github.com/miniscruff/changie) - 自动更改日志工具，用于准备具有大量自定义选项的版本.
...
- [filetype](https://github.com/h2non/filetype) - 小包推断文件类型检查幻数签名.
...
- [go-funk](https://github.com/thoas/go-funk) - 现代 Go 实用程序库，提供帮助程序（map、find、contains、filter、chunk、reverse，...）.
...
- [go-lock](https://github.com/viney-shih/go-lock) - go-lock 是一个锁库，实现了读写互斥锁和读写 trylock 而不会出现饥饿.
- [go-pkg](https://github.com/chenquan/go-pkg) - 一个围棋工具包.
...
- [goback](https://github.com/carlescere/goback) - 使用简单的指数退避包.
...
- [goreadability](https://github.com/philipjkim/goreadability) - 网页摘要提取器使用 Facebook Open Graph 和 arc90 的可读性.
...
- [gpath](https://github.com/tenntenn/gpath) - 使用 Go 在反射中的表达式简化访问结构字段的库.
...
- [jump](https://github.com/gsamokovarov/jump) - Jump通过学习你的习惯帮助你更快地导航.
- [koazee](https://github.com/wesovilabs/koazee) - 受惰性评估和函数式编程启发的库，消除了使用数组的麻烦.
...
- [mc](https://github.com/minio/mc) - Minio Client 提供最少的工具来处理与 Amazon S3 兼容的云存储和文件系统.
...
- [objwalker](https://github.com/rekby/objwalker) - 走过去有反射的物体.
...
- [rest-go](https://github.com/edermanoel94/rest-go) - 一个包，它提供了许多使用 rest api 的有用方法.
- [retry](https://github.com/kamilsk/retry) - 重复执行动作直到成功的最先进的功能机制.
...
- [scany](https://github.com/georgysavva/scany) - 用于将数据库中的数据扫描到 Go 结构等中的库.
...
- [silk](https://github.com/chrispassas/silk) - 阅读丝绸 netflow 文件.
...
- [sshman](https://github.com/shoobyban/sshman) - 用于多个远程服务器上的授权密钥文件的 SSH 管理器.
...
- [throttle](https://github.com/yudppp/throttle) - 油门是一个在每个持续时间内将执行一个动作的对象.
- [tik](https://github.com/andy2046/tik) - 简单易用的 Go 计时轮包.
- [tome](https://github.com/cyruzin/tome) - Tome 旨在为简单的 RESTful API 分页.
- [toolbox](https://github.com/viant/toolbox)  - 切片、映射、多重映射、结构、函数、数据转换实用程序. 服务路由器、宏评估器、标记器.
...
- [ulid](https://github.com/oklog/ulid) - 执行 ULID（通用唯一字典排序标识符）.
- [uniq](https://gitlab.com/skilstak/code/go/uniq) - 没有麻烦的安全，快速的命令唯一标识符.
...
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - 支持使用通常代码结构中指定的可配置和可扩展验证规则而不是结构标记来验证各种数据类型（结构、字符串、映射、切片等）.
- [terraform-validator](https://github.com/thazelart/terraform-validator) - Terraform 的规范和约定验证器.
- [validate](https://github.com/gookit/validate)  - 用于数据验证和过滤的包. 支持验证 Map、Struct、Request(Form、JSON、url.Values、Uploaded Files) 数据等功能.
...
- [git2go](https://github.com/libgit2/git2go) - 为 libgit2 绑定.
- [githooks](https://github.com/gabyx/githooks) - 具有版本控制和自动更新的每个 repo 和共享 Git 挂钩.
...
- [anoweb](https://github.com/go-the-way/anoweb) - 轻量级和强大的 Web 框架，使用 Go.Another 的新方式.
- [appy](https://github.com/appist/appy) - 一个固执己见的高效网络框架，有助于更轻松地扩展业务.
...
- [Gondola](https://github.com/rainycape/gondola) - 用于更快地编写网站的 Web 框架.
...
- [goweb](https://github.com/twharmon/goweb) - 带有路由、websockets、日志记录、中间件、静态文件服务器（可选 gzip）和自动 TLS 的 Web 框架.
...
- [Macaron](https://github.com/go-macaron/macaron) - Macaron 是 Go 语言中的高产模块化设计 Web 框架.
- [mango](https://github.com/paulbellamy/mango) - Mango 是一个模块化的 Go 网络应用程序框架，灵感来自 Rack 和 PEP333.
...
- [rk-boot](https://github.com/rookie-ninja/rk-boot) - 一个引导库，用于使用 Gin 和 gRPC 快速轻松地构建企业微服务.
...
- [WebGo](https://github.com/bnkamalesh/webgo)  - 构建网络应用程序的微框架； 处理程序链接、中间件和上下文注入. 使用符合标准库的 HTTP 处理程序（即 http.HandlerFunc）.
...
- [formjson](https://github.com/rs/formjson) - 透明地处理 JSON 输入作为标准表单 POST.
...
- [catena](https://github.com/codemodus/catena) - http.Handler 包装连接（与“链”相同的 API）.
- [chain](https://github.com/codemodus/chain) - 处理程序包装链与范围数据（基于网络/上下文的“中间件”）.
...
- [interpose](https://github.com/carbocation/interpose) - golang 的极简主义 net/http 中间件.
- [mediary](https://github.com/HereMobilityDevelopers/mediary) - 添加拦截器到 `http.Client` 以允许转储/整形/跟踪/...请求/响应.
...
- [fasthttprouter](https://github.com/buaazp/fasthttprouter)  - 从 `httprouter` 派生的高性能路由器. 第一个适合`fasthttp`的路由器.
...
- [lars](https://github.com/go-playground/lars) - 是用于创建可定制框架的轻量级、快速和可扩展的零分配 HTTP 路由器.
- [mux](https://github.com/gorilla/mux) - 强大的 URL 路由器和 golang 调度程序.
- [nchi](https://github.com/muir/nchi) - 基于 httprouter 的 chi-like 路由器，带有基于依赖注入的中间件包装器
...
- [violetear](https://github.com/nbari/violetear) - 使用 HTTP 路由器.
- [xmux](https://github.com/rs/xmux) - 基于 `httprouter` 的高性能多路复用器，支持 `net/context`.
- [xujiajun/gorouter](https://github.com/xujiajun/gorouter) - Go 的简单快速的 HTTP 路由器.


## WebAssembly

- [dom](https://github.com/dennwc/dom) - DOM 库.
- [go-canvas](https://github.com/markfarnan/go-canvas) - 使用 HTML5 Canvas 的库，所有绘图都包含在 go 代码中.
- [tinygo](https://github.com/tinygo-org/tinygo)  - 小地方的 Go 编译器. 微控制器、WebAssembly 和命令行工具. 基于 LLVM.
...
- [xmlwriter](https://github.com/shabbyrobe/xmlwriter) - 基于 libxml2 的 xmlwriter 模块的程序化 XML 生成 API.
...
- [apicompat](https://github.com/bradleyfalzon/apicompat) - 检查最近对 Go 项目的更改以查找向后不兼容的更改.
...
- [tarp](https://github.com/verygoodsoftwarenotvirus/tarp) - tarp 在 Go 源代码中无需直接单元测试即可查找函数和方法.
...
- [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) - 未使用检查 Go 代码中未使用的常量、变量、函数和类型.
...
- [go-plus](https://github.com/joefitzgerald/go-plus) - 用于 Atom 的 Go (Golang) 包，添加了自动完成、格式化、语法检查、Linting 和审查.
...
- [vscode-go](https://github.com/golang/vscode-go) - 为 Go 语言提供支持的 Visual Studio Code (VS Code) 扩展.
...
- [gocontracts](https://github.com/Parquery/gocontracts) - 通过将代码与文档同步，将按合同设计带到 Go.
- [godal](https://github.com/mafulong/godal) - 通过指定sql ddl文件生成golang对应的orm模型，gorm可以使用.
...
- [colorgo](https://github.com/songgao/colorgo) - 围绕 `go` 命令包装彩色 `go build` 输出.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) - 使用点格式可视化你的 Go 程序的调用图.
...
- [Balerter](https://github.com/balerter/balerter) - 自托管的基于脚本的警报管理器.
...
- [gobrew](https://github.com/cryptojuice/gobrew) - gobrew 让您可以轻松地在 go 的多个版本之间切换.
...
- [gox](https://github.com/mitchellh/gox) - 死的简单，没有多余的装饰去交叉编译工具.
...
- [Mizu](https://github.com/up9inc/mizu) - 用于 Kubernetes 的 API 流量查看器，使您能够查看微服务之间的所有 API 通信，多协议支持：HTTP1.1、HTTP/2、AMQP、Kafka、Redis.
...
- [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) - Terraform 提供程序插件，在运行时根据包含公开 API 定义的 OpenAPI 文档（以前称为 swagger 文件）动态配置自身.
- [traefik](https://github.com/containous/traefik) - 支持多个后端的反向代理和负载均衡器.
- [trubka](https://github.com/xitonix/trubka) - 一个用于管理和排除 Apache Kafka 集群故障的 CLI 工具，具有向/从 Kafka 发布/使用协议缓冲区和纯文本事件的一般能力.
- [uTask](https://github.com/ovh/utask) - 建模和执行在 yaml 中声明的业务流程的自动化引擎.
- [Vegeta](https://github.com/tsenart/vegeta)  - HTTP 负载测试工具和库. 超过9000！
- [wait-for](https://github.com/dnnrly/wait-for)  - 等待某事发生（从命令行），然后再继续. 轻松编排 Docker 服务和其他内容.
...
- [Better Go Playground](https://goplay.tools) - 带有语法高亮、代码完成和其他功能的游乐场.
...
- [goblin](https://goblin.reaper.im) - 由 goblins 构建的卷曲 Golang 二进制文件.
- [GoBoy](https://github.com/Humpheh/goboy) - 用 Go 编写的 Nintendo Game Boy Color 模拟器.
- [gocc](https://github.com/goccmack/gocc) - Gocc 是一个用 Go 编写的 Go 编译器工具包.
- [GoDocTooltip](https://github.com/diankong/GoDocTooltip) - Go Doc 站点的 Chrome 扩展，在功能列表中将功能描述显示为工具提示.
- [Gokapi](https://github.com/Forceu/gokapi)  - 用于共享文件的轻量级服务器，这些文件会在一定的下载量或数天后过期. 类似于 Firefox Send，但没有公开上传.
...
- [Leaps](https://github.com/jeffail/leaps) - 使用 Operational Transforms 配对编程服务.
- [lgo](https://github.com/yunabe/lgo)  - 使用 Jupyter 进行交互式 Go 编程. 它支持代码完成、代码检查和 100% Go 兼容性.
- [limetext](https://limetext.github.io) - Lime Text 是一个强大而优雅的文本编辑器，主要在 Go 中开发，旨在成为 Sublime Text 的免费和开源软件继任者.
- [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE 是一个简单的、开源的、跨平台的 Go IDE.
- [mockingjay](https://github.com/quii/mockingjay-server)  - 从一个配置文件中伪造 HTTP 服务器和消费者驱动的合同. 您还可以让服务器随机出现异常行为，以帮助进行更真实的性能测试.
- [myLG](https://github.com/mehrdadrad/mylg) - 用 Go 编写的命令行网络诊断工具.
- [naclpipe](https://github.com/unix4fun/naclpipe) - 简单的基于 NaCL EC25519 的加密管道工具，用 Go 编写.
- [Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay)  - 牛赛重生了. 为新时代.
...
- [protoncheck](https://github.com/servusdei2018/protoncheck) - 用于waybar/polybar/yabar/i3blocks 的 ProtonMail 模块.
...
- [stew](https://github.com/marwanhawari/stew) - 用于已编译二进制文件的独立包管理器.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) - 代理来模拟自动化测试的网络和系统条件.
...
- [wellington](https://github.com/wellington/wellington) - Sass 项目管理工具，用 sprite 函数扩展语言（如 Compass）.
...
- [go-json-benchmark](https://github.com/zerosnake0/go-json-benchmark) - 去 JSON 基准测试.
...
- [golang-sql-benchmark](https://github.com/tyler-smith/golang-sql-benchmark) - 收集流行的 Go 数据库/SQL 实用程序的基准.
...
- [Writing An Interpreter In Go](https://interpreterbook.com) - 这本书介绍了数十种用于编写惯用、富有表现力和高效的 Go 代码的技术，以避免常见的陷阱.
...
- [How To Code in Go eBook](https://www.digitalocean.com/community/books/how-to-code-in-go-ebook) - 针对首次开发人员的 600 页 Go 简介.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - Maria Letta 的 Gopher 图形包，带有矢量和光栅的插图和情感字符.
- [Go-gopher-Vector](https://github.com/keygx/Go-gopher-Vector) - 去 gopher 矢量数据 [.ai, .svg].
...
- [gophers](https://github.com/scraly/gophers) - Aurélie Vache 的地鼠.
...
- [Go In 5 Minutes](https://www.goin5minutes.com/) - 5 分钟的截屏视频专注于完成一件事.
...
- [Golang Resources](https://golangresources.com) - 精选学习围棋的最佳文章、练习、讲座和视频.
...
- [justforfunc](https://www.youtube.com/c/justforfunc) - 专注于 Go 编程语言提示和技巧的 Youtube 频道，由 Francesc Campoy 主持 [@francesc](https://twitter.com/francesc).
- [Learn Go Programming](https://blog.learngoprogramming.com) - 通过插图学习围棋概念.
- [Lille Gophers](https://lille-gophers.loscrackitos.codes/) - 法国里尔的 Golang 对话社区（[@LilleGophers](https://twitter.com/LilleGophers)).
...
- [A Guide to Golang E-Commerce](https://snipcart.com/blog/golang-ecommerce-ponzu-cms-demo?utm_term=golang-ecommerce-ponzu-cms-demo) - 为电子商务构建 Golang 网站（包括演示）.
...
- [Building and Testing a REST API in Go with Gorilla Mux and PostgreSQL](https://semaphoreci.com/community/tutorials/building-and-testing-a-rest-api-in-go-with-gorilla-mux-and-postgresql) - 我们将在强大的 Gorilla Mux 的帮助下编写一个 API.
...
- [Debugged.it Go patterns](https://github.com/haveyoudebuggedit/go-patterns) - 高级 Go 模式和可立即运行的示例.
...
- [Games With Go](https://gameswithgo.org/) - 一个视频系列教学编程和游戏开发.
- [Go By Example](https://gobyexample.com/) - 使用带注释的示例程序动手介绍 Go.
- [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - 围棋的参考卡.
...
- [Go Playground for iOS](https://codeplayground.app) - 在您的移动设备上交互式地编辑和播放 Go 片段.
...
- [How to Use Godog for Behavior-driven Development in Go](https://semaphoreci.com/community/tutorials/how-to-use-godog-for-behavior-driven-development-in-go) - 开始使用 Godog — 一个用于构建和测试 Go 应用程序的行为驱动的开发框架.
- [Implementing CRUD in Golang REST API with Mux & GORM](https://codewithmukesh.com/blog/implementing-crud-in-golang-rest-api/)  - 使用 MUX、GORM、MySQL、Viper 和干净的文件夹分离从头开始构建 CRUD Golang REST API. 整个源代码也包括在内！
...
- [Saving a Third of Our Memory by Re-ordering Go Struct Fields](https://qvault.io/golang/struct-field-ordering-memory/) - Go 结构中的字段排序效率如何.
- [The world’s easiest introduction to WebAssembly with Golang](https://medium.com/@martinolsansky/webassembly-with-golang-is-fun-b243c0e34f02)
- [Working with Go](https://github.com/mkaz/working-with-go) - 介绍给有经验的程序员.
