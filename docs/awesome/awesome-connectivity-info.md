...
<div align="center">
  ...
  <br>
  <sup>灵感来自 Sindre Sorhus 的<a href="https://awesome.re">精彩列表</a></sup>
  <br>
</div>

## [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)

连接索引、地图和报告的列表，可帮助您更好地了解谁可以访问通信基础设施以及访问条件. 公共领域的所有信息.

<sub>更多关于我的连接</sub> [website](https://manypossibilities.net) 或在 [twitter](https://twitter.com/stevesong).</sub>
...
**[`^        back to top        ^`](#)**
 ...
 - 国际电联衡量数字发展：包含最重要的 ICT 指标概览，包括对本年度的估计.  ([2021](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/FactsFigures2021.pdf)) ([2020](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/FactsFigures2020.pdf)) 
- 网络就绪指数 - ([2021](https://networkreadinessindex.org/wp-content/uploads/reports/nri_2021.pdf))([2020](https://networkreadinessindex.org/wp-content/uploads/2020/11/NRI-2020-V8_28-11-2020.pdf)) ([2019](https://networkreadinessindex.org/2019/wp-content/uploads/2020/03/The-Network-Readiness-Index-2019-New-version-March-2020-2.pdf)) 网络就绪指数，涵盖来自 Portulans Institute 的 121 个经济体
- [GSMA Mobile Connectivity Index](https://www.mobileconnectivityindex.com/) - (2019) 衡量各国采用移动互联网的四个推动因素：基础设施、可负担性、消费者准备度和内容.
- [A4AI Affordability Drivers Index](https://a4ai.org/affordability-report/data/?_year=2020&indicator=INDEX) - (2020) 负担得起的互联网接入联盟的互联网负担能力指数（[A4AI](https://a4ai.org)).
...
- [Facebook/EIU Inclusive Internet Index](https://theinclusiveinternet.eiu.com/) - (2020) 根据可用性、可负担性、相关性和准备情况衡量互联网连接的指数.
- [Huawei Global Connectivity Index](http://www.huawei.com/minisite/gci/en/) - (2017) 根据供应、需求、经验和潜力衡量的 50 个国家的“数字化转型”状态快照.
...
- [ITU Broadband Atlas](https://www.itu.int/ITU-D/treg/atlas/broadbandatlas.asp) - (2010) 展示全球宽带部署状况和宽带监管格局的交互式信息图表工具.
- [InternetLiveStats](http://www.internetlivestats.com/internet-users-by-country/) - (2016) 按国家/地区划分的互联网用户，根据国际电联、联合国人口司、印度互联网和移动协会 (IAMAI) 和世界银行数据进行插值.
...
- [BCG e-Intensity Index](https://www.bcg.com/publications/interactives/bcg-e-intensity-index.aspx) - (2015) 波士顿咨询集团开发的指数，基于三个向量：启用、参与和支出，着眼于 85 个互联网经济体的成熟度.
- [Speedtest Global Index](http://www.speedtest.net/global-index) - (2018) 每月全球移动和固定宽带速度指数.
...
- [African Undersea Cables](https://manypossibilities.net/african-undersea-cables/) - Steve Song 绘制的非洲海底光缆地图.
...
- [ITU Interactive Transmission Map](http://www.itu.int/itu-d/tnd-map-public/) - 国际电联提供的地面光纤和微波网络在线地图.
- [GSMA Mobile Coverage Maps @ Mobile World Live](http://maps.mobileworldlive.com/) - 有点过时但仍然有用的按国家/地区划分的移动网络覆盖地图.
...
- GSMA - 移动互联网连接状况（[2020](https://www.gsma.com/r/wp-content/uploads/2020/09/GSMA-State-of-Mobile-Internet-Connectivity-Report-2020.pdf)) ([2019](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2019/07/GSMA-State-of-Mobile-Internet-Connectivity-Report-2019.pdf)) ([2018](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2018/09/State-of-Mobile-Internet-Connectivity-2018.pdf))
...
- 一项电子政务调查 [2018](https://publicadministration.un.org/egovkb/en-us/Reports/UN-E-Government-Survey-2018) [2016](https://publicadministration.un.org/egovkb/en-us/Reports/UN-E-Government-Survey-2016) - 全球电子政务和电子参与发展指数. 
- [OECD Broadband Portal](https://www.oecd.org/internet/broadband/broadband-statistics/) - 最新数据更新：2019 年 7 月 9 日.
- [AfterAccess - Mobile & Internet Use in the Global South](http://afteraccess.net/wp-content/uploads/After-Access-Website-layout-r1.pdf) - 全球南方 16 个发展中国家公共领域中家庭和个人 ICT 接入和使用的全国代表性调查的信息图表重点.
- 国际电联衡量数字发展：ICT 价格趋势 - [2019](https://www.itu.int/en/ITU-D/Statistics/Documents/publications/prices2019/ITU_ICTpriceTrends_2019.pdf)  - 分析和比较移动语音服务、移动数据和固定宽带的价格数据. 取代“衡量信息社会报告”.
...
- GSMA 移动经济 - 撒哈拉以南非洲（[2020](https://www.gsma.com/mobileeconomy/wp-content/uploads/2020/09/GSMA_MobileEconomy2020_SSA_Eng.pdf)) ([2018](https://policy.communitynetworks.group/_media/gsma_mobile_economy-ssa_2018.pdf))
...
- [RIA Africa Mobile Pricing (RAMP) Indices Portal](https://researchictafrica.net/ramp_indices_portal/) -（2018 年第 3 季度）有关语音/短信篮、1GB 数据篮和物有所值捆绑包的定价信息.
- 歌剧 - 非洲移动网络状况 - [2016](https://blogs.opera.com/news/wp-content/uploads/sites/2/2016/11/SMWAfrica-Opera-report-2016-01-WEB-1.pdf).
...
- [Open Signal - State of Mobile Networks Reports](http://opensignal.com/reports/) - 报告涵盖了基于 OpenSignal 数据收集的大量国家.
...
- [SimilarWeb - Mobile App Ranking](https://www.similarweb.com/apps/top/google/app-index/us/all/top-free) - 各国流行移动应用程序的排名.
- [Global Stats by StatCounter](http://gs.statcounter.com/) - 浏览器市场份额随着时间的推移按浏览器、地区、操作系统划分.
...
- [CIESIN Earth Institute - High Resolution Settlement Layer GIS data](https://ciesin.columbia.edu/data/hrsl/) - HRSL 数据集在人口测绘方面提供了前所未有的准确性.
...
在法律允许的范围内， [Steve Song](https://manypossibilities.net) 已放弃本作品的所有版权和相关或邻接权.
