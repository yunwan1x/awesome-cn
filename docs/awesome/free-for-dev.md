...
## APIs, Data and ML
  ...
  * [Duply.co](https://duply.co)  — 从 API 和 URL 创建动态图像，设计模板一次并重复使用. 免费套餐每月通过 API 和 URL 创建 70 张图像，通过 Form 创建最多 100 张图像.
 ...
 * [Artifactory](https://jfrog.com/start-free/)  - 一个支持多种包格式的工件存储库，如 Maven、Docker、Cargo、Helm、PyPI、CocoaPods 和 GitLFS. 包括包扫描工具 XRay 和 CI/CD 工具 Pipelines（以前称为 Shippable），每月免费提供 2,000 CI/CD 分钟.
...
## CMS
  ...
  * [sanity.io](https://www.sanity.io/)  – 使用 React 构建的可定制的 MIT 许可编辑器托管结构化内容的后端. 无限的项目.  3 个用户，2 个数据集，500k API CDN 请求，每个项目免费 5GB 资产
...
## CI and CD
  ...
  * [Continuous PHP](https://continuousphp.com/)  — Continuousphp 是第一个也是唯一一个以 PHP 为中心的平台，可以在同一工作流程中构建、打包、测试和部署应用程序. 免费用于社区项目，即 OSS/公共/教育项目.
...
## Security and PKI
  ...
  * [snyk.io](https://snyk.io)  — 可以在您的开源依赖项中找到并修复已知的安全漏洞. 对开源项目的无限测试和修复. 您的私人项目每月限制为 200 次测试.
  ...
  * [Virushee](https://virushee.com/)  — 由混合启发式和人工智能辅助引擎提供支持的面向隐私的文件/数据扫描. 可以使用内部动态沙箱分析. 每个文件上传限制为 50MB
...
## Forms
  ...
  * [WaiverStevie.com](https://waiverstevie.com)  - 带有 REST API 的电子签名平台. 使用 webhook 接收通知. 免费计划水印签名文件，但允许无限的信封+签名.
...
## PaaS
  ...
  * [SUSE Developer Program](https://developer.suse.com)  — 免费体验云原生生产力. 使用您自己的开发人员沙盒亲身体验 SUSE Cloud Application Platform.  1 免费申请. 随 API for CLI 一起提供的免费子域.  1 GB 的存储和内存配额.
  ...
  * [Divio](https://www.divio.com/)  - 管理仅使用 Docker 部署的云应用程序的平台. 可免费订阅开发项目.
...
## IaaS
  ...
  * [filebase.com](https://filebase.com/)  - 由区块链支持的 S3 兼容对象存储.  5 GB 无限期免费存储.
...
## Storage and Media Processing
   ...
   * [degoo.com](https://degoo.com/) – 基于人工智能的云存储，最多可免费使用 100 Gb、5 台设备、500 Gb 推荐奖金（365 天帐户不活动）.
...
## Design and UI
  ...
  * [marvelapp.com](https://marvelapp.com/) — 设计、原型制作和协作，仅限一位用户和一个项目的免费计划.
...
## Analytics, Events and Statistics
   ...
   * [Databox](https://databox.com)  — 通过结合其他分析和 BI 平台获得业务洞察和分析. 免费计划提供 3 个用户、仪表板和数据源.  11M 历史数据记录.
...
## Visitor Session Recording
   ...
   * [smartlook.com](https://www.smartlook.com/) — Web 和移动应用程序的免费包（1500 次/月）、3 个热图、1 个漏斗、1 个月的数据历史记录
...
## Payment and Billing Integration
  ...
  * [Freecurrencyapi.net](https://freecurrencyapi.net/)  — 免费的货币换算和汇率数据API.  10 个请求/小时，无需 API 密钥，免费注册时每月 50 000 个请求.
