...
- [Pioneer](http://autonomousdriving.pioneer/en/3d-lidar/)  - 激光雷达制造商，专门从事基于 MEMS 反射镜的光栅扫描激光雷达 (3D-LiDAR). 先锋总部位于日本东京.
...
- [Quanenergy](https://quanergy.com/)  - Quanenergy Systems / 固态和机械 LIDAR 传感器 / 在地图绘制、工业自动化、运输和安全领域提供端到端解决方案. 总部位于美国加利福尼亚州桑尼维尔.
  - [YouTube channel :red_circle:](https://www.youtube.com/c/QuanergySystems)
- [Cepton](https://www.cepton.com/index.html)  - Cepton（Cepton Technologies, Inc.）/无摩擦和无反光镜设计的先驱，自主研发的MMT（微动技术）激光雷达技术. 总部位于美国加利福尼亚州圣何塞.
  - [YouTube channel :red_circle:](https://www.youtube.com/channel/UCUgkBZZ1UWWkkXJ5zD6o8QQ)
- [Blickfeld](https://www.blickfeld.com/) - Blickfeld 是一家位于德国慕尼黑的用于自主移动和物联网的固态激光雷达制造商.
...
- [UofTPed50 Dataset](https://www.autodrive.utoronto.ca/uoftped50)  - 多伦多大学，aUToronto 的自动驾驶汽车数据集，其中包含 GPS/IMU、3D LIDAR 和单目相机数据. 它可用于 3D 行人检测.
...
- [PyTorch3d](https://pytorch3d.org/) - PyTorch3d 是一个用于深度学习的库，其 3D 数据由 Facebook 人工智能研究计算机视觉团队编写和维护.
...
- [pointcloudset](https://virtual-vehicle.github.io/pointcloudset/) - 用于高效分析随时间记录的点云的大型数据集的 Python 库.
...
- [Baidu Apollo](https://apollo.auto/) - Apollo 是一种流行的框架，可加速自动驾驶汽车的开发、测试和部署.
...
- [Iterative closest point :red_circle:](https://www.youtube.com/watch?v=uzOCS_gdZuM) - 特征匹配应用程序（ICP）的必备算法.
  ...
  - [Paper :newspaper:](https://link.springer.com/content/pdf/10.1007/s10514-013-9327-2.pdf) - libpointmatcher：比较现实世界数据集上的 ICP 变体.
...
- [PolarNet :newspaper:](https://arxiv.org/pdf/2003.14032.pdf) - 在线 LiDAR 点云语义分割的改进网格表示.
...
- [LIO-SAM :newspaper:](https://arxiv.org/pdf/2007.00258.pdf) - 通过平滑和映射紧密耦合的激光雷达惯性里程计.
...
- [Learning to Optimally Segment Point Clouds :newspaper:](https://arxiv.org/abs/1912.04976)  - 作者：卡内基梅隆大学的 Peiyun Hu、David Held 和 Deva Ramanan.  IEEE 机器人与自动化快报，2020 年.
...
- [LGSVL](https://www.lgsvlsimulator.com/)  - 基于 Unity Engine 的汽车应用模拟器. 兼容 Autoware、百度 Apollo 和 ROS/ROS2.
