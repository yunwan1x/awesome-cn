...
[Neuroscience](https://en.wikipedia.org/wiki/Neuroscience) 是对神经系统如何发育、其结构及其作用的研究. 神经科学家专注于大脑及其对行为和认知功能的影响. 传统上，神经科学一直被视为生物学的一个分支，但它已经发展到涵盖广泛的跨学科领域，这些领域共同致力于在多个研究层面阐明大脑功能.
...
- [NiBabel](https://github.com/nipy/nibabel) - 提供对一些常见的医学和神经影像文件格式的读写访问.
- [PsychoPy](https://github.com/psychopy/psychopy)  - 运行心理学和神经科学实验包. 它允许在 Python 中创建心理刺激.
- [NuPic](https://github.com/numenta/nupic) - Numenta 智能计算平台是分层时间记忆 (HTM) 的实现，这是一种严格基于新皮质神经科学的智能理论.
- [Brian2](https://github.com/brian-team/brian2) - 用于脉冲神经网络的免费开源模拟器.
- [expyriment](https://github.com/expyriment/expyriment) - 独立于平台的轻量级 Python 库，用于设计和进行时间关键的行为和神经成像实验.
 - [BindsNET](https://github.com/Hananel-Hazan/bindsnet) - 用于模拟脉冲神经网络以进行强化和机器学习的软件包.
 - [SpikeInterface](https://github.com/SpikeInterface/spikeinterface) - 旨在统一尖峰分类技术的框架
 
### Matlab

- [Brain Dynamics Toolbox](https://bdtoolbox.org/) - 用于模拟神经科学中的动态系统的开放软件.
...
- [SPM](https://www.fil.ion.ucl.ac.uk/spm/) - 用于分析脑成像数据序列（fMRI、PET、SPECT、EEG、MEG）的免费和开源软件.

### C++

- [Brayns](https://github.com/BlueBrain/Brayns)  - 可以对神经元进行光线追踪渲染的简约可视化器. 光线追踪可以帮助突出神经回路中细胞相互接触的区域以及正在创建突触的区域，从而更好地了解单个细胞以及随后的大脑功能.

### JavaScript
- [Brainbrowser](https://github.com/aces/brainbrowser) - 图书馆公开了一组主要针对神经影像学的基于网络的 3D 可视化工具.
- [jsPsych](https://www.jspsych.org/) - 用于在 Web 浏览器中创建和运行行为实验的库.

### R
- [nat: NeuroAnatomy Toolbox](https://github.com/jefferis/nat) - 用于生物图像数据的（3D）可视化和分析的软件包，尤其是单个神经元的追踪.
...
- [Neuroskeptic](https://www.discovermagazine.com/author/neuroskeptic) - [Discover magazine](http://discovermagazine.com/)的神经科学博客，通过批判性视角介绍神经科学、精神病学和心理学的最新发展.
- [The Neurocritic](http://neurocritic.blogspot.in/) - 通常对人脑成像、认知神经科学和精神药理学中最耸人听闻的最新发现提出批评.
- [The scicurious brain](https://blogs.scientificamerican.com/scicurious-brain/) - 由维护 [Scientific American](https://blogs.scientificamerican.com/)，该博客通常在一个条目中涵盖一篇研究论文.
- [Action Potential](http://blogs.nature.com/actionpotential) - 由《自然》杂志的神经科学编辑运营的论坛.

### MOOCs

[Massive Open Online Courses (MOOCs)](https://en.wikipedia.org/wiki/Massive_open_online_course) 是免费的基于 Web 的远程学习计划，旨在让大量地理分散的学生参与.
MOOC 可能以学院或大学课程为模式，也可能不太结构化.

- [The Fundamentals of Neuroscience | Harvard & edX](https://www.mcb80x.org/) - 提供神经科学主题的介绍性调查，没有特定的先决条件，尽管事先接触生物学和/或化学可能会有所帮助.
- [Introduction to Neuroscience | MIT OCW](https://ocw.mit.edu/courses/brain-and-cognitive-sciences/9-01-introduction-to-neuroscience-fall-2007/) - 哺乳动物神经系统简介，重点是人脑的结构和功能.
...
- [Neuromatch Academy](https://github.com/NeuromatchAcademy/course-content) - 用于计算神经科学为期三周的密集暑期学校的 Jupyter 笔记本. 

### Communities
- [Quora](https://www.quora.com/topic/Neuroscience-1) - Quora 上的神经科学主题包含从基本到高级的问题的答案，通常由专家提供.
...
- [Comp-neuro](http://www.tnb.ua.ac.be/mailman/listinfo/comp-neuro) - 旨在解决计算神经科学一般领域所涉及的广泛研究方法和问题的邮件列表. 
...
- [Neuroscience Mindmap](https://learn-anything.xyz/neuroscience) - 包含精选资源的交互式思维导图，供有兴趣学习神经科学的人使用.
- [neuroSummerSchools](https://github.com/PhABC/neuroSummerSchools) - 神经科学和相关领域的夏季（和季节性）暑期学校名单.
...
在法律允许的范围内， [Akash Tandon](https://github.com/analyticalmonk) has waived all copyright and
本作品的相关或邻接权.
