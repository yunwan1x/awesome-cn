...
* [Colony](https://github.com/mattreecebentley/plf_colony)  - 一个无序的“包”型容器，它在高修改场景中优于标准容器，同时无论插入/擦除如何都保持指向未擦除元素的永久指针.  [zLib] [website](http://www.plflib.org/colony.htm)
...
* [Oxygine](http://oxygine.org/)  - 跨平台的 2D C++ 游戏引擎.  [麻省理工学院]
