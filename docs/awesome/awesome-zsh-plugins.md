...
- 超快速并行安装.
- 配置文件使用 [TOML](https://github.com/toml-lang/toml) syntax.
- 使用锁定文件更快地加载插件.
...
- [termuxer](https://github.com/patrick330602/termuxer) - Theme inspired by [Agnoster](https://github.com/agnoster/agnoster-zsh-theme) 和linuxer.
