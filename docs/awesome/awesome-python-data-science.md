...
* [PyFlux](https://github.com/RJT1990/pyflux) -用于Python的开源时间序列库.
...
## Web Scraping
* [BeautifulSoup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/)：最容易为初学者刮除静态网站的库
* [Scrapy](https://scrapy.org/) ：快速且可扩展的抓取库. 可以编写规则并创建自定义的刮板，而不会碰到任何问题
* [Selenium](https://selenium-python.readthedocs.io/installation.html#introduction)：使用Selenium Python API以类似于真实用户的直观方式访问Selenium WebDriver的所有功能.
* [Pattern](https://github.com/clips/pattern) ：针对完善的网站（例如Google，Twitter和Wikipedia）进行高级抓取. 还具有NLP，机器学习算法和可视化
* [twitterscraper](https://github.com/taspinar/twitterscraper)：高效的库来刮推特

## Data Manipulation

### Data Containers
* [pandas](https://pandas.pydata.org/pandas-docs/stable/) -强大的Python数据分析工具包.
* [pandas_profiling](https://github.com/pandas-profiling/pandas-profiling) -从pandas DataFrame对象创建HTML分析报告
...
* [vaex](https://github.com/vaexio/vaex) -适用于Python，ML的核心数据框，以每秒十亿行的速度可视化和浏览大型表格数据.
...
* [Prodmodel](https://github.com/prodmodel/prodmodel) -建立数据科学管道系统.
* [CircleCi](https://circleci.com/)：自动化您的软件构建，测试和部署.

## Feature Engineering

### General
* [Featuretools](https://github.com/Featuretools/featuretools) -自动功能工程.
...
* [Altair](https://altair-viz.github.io/)  -用于Python的声明性统计可视化库. 可以轻松地在代码内进行许多数据转换以创建图形
* [bqplot](https://github.com/bqplot/bqplot) -用于IPython / Jupyter笔记本的绘图库
### Map
* [folium](https://python-visualization.github.io/folium/quickstart.html#Getting-Started) -轻松可视化交互式开放式街道地图上的数据
* [geemap](https://github.com/giswqs/geemap) -用于与Google Earth Engine（GEE）进行交互式映射的Python包
### Automatic Plotting
* [HoloViews](https://github.com/ioam/holoviews) -停止绘制数据-注释数据并使其可视化.
* [AutoViz](https://github.com/AutoViML/AutoViz)：使用1行代码自动可视化数据（对于机器学习而言是理想选择）
...
## Deployment
* [datapane](https://datapane.com/) -一组将脚本和笔记本转换为交互式报告的API.
* [binder](https://mybinder.org/) -启用共享并执行Jupyter Notebook
* [fastapi](https://fastapi.tiangolo.com/) -用于使用Python构建API的现代，快速（高性能）网络框架
...
* [L2X](https://github.com/Jianbo-Lab/L2X) -复制论文中的实验的代码*学习解释：模型解释的信息理论观点*.
...
* [Stable Baselines](https://github.com/hill-a/stable-baselines) -一组基于OpenAI基线的强化学习算法的改进实现.
...
* [SafeOpt](https://github.com/befelix/SafeOpt) -安全的贝叶斯优化.
...
* [POT](https://github.com/rflamary/POT) -Python最佳运输库.
...
* [Xcessiv](https://github.com/reiinakano/xcessiv) -基于Web的应用程序，可进行快速，可扩展和自动化的超参数调整和堆叠式集成.
