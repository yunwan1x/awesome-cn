...
* [frugally-deep](https://github.com/Dobiasd/frugally-deep)  - 在 C++ 中使用 Keras 模型的仅头文件库.  [麻省理工学院]
...
* [tiny-dnn](https://github.com/tiny-dnn/tiny-dnn)  - C++11 中仅标头、无依赖的深度学习框架.  [BSD]
...
* [libsequence](http://molpopgen.github.io/libsequence/)  - 用于表示和分析种群遗传数据的 C++ 库.  [通用公共许可证]
 ...
 * [Argh!](https://github.com/adishavit/argh)  - 一个极简的、无挫折的、仅标头的参数处理程序.  [BSD]
...
* [Intel Parallel STL](https://github.com/intel/parallelstl)  - 用于 C++11 及更高版本的 C++17 STL 的英特尔® 实现.  [阿帕奇2]
...
* [Tink](https://github.com/google/tink)  - 一个多语言、跨平台的库，提供安全、易于正确使用且难以（更）误用的加密 API.  [Apache-2.0]
...
* [VLD](http://vld.codeplex.com/)  - 视觉检漏仪. 一个免费的、强大的、开源的 Visual C++ 内存泄漏检测系统.
...
* [xtd](https://github.com/gammasoft71/xtd)  - 现代 C++17/20 框架，用于在 Windows、macOS、Linux、iOS 和 android 上创建控制台 (CLI)、表单（GUI 类似于 WinForms）和 tunit（单元测试，例如 Microsoft 单元测试框架）应用程序.  [麻省理工学院]
...
* [TinyEXIF](https://github.com/cdcseacave/TinyEXIF)  - 用于 JPEG 的小型 ISO 兼容 C++ EXIF 和 XMP 解析库.  [麻省理工学院]
...
* [frozen](https://github.com/cesanta/frozen)  - 用于 C/C++ 的 JSON 解析器和生成器.  [GPL &amp; GPL2]
...
* [json-voorhees](https://github.com/tgockel/json-voorhees)  - C++ 的 JSON 库. 支持 C++11. 没有依赖性，快速且对开发人员友好.  [阿帕奇2]
...
* [PicoJSON](https://github.com/kazuho/picojson)  - C++ 中仅包含头文件的 JSON 解析器序列化器.  [BSD]
...
* [Easylogging++](https://github.com/amrayn/easyloggingpp)  - 用于 C++11（或更高版本）应用程序的极其轻量级的高性能日志记录库.  [麻省理工学院]
...
* [templog](http://www.templog.org/)  - 一个非常小且轻量级的 C++ 库，您可以使用它向 C++ 应用程序添加日志记录.  [促进]
...
* [CCV](https://github.com/liuliu/ccv)  - 基于 C 的/缓存/核心计算机视觉库，现代计算机视觉库.  [BSD]
...
* [SHOGUN](https://github.com/shogun-toolbox/shogun)  - 幕府将军机器学习工具箱.  [GPLv3]
...
* [autodiff](https://github.com/autodiff/autodiff)  - 用于自动微分的现代、快速和富有表现力的 C++ 库.  [麻省理工学院] [website](https://autodiff.github.io)
...
* [Libmicrohttpd](http://www.gnu.org/software/libmicrohttpd/)  - GNU libmicrohttpd 是一个小型的 C 库，旨在让作为另一个应用程序的一部分运行 HTTP 服务器变得容易.  [LGPL v2.1+]
...
* [Onion](https://github.com/davidmoreno/onion)  - C 语言的 HTTP 服务器库设计为轻量级且易于使用.  [Apache2/GPL2]
* [PF_RING™](https://github.com/ntop/PF_RING)  - 高速数据包处理框架.  [LGPL-2.1] [website](https://www.ntop.org/products/packet-capture/pf_ring/)
* [PicoHTTPParser](https://github.com/h2o/picohttpparser)  - 一个微小的、原始的、快速的 HTTP 请求/响应解析器.  [麻省理工学院]
* [POCO](https://github.com/pocoproject)  :zap: - C++ 类库和框架，用于构建在桌面、服务器、移动和嵌入式系统上运行的基于网络和 Internet 的应用程序.  [促进] [website](http://pocoproject.org/)
...
* [restclient-cpp](https://github.com/mrtazz/restclient-cpp)  - 用于 C++ 的简单 REST 客户端. 它为 HTTP 请求包装了 libcurl.  [麻省理工学院]
* [Seasocks](https://github.com/mattgodbolt/seasocks)  - 具有 WebSockets 支持的简单、小型、可嵌入 C++ 的网络服务器.  [BSD]
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets)  - µWS 是可用的最轻量、最高效和可扩展的 WebSocket 和 HTTP 服务器实现之一.  [Zlib]
* [WAFer](https://github.com/riolet/WAFer)  - 基于 AC 语言的超轻型软件平台，用于可扩展的服务器端和网络应用程序. 为 C 程序员考虑 node.js.  [GPL2]
...
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus)  - 一个多平台 C++ 网络嗅探和数据包解析和制作框架.  [未授权]
...
* [MuPDF](https://mupdf.com/)  - 轻量级 PDF、XPS 和电子书查看器.  [AGPL/商业]
...
* [Kratos](https://github.com/KratosMultiphysics/Kratos)  - 构建并行、多学科仿真软件的框架，旨在实现模块化、可扩展性和高性能.  [BSD] [website](http://www.cimne.com/kratos/)
* [ofxBox2d](https://github.com/vanderlin/ofxBox2d)  - Box2D 的 openFrameworks 包装器.  [类BSD]
* [PhysX](https://github.com/NVIDIAGameWorks/PhysX-3.4)  - 由 Nvidia 开发的开源实时物理引擎中间件 SDK，作为 Nvidia GameWorks 软件套件的一部分.  [BSD-3-条款]
* [Project Chrono](https://github.com/projectchrono/chrono)  - 一个开源的多物理场仿真引擎.  [BSD-3-条款] [website](https://projectchrono.org/)
* [Quantum++](https://github.com/vsoftco/qpp)  - 现代 C++11 量子计算库.  [麻省理工学院]
* [Simbody](https://github.com/simbody/simbody)  - 高性能 C++ 多体动力学/物理库，用于模拟铰接式生物力学和机械系统，如车辆、机器人和人体骨骼.  [阿帕奇2]
* [SOFA](https://github.com/sofa-framework/sofa)  - SOFA 是一个针对实时模拟的开源框架，重点是医学模拟.  [LGPL] [website](https://www.sofa-framework.org)

## Reflection

* [config-loader](https://github.com/netcan/config-loader)  - C++17 静态反射框架，从解析配置文件到原生数据结构.  [麻省理工学院]
...
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions)  - 编译时 PCRE（几乎）兼容的正则表达式匹配器.  [麻省理工学院]
* [Hyperscan](https://github.com/intel/hyperscan)  - Hyperscan 是 Intel 的高性能多正则表达式匹配库. 提供大量正则表达式（最多数万个）的同时匹配. 通常用于 DPI 库堆栈.  [BSD]
* [Oniguruma](https://github.com/kkos/oniguruma)  - 一个现代灵活的正则表达式库，支持多种字符编码.  [BSD]
* [PCRE](http://pcre.org/)  - 受 Perl 中的正则表达式功能启发的正则表达式 C 库.  [BSD]
* [PIRE](https://github.com/yandex/pire)  - Yandex 的 Perl 不兼容正则表达式库. 可以非常快（超过 400 MB/s）.  [LPGL v3.0]
* [RE2](https://github.com/google/re2)  - 通过使用自动机理论的有限状态机的正则表达式软件库.  [BSD-3-条款]
* [SLRE](https://github.com/cesanta/slre)  - 用于 C/C++ 的超轻正则表达式引擎.  [GPLv2/商业]
* [sregex](https://github.com/openresty/sregex)  - 基于非回溯 NFA/DFA 的 Perl 兼容正则表达式引擎库，用于匹配大数据流.  [BSD]
...
* [Torch](https://github.com/torch/torch7)  - 一个科学计算框架，广泛支持将 GPU 放在首位的机器学习算法.  [BSD-3-条款] [website](http://torch.ch/)

## Scripting

* [AngelScript](https://www.angelcode.com/angelscript/)  - AngelScript 是一种面向游戏的解释/编译脚本语言.  [zlib]
* [Boost.Python](http://www.boost.org/doc/libs/1_65_1/libs/python/doc/html/index.html)  - 一个 C++ 库，可实现 C++ 和 Python 编程语言之间的无缝互操作.  [促进]
...
* [nbind](https://github.com/charto/nbind)  - 神奇的头文件，让你的 C++ 库可以从 JavaScript 访问.  [麻省理工学院]
* [PHP-CPP](https://github.com/CopernicaMarketingSoftware/PHP-CPP)  - 使用 C++ 构建 PHP 扩展的库.  [阿帕奇2] [website](http://www.php-cpp.com/)
* [pybind11](https://github.com/pybind/pybind11)  - C++11 和 Python 之间的无缝操作.  [BSD]
...
* [SWIG](https://github.com/swig/swig)  - 一个包装器/接口生成器，可让您将 C++ 代码链接到 Javascript、Perl、PHP、Python、Tcl 和 Ruby.  [GPL/输出未经许可] [website](http://www.swig.org/)
* [V7](https://github.com/cesanta/v7)  - 嵌入式 JavaScript 引擎.  [GPL2]
* [V8](https://v8.dev)  - 一个快速的谷歌 JavaScript 引擎，可以嵌入到任何 C++ 应用程序中.  [BSD]
* [ChakraCore](https://github.com/Microsoft/ChakraCore)  - 微软的 JavaScript 引擎，可以嵌入到 nodejs 中.  [麻省理工学院]

## Serialization

* [Bitsery](https://github.com/fraillt/bitsery)  - 仅标头 C++ 二进制序列化库.  [麻省理工学院]
* [Bond](https://github.com/Microsoft/bond)  - 一个用于处理模式化数据的开源、跨平台框架.  [麻省理工学院]
...
* [MessagePack](https://github.com/msgpack/msgpack-c)  - 用于 C 和 C++ 的高效二进制序列化格式“类似 JSON”.  [阿帕奇2] [website](http://msgpack.org/)
...
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) - 协议缓冲区在 C 中的实现. [BSD]
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding)  - 以二进制格式为低延迟应用程序编码和解码应用程序消息.  [阿帕奇2]
* [upb](https://github.com/protocolbuffers/upb) - C 中的一个小型 protobuf 实现. [BSD]
* [YAS](https://github.com/niXman/yas)  - 非常快 **Y**et **A**nother **S** 序列化库支持二进制/文本/json 格式.  [促进]
...
* [libde265](https://github.com/strukturag/libde265)  - 打开 h.265 视频编解码器实现.  [LGPL] [website](http://www.libde265.org/)
* [x265](https://bitbucket.org/multicoreware/x265_git/src)  - 打开 h.265 视频编解码器实现.  [GPL2] [website](https://x265.readthedocs.io/en/master/)
* [OpenH264](https://github.com/cisco/openh264)  - 开源 H.264 编解码器.  [BSD] [website](http://www.openh264.org/)
* [Theora](http://www.theora.org/)  - 一种免费开放的视频压缩格式.  [BSD]
* [Vireo](https://github.com/twitter/vireo/)  - Twitter 提供的轻量级多功能视频处理库.  [麻省理工学院]

## Virtual Machines

* [CarpVM](https://github.com/tekknolagi/carp)  - C 中“有趣”的 VM.让我们看看这是怎么回事.  [GPLv3]
...
* [Civetweb](https://github.com/civetweb/civetweb)  - 提供易于使用、功能强大、可嵌入 C/C++ 的 Web 服务器，具有可选的 CGI、SSL 和 Lua 支持.  [麻省理工学院]
...
* [Cutelyst](https://github.com/cutelyst/cutelyst)  - 建立在 Qt 之上的 C++ Web 框架，使用 Catalyst (Perl) 框架的简单方法.  [LGPLv2.1+] [website](https://cutelyst.org/)
* [Drogon](https://github.com/an-tao/drogon)  - 基于 C++14/17 的高性能 HTTP 应用程序框架.  [麻省理工学院]
* [facil.io](https://github.com/boazsegev/facil.io)  - 支持 HTTP、WebSockets、SSE 等的事件化、高性能 C Web 框架.  [麻省理工学院] [website](http://facil.io)
* [Kore](https://kore.io/) - 用于用 C 开发的 Web 应用程序的超快速和灵活的 Web 服务器/框架. [ISC]
...
* [oat++](https://github.com/oatpp/oatpp)  - 用于创建高性能 Web 服务的轻量级、零依赖框架.  [Apache-2.0] [website](https://oatpp.io/)
* [Pistache](http://pistache.io/)  - Pistache 是一个用纯 C++11 编写的 C++ REST 框架，没有外部依赖.  [阿帕奇2]
* [QDjango](https://github.com/jlaine/qdjango/)  - 用 C++ 编写并构建在 Qt 库之上的 Web 框架. 在可能的情况下，它会尝试遵循 django 的 API，因此得名.  [LGPL]
...
* [libxml++](http://libxmlplusplus.sourceforge.net/)  - 用于 C++ 的 XML 解析器.  [LGPL2]
* [Mini-XML](https://github.com/michaelrsweet/mxml) - 一个用 ANSI C 编写的小型 XML 解析库.[LGPL2 有例外]
* [PugiXML](http://pugixml.org/)  - 轻量级、简单且快速的 C++ XML 解析器，支持 XPath.  [麻省理工学院]
* [RapidXml](http://rapidxml.sourceforge.net/)  - 尝试创建最快的 XML 解析器，同时保留可用性、可移植性和合理的 W3C 兼容性.  [促进]
* [TinyXML](http://sourceforge.net/projects/tinyxml/)  - 一个简单、小巧、最小的 C++ XML 解析器，可以轻松集成到其他程序中.  [zlib]
* [TinyXML2](https://github.com/leethomason/tinyxml2)  - 一个简单、小巧、高效的 C++ XML 解析器，可以轻松集成到其他程序中.  [zlib]
* [TinyXML++](https://github.com/rjpcomputing/ticpp)  - 一个全新的 TinyXML 接口，它使用了许多 C++ 的优势. 模板、异常和更好的错误处理.  [麻省理工学院]
...
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) - C++ 中的 YAML 解析器和发射器 [MIT]

## Miscellaneous
*不属于上述类别或可能尚未分类的有用库或工具*

* [access_profiler](https://github.com/arvidn/access_profiler)  - 在 C++ 程序中计算对成员变量的访问的工具.  [GPL3]
* [American fuzzy lop](http://lcamtuf.coredump.cx/afl/) 又名 afl-fuzz - 疯狂的模糊测试工具，可在给定时间和最少示例输入的情况下自动发现错误.  [阿帕奇2]
* [Better String](http://bstring.sourceforge.net)  - C 的字符串库的替代方案，功能更强大且没有缓冲区溢出溢出问题. 还包括一个 C++ 包装器.  [BSD，GPL2]
* [Boost.Signals](http://www.boost.org/doc/libs/1_56_0/doc/html/signals.html)  - 托管信号和插槽系统的实现.  [促进]
* [CPPItertools](https://github.com/ryanhaining/cppitertools)  - 受 Python 内置程序和 itertools 库启发的基于范围的 for 循环附加组件.  [BSD-2-条款]
* [DynaMix](https://github.com/iboB/dynamix)  - 允许您在运行时组合和修改对象的库.  [麻省理工学院]
* [{fmt}](https://github.com/fmtlib/fmt)  :zap: - 用于 C++ 的小型、安全且快速的格式化库.  [简化的BSD]
...
* [libcpuid](https://github.com/anrieff/libcpuid)  - 一个用于 x86 CPU 检测和特征提取的小型 C 库.  [BSD]
* [libevil](https://github.com/avati/libevil)  - 邪恶的许可证管理器.  [GPLv3]
* [libnih](https://github.com/keybuk/libnih)  - 一个轻量级的 C 函数和结构库.  [GPL2.1]
* [libusb](https://libusb.info/)  - 通用 USB 库，允许对 USB 设备进行便携式访问.  [LGPL2]
* [Mach7](https://github.com/solodon4/Mach7)  - C++ 的模式匹配库.  [BSD]
* [mio](https://github.com/mandreyel/mio)  - 用于内存映射文件 IO 的跨平台 C++11 头文件库.  [麻省理工学院]
...
* [Tulip Indicators](https://tulipindicators.org)  - 超过 100 种金融技术分析指标的 AC 库.  [LGPL]
* [ub-canaries](https://github.com/regehr/ub-canaries) - 一组 C/C++ 程序，试图让编译器利用未定义的行为.
...
* [ZBar](http://zbar.sourceforge.net/)  - 条码扫描器库，允许扫描照片/图像/视频流以获取条码并返回它们的值.  [LGPL2]
* [ZXing](https://github.com/zxing/zxing/)  - 一个用 Java 实现的开源、多格式一维/二维条码图像处理库，并带有其他语言的端口.  [阿帕奇]
...
* [Oracle Solaris Studio](http://www.oracle.com/technetwork/server-storage/solarisstudio/overview/index.html)  - 用于 SPARC 和 x86 的 C、C++ 和 Fortran 编译器. 支持 C++11. 在 Linux 和 Solaris 上可用.  [OTN 开发者许可证]
...
* [Ideone](http://ideone.com/) - 一个在线编译器和调试工具，允许您编译源代码并以 60 多种编程语言在线执行.
...
* [IBM VisualAge](http://www-03.ibm.com/software/products/en/visgen) - 来自 IBM 的一系列计算机集成开发环境.
...
* [Microsoft Visual Studio](https://www.visualstudio.com/) - 来自微软的 IDE.
* [Microsoft Visual Studio Code](https://code.visualstudio.com/)  :zap: - 来自 Microsoft 的开源 IDE.  [麻省理工学院]
* [NetBeans](https://netbeans.org/) - 主要使用 Java 进行开发的 IDE，但也使用其他语言，特别是 PHP、C/C++ 和 HTML5.
...
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) - YouCompleteMe 是一个用于 Vim 的快速、随你输入、模糊搜索代码完成引擎.
...
* [Buck](https://github.com/facebook/buck)  - 一个快速构建系统，鼓励在各种平台和语言上创建小型、可重用的模块，包括在 Facebook 开发和使用的 C++. 用Java编写.  [阿帕奇]
* [build2](https://build2.org/)  - 用于开发和打包 C/C++ 项目的跨平台构建、打包和依赖项管理工具链.  [麻省理工学院]
* [clib](https://github.com/clibs/clib)  - C 编程语言的包管理器.  [麻省理工学院]
* [CMake](https://cmake.org/)  - 跨平台的免费开源软件，用于使用独立于编译器的方法管理软件的构建过程.  [BSD]
...
* [MesonBuild](http://mesonbuild.com) - 一个开源构建系统意味着既要非常快，更重要的是，要尽可能地用户友好.
* [Ninja](https://ninja-build.org/) - 一个专注于速度的小型构建系统.
* [Scons](http://www.scons.org/) - 配置了 Python 脚本的软件构建工具.
...
* [SW](https://software-network.org/)  - 跨平台 C++（和其他语言）构建系统和包管理器，提供大量可用包.  [GPLv3]
* [tundra](https://github.com/deplinenoise/tundra) - 高性能代码构建系统，旨在为非常大的软件项目提供最佳的增量构建时间.
* [tup](http://gittup.org/tup/) - 基于文件的构建系统，可在后台监视更改的文件.
* [Premake](http://premake.github.io) - 配置了 Lua 脚本的工具，用于为 Visual Studio、GNU Make、Xcode、Code::Blocks 等跨 Windows、Mac OS X 和 Linux 生成项目文件.
* [Vcpkg](https://github.com/microsoft/vcpkg)  - 适用于 Windows、Linux 和 MacOS 的 C++ 库管理器.  [麻省理工学院]
* [waf](https://github.com/waf-project/waf)  - 基于 Python 的框架，用于配置、编译和安装应用程序.  [BSD] [website](https://waf.io/)
...
* [CppDepend](https://www.cppdepend.com/) - 通过分析和可视化代码依赖关系、定义设计规则、进行影响分析以及比较不同版本的代码，来简化管理复杂的 C/C++ 代码库.
* [cpplint](https://github.com/cpplint/cpplint) - 遵循 Google 的 C++ 风格指南的 C++ 风格检查器.
...
* [include-what-you-use](https://github.com/include-what-you-use/include-what-you-use) - 与 clang 一起使用以分析包含在 C 和 C++ 源文件中的工具. [website](https://include-what-you-use.org/)
* [Infer](https://github.com/facebook/infer)  - Java、C 和 Objective-C 的静态分析器.  [BSD]
* [OCLint](http://oclint.org/)  - 一种静态源代码分析工具，可提高 C、C++ 和 Objective-C 的质量并减少缺陷.  —— [source](https://github.com/oclint/oclint)
...
* [ClangFormat](http://clang.llvm.org/docs/ClangFormat.html) - 一种格式化 C/C++/Obj-C 代码的工具.
...
* [C++Now 2013 Presentations](https://github.com/boostcon/cppnow_presentations_2013) - 在 C++Now 2013 上提供的演示材料.
* [C++Now 2012 Presentations](https://github.com/boostcon/cppnow_presentations_2012) - 在 C++Now 2012 上提供的演示材料.

## Books
*很棒的 C 或 C++ 相关书籍.*

* [List of Free C or C++ Books](https://github.com/fffaraz/awesome-cpp/blob/master/books.md)
* [Free C Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md#c) - 甚高频/免费编程书籍/C.
* [Free C++ Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md#cpp) - 甚高频/免费编程书籍/C++.
* [cppbestpractices](https://github.com/lefticus/cppbestpractices) - C++ 最佳实践的协作集合.

## Coding Style

* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) - “官方”的 C++ 指南集，由 C++ 的作者审查.
...
* [超棒的高清晰度 C 编程教程 [高清]](https://www.youtube.com/playlist?list=PLCB9F975ECF01953C) - 面向初学者和新程序员的详细 C 编程语言教程集合.
...
* [C++ Programming Tutorials from thenewboston](https://www.youtube.com/playlist?list=PLF541C2C1F671AEF6) - 这些是新波士顿的所有 C++ 编程教程.
* [C++ GUI with Qt Playlist](https://www.youtube.com/playlist?list=PLD0D54219E5F2544D) - 带有 Qt 教程的 newboston C++ GUI 的官方播放列表.
...
* [Guru of the Week](http://www.gotw.ca/gotw/) - 由 Herb Sutter 创建和编写的一系列常规 C++ 编程问题.
* [Meeting C++](http://meetingcpp.com/)
* [C++ Quiz](http://q.viva64.com/) - C++ 测验，您建议在其中找出开源项目代码片段中的错误.
* [Udemy C++ Courses and Tutorials](https://www.udemy.com/topic/C-plus-plus-tutorials/)
* [C++ Hints](http://cpphints.com/) - 每个工作日都会从 PVS-Studio 团队提示最常见的 C++ 错误以及解决这些错误的方法.
* [C++ tutorial](https://hackr.io/tutorials/learn-c-plus-plus) - 一个用户排名在线教程银行站点，显示多门课程可供学习 C++.

## Weblogs
*有用的 C 或 C++ 相关博客.*

* [Coding For Speed](https://codingforspeed.com/) - 编码速度 DOT COM，更少的执行时间.
...
* [C++ Awesome Pack](https://github.com/juniandotnet/cpp-awesome-pack) - 包含一些很棒的 C++ 代码，合二为一.
...
* [Awesome Modern C++](https://github.com/rigtorp/awesome-modern-cpp) - 现代 C++ 资源的集合.
...
* [Inqlude](http://inqlude.org/) - Qt 库存档.
* [papers-we-love](https://github.com/papers-we-love/papers-we-love) - 来自计算机科学界的论文供阅读和讨论.
* [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) - 精选的学习和/或练习算法的绝佳场所列表.
* [awesome-talks](https://github.com/JanVanRyswyck/awesome-talks) - 大量截屏、用户组聚会和会议谈话的录音.
* [Projects](https://github.com/karan/Projects) - 任何人都可以用任何编程语言解决的实际项目列表.
* [Awesome interview questions](https://github.com/MaximAbramchuck/awesome-interviews) - 最流行的技术（包括 C 和 C++）的面试问题列表.
