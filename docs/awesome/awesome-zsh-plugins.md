...
* [basex](https://github.com/dirkk/zsh-basex) - Adds several [BaseX](http://basex.org/) 简化使用的别名.
...
* [lando (joshuabedford)](https://github.com/JoshuaBedford/lando-zsh) - 一组别名函数，可在其中使用 CLI [Lando](https://docs.lando.dev) without having to type lando to access them.
...
* [dustmod](https://github.com/bmihaila/dustmod) - 源自 [dst](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/dst.zsh-theme) theme in oh-my-zsh.
