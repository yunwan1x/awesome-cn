...
官方插件 [Capacitor](https://github.com/ionic-team/capacitor-plugins) 并由 ionic 维护在此处列出.
...
- [Clipboard](https://github.com/ionic-team/capacitor-plugins/tree/main/clipboard) - 允许复制和粘贴到/从系统剪贴板.
- [Device](https://github.com/ionic-team/capacitor-plugins/tree/main/device) - 公开有关设备的内部信息，例如型号和操作系统版本，以及唯一 ID 等用户信息.
- [Dialog](https://github.com/ionic-team/capacitor-plugins/tree/main/dialog) - 提供触发本机对话窗口以进行警报、确认和输入提示的方法.
- [File system](https://github.com/ionic-team/capacitor-plugins/tree/main/filesystem) - 提供类似 NodeJS 的 API，用于处理设备上的文件.
- [Geolocation](https://github.com/ionic-team/capacitor-plugins/tree/main/geolocation) - 提供使用 GPS 获取和跟踪设备当前位置的简单方法，以及海拔、航向和速度信息（如果有）.
...
- [Apple sign in](https://github.com/capacitor-community/apple-sign-in) - 电容器用 Apple 登录.
...
- [Twitter](https://github.com/capacitor-community/twitter) - 为电容器启用 TwitterKit 功能.
- [Uxcam](https://github.com/capacitor-community/uxcam)  - UXCam 和 FullStory 分析. 它使用适用于 Android 和 iOS 平台的 UXCam 和适用于 Web/PWA 的 FullStory.
...
- [Docgen](https://github.com/ionic-team/capacitor-docgen) - 文档自述文件 Markdown 和用于电容器插件的 JSON 生成器.
- [Plugin generator](https://github.com/ionic-team/create-capacitor-plugin) - 创建一个新的电容器插件.
...
- [Capacitor Crash Course](https://www.udemy.com/course/capacitor-crash-course/) - Simon Grimm 学习使用带有离子的电容器.
...
- [Capacitor Workflow in an Ionic Application](https://www.youtube.com/watch?v=oXbRcpsytGQ) - 涵盖在 Ionic 应用程序中使用电容器时的基本工作流程.
...
- [capacitor-plugin-demo](https://github.com/robingenz/capacitor-plugin-demo) - 简单的 Ionic Angular 应用程序来演示某些电容器插件的使用.
...
- [capacitor-updater-plugin-demo](https://github.com/Cap-go/demo-app) - 简单的 Ionic Vue 应用程序来演示 OTA 更新的使用.
...
- [Proposal](https://github.com/capacitor-community/proposals) - 插件和平台请求的官方仓库.
