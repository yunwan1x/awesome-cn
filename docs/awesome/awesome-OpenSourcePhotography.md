...
- [PhotoFlow](https://github.com/aferrero2707/PhotoFlow) - 一个无损照片修饰程序，包括 RAW 图像开发.
...
- [CHDK](http://chdk.wikia.com/wiki/CHDK) - Canon Hack Development Kit，适用于佳能相机. 
...
### GoPro
- [GoPro](https://github.com/kschzt/gopro) - 从 Node.js 控制 GoPro Hero 3 摄像头的 API.
- [GoPro](https://github.com/DenisCarriere/gopro) - GoPro 英雄 4 - Python API.
...
- [digiCamControl](https://github.com/dukus/digiCamControl) - 单反相机遥控开源软件.
...
- [Raw Studio](https://github.com/rawstudio/rawstudio) - 从数码相机读取和处理 RAW 图像.
...
- [GPhoto](http://www.gphoto.org/) - 一个程序和库框架，让用户可以从他们的数码相机中下载图片.
- [Lychee](http://lychee.electerious.com/) - 一个外观精美且易于使用的照片管理系统，您可以在服务器上运行，以管理和分享照片.
- [Simple Gallery](https://github.com/SimpleMobileTools/Simple-Gallery/) - 一个安卓图库应用，用于查看类似于安卓图库的照片和视频，支持文件复制/移动/重命名/删除/共享.
- [Leaf Pic](https://github.com/HoraApps/LeafPic/) - 材料设计的安卓画廊替代品.
- [A Photo Manager](https://github.com/k3b/APhotoManager/) - 在 Android 上管理本地照片：图库、带有照片地图的地理标记、标签、查找、排序、查看、复制、删除、发送……
...
- [Cinepaint](http://sourceforge.net/projects/cinepaint/files/CinePaint/) - 一个基于 GIMP 绘制和修饰电影位图帧的程序.

## Communities
- [Flickr Open Source Photography Group](https://www.flickr.com/groups/83823859@N00/)
- [/r/FOSSPhotography](http://reddit.com/r/fossphotography) - 关于 reddit 上用于摄影的免费​​开源软件的社区.
...
- [Blender](https://www.blender.org/) - 这个开源 3D 图形具有用于视频编辑的工具.
