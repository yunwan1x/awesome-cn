...
- [Smush it](http://www.imgopt.com/) <i>- Smush it uses optimization techniques specific to image format to remove unnecessary bytes from image files.</i> <b>- Smush 它使用特定于图像格式的优化技术从图像文件中删除不必要的字节。</b> <i>It is a &quot;lossless&quot; tool, which means it optimizes the images without changing their look or visual quality.</i><b>它是一种“无损”工具，这意味着它可以优化图像而不改变其外观或视觉质量。</b>
