...
* [DutchGhost/ArrayVec](https://github.com/DutchGhost/ArrayVec) - 具有矢量感的数组.
* [emekoi/deque.zig](https://github.com/emekoi/deque.zig) - 一个无锁的追逐列夫双端队列.
* [kristoff-it/zig-cuckoofilter](https://github.com/kristoff-it/zig-cuckoofilter) - 适用于任何 C ABI 兼容目标的生产就绪型 Cuckoo 过滤器.
* [marijnfs/zigtimsort](https://github.com/marijnfs/zigtimsort) - TimSort 实施.
* [Sahnvour/zig-containers](https://github.com/Sahnvour/zig-containers) - 一个容器库.
* [Srekel/zig-sparse-set](https://github.com/Srekel/zig-sparse-set) - 稀疏集，支持 SOA 和 AOS 风格.
* [hexops/xorfilter](https://github.com/hexops/xorfilter) - Xor 过滤器用于检查键是否是集合的一部分.
* [JakubSzark/zig-string](https://github.com/JakubSzark/zig-string) - UTF-8 字符串数据结构.


## Allocators and memory
* [fengb/zee_alloc](https://github.com/fengb/zee_alloc) - 主要针对 WebAssembly 的小型分配器.
* [mdsteele/ziegfried](https://github.com/mdsteele/ziegfried) - 通用内存分配器.
* [suirad/Seal](https://github.com/suirad/Seal) - 包装另一个分配器并检测内存在使用后是否泄漏的分配器.
* [Hejsil/zig-gc](https://github.com/Hejsil/zig-gc) - 一个超级简单的标记和清除垃圾收集器.
...
* [andrewrk/clashos](https://github.com/andrewrk/clashos) - 裸机 Raspberry Pi 3 B+ 多人街机游戏.
...
* [iguessthislldo/georgios](https://github.com/iguessthislldo/georgios) - 爱好操作系统.
* [jzck/kernel-zig](https://github.com/jzck/kernel-zig) - 爱好 x86 内核.
* [markfirmware/zig-bare-metal-microbit](https://github.com/markfirmware/zig-bare-metal-microbit) - 裸机 microbit 程序.
* [markfirmware/zig-bare-metal-raspberry-pi](https://github.com/markfirmware/zig-bare-metal-raspberry-pi) - 裸机树莓派程序.
...
* [nrdmn/uefi-paint](https://github.com/nrdmn/uefi-paint) - UEFI 可启动的触控画应用程序.
* [SamTebbs33/pluto](https://github.com/SamTebbs33/pluto) - x86 内核.
* [sjdh02/trOS](https://github.com/sjdh02/trOS) - 微小的 aarch64 裸机操作系统.
* [tralamazza/embedded_zig](https://github.com/tralamazza/embedded_zig) - 最小的嵌入式 ARM 示例（STM32F103 蓝色药丸）.
* [yvt/zig-armv8m-test](https://github.com/yvt/zig-armv8m-test) - Armv8-M + TrustZone 的示例应用程序.
* [ZeeBoppityZagZiggity/ZBZZ.OS](https://github.com/ZeeBoppityZagZiggity/ZBZZ.OS) - 为 RISCV 构建的操作系统.
...
* [ziglang/zig.vim](https://github.com/ziglang/zig.vim) - Zig 的 Vim 配置.
* [zigtools/zls](https://github.com/zigtools/zls) - Zig LSP 实施 + Zig 语言服务器.


## Emulators
* [fengb/fundude](https://github.com/fengb/fundude) - WASM 的 Gameboy 模拟器.
* [GrooveStomp/chip8-zig](https://github.com/GrooveStomp/chip8-zig) - CHIP-8 模拟器.
...
* [TM35-Metronome/metronome](https://github.com/TM35-Metronome/metronome) - 一组用于修改和随机化神奇宝贝游戏的工具.
...
## Games
* [Akuli/curses-minesweeper](https://github.com/Akuli/curses-minesweeper) - 用诅咒写的扫雷游戏.
* [andrewrk/tetris](https://github.com/andrewrk/tetris) - 一个简单的俄罗斯方块克隆.
* [fabioarnold/snake-zig](https://github.com/fabioarnold/snake-zig) - 一个简单的蛇克隆.
...
* [batiati/IUPforZig](https://github.com/batiati/IUPforZig) - 用于 IUP 便携式用户界面工具包的 Zig 惯用和类型检查绑定.
* [zenith391/zgt](https://github.com/zenith391/zgt) - Zig GUI Toolkit：用于在 Zig 中制作原生 GUI 的便携式库.
* [kassane/QML-zig](https://github.com/kassane/qml_zig) - QML 绑定.
* [cshenton/learnopengl](https://github.com/cshenton/learnopengl) - [Learn OpenGL](https://learnopengl.com) 移植到 Zig 的教程.
* [ifreund/river](https://github.com/ifreund/river) - 从 dwm 和 bspwm 中汲取灵感的动态 Wayland 合成器.
* [Nelarius/weekend-raytracer-zig](https://github.com/Nelarius/weekend-raytracer-zig) - “周末光线追踪”一书的实现.
...
* [MasterQ32/ZigPaint](https://github.com/MasterQ32/ZigPaint)  - 一个简单的油漆应用程序. 用于创建 OpenGL 加载器/包装器和最小的 UI 系统.
...
* [kprotty/zap](https://github.com/kprotty/zap) - 为编写高性能应用程序提供系统接口的库集合.
* [mlarouche/zigimg](https://github.com/mlarouche/zigimg) - 用于读取和写入不同图像格式的 Zig 库.
* [ziglibs/known-folders](https://github.com/ziglibs/known-folders) - 提供对跨多个操作系统的知名文件夹的访问.
* [SasLuca/zig-nanoid](https://github.com/SasLuca/zig-nanoid)  - 经过实战测试、小巧、安全、URL 友好、唯一的字符串 ID 生成器. 现在可在纯 Zig 中使用.

## Network
* [euantorano/ip.zig](https://github.com/euantorano/ip.zig) - 用于处理 IP 地址的库.
* [lun-4/zigdig](https://github.com/lun-4/zigdig) - 天真的 DNS 客户端库.
* [marler8997/netpunch](https://github.com/marler8997/netpunch) - 出站代理协议.
* [remeh/statsd-zig](https://github.com/remeh/statsd-zig) - 基本 DogStatsD UDP 服务器.


### HTTP
* [Luukdegram/apple_pie](https://github.com/Luukdegram/apple_pie) - HTTP 1.0/1.1 服务器实现.
* [truemedian/zfetch](https://github.com/truemedian/zfetch) - 基于 iguanaTLS 的 HTTP(S) 客户端.
...
* [thejoshwolfe/hexdump-zip](https://github.com/thejoshwolfe/hexdump-zip) - 生成 zip 文件的带注释的 hexdump.
...
### Package managers
* [zigtools/zpm](https://github.com/zigtools/zpm) - 非官方的 Zig 包管理器.
* [mattnite/gyro](https://github.com/mattnite/gyro) - 具有索引、构建运行器和构建依赖项的包管理器.
* [nektro/zigmod](https://github.com/nektro/zigmod) - Zig 包管理器.
* [cheetah/asdf-zig](https://github.com/cheetah/asdf-zig) - ASDF 包管理器的 Zig 插件.
...
* [gernest/base32](https://github.com/gernest/base32) - Base32 编码/解码.
* [caolan/zig-netstring](https://git.sr.ht/~caolan/zig-netstring) - 网络字符串解析器.
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) - 利用 Zig 的 comptime 实现 Protocol Buffers v3.
* [iddev5/inon](https://github.com/iddev5/inon) - 数据配置文件格式.

## Learning resources
* [belse-de/zig-tut](https://github.com/belse-de/zig-tut) - 一系列学习 Zig 的小项目和教程.
...
* [vegecode/svd2zig](https://github.com/vegecode/svd2zig) - 将系统视图描述 (svd) 文件转换为 Zig 标头以进行裸机开发.
...
* [kubkon/zig-ios-example](https://github.com/kubkon/zig-ios-example) - 针对 iOS 的最小 `build.zig`.
* [ynuwenhof/zigbraten](https://github.com/ynuwenhof/zigbraten) - Cube 2: Sauerbraten 的概念证明内部作弊.
