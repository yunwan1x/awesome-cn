...
* [Microsoft Azure](https://azure.microsoft.com/en-us/free/students/) <i>- Microsoft Azure is an ever-expanding set of cloud services to help you build, manage, and deploy applications.</i> <b>- Microsoft Azure 是一组不断扩展的云服务，可帮助您构建、管理和部署应用程序。</b> <i>Level up your ideas by learning cloud computing skills and get a $100 credit with your free Azure for Students account—no credit card required.</i><b>通过学习云计算技能提升您的想法，并使用免费的 Azure for Students 帐户获得 100 美元的信用额度——无需信用卡。</b>
