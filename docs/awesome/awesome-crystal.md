...
欢迎投稿. 请快速浏览 [contribution guidelines](https://github.com/veelenga/awesome-crystal/blob/master/.github/CONTRIBUTING.md) 第一的.
 ...
 * [kd_tree](https://github.com/geocrystal/kd_tree) - “K-Dimensional Tree”和“N-Nearest Neighbors”的实现
 ...
 * [lff](https://github.com/mkdika/lff-cr) - 命令行中简单直接的大文件查找器实用程序
 * [meet](https://github.com/ryanprior/meet) - 从舒适的命令行中快速开始 jitsi 会议
 * [oq](https://github.com/Blacksmoke16/oq)  - 一个高性能、可移植的 jq 包装器，以方便 JSON 以外的格式的消费和输出； 使用 [jq](https://github.com/stedolan/jq) 过滤器来转换数据
 ...
 * [Gzip](https://crystal-lang.org/api/Compress/Gzip.html) - gzip 格式的读写器（Crystal stdlib）
 * [polylines.cr](https://github.com/BuonOmo/polylines.cr) — 坐标系列的压缩
 * [snappy](https://github.com/naqvis/snappy) - 用于 Crystal 的 Snappy 压缩格式读取器/写入器
 * [Zip](https://crystal-lang.org/api/Compress/Zip.html) - zip格式的读者和作者（Crystal stdlib）
 * [Zlib](https://crystal-lang.org/api/Compress/Zlib.html) - zlib 格式的读写器（Crystal stdlib）
 ...
 * [Crystalizer](https://github.com/j8r/crystalizer)  - （反）序列化任何水晶对象； 开箱即用支持 JSON、YAML 和 Byte 格式
 ...
 * [prime](https://github.com/wontruefree/prime) - 素数发生器
...
## Database Tools
 * [migrate](https://github.com/vladfaust/migrate.cr) - 一个更简单的带有事务的数据库迁移工具
 * [queryit](https://github.com/hugopl/queryit) - 基于无设置终端的 SQL 查询运行器

## Debugging
* [backtracer.cr](https://github.com/Sija/backtracer.cr) - 旨在帮助将回溯解析为结构化形式的 Shard
* [debug.cr](https://github.com/Sija/debug.cr) - `debug!(…)` 宏，用于 `pp` 风格的调试
 ...
 * [Athena Event Dispatcher](https://github.com/athena-framework/event-dispatcher) - 一个中介者和观察者模式事件库
 ...
 * [Shield](https://github.com/grottopress/shield) - *Lucky* 框架的综合安全性
 * [shrine.cr](https://github.com/jetrockets/shrine.cr)  - Crystal 应用程序的文件附件工具包. 深受红宝石神社的启发
 * [tourmaline](https://github.com/protoncr/tourmaline) - Telegram bot 框架，其 API 松散地基于 [telegraf.js](https://telegraf.js.org/)
 ...
 * [crystal-imgui-sfml](https://github.com/oprypin/crystal-imgui-sfml) - 绑定集成 [Dear ImGui](https://github.com/ocornut/imgui) 成一个 [SFML](https://www.sfml-dev.org/) 项目
 * [entitas.cr](https://github.com/spoved/entitas.cr) - Crystal 的实体组件系统框架
 * [MyECS](https://github.com/konovod/myecs) - Crystal 的稀疏实体组件系统框架
...
## HTML Builders
 * [form_builder.cr](https://github.com/westonganger/form_builder.cr) - Crystal 的简单 HTML 表单构建器，内置支持许多流行的 UI 库，例如 Bootstrap
 ...
 * [crest](https://github.com/mamantoha/crest) - 受 Ruby 的 RestClient gem 启发的简单 HTTP 和 REST 客户端
 * [crul](https://github.com/porras/crul) - 命令行 HTTP 客户端
 * [digest-auth](https://github.com/spider-gazelle/digest-auth) - 摘要认证
 * [halite](https://github.com/icyleaf/halite) - 带有可链接 REST API、内置会话和记录器的 Crystal HTTP 请求
 ...
 * [HTTP::Client](https://crystal-lang.org/api/HTTP/Client.html) - HTTP 客户端（水晶标准库）
 ...
 * [myst-lang](https://github.com/myst-lang/) - 一种实用、动态的语言，旨在尽可能轻松高效地编写和理解
 ...
 * [any_hash.cr](https://github.com/Sija/any_hash.cr) - 包含更好的 JSON::Any 的递归哈希
 * [anyolite](https://github.com/Anyolite/anyolite) - 具有简单绑定的完整 mruby 解释器，允许在项目中轻松编写脚本支持
 * [burocracia.cr](https://github.com/vinibrsl/burocracia.cr) - burocracia.cr 用于验证、生成和格式化巴西 burocracias（如 CPF、CNPJ 和 CEP）的无依赖分片
 ...
 * [crystal-web-framework-stars](https://github.com/isaced/crystal-web-framework-stars) - Crystal 的 Web 框架，在 Github 上获得最多星标
 ...
 * [jennifer.cr](https://github.com/imdrasil/jennifer.cr) - 具有灵活查询链式构建器和迁移系统的 Active Record 模式实现
...
## Routing
 * [orion](https://github.com/obsidian/orion) - 一个最小的 Rails 式路由库
 ...
 * [tasker](https://github.com/spider-gazelle/tasker) - 一个高精度调度程序，包括时区感知 cron 作业

## Science and Data analysis
 * [alea](https://github.com/nin93/alea) - 可重复采样、CDF 和其他实用程序来处理概率分布
 * [ishi](https://github.com/toddsundsted/ishi) - 图形绘图包，带有一个小 API 和由 gnuplot 提供支持的合理默认值
 ...
 * [soegen](https://github.com/Ragmaanir/soegen) - Crystal 的 Elasticsearch 客户端类似于红宝石的伸展器宝石
 ...
 * [ECR (Embedded Crystal)](https://crystal-lang.org/api/ECR.html) - 使用纯水晶表达式的编译时模板语言（Crystal stdlib）
 ...
 * [microtest](https://github.com/Ragmaanir/microtest) - 专注于电源断言的小型自以为是的测试库
 * [minitest.cr](https://github.com/ysbaddaden/minitest.cr) - 单元测试和断言库
 * [mocks.cr](https://github.com/waterlink/mocks.cr) - Crystal 的模拟库
 * [Spec](https://crystal-lang.org/api/Spec.html) - 规范框架（水晶标准库）
 * [spectator](https://gitlab.com/arctic-fox/spectator) - 使用现代期望语法的功能丰富的规范框架
 * [timecop.cr](https://github.com/crystal-community/timecop.cr)  - 使用 `Time.now` 模拟的库. 灵感来自 [timecop ruby gem](https://github.com/travisjeffery/timecop)
 ...
 * [host_meta](https://github.com/toddsundsted/host_meta) - 一个 Web 主机元数据 (https://tools.ietf.org/html/rfc6415) 客户端
 ...
 * [Shivneri](https://github.com/ujjwalguptaofficial/shivneri) - 基于组件的 MVC Web 框架，用于晶体目标良好的代码结构、模块化和性能
 * [spider-gazelle](https://github.com/spider-gazelle/spider-gazelle) - 一个专注于速度和可扩展性的 Rails 式 Web 框架
 ...
 * [Programming Crystal](https://pragprog.com/book/crystal/programming-crystal) - 开始您的水晶之旅的 PragProg 书籍
 ...
 * [Crystal [ANN]](https://crystal-ann.com) - 宣布新项目、博客文章、版本更新或任何其他 Crystal 工作
 ...
 * [shards.info](http://shards.info/)  - 列出 GitHub 上包含 Crystal 代码的所有存储库的 Web 服务. 来源可在 [GitHub](https://github.com/mamantoha/shards-info)
...
## DevOps
 * [ansible-crystal](https://github.com/CorbanR/ansible-crystal) - 安装水晶的 Ansible 剧本
 * [DPPM](https://github.com/DFabric/dppm) - 一种以包形式安装和管理应用程序的简单通用方法（主要是 Linux）
 ...
 * 视觉工作室代码
   * [vscode-crystal-lang](https://github.com/crystal-lang-tools/vscode-crystal-lang) - `cr` 和 `ecr` 文件的格式化程序、linter 和语法高亮显示

## LSP Language Server Protocol Implementations
 * [crystalline](https://github.com/elbywan/crystalline) - Crystalline 是为 Crystal 语言编写的语言服务器协议的实现
