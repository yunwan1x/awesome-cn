...
- [Service per Team](https://microservices.io/patterns/decomposition/service-per-team.html) <i>- Each team is responsible for one or more business functions (eg business capabilities).</i> <b>- 每个团队负责一项或多项业务功能（例如业务能力）。</b> <i>A team owns a code base consisting of one or more modules.</i><b>一个团队拥有一个由一个或多个模块组成的代码库。</b> <i>Its code base is sized so as to not exceed the cognitive capacity of team.</i><b>它的代码库大小不超过团队的认知能力。</b> <i>The team deploys its code as one or more services.</i><b>团队将其代码部署为一项或多项服务。</b> <i>A team should have exactly one service unless there is a proven need to have multiple services.</i><b>一个团队应该只拥有一项服务，除非证明需要拥有多项服务。</b>
