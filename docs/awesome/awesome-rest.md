...
* [HATEOAS](http://timelessrepo.com/haters-gonna-hateoas) - 清楚说明什么是 HATEOAS，以及为什么要使用它.
* [How to GET a cup of coffee](http://www.infoq.com/articles/webber-rest-workflow/)
* [REST API Tutorial](http://www.restapitutorial.com/) - RestApiTutorial.com 致力于跟踪 REST API 最佳实践并提供可用资源，以便为开发人员提供快速参考和自我教育.
...
* [RAML](http://raml.org/) - 描述 RESTful API 的简单而简洁的方式.
* [JSend](http://labs.omniti.com/labs/jsend) - 简单的规范，为来自 Web 服务器的 JSON 响应应如何格式化制定了一些规则.
* [OData](http://www.odata.org/)  - 允许创建和使用可查询和可互操作的 RESTful API 的开放协议. 相当复杂.
* [HAL](https://tools.ietf.org/html/draft-kelly-json-hal-06) - 简单的格式，为 API 中资源之间的超链接提供了一致且简单的方法（请参阅： [HATEOAS](#hateoas)).
...
* [OpenAPI](https://openapis.org/) - 以前称为 Swagger 规范，OpenAPI 规范是世界上最流行的定义 Restful API 的描述格式.
...
* [restangular](https://github.com/mgonto/restangular) - AngularJS 服务可以正确轻松地处理 REST API.
...
* [Sails.js](http://sailsjs.org/) - Node.js Web 框架嵌入了自动生成 REST API 的命令.
* [mers](https://github.com/jspears/mers) - Express 服务将 Mongoose finder 公开为 RESTful API.
...
* [Feathers](http://feathersjs.com/) - 是一个实时的微服务 Web 框架，让您可以通过 RESTful 资源、套接字和灵活的插件来控制您的数据.
* [Expressa](https://github.com/thomas4019/expressa) - 使用简单的管理编辑器和权限模型从 JSON 模式创建 API 的 Express 中间件.
...
* [FOSRestBundle](https://github.com/FriendsOfSymfony/FOSRestBundle) - REST API 的捆绑处理视图、路由、错误处理等.
* [stanlemon/rest-bundle](https://github.com/stanlemon/rest-bundle) - 使用约定优于配置，基于 Doctrine 实体构建 REST API.
...
* [Symfony REST Edition](https://github.com/gimler/symfony-rest-edition) - 从 Symfony2 应用程序开始，并预先配置所有 REST 友好的包.
...
* [Ramses](https://ramses.readthedocs.org/en/stable/) - 通过在运行时从 RAML 文件生成生产就绪的 API 使 RAML 文件可执行.
...
* [FastAPI](https://github.com/tiangolo/fastapi)  - FastAPI 是一种现代、快速（高性能）的 Web 框架，用于基于标准 Python 类型提示使用 Python 3.6+ 构建 API. 使用 Swagger UI 和 ReDoc 的自动 API 文档，基于 OpenAPI 和 JSON 架构.

### Ruby

* [Grape](http://www.ruby-grape.org) - 用于在 Ruby 中创建类 REST API 的有意见的微框架.
* [Rails](http://guides.rubyonrails.org/api_app.html) - RailsGuides：将 Rails 用于仅 API 的应用程序.

### Go

* [gocrud](https://github.com/manishrjain/gocrud)：Go 库以简化创建、更新和删除任意深度结构化数据的过程——使构建 REST 服务变得快速而简单.
* [go-json-rest](https://github.com/ant0ine/go-json-rest) - 在 `net/http` 之上的薄层，有助于轻松构建 RESTful API.
...
* [go-restful](https://github.com/emicklei/go-restful) - 一个声明性的高可读性框架，用于构建 Restful API.
...
* [RestExpress](https://github.com/RestExpress/RestExpress) - 基于 Netty 的高性能、轻量级、无容器、插件可扩展的框架，非常适合微服务架构.
* [Vertx-Web](https://github.com/vert-x3/vertx-web) - Vert.x-Web 是一组用于使用 Vert.x 构建 Web 应用程序的构建块，Vert.x 是用于在 JVM 上构建响应式应用程序的工具包.
* [Dropwizard](https://github.com/dropwizard/dropwizard) - 用于开发操作友好、高性能、RESTful Web 服务的框架.

### Scala

* [Chaos](https://github.com/mesosphere/chaos) - 在 Scala 中编写 REST 服务的轻量级框架.
...
* [httpie](https://github.com/jkbrzt/httpie) - 命令行 HTTP 客户端，远比 `curl` 更友好.
* [Postman REST Client](https://chrome.google.com/webstore/detail/postman-rest-client/fdmmgilgnpjigdojojpjoooidkmcomcm) - 手动测试 REST API 必不可少的 Chrome 扩展程序.
...
* [Http-console](https://github.com/cloudhead/http-console) - HTTP 的命令行界面，让您*像本地人一样使用 HTTP*
* [HTTP Prompt](https://github.com/eliangcs/http-prompt) - HTTP Prompt 是一个交互式命令行 HTTP 客户端，具有自动完成和语法突出显示功能，建立在 HTTPie 和 prompt_toolkit 之上.
...
* [httpbin](http://httpbin.org) - HTTP 请求和响应服务 - 用于 HTTP 的 a/k/a Swiss Army Knife.
...
* [Mocky.io](http://www.mocky.io/) - 创建虚假 HTTP 响应的免费在线服务.
* [Swagger API Mock](https://github.com/bulkismaslom/swagger-api-mock) - 基于 swagger 模式模拟 RESTful API
...
* [Public APIS](https://www.publicapis.com/) - 探索银河中最大的 API 目录.
* [Marvel Comics API](http://developer.marvel.com/) - 查询有关漫威超级英雄的人物、故事、事件.
...
* [API Umbrella](https://github.com/NREL/api-umbrella) - 用于公开 Web 服务的 API 管理平台，具有 Web 界面和分析，用 Lua 编写.
* [WSO2 API Management](https://github.com/wso2/product-apim) - 带有轻量级网关和 API 生命周期管理的 API 管理工具，用 Java 编写.
...
* [Apigee](https://apigee.com) - Apigee 是面向企业和开发者的 API 技术和服务的领先供应商.
* [3scale](https://www.3scale.net/) - 基于 Nginx 的 API 网关，将内部和外部 API 服务与 3scale 的 API 管理平台集成.
