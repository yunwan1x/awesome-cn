...
[GNOME](https://www.gnome.org/) 是 Linux 和 Unix 的桌面环境，旨在让用户控制并完成工作. 它的应用程序使用 GTK，官方桌面 shell 使用 Clutter 和 JavaScript.

&gt; 标有 ![GNOME Core][GNOME Core] 的项目是由 GNOME 项目正式维护和分发的应用程序，作为核心应用程序和工具集的一部分，或作为经典模式的一部分维护和分发的扩展.

&gt; 标有 ![GNOME Circle][GNOME Circle] 的项目是由 [GNOME Circle](https://circle.gnome.org/) 旨在展示 GNOME 的最佳应用程序和库的倡议.
...
- [GNOME Web](https://wiki.gnome.org/Apps/Web)  - GNOME 的官方网页浏览器项目.  ![GNOME 核心][GNOME 核心]
- [Fragments](https://gitlab.gnome.org/World/Fragments)  - BitTorrent 客户端.  ![GNOME 圈子][GNOME 圈子]
- [Newsflash](https://gitlab.com/news-flash/news_flash_gtk)  - RSS 订阅阅读器.  ![GNOME 圈子][GNOME 圈子]
...
- [Eolie](https://gitlab.gnome.org/World/eolie) - 使用垂直选项卡的 Web 浏览器.
...
- [Jami](https://jami.net/) - Jami 客户端，一种安全的通信工具.
...
- [Blanket](https://flathub.org/apps/details/com.rafaelmardojai.Blanket)  - 听不同的声音.  ![GNOME 圈子][GNOME 圈子]
- [Health](https://flathub.org/apps/details/dev.Cogitri.Health) - 健康跟踪.
...
- [Nuvola Player](https://tiliado.eu/nuvolaplayer/) - 基于 Web 的音乐流媒体服务的运行时提供更原生的用户体验并与 Linux 桌面环境集成.
...
- [Coulr](https://github.com/Huluti/Coulr) - 在 RGB 和十六进制代码之间转换颜色.
...
- [Menulibre](https://smdavis.us/projects/menulibre/) - 如果您使用传统的应用程序菜单（如 Arc 或应用程序菜单），请管理您的应用程序类别.
...
- [Dynamic Gnome Wallpapers](https://github.com/manishprivet/dynamic-gnome-wallpapers) - 像动态壁纸一样的 MacOS 画廊，以及安装它们的简单脚本
...
- [Detwinner](https://neatdecisions.com/products/detwinner-linux/) - 删除重复文件的简单快速工具.
- [Recipes](https://gitlab.gnome.org/GNOME/recipes/) - 烹饪应用程序.
- [RecApp](https://github.com/amikha1lov/RecApp) - 用户友好的开源截屏.
- [Sunflower](http://sunflower-fm.org) - 小型且高度可定制的双面板文件管理器.
- [Kooha](https://github.com/SeaDve/Kooha) - 一个简单的屏幕录像机.
- [Junction](https://junction.sonny.re/)  - Junction 允许您选择应用程序来打开文件和链接.  ![GNOME 圈子][GNOME 圈子]
...
- [Webfont Kit Generator](https://github.com/rafaelmardojai/WebfontKitGenerator)  - 轻松创建@font-face 套件.  ![GNOME 圈子][GNOME 圈子]
- [Commit](https://apps.gnome.org/app/re.sonny.Commit/)  - 提交消息编辑器.  ![GNOME 圈子][GNOME 圈子]
- [Sysprof](https://apps.gnome.org/app/org.gnome.Sysprof3/) - 分析应用程序或整个系统.
- [DevHelp](https://apps.gnome.org/app/org.gnome.Devhelp/) - 用于浏览和搜索 API 文档的开发工具.
- [Workbench](https://github.com/sonnyp/Workbench) - 使用 GNOME 技术学习和制作原型.

#### Design Tooling

- [Icon Preview](https://gitlab.gnome.org/World/design/icon-preview) - 预览图标的简单实用程序.
- [Palette](https://gitlab.gnome.org/World/design/palette) - 查看 GNOME 调色板的工具.
- [Contrast](https://gitlab.gnome.org/World/design/contrast) - 检查两种颜色之间的对比度.
- [Icon Library](https://apps.gnome.org/app/org.gnome.design.IconLibrary/) - 应用程序的符号图标.
...
- [Arc Menu](https://gitlab.com/arcmenu/Arc-Menu) - 受 Zorin OS 启发的类似 Windows7 的应用程序菜单.
- [Fly-Pie](https://github.com/Schneegans/Fly-Pie) - 基于鼠标的菜单.
...
### Docks and Panels
- [Dash-to-Dock](https://micheleg.github.io/dash-to-dock/) - 一个功能齐全的码头.
...
- [Compiz alike windows effect](https://github.com/hermes83/compiz-alike-windows-effect) - 为窗口添加摇摆不定的效果.
...
- [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) - 材质图标主题，最初基于 Paper.
...
- [GNOME Newcomers Wiki](https://wiki.gnome.org/Newcomers/) - 开始为 GNOME 做贡献的完美场所.
