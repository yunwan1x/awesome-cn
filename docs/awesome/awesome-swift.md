...
* [DataKernel](https://github.com/mrdekk/DataKernel)  - DataKernel 是 Core Data 堆栈的简约包装器，以简化持久性操作. 没有外部依赖.
...
* [OHHTTPStubs](https://github.com/AliSoftware/OHHTTPStubs) - 旨在轻松存根您的网络请求的测试库.
