...
:-- | :--: | :--: | :--: | :--: | :--:
[Calculus 1A: Differentiation](https://openlearninglibrary.mit.edu/courses/course-v1:MITx+18.01.1x+2T2019/about) ([alt](https://ocw.mit.edu/courses/mathematics/18-01sc-single-variable-calculus-fall-2010/index.htm) ) |  13 周 |  6-10 小时/周 | 替代课程涵盖此课程和以下 2 门课程 | [high school math](https://github.com/ossu/computer-science/blob/master/FAQ.md#how-can-i-review-the-math-prerequisites) | [chat](https://discord.gg/mPCt45F)
...
[Linear Algebra](https://ocw.mit.edu/courses/mathematics/18-06sc-linear-algebra-fall-2011/)  |  14 周 |  12 小时/周 | 共同条件：线性代数的本质| [chat](https://discord.gg/k7nSWJH)
...
希望在创建项目时获得更多指导的学生可以选择使用一系列面向项目的课程. 以下是一个选项示例（还有更多可用选项，此时您应该能够确定一个有趣且与您相关的系列）：
...
完成最终项目后：
- 提交您的项目信息至 [PROJECTS](https://github.com/ossu/computer-science/blob/master/PROJECTS.md) 通过拉取请求.
- 将 OSSU-CS 徽章放在您存储库的自述文件中！
...
- 关注软件开发领域的新兴技术：
  + 探索 **actor 模型** [Elixir](http://elixir-lang.org/), a new functional programming language for the web based on the battle-tested Erlang Virtual Machine!
