...
* [SwiftyGPIO](https://github.com/uraimo/SwiftyGPIO) :penguin: - 与 ARM 上的 Linux GPIO/SPI/PWM 交互.
...
* [PassportScanner](https://github.com/evermeer/PassportScanner) - 扫描护照的机读区代码，提取名字、姓氏、护照号码、国籍、出生日期、有效期和个人号码.
...
* [AwaitKit](https://github.com/yannickl/AwaitKit) - ES7 Async/Await 控制流.
* [Each](https://github.com/dalu93/Each) - 每个都是 NSTimer 桥接库.
* [GCDTimer](https://github.com/hemantasapkota/GCDTimer) - 一个经过良好测试的 GCD 计时器.
* [Schedule](https://github.com/luoxiu/Schedule) :penguin: - 一个缺少的轻量级任务调度程序，具有令人难以置信的人性化语法.
* [SwiftyTimer](https://github.com/radex/SwiftyTimer) - NSTimer 的 API.

### UI
*一系列预打包的过渡和酷炫的 ui 内容.* [back to top](#readme) 
...
* [CustomSegue](https://github.com/phimage/CustomSegue) - 带有幻灯片和交叉淡入淡出效果的 OSX Storyboards 的自定义 segue.
...
* [Dodo](https://github.com/evgenyneu/Dodo) - iOS 的消息栏.
...
* [Fashion](https://github.com/vadymmarkov/Fashion) - 时尚配饰和美容工具，用于共享和重用 UI 样式.
...
* [MantleModal](https://github.com/canalesb93/MantleModal) - 一个简单的模式资源，它使用 UIScrollView 允许用户通过向下拖动来关闭模式.
* [Material](https://github.com/CosmicMind/Material) - 使用 Material 表达您的创造力，这是一种适用于 Google 的 Material Design 和 Apple 的 Flat UI 的动画和图形框架.
...
* [MultiSlider](https://github.com/yonat/MultiSlider) - 具有多个拇指和值、范围突出显示、可选捕捉间隔、可选值标签（垂直或水平）的 UISlider 克隆.
* [MXParallaxHeader](https://github.com/maxep/MXParallaxHeader) - UIScrollView 的简单视差标头.
* [MZFormSheetPresentationController](https://github.com/m1entus/MZFormSheetPresentationController) - 提供原生 iOS UIModalPresentationFormSheet 的替代方案，增加对 iPhone 的支持以及设置控制器大小和感觉表单的额外机会.
* [NeumorphismKit](https://github.com/y-okudera/NeumorphismKit) - UIKit 的神经拟态框架.
...
* [OverlayContainer](https://github.com/applidium/OverlayContainer) - OverlayContainer 使开发基于覆盖的界面变得更加容易，例如 Apple Maps 或 Stocks 应用程序中呈现的界面.
* [PPAssetsActionController](https://github.com/pavelpantus/PPAssetsActionController) - 具有资产预览的高度可定制的操作表控制器.
* [Preferences](https://github.com/sindresorhus/Preferences) - 在几分钟内将首选项窗口添加到您的 macOS 应用程序.
...
* [RangeSeekSlider](https://github.com/WorldDownTown/RangeSeekSlider) - 一个可自定义的范围滑块，如 iOS 的 UISlider.
...
* [SpreadsheetView](https://github.com/kishikawakatsumi/SpreadsheetView) - 适用于 iOS 应用程序的完全可配置的电子表格视图用户界面.
* [StarryStars](https://github.com/peterprokop/StarryStars) - 显示和编辑评级，可从界面生成器完全自定义.
...
* [SweetCurtain](https://github.com/multimediasuite/SweetCurtain)  - 真正甜蜜和容易的底部可拉片实施. 您可以在 Apple Maps、Find My、Stocks 等应用程序中找到类似的实现.
...
* [Wallet](https://github.com/russ-stamant/Wallet)  - Apple 钱包界面的复制品. 添加、删除或出示您的卡片和通行证.
...
* [YNSearch](https://github.com/younatics/YNSearch) - 令人敬畏的完全可定制的搜索视图，如 Pinterest.
...
* [KRAlertController](https://github.com/krimpedance/KRAlertController) - 一个漂亮的 iOS 警报控制器.
...
* [PopupDialog](https://github.com/orderella/PopupDialog)  - 一个简单的、可自定义的弹出对话框. 替换 UIAlertController 警报样式.
...
* [Swift-Prompts](https://github.com/GabrielAlva/Swift-Prompts) - 设计具有多种选择的自定义提示.
* [SwiftEntryKit](https://github.com/huri000/SwiftEntryKit) - 一个简单而多才多艺的弹出式演示者.
* [SwiftMessages](https://github.com/SwiftKickMobile/SwiftMessages) - 适用于 iOS 的非常灵活的消息栏.
...
* [Toast-Swift](https://github.com/BastiaanJansen/Toast-Swift) - 一个易于使用的库，用于创建 iOS 14 和更新样式的 toast.
* [XLActionController](https://github.com/xmartlabs/XLActionController) - 完全可定制和可扩展的动作表控制器.
* [Zingle](https://github.com/hemangshah/Zingle) - 在您的 UINavigationBar 下方会显示一条警报.
...
* [Floaty](https://github.com/kciter/Floaty) - iOS 的浮动操作按钮.
* [IGStoryButtonKit](https://github.com/KaoruMuta/IGStoryButtonKit) - 易于使用的按钮，带有受 Instagram 故事启发的丰富动画.
...
* [NFDownloadButton](https://github.com/LeonardoCardoso/NFDownloadButton)  - 改进的下载按钮. 这有点像 Netflix 应用程序下载按钮的逆向工程.
...
* [SwiftShareBubbles](https://github.com/takecian/SwiftShareBubbles) - iOS 的动画社交分享按钮控制.
...
* [CalendarView](https://github.com/mmick66/CalendarView) - 日历组件，它具有垂直和水平布局（和滚动）以及本地日历事件的显示.
...
* [CardParts](https://github.com/intuit/CardParts) - 为 iOS 开发人员构建的基于 UIKit 的反应式、基于卡片的 UI 框架.
...
* [ObjectForm](https://github.com/haojianzong/ObjectForm) - 一个简单而强大的库，可为您的类模型构建表单.
...
* [KRProgressHUD](https://github.com/krimpedance/KRProgressHUD) - 一个漂亮且可定制的进度HUD.
...
* [IncrementableLabel](https://github.com/tbaranes/IncrementableLabel) - UILabel 的子类，用于（减）增加 UILabel 中的数字.
* [KDEDateLabel](https://github.com/delannoyk/KDEDateLabel) - 一个 UILabel 子类，它可以自我更新以使时间前的格式更容易.
* [LTMorphingLabel](https://github.com/lexrus/LTMorphingLabel) - UILabel 的优美变形效果.
...
* [SMIconLabel](https://github.com/anatoliyv/SMIconLabel) - 带有图像的 UILabel 从左侧或右侧放置.
...
* [FlowingMenu](https://github.com/yannickl/FlowingMenu) - 交互式视图过渡以显示具有流动和弹跳效果的菜单.
* [GuillotineMenu](https://github.com/Yalantis/GuillotineMenu) - 断头台风格的菜单.
...
* [MenuItemKit](https://github.com/cxa/MenuItemKit) - `UIMenuItem` 支持图像和块（闭包）.
...
* [SlideController](https://github.com/touchlane/SlideController)  - 它是使用泛型类型的强大功能构建的 UIPageViewController 的一个不错的替代方案. 使用交互式标题导航控件在页面之间滑动. 为无限页数配置水平或垂直链.
...
* [MFCard](https://github.com/MobileFirstInc/MFCard) - 在 iOS 应用中轻松集成信用卡支付.
...
* [TextFieldEffects](https://github.com/raulriera/TextFieldEffects) - 几个现成的 UITextFields 效果.
* [UITextField-Navigation](https://github.com/T-Pham/UITextField-Navigation)  - UITextField-Navigation 为您的 UITextFields 添加下一个、上一个和完成按钮到键盘. 高度可定制.
* [VKPinCodeView](https://github.com/Sunspension/VKPinCodeView) - 用于输入 PIN 的简单优雅的 UI 组件.

#### Transition
[back to top](#readme) 

* [BubbleTransition](https://github.com/andreamazz/BubbleTransition) - 以简单的方式进行气泡过渡.
* [Cards XI](https://github.com/PaoloCuscela/Cards) - 真棒 iOS 11 AppStore 的卡片视图.
...
* [MusicPlayerTransition](https://github.com/xxxAIRINxxx/MusicPlayerTransition) - 自定义交互过渡，如 Apple Music iOS App.
...
* [SamuraiTransition](https://github.com/hachinobu/SamuraiTransition) - 基于 Swift 的库提供了一系列 ViewController 过渡，其中包含许多简洁的切割动画.
* [SPLarkController](https://github.com/ivanvorobei/SPLarkController)  - 两个控制器之间的自定义转换. 翻译到顶部.
* [SPStorkController](https://github.com/ivanvorobei/SPStorkController)  - 现在从 Apple Music 播放控制器. 可定制的高度.
* [StarWars.iOS](https://github.com/Yalantis/StarWars.iOS) - 将动画转换为将视图控制器分解成小块.
* [Transition](https://github.com/Touchwonders/Transition) - 简单的交互式可中断自定义 ViewController 转换.

#### 3D
[back to top](#readme) 

* [Insert3D](https://github.com/Viktoo/Insert3D) - 嵌入 3D 模型的最快方式.

#### UICollectionView
[back to top](#readme) 

* [ASCollectionView](https://github.com/abdullahselek/ASCollectionView) - 受 Airbnb 启发的轻量级自定义集合视图.
* [AZCollectionViewController](https://github.com/AfrozZaheer/AZCollectionViewController) - 在 CollectionView 中将分页与虚拟视图集成的简单方法，让 Instagram 发现几分钟.
* [Blueprints](https://github.com/zenangst/Blueprints) - 一个旨在让您在使用集合视图流布局时更轻松的框架.
* [BouncyLayout](https://github.com/roberthein/BouncyLayout) - 使您的单元格反弹的集合视图布局.
...
* [CenteredCollectionView](https://github.com/BenEmdon/CenteredCollectionView) - 一个轻量级的 UICollectionViewLayout，它分页和居中它的单元格.
* [CheckmarkCollectionViewCell](https://github.com/yonat/CheckmarkCollectionViewCell) - UICollectionViewCell 选中时带有复选框，未选中时带有空圆圈 - 就像 Photos.app 的“选择”模式.
* [CollectionViewShelfLayout](https://github.com/pitiphong-p/CollectionViewShelfLayout) - UICollectionViewLayout 子类将其项目显示为类似于 App Store 功能选项卡的项目行，而没有嵌套的 UITableView/UICollectionView hack.
...
* [CollapsibleTableSectionViewController](https://github.com/jeantimex/CollapsibleTableSectionViewController) - 一个支持表格视图中可折叠部分的库.
...
* [ExpandableCell](https://github.com/younatics/ExpandableCell)  - 完全重构了 YNExapnadableCell，更简洁、无错误. 适用于 iOS 的可扩展和可折叠单元的最简单用法. 您可以自定义任何您喜欢的可扩展 UITableViewCell. 制作 ExpandableCell 是因为 insertRows 和 deleteRows 很难使用. 只是继承 ExpandableDelegate.
...
* [HGPlaceholders](https://github.com/HamzaGhazouani/HGPlaceholders) - 显示项目中任何 UITableView/UICollectionView 的占位符和空状态的好库.
* [OKTableViewLiaison](https://github.com/okcupid/OKTableViewLiaison) - 帮助您更好地管理 UITableViews 的框架.
* [ParallaxHeader](https://github.com/romansorochak/ParallaxHeader) - 将视差标题添加到 UIScrollView/UITableView 的简单方法.
...
* [PaperOnboarding](https://github.com/Ramotion/paper-onboarding) - PaperOnboarding 是一个材料设计 UI 滑块.
...
* [Bow](https://github.com/bow-swift/bow) - 用于类型化函数式编程的配套库.
* [Butterfly](https://github.com/wongzigii/Butterfly) - 一个轻量级库，用于将错误报告和反馈功能与摇动事件集成.
* [CallbackURLKit](https://github.com/phimage/CallbackURLKit) - 实现 x-callback-url（应用间通信）.
...
* [Delegated](https://github.com/dreymonde/Delegated) - 基于闭包的委托，没有内存泄漏.
...
* [Dollar](https://github.com/ankurp/Dollar) - 类似于 Javascript 中的 Lo-Dash 或下划线.
...
* [ExceptionCatcher](https://github.com/sindresorhus/ExceptionCatcher) - 捕获 Objective-C 异常.
...
* [Percentage](https://github.com/sindresorhus/Percentage) - 使百分比更具可读性和类型安全性.
...
* [R.swift](https://github.com/mac-cain13/R.swift) - 获取强类型、自动完成的资源（如图像、单元格和 segue）的工具.
...
* [Result](https://github.com/antitypical/Result) - 类型建模任意操作的成功/失败.
...
* [Then](https://github.com/devxoul/Then) - 用于初始化程序的超级甜美语法糖.
* [TSAO](https://github.com/lilyball/swift-tsao) - 类型安全的关联对象.
* [URLQueryItemEncoder](https://github.com/pitiphong-p/URLQueryItemEncoder) - 用于将任何 Encodable 值编码到 URLQueryItem 数组中的编码器.
* [UTIKit](https://github.com/cockscomb/UTIKit) - UTI（统一类型标识符）包装器.
* [Vaccine](https://github.com/zenangst/Vaccine) - 使您的应用程序不受重新编译死亡的影响.
* [WeakableSelf](https://github.com/vincent-pradeilles/weakable-self) - 在闭包中封装 [weak self] 和保护语句的微框架.
...
#### Phone Numbers
*管理电话号码的库.* [back to top](#readme) 

* [NKVPhonePicker](https://github.com/NikKovIos/NKVPhonePicker) - 一个 UITextField 子类，用于简化国家代码的选择.
...
* [Version Tracker Swift](https://github.com/tbaranes/VersionTrackerSwift) - 适用于您的 iOS、OS X 和 tvOS 应用的版本跟踪器.

### Video
[back to top](#readme) 

* [BMPlayer](https://github.com/BrikerMan/BMPlayer)  - 一款基于AVPlayer的iOS视频播放器，支持横屏、竖屏. 支持调整音量、亮度和滑动搜索.
...
* [MMPlayerView](https://github.com/MillmanY/MMPlayerView) - 自定义 AVPlayerLayer 视图和过渡播放器，效果很好，如 YouTube 和 Facebook.
...
* [YiVideoEditor](https://github.com/coderyi/YiVideoEditor) - 用于旋转、裁剪、添加图层（水印）以及向视频添加音频（音乐）的库.

## Serverless

* [Azure Functions for Swift](https://github.com/SalehAlbuga/azure-functions-swift) :penguin: - 用于 Azure Functions 的 Swift Worker.


### Contributing

请快速浏览 [contribution guidelines](https://github.com/matteocrippa/awesome-swift/blob/master/.github/CONTRIBUTING.md) 第一的. 如果您在此处看到不再维护或不合适的包或项目，请提交拉取请求以改进此文件. 谢谢你们 [contributors](https://github.com/matteocrippa/awesome-swift/graphs/contributors) ; 你摇滚！！
