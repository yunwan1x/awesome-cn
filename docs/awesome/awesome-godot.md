...
- [Vim](https://github.com/habamax/vim-godot) <i>- Syntax highlighting, autocompletion and linting using the LSP server provided by the Godot editor.</i> <b>- 使用 Godot 编辑器提供的 LSP 服务器进行语法高亮、自动完成和 linting。</b> <i>Also supports the Godot shader language.</i><b>还支持 Godot 着色器语言。</b>
- Visual Studio Code
