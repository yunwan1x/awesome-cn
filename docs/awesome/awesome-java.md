...
- [Bootique](https://bootique.io) - 可运行应用程序的最低限度自以为是的框架.
...
- [Play](https://www.playframework.com) - 基于 Akka 构建，它为 Java 和 Scala 中高度可扩展的应用程序提供可预测和最小的资源消耗（CPU、内存、线程）.
- [PrimeFaces](https://www.primefaces.org) - 具有免费和商业/支持版本和前端组件的 JSF 框架.
- [Ratpack](https://ratpack.io) - 一组有助于快速、高效、可进化和经过良好测试的 HTTP 应用程序的库.
- [Takes](https://github.com/yegor256/takes) - 围绕真正面向对象编程和不变性的概念构建的自以为是的 Web 框架.
...
- [Holly Cummins](https://twitter.com/holly_cummins) - IBM 伦敦 Bluemix Garage 的技术主管、Java Champion、开发人员、作家、JavaOne 摇滚明星.
...
- [Mani Sarkar](https://twitter.com/theNeomatrix369)  - Java 冠军、Polyglot、参与@graalvm 的软件工匠、AI/ML/DL、数据科学、开发人员社区、演讲者和博主. 像这样的几个很棒的列表的创建者.
- [Mario Fusco](https://twitter.com/mariofusco) - RedHatter，JUG 协调员，经常演讲和作家.
- [Mark Heckler](https://twitter.com/MkHeck) - Pivotal 首席技术专家和开发人员倡导者、会议发言人、出版作者和 Java 冠军，专注于物联网和云计算.
- [Mark Reinhold](https://twitter.com/mreinhold) - 首席架构师，Java 平台集团，甲骨文.
- [Markus Eisele](https://twitter.com/myfear) - Java EE 布道者，红帽.
- [Martijn Verburg](https://twitter.com/karianna) - London JUG 联合领导者、演讲者、作家、Java Champion 等等.
- [Martin Thompson](https://twitter.com/mjpt777) - 糊状的表演流氓.
...
- [Spencer Gibb](https://twitter.com/spencerbgibb) - 软件工程师，爸爸，Geek，Spring Cloud Core @pivotal 的联合创始人和负责人.
...
- [Venkat Subramaniam](https://twitter.com/venkat_s) - 作者，休斯顿大学教授，微软 MVP 奖获得者，JavaOne Rock Star，Java Champion.
...
- [Groundbreakers](https://apexapps.oracle.com/pls/apex/f?p=119297:3::::::) - Oracle ACE、Groundbreaker 大使和 Java 冠军.
