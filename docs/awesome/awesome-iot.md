...
- [Microduino](https://www.microduino.cc/) <i>- Microduino and mCookie bring powerful, small, stackable electronic hardware to makers, designers, engineers, students and curious tinkerers of all ages.</i> <b>- Microduino 和 mCookie 为各个年龄段的制造商、设计师、工程师、学生和好奇的修补匠带来了强大、小巧、可堆叠的电子硬件。</b> <i>Build open-source projects or create innovative new ones.</i><b>构建开源项目或创建创新的新项目。</b>
...
#### Operating systems
 ...
 - [OpenWrt](https://openwrt.org/) <i>- OpenWrt is an operating system (in particular, an embedded operating system) based on the Linux kernel, primarily used on embedded devices to route network traffic.</i> <b>- OpenWrt 是一个基于 Linux 内核的操作系统（特别是嵌入式操作系统），主要用于嵌入式设备上路由网络流量。</b> <i>The main components are the Linux kernel, util-linux, uClibc or musl, and BusyBox.</i><b>主要组件是 Linux 内核、util-linux、uClibc 或 musl 和 BusyBox。</b> <i>All components have been optimized for size, to be small enough for fitting into the limited storage and memory available in home routers.</i><b>所有组件都针对尺寸进行了优化，小到足以适应家庭路由器中有限的存储空间和内存。</b>
...
#### Middlewares
 ...
 - [Losant](https://losant.com) <i>- Losant is an easy-to-use and powerful developer platform designed to help you quickly and securely build complex connected solutions.</i> <b>- Losant 是一个易于使用且功能强大的开发者平台，旨在帮助您快速安全地构建复杂的连接解决方​​案。</b> <i>Losant uses open communication standards like REST and MQTT to provide connectivity from one to millions of devices.</i> <b>Losant 使用 REST 和 MQTT 等开放通信标准来提供从一台到数百万台设备的连接。</b> <i>Losant provides powerful data collection, aggregation, and visualization features to help understand and quantify vast amounts of sensor data.</i> <b>Losant 提供强大的数据收集、聚合和可视化功能，以帮助理解和量化大量传感器数据。</b> <i>Losant&#39;s drag-and-drop workflow editor allows you to trigger actions, notifications, and machine-to-machine communication without programming.</i> <b>Losant 的拖放式工作流编辑器允许您触发操作、通知和机器对机器通信，而无需编程。</b>
...
#### Libraries and Tools
 ...
 - [QuestDB](https://github.com/questdb/questdb) <i>- an open source time series database used for real-time analytics and high-performance applications.</i> <b>- 用于实时分析和高性能应用程序的开源时间序列数据库。</b> <i>Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.</i><b>支持通过 InfluxDB 线路协议和 SQL 作为查询语言的高吞吐量摄取。</b>
