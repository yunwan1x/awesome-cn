...
<div align="center">
	...
	<p>
		...
		<a href="https://bit.io/?utm_campaign=github_repo&utm_medium=referral&utm_content=awesome&utm_source=github">
			...
			<div>
				<sup>在几秒钟内导入任何数据集，单击与任何人共享，无需注册即可尝试</sup>
			</div>
		</a>
		<br>
		<br>
...
<div align="center">
	<b>关注<a href="https://twitter.com/awesome__re">Awesome Twitter 帐户</a>以获取有关新增列表的更新.</b>
</div>

<br>

<p align="center">
	<sub>只需输入<a href="https://awesome.re"><code>awesome.re</code></a>即可转到此处.</sub> <sub>查看我的<a href="https://blog.sindresorhus.com">博客</a>并在<a href="https://twitter.com/sindresorhus">Twitter 上</a>关注我.</sub>
</p>
<br>
...
- [iOS](https://github.com/vsouza/awesome-ios#readme) - 适用于苹果手机和平板电脑的移动操作系统.
...
- [Cordova](https://github.com/busterc/awesome-cordova#readme) - 用于混合应用程序的 JavaScript API.
- [React Native](https://github.com/jondot/awesome-react-native#readme) - 用于为 iOS 和 Android 编写原生渲染移动应用程序的 JavaScript 框架.
...
- [Linux](https://github.com/inputsh/awesome-linux#readme)
	...
	- [AppImage](https://github.com/AppImage/awesome-appimage#readme) - 将应用程序打包在单个文件中，适用于各种主流 Linux 发行版.
- [macOS](https://github.com/iCHAIT/awesome-macOS#readme) - 适用于 Apple Mac 计算机的操作系统.
...
- [Flutter](https://github.com/Solido/awesome-flutter#readme) - Google 的移动 SDK，用于从用 Dart 编写的单个代码库构建原生 iOS 和 Android 应用程序.
...
- [JavaScript](https://github.com/sorrycc/awesome-javascript#readme)
	...
	- [ESLint](https://github.com/dustinspecker/awesome-eslint#readme) - 短绒.
	...
	- [Ponyfills](https://github.com/Richienb/awesome-ponyfills#readme) - 像 polyfills 但不覆盖原生 API.
- [Swift](https://github.com/matteocrippa/awesome-swift#readme) - Apple 编译的编程语言，安全、现代、程序员友好且快速.
...
- [Python](https://github.com/vinta/awesome-python#readme) - 为可读性而设计的通用编程语言.
	...
	- [Scientific Audio](https://github.com/faroit/awesome-python-scientific-audio#readme) - 音频/音乐方面的科学研究.
...
- [C/C++](https://github.com/fffaraz/awesome-cpp#readme) - 偏向于系统编程和嵌入式资源受限软件的通用语言.
...
- [Java](https://github.com/akullpp/awesome-java#readme) - 流行的安全面向对象语言，旨在实现“一次编写，随处运行”的灵活性.
...
- [ActionScript 3](https://github.com/robinrodricks/awesome-actionscript3#readme) - 针对 Adob​​e AIR 的面向对象语言.
...
- [Ada/SPARK](https://github.com/ohenley/awesome-ada#readme) - 现代编程语言，专为可靠性和效率至关重要的大型、长期应用程序而设计.
...
- [CSS](https://github.com/awesome-css-group/awesome-css#readme) - 指定如何在屏幕上显示 HTML 元素的样式表语言.
...
- [jQuery](https://github.com/petk/awesome-jquery#readme) - 易于使用的用于 DOM 操作的 JavaScript 库.
...
- [WordPress-Gatsby](https://github.com/henrikwirth/awesome-wordpress-gatsby#readme) - 以 WordPress 作为后端和 Gatsby 作为前端的 Web 开发技术堆栈.
...
- [PageSpeed Metrics](https://github.com/csabapalfi/awesome-pagespeed-metrics#readme) - 帮助了解页面速度和用户体验的指标.
...
- [Vert.x](https://github.com/vert-x3/vertx-awesome#readme) - 用于在 JVM 上构建响应式应用程序的工具包.
...
- [Speech and Natural Language Processing](https://github.com/edobashira/speech-language-processing#readme)
	...
	- [Natural Language Generation](https://github.com/tokenmill/awesome-nlg#readme) - 生成用于数据到文本、会话代理和叙述生成应用程序的文本.
...
- [Hadoop](https://github.com/youngwookim/awesome-hadoop#readme) - 分布式存储和处理超大数据集的框架.
...
- [Algorithms](https://github.com/tayllan/awesome-algorithms#readme)
	- [Education](https://github.com/gaerae/awesome-algorithms-education#readme) - 学习和实践.
...
- [Game Remakes](https://github.com/radek-sprta/awesome-game-remakes#readme) - 积极维护开源游戏重制版.
...
- [GitHub](https://github.com/phillipadsmith/awesome-github#readme) - Git 存储库的托管服务.
	...
	- [Pinned Gists](https://github.com/matchai/awesome-pinned-gists#readme) - GitHub 个人资料的动态固定要点.
...
- [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) - 识别信息技术系统中安全缺陷的个人群体.
...
- [Textpattern](https://github.com/drmonkeyninja/awesome-textpattern#readme) - 轻量级的基于 PHP 的 CMS.
...
- [Electronics](https://github.com/kitspace/awesome-electronics#readme) - 对于电子工程师和爱好者.
...
- [Social Enterprise](https://github.com/RayBB/awesome-social-enterprise#readme) - 建立一个主要关注至少部分自筹资金的社会影响的组织.
- [Engineering Team Management](https://github.com/kdeldycke/awesome-engineering-team-management#readme) - 如何从软件开发过渡到工程管理.
- [Developer-First Products](https://github.com/agamm/awesome-developer-first#readme) - 以开发者为用户的产品.
- [Billing](https://github.com/kdeldycke/awesome-billing#readme) - 付款、发票、定价、会计、市场、欺诈和商业智能.
...
- [EOSIO](https://github.com/DanailMinchev/awesome-eosio#readme) - 一个支持工业规模应用的去中心化操作系统.
- [Corda](https://github.com/chainstack/awesome-corda#readme) - 专为商业设计的开源区块链平台.
...
- [Creative Tech Events](https://github.com/danvoyce/awesome-creative-tech-events#readme) - 全球范围内有关创意编码、技术、设计、音乐、艺术和酷炫事物的活动.
...
- [k6](https://github.com/k6io/awesome-k6#readme) - 开源的、以开发人员为中心的性能监控和负载测试解决方案.
- [Playwright](https://github.com/mxschmitt/awesome-playwright#readme) - Node.js 库，可使用单个 API 自动化 Chromium、Firefox 和 WebKit.
- [Quality Assurance Roadmap](https://github.com/fityanos/awesome-quality-assurance-roadmap#readme) - 如何开始和建立软件测试的职业生涯.
...
- [AMA](https://github.com/sindresorhus/amas#readme) - 问我任何事情.
...
- [Citizen Science](https://github.com/dylanrees/citizen-science#readme) - 针对社区和非机构科学家.
...
- [Esolangs](https://github.com/angrykoala/awesome-esolangs#readme) - 为实验或作为笑话而不是实际使用而设计的编程语言.
...
- [Open Source Supporters](https://github.com/zachflower/awesome-open-source-supporters#readme) - 免费为开源项目提供工具和服务的公司.
...
- [Captcha](https://github.com/ZYSzys/awesome-captcha#readme) - 一种用于计算的挑战-响应测试，用于确定用户是否为人类.
- [Jupyter](https://github.com/markusschanta/awesome-jupyter#readme) - 创建和共享包含代码、方程、可视化和叙述文本的文档.
...
- [Agriculture](https://github.com/brycejohnston/awesome-agriculture#readme) - 农业和园艺的开源技术.
...
- [Web Archiving](https://github.com/iipc/awesome-web-archiving#readme) - 为子孙后代保护网络的努力.
- [WP-CLI](https://github.com/schlessera/awesome-wp-cli#readme) - WordPress 的命令行界面.
- [Credit Modeling](https://github.com/mourarthur/awesome-credit-modeling#readme) - 将信贷申请人分类为风险等级的方法.
