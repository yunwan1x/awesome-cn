<div class="github-widget" data-repo="0xnr/awesome-analytics"></div>
...
<i>Your feedback and contributions are always welcome!</i><b>随时欢迎您的反馈和贡献！</b> <i>Maintained by</i><b>维护者</b> [@onurakpolat](https://github.com/onurakpolat) & [@koconder](https://github.com/koconder)
...
* [Plausible Analytics](https://plausible.io/) - Lightweight and [open source](https://github.com/plausible-insights/plausible) web analytics. Doesn’t use cookies and doesn't track personal data. A privacy-friendly alternative to Google Analytics. ([Source Code](https://github.com/plausible/analytics/)) `WITH` `Elixir`
