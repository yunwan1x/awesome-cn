...
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) - YouCompleteMe 是一个用于 Vim 的快速、按需输入、模糊搜索代码完成引擎.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) - “官方” C++ 指南集，由 C++ 的作者审查.
