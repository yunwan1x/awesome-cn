...
* [DeepL](https://github.com/uinput/deeplator) - 一款性能优于谷歌、微软和 Facebook 的在线翻译器.
...
* [Grge](https://gitlab.com/ApexAI/grge) - Grge 是一个增强 GitLab 的守护进程和命令行实用程序.
* [gitlab-triage](https://gitlab.com/gitlab-org/gitlab-triage) - Gitlab 的问题和合并请求分类，自动化.
* [Helpy](https://github.com/helpyio/helpy) - 一个现代的开源帮助台客户支持应用程序.
...
* [jitsi-meet](https://github.com/jitsi/jitsi-meet) - 安全、简单且可扩展的视频会议，可用作独立应用程序或嵌入 Web 应用程序.
* [mattermost](https://github.com/mattermost/mattermost-server) - 开源、私有云、Slack 替代方案.
...
* [Sphinx](https://github.com/sphinx-doc/sphinx/) - 一种工具，可以轻松为 Python 项目创建智能且美观的文档.
* [paperless](https://github.com/the-paperless-project/paperless) - 索引和存档您扫描的所有纸质文档.
* [carbon](https://github.com/carbon-app/carbon) - 分享您的源代码的美丽图像.
...
* [GitLab-Release-Note-Generator](https://github.com/jk1z/GitLab-Release-Note-Generator) - 一个 Gitlab 发行说明生成器，可在最新标签上生成发行说明.
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) - 为扫描的 PDF 文件添加 OCR 文本层，以便对其进行搜索.
...
* [overleaf](https://github.com/overleaf/overleaf) - 一个开源在线实时协作 LaTeX 编辑器.
...
* [swiftlatex](https://www.swiftlatex.com/) - 所见即所得的基于浏览器的 LaTeX 编辑器.
* [foam](https://github.com/foambubble/foam) - Foam 是一个受 Roam Research 启发的个人知识管理和共享系统，基于 Visual Studio Code 和 GitHub 构建.
* [CodiMD](https://github.com/codimd/server) - 开源在线实时协作在markdown中的团队文档.
...
* [mkdocs](https://github.com/mkdocs/mkdocs/) - 一个快速、简单、华丽的静态站点生成器，用于构建项目文档.
* [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) - 用于绘制报告和演示的神经网络的乳胶代码.
* [Excalidraw](https://github.com/excalidraw/excalidraw) - 用于绘制手绘图的虚拟白板.
* [SVGrepo](https://www.svgrepo.com/) - 下载免费的 SVG Vectors 用于商业用途.
...
* [Zotero](https://github.com/zotero/zotero) - 一个免费、易于使用的工具，可帮助您收集、组织、引用和分享您的研究资源.
...
* [Automated Valet Parking Safety Documents](https://avp-project.uk/publication-of-safety-documents) - 创建用于支持在停车场使用 StreetDrone 测试车辆对自动代客泊车功能进行安全测试.
* [safe_numerics](https://github.com/boostorg/safe_numerics) - 替换标准数字类型，在错误时抛出异常.
* [Air Vehicle C++ development coding standards](http://www.stroustrup.com/JSF-AV-rules.pdf) - 为 C++ 程序员提供指导和指导，使他们能够采用良好的编程风格和经过验证的编程实践，从而生成安全、可靠、可测试和可维护的代码.
...
成功设计系统架构.
* [robmosys](https://robmosys.eu/) - RobMoSys 通过应用模型驱动的方法和工具，设想了一种建立在当前以代码为中心的机器人平台之上的集成方法.
...
* [yEd](https://www.yworks.com/products/yed) - 一款功能强大的桌面应用程序，可用于快速有效地生成高质量图表.
* [yed_py](https://github.com/true-grue/yed_py) - 生成可以在 yEd 中打开的 graphML.
* [Plantuml](https://github.com/plantuml/plantuml-server) - 在您的实时文档中即时生成 UML 图的 Web 应用程序.
...
* [Architecture_Decision_Record](https://github.com/joelparkerhenderson/architecture_decision_record) - 一份记录了重要架构决策及其上下文和后果的文档.

## Frameworks and Stacks
* [ROS](https://github.com/ros) - （机器人操作系统）提供库和工具来帮助软件开发人员创建机器人应用程序.
* [awesome-ros2](https://github.com/fkromer/awesome-ros2) - 精选的机器人操作系统版本 2.0 (ROS 2) 资源和库的精选列表.
...
* [Automotive Grade Linux](https://www.automotivelinux.org/) - Automotive Grade Linux 是一个协作开源项目，它将汽车制造商、供应商和技术公司聚集在一起，以加速开发和采用用于联网汽车的完全开放的软件堆栈.
...
* [ArduPilot](https://github.com/ArduPilot/ardupilot) - 自动驾驶汽车的开源控制软件 - 直升机/飞机/漫游者/船/潜水器.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) - 用于编辑-构建-调试周期的代码编辑器.
* [atom](https://github.com/atom/atom) - 21 世纪的可破解文本编辑器.
* [Teletype](https://github.com/atom/teletype) - 与团队成员共享您的工作空间，并在 Atom 中实时协作处理代码.
...
* [recipe-wizard](https://github.com/trn84/recipe-wizard) - 一个 Dockerfile 生成器，用于在远程无头服务器系统上运行带有 nvidia-docker2、CUDA、ROS 和 Gazebo 的 OpenGL (GLX) 应用程序.
...
* [ROS IDEs](http://wiki.ros.org/IDEs) - 此页面收集了有关使用集成开发环境 (IDE) 和 ROS 的经验和建议.
...
* [pybind11](https://github.com/pybind/pybind11) - C++11 和 Python 之间的无缝可操作性.
* [Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail) - 免费和开源的跨平台资源浏览器.
* [rebound](https://github.com/shobrook/rebound) - 命令行工具，可在抛出异常时立即获取 Stack Overflow 结果.
* [mybinder](https://mybinder.org/) - 在可执行环境中打开笔记本，让任何人、任何地方都可以立即复制您的代码.
* [ROSOnWindows](https://ms-iot.github.io/ROSOnWindows/) - 适用于 Windows 的 ROS1 实验版本.
* [live-share](https://github.com/MicrosoftDocs/live-share) - 使用您最喜欢的工具进行实时协作开发.
* [cocalc](https://github.com/sagemathinc/cocalc) - 云端协同计算.
* [EasyClangComplete](https://github.com/niosus/EasyClangComplete) - Sublime Text 3 的强大的 C/C++ 代码完成.
* [vscode-ros](https://github.com/ms-iot/vscode-ros) - 用于机器人操作系统 (ROS) 开发的 Visual Studio Code 扩展.
* [awesome-hpp](https://github.com/p-ranav/awesome-hpp) - 精选的仅包含标头的 C++ 库的精选列表.
* [Gitpod](https://github.com/gitpod-io/gitpod) - 一个开源开发者平台，可自动提供准备好的代码开发环境.

### Template
* [ROS](https://github.com/leggedrobotics/ros_best_practices/tree/master/ros_package_template) - C++ 中 ROS 节点标准化的模板.
* [Launch](https://wiki.ros.org/roslaunch/Tutorials/Roslaunch%20tips%20for%20larger%20projects) - 有关如何为大型项目创建启动文件的模板.
* [Bash](https://github.com/ralish/bash-script-template) - 一个结合了最佳实践和几个有用功能的 bash 脚本模板.
* [URDF](https://wiki.ros.org/urdf/Examples) - 关于如何为不同种类的机器人创建统一机器人描述格式 (URDF) 的示例.
* [Python](http://wiki.ros.org/PyStyleGuide) - 为 ROS 编写 Python 代码时应遵循的样式指南.
* [Docker](https://ade-cli.readthedocs.io/en/latest/create-custom-base-image.html) - minimum-ade 项目中的 Dockerfile 显示了如何创建自定义基础映像的最小示例.
* [VS Code ROS2 Workspace Template](https://github.com/athackst/vscode_ros2_workspace) - 使用 VSCode 作为 ROS2 开发的 IDE 的模板.

### Build and Deploy
* [qemu-user-static](https://github.com/multiarch/qemu-user-static) - 启用 QEMU 和 binfmt_misc 执行不同的多架构容器.
...
* [catkin_tools](https://github.com/catkin/catkin_tools) - 使用 catkin 的命令行工具.
* [industrial_ci](https://github.com/ros-industrial/industrial_ci) - 用于 ROS 存储库的简单持续集成存储库.
* [ros_gitlab_ci](https://gitlab.com/VictorLamoine/ros_gitlab_ci) - 包含有关如何将持续集成 (CI) 用于托管在 GitLab 实例上的 ROS 项目的帮助脚本和说明.
* [gitlab-runner](https://gitlab.com/gitlab-org/gitlab-runner) - 运行测试并将结果发送到 GitLab.
* [colcon-core](https://github.com/colcon/colcon-core) - 命令行工具，用于改进构建、测试和使用多个软件包的工作流程.
* [gitlab-release](https://gitlab.com/alelec/gitlab-release) - 用于将文件（从 ci）上传到当前项目版本（标签）的简单 python3 脚本.
* [clang](https://github.com/llvm-mirror/clang) - 这是 C 系列语言（C、C++、Objective-C 和 Objective-C++）的编译器前端，它是作为 LLVM 编译器基础设施项目的一部分而构建的.
* [catkin_virtualenv](https://github.com/locusrobotics/catkin_virtualenv) - 通过 virtualenv 在 catkin 包中捆绑 python 需求.
...
* [docker_images](https://github.com/osrf/docker_images) - OSRF 在 ROS(2) 和 Gazebo 上维护的官方 Docker 镜像.
...
* [ryo-iso](https://ryo-iso.readthedocs.io/en/latest/) - 现代 ISO 构建器，简化了从 yaml 配置文件部署完整机器人操作系统的过程.
* [network_autoconfig](http://docs.ros.org/kinetic/api/network_autoconfig/html/) - 为大多数用例自动配置 ROS 网络，而不影响需要手动配置的使用.
* [rosbuild](https://roscon.ros.org/2016/presentations/ROSCon2016%20Build%20Farm.pdf) - ROS 建造农场.
* [cros](https://github.com/ros-industrial/cros) - ROS框架的单线程纯C实现.


### Unit and Integration Test
* [setup-ros](https://github.com/ros-tooling/setup-ros) - 此操作设置 ROS 和 ROS 2 环境以在 GitHub 操作中使用.
* [UnitTesting](https://wiki.ros.org/Quality/Tutorials/UnitTesting) - 本页列出了为 ROS 编写和运行单元测试和集成测试的基本原理、最佳实践和策略.
* [googletest](https://github.com/google/googletest) - Google 的 C++ 测试框架.
...
* [action-ros-ci](https://github.com/ros-tooling/action-ros-ci) - 使用 colcon 构建和测试 ROS 2 包的 GitHub 操作.
...
* [shellcheck](https://github.com/koalaman/shellcheck) - 用于 shell 脚本的静态分析工具.
* [catkin_lint](https://github.com/fkie/catkin_lint) - Checks package configurations for the catkin build system of ROS.
* [pylint](https://github.com/PyCQA/pylint/) - Pylint 是一个 Python 静态代码分析工具，可查找编程错误、帮助执行编码标准、嗅探代码异味并提供简单的重构建议.
* [black](https://github.com/psf/black) - 毫不妥协的 Python 代码格式化程序.
* [pydocstyle](https://github.com/PyCQA/pydocstyle) - 用于检查是否符合 Python 文档字符串约定的静态分析工具.
* [haros](https://github.com/git-afsantos/haros) - ROS应用程序代码的静态分析.
...
* [cppinsights](https://github.com/andreasfertig/cppinsights) - C++ Insights - 以编译器的眼光查看您的源代码.
* [inspect](https://pymotw.com/2/inspect/) - 检查模块提供了学习活对象的功能，包括模块、类、实例、函数和方法.
* [Roslaunch Nodes in Valgrind or GDB](https://wiki.ros.org/roslaunch/Tutorials/Roslaunch%20Nodes%20in%20Valgrind%20or%20GDB) - 在调试您使用 roslaunch 启动的 roscpp 节点时，您可能希望在 gdb 或 valgrind 等调试程序中启动该节点.
...
* [pudb](https://github.com/inducer/pudb) - 适用于 Python 的全屏控制台调试器.
...
### Version Control
* [git-fuzzy](https://github.com/bigH/git-fuzzy) - 严重依赖 fzf 的 git 的 CLI 界面.
* [meld](https://github.com/GNOME/meld) - Meld 是一个可视化的差异和合并工具，可帮助您比较文件、目录和版本控制项目.
* [tig](https://github.com/jonas/tig) - git 的文本模式界面.
* [gitg](https://github.com/GNOME/gitg) - git 的图形用户界面.
* [git-cola](https://github.com/git-cola/git-cola) - 高度咖啡因的 Git GUI.
* [python-gitlab](https://github.com/python-gitlab/python-gitlab) - 一个 Python 包，提供对 GitLab 服务器 API 的访问.
* [bfg-repo-cleaner](https://github.com/rtyley/bfg-repo-cleaner) - 像 git-filter-branch 一样删除大的或麻烦的 blob，但速度更快.
...
* [go-semrel-gitab](https://gitlab.com/juhani/go-semrel-gitlab) - Gitlab 的自动化版本管理.
* [Git-repo](https://gerrit.googlesource.com/git-repo/) - Git-Repo 帮助管理许多 Git 存储库，上传到修订控制系统，并使部分开发工作流程自动化.
* [dive](https://github.com/wagoodman/dive) - 用于探索 docker 图像中每一层的工具.
* [dvc](https://github.com/iterative/dvc) - 数据集和机器学习模型的管理和版本控制.
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) - 一个 git 存储库可视化工具、沙箱和一系列教育教程和挑战.
* [gitfs](https://github.com/Presslabs/gitfs) - 您可以在本地挂载远程存储库的分支，随后对文件所做的任何更改都将自动提交到远程.
* [git-secret](https://github.com/sobolevn/git-secret) - 使用允许用户的公钥加密文件，允许您信任的用户使用 pgp 及其密钥访问加密数据.
* [git-sweep](https://github.com/arc90/git-sweep) - 一个命令行工具，可帮助您清理已合并到 master 中的 Git 分支.
* [lazygit](https://github.com/jesseduffield/lazygit) - 一个简单的 git 命令终端 UI，用 Go 语言和 gocui 库编写.
...
* [Drake](https://github.com/RobotLocomotion/drake) - Drake 旨在模拟甚至非常复杂的机器人动力学.
...
* [ros-bridge](https://github.com/carla-simulator/ros-bridge) - CARLA 模拟器的 ROS 桥.
...
* [uuv_simulator](https://github.com/uuvsimulator/uuv_simulator) - 用于水下机器人模拟的 Gazebo/ROS 软件包.
* [AirSim](https://github.com/microsoft/AirSim) - 基于虚幻引擎的自动驾驶汽车开源模拟器.
...
* [gym-pybullet-drones](https://github.com/utiasDSL/gym-pybullet-drones) - 基于 PyBullet 的 Gym 环境，用于四轴飞行器控制的单代理和多代理强化学习.
...
* [VREP Interface](http://www.coppeliarobotics.com/helpFiles/en/rosInterf.htm) - VREP 模拟器的 ROS 桥.
* [car_demo](https://github.com/osrf/car_demo) - 这是 Gazebo 9 中的 Prius 模拟，传感器数据使用 ROS 动力学发布.
...
* [ESIM](https://github.com/uzh-rpg/rpg_esim/) - 一个开放的事件相机模拟器.
* [Menge](https://github.com/MengeCrowdSim/Menge) - 人群模拟框架.
* [pedsim_ros](https://github.com/srl-freiburg/pedsim_ros) - 由 Gazebo 的社会力量模型驱动的行人模拟器.
...
* [OpenSceneGraph](https://github.com/openscenegraph/OpenSceneGraph) - 一个开源的高性能 3D 图形工具包，供应用程序开发人员在视觉模拟、游戏、虚拟现实、科学可视化和建模等领域使用.
...
* [rotors_simulator](https://github.com/ethz-asl/rotors_simulator) - 提供一些多旋翼型号.
* [flow](https://github.com/flow-project/flow) - 深度强化学习的计算框架和交通微观模拟控制实验.
* [gnss-ins-sim](https://github.com/Aceinna/gnss-ins-sim)  - GNSS + 惯性导航、传感器融合模拟器. 运动轨迹生成器、传感器模型和导航.
* [Ignition Robotics](https://ignitionrobotics.org) - 在安全方面测试控制策略，并在持续集成测试中利用模拟.
* [simulation assets for the SubT](https://subtchallenge.world/openrobotics/fuel/collections/SubT%20Tech%20Repo) - 该集合包含 Gazebo 的 SubT Challenge Virtual Competition 的模拟资产.
* [gazebo_ros_motors](https://github.com/nilseuropa/gazebo_ros_motors) - 目前包含两个用于 Gazebo 的电机插件，一个带有理想的速度控制器，一个没有模拟直流电机的控制器.
...
* [gym-carla](https://github.com/cjy1992/gym-carla) - CARLA 模拟器的 OpenAI 健身房包装器.
* [simbody](https://github.com/simbody/simbody) - 用于模拟关节生物力学和机械系统（如车辆、机器人和人体骨骼）的高性能 C++ 多体动力学/物理库.
...
* [Trick](https://github.com/nasa/Trick) - 由 NASA 约翰逊航天中心开发，是一个强大的模拟开发框架，使用户能够为航天器开发的所有阶段构建应用程序.
* [usv_sim_lsa](https://github.com/disaster-robotics-proalertas/usv_sim_lsa) - 带有水流和风的 Gazebo 上的无人水面车辆模拟.
...
* [Unity-Robotics-Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) - Unity 中用于机器人仿真的工具、教程、资源和文档的中央存储库.
* [BlueSky](https://github.com/TUDelft-CNS-ATM/bluesky) - BlueSky 的目标是为所有想要可视化、分析或模拟空中交通的人提供一个工具，让他们不受任何限制、许可或限制.
* [Cloe](https://github.com/eclipse/cloe) - 通过为闭环仿真提供统一接口，为自动驾驶软件组件的开发人员提供支持.
* [Dynamic_logistics_Warehouse](https://github.com/belal-ibrahim/dynamic_logistics_warehouse) - Gazebo 模拟仓库中的动态环境.
* [OpenCDA](https://github.com/ucla-mobility/OpenCDA) - CARLA+SUMO 下的全栈协同驾驶自动化应用原型设计通用框架.


## Electronics and Mechanics
* [HRIM](https://github.com/AcutronicRobotics/HRIM) - 机器人硬件的信息模型.
* [URDF](https://github.com/ros/urdf) - 统一机器人描述格式 (URDF) 解析代码的存储库.
* [phobos](https://github.com/dfki-ric/phobos) - Blender 的附加组件，允许在所见即所得的环境中创建 URDF、SDF 和 SMURF 机器人模型.
...
* [kicad-3rd-party-tools](https://github.com/xesscorp/kicad-3rd-party-tools) - 由其他人制作的用于增强 KiCad PCB EDA 套件的工具.
* [PandaPower](http://www.pandapower.org) - 一个易于使用的开源工具，用于电力系统建模、分析和优化，自动化程度高.
...
* [NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) - 在这里，您会发现来自 NASA 内部的越来越多的 3D 模型、纹理和图像集合.
...
* [tf2](http://wiki.ros.org/tf2) - 变换库，让用户随时间跟踪多个坐标系.
* [TriP](https://github.com/TriPed-Robot/TriP) - 用于串行机器人、并行机器人和两者混合的反向运动学库.
* [lidar_align](https://github.com/ethz-asl/lidar_align) - 一种用于查找 3D 激光雷达和 6 自由度姿态传感器之间的外部校准的简单方法.
* [kalibr](https://github.com/ethz-asl/kalibr) - Kalibr 视觉惯性校准工具箱.
* [Calibnet](https://github.com/epiception/CalibNet) - 使用 3D 空间变压器网络的自监督外部校准.
* [lidar_camera_calibration](https://github.com/ankitdhall/lidar_camera_calibration) - 用于在 LiDAR 和相机之间找到刚体转换的 ROS 包.
* [ILCC](https://github.com/mfxox/ILCC) - 反射强度辅助 3D LiDAR 的自动和准确的外部校准.
* [easy_handeye](https://github.com/IFL-CAMP/easy_handeye) - 用于手眼校准的简单、直接的 ROS 库.
* [imu_utils](https://github.com/gaowenliang/imu_utils) - 用于分析 IMU 性能的 ROS 软件包工具.
* [kalibr_allan](https://github.com/rpng/kalibr_allan) - IMU Allan 标准偏差图表，用于 Kalibr 和惯性卡尔曼滤波器.
* [pyquaternion](https://github.com/KieranWynn/pyquaternion) - 用于表示和使用四元数的全功能 Python 模块.
* [robot_calibration](https://github.com/mikeferguson/robot_calibration/) - 该软件包提供机器人的许多参数的校准，例如：3D 相机内在参数、外在参数 关节角度偏移和机器人框架偏移.
* [multi_sensor_calibration](https://github.com/tudelft-iv/multi_sensor_calibration/) - 包含一个校准工具，用于校准由激光雷达、雷达和摄像头组成的传感器设置.
...
* [ikpy](https://github.com/Phylliade/ikpy) - 针对性能和模块化的反向运动学库.
...
* [e2calib](https://github.com/uzh-rpg/e2calib) - 包含从用于校准的事件数据实现视频重建的代码.


### Perception Pipeline
* [SARosPerceptionKitti](https://github.com/appinho/SARosPerceptionKitti) - 用于 KITTI Vision Benchmark Suite 感知（传感器处理、检测、跟踪和评估）的 ROS 包.
* [multiple-object-tracking-lidar](https://github.com/praveen-palanisamy/multiple-object-tracking-lidar) - 使用激光雷达扫描或点云检测、跟踪和分类多个对象的 C++ 实现.
* [cadrl_ros](https://github.com/mfe7/cadrl_ros) - 为使用深度 RL 训练的地面机器人提供动态避障的 ROS 包.
...
* [GibsonEnv](https://github.com/StanfordVL/GibsonEnv) - 吉布森环境：具体代理的真实世界感知.
* [morefusion](https://github.com/wkentaro/morefusion) - 从体积融合进行 6D 姿势估计的多对象推理.
* [se(3)-TrackNet](https://github.com/wenbowen123/iros20-6d-pose-tracking) - 当对象的 CAD 模型可用时，用于动态对象的 6D 姿势跟踪的软件包.
...
* [tpot](https://github.com/EpistasisLab/tpot) - 一种 Python 自动机器学习工具，可使用基因编程优化机器学习管道.
...
* [finn](https://github.com/Xilinx/finn) - 在 FPGA 上进行快速、可扩展的量化神经网络推理.
* [neuropod](https://github.com/uber/neuropod) - Neuropod 是一个库，它提供了一个统一的接口来运行来自多个 C++ 和 Python 框架的深度学习模型.
...
* [mlflow](https://github.com/mlflow/mlflow) - 简化机器学习开发的平台，包括跟踪实验、将代码打包成可重现的运行，以及共享和部署模型.
* [Netron](https://github.com/lutzroeder/Netron) - 用于神经网络、深度学习和机器学习模型的可视化工具.
* [MNN](https://github.com/alibaba/MNN) - 一个超快速、轻量级的深度学习框架，经过阿里巴巴关键业务用例的实战测试.
* [Tensorforce](https://github.com/tensorforce/tensorforce) - 一个开源的深度强化学习框架，强调模块化灵活的库设计和在研究和实践中的应用程序的直接可用性.
* [Dopamine](https://github.com/google/dopamine) - 强化学习算法的快速原型研究框架.
* [catalyst](https://github.com/catalyst-team/catalyst) - 开发的重点是可重复性、快速实验和代码/想法重用.
* [ray](https://github.com/ray-project/ray) - 用于构建和运行分布式应用程序的快速简单的框架.
* [tf-agents](https://github.com/tensorflow/agents) - 用于上下文强盗和强化学习的可靠、可扩展且易于使用的 TensorFlow 库.
* [ReAgent](https://github.com/facebookresearch/ReAgent) - 在 Facebook 开发和使用的应用强化学习 (RL) 的开源端到端平台.
...
* [cnn-explainer](https://github.com/poloclub/cnn-explainer) - 使用交互式可视化学习卷积神经网络.
* [modelzoo](https://github.com/autowarefoundation/modelzoo) - 用于自动驾驶应用的机器学习模型集合.
* [nnstreamer-ros](https://github.com/nnstreamer/nnstreamer-ros) - 一组 Gstreamer 插件和 ROS 示例，使 Gstreamer 开发人员可以轻松高效地采用神经网络模型，神经网络开发人员可以轻松高效地管理神经网络管道及其过滤器.
...
* [OpenMP](https://www.openmp.org/) - 一个应用程序编程接口，支持 C、C++ 和 Fortran 中的多平台共享内存多处理编程.
...
### Image Processing
* [CV-pretrained-model](https://github.com/balavenkatesh3322/CV-pretrained-model) - 计算机视觉预训练模型的集合.
...
* [vision_opencv](https://github.com/ros-perception/vision_opencv) - 用于将 ROS 与 OpenCV 接口的软件包，OpenCV 是一个用于实时计算机视觉的编程函数库.
* [darknet_ros](https://github.com/leggedrobotics/darknet_ros) - YOLO ROS：ROS 的实时目标检测.
* [ros_ncnn](https://github.com/nilseuropa/ros_ncnn) - YOLACT / YOLO *（除其他外）* 用于 ROS 的 NCNN 推理引擎.
* [tf-pose-estimation](https://github.com/ildoonet/tf-pose-estimation) - 使用带有自定义架构的 Tensorflow 实现深度姿势估计，以实现快速推理.
* [find-object](https://github.com/introlab/find-object) - 简单的 Qt 接口，用于尝试 SIFT、SURF、FAST、BRIEF 和其他特征检测器和描述符的 OpenCV 实现.
* [yolact](https://github.com/dbolya/yolact) - 一个简单的、完全卷积的实时实例分割模型.
* [Kimera-Semantics](https://github.com/MIT-SPARK/Kimera-Semantics) - 从 2D 数据进行实时 3D 语义重建.
* [detectron2](https://github.com/facebookresearch/detectron2) - 用于对象检测和分割的下一代研究平台.
* [OpenVX](https://www.khronos.org/openvx/) - 实现性能和功耗优化的计算机视觉处理，这在嵌入式和实时用例中尤其重要.
...
* [semantic_slam](https://github.com/floatlazer/semantic_slam) - 使用手持 RGB-D 相机在 ROS 中进行实时语义大满贯.
* [kitti_scan_unfolding](https://github.com/ltriess/kitti_scan_unfolding) - 我们在我们的论文基于扫描的 LiDAR 点云语义分割：一项实验研究中提出了展开 KITTI 扫描.
* [packnet-sfm](https://github.com/TRI-ML/packnet-sfm) - 由丰田研究所 (TRI) 的 ML 团队发明的自我监督单目深度估计方法的官方 PyTorch 实现.
...
* [Poly-YOLO](https://gitlab.com/irafm-ai/poly-yolo) - 建立在 YOLOv3 的原始思想之上，并消除了它的两个弱点：大量重写标签和锚点分布效率低下.
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) - 使用卫星和航空图像进行深度学习的资源.
* [robosat](https://github.com/mapbox/robosat) - 航空和卫星图像的语义分割.
* [big_transfer](https://github.com/google-research/big_transfer) - Google Research 创建的通用视觉表示学习模型.
...
* [opendatacam](https://github.com/opendatacam/opendatacam) - 仅保存测量的元数据，特别是对象移动的路径或某个点的计数对象数量.
* [Cam2BEV](https://github.com/ika-rwth-aachen/Cam2BEV) - 给定多个车载摄像头的图像，用于计算语义分割鸟瞰 (BEV) 图像的 TensorFlow 实现.
...
* [AliceVision](https://github.com/alicevision/AliceVision) - 摄影测量计算机视觉框架，提供 3D 重建和相机跟踪算法.
...
* [eo-learn](https://github.com/sentinel-hub/eo-learn) - 开源 Python 包的集合，已开发用于及时和自动地无缝访问和处理任何卫星舰队获取的时空图像序列.
...
* [CameraRadarFusionNet](https://github.com/TUMFTM/CameraRadarFusionNet) - TUM Roborace 团队软件堆栈 - 路径跟踪控制、速度控制、曲率控制和状态估计.
...
* [SqueezeSeg](https://github.com/BichenWuUCB/SqueezeSeg) - 实现 SqueezeSeg，用于 LiDAR 点影响分割的卷积神经网络.
* [point_cloud_io](https://github.com/ANYbotics/point_cloud_io) - ROS 节点从文件读取和写入点云（例如 ply、vtk）.
* [python-pcl](https://github.com/strawlab/python-pcl) - Python 绑定到点云库.
* [libpointmatcher](https://github.com/ethz-asl/libpointmatcher) - 用于机器人学中的 2-D/3-D 映射的“迭代最近点”库.
* [depth_clustering](https://github.com/PRBonn/depth_clustering) - 使用 Velodyne 传感器生成的点云快速而稳健的聚类.
* [lidar-bonnetal](https://github.com/PRBonn/lidar-bonnetal) - 用于自动驾驶的 LiDAR 点云的语义和实例分割.
* [CSF](https://github.com/jianboqi/CSF) - 基于布料模拟的LiDAR点云地面滤波/分割（裸地提取）方法.
* [robot_body_filter](https://github.com/peci1/robot_body_filter) - 高度可配置的 LaserScan/PointCloud2 过滤器，允许从测量中动态移除机器人的 3D 身体.
* [grid_map](https://github.com/ANYbotics/grid_map) - 用于移动机器人测绘的通用网格地图库.
* [elevation_mapping](https://github.com/ANYbotics/elevation_mapping) - 用于崎岖地形导航的以机器人为中心的高程映射.
...
* [fast_gicp](https://github.com/SMRT-AIST/fast_gicp) - 基于 GICP 的快速点云配准算法集合.
...
* [PointCNN](https://github.com/yangyanli/PointCNN) - 一个简单而通用的点云特征学习框架.
* [segmenters_lib](https://github.com/LidarPerception/segmenters_lib) - LiDAR 分段器库，用于基于分段的检测.
* [MotionNet](https://github.com/pxiangwu/MotionNet) - 基于鸟瞰图的自动驾驶联合感知和运动预测.
* [PolarSeg](https://github.com/edwardzhou130/PolarSeg) - 一种改进的在线 LiDAR 点云语义分割网格表示.
* [traversability_mapping](https://github.com/TixiaoShan/traversability_mapping) - 从 Velodyne VLP-16 激光雷达中获取点云，并实时输出用于自主导航的可穿越性地图.
* [lidar_super_resolution](https://github.com/RobustFieldAutonomyLab/lidar_super_resolution) - 用于地面车辆的基于仿真的激光雷达超分辨率.
* [Cupoch](https://github.com/neka-nat/cupoch) - 一个使用 CUDA 实现快速 3D 数据处理和机器人计算的库.
...
* [Det3D](https://github.com/poodarchu/Det3D) - 第一个 3D 对象检测工具箱，提供许多 3D 对象检测算法的开箱即用实现，例如 PointPillars、SECOND、PIXOR.
* [OverlapNet](https://github.com/PRBonn/OverlapNet) - 改进的连体网络，可预测由 3D LiDAR 扫描生成的一对距离图像的重叠和相对偏航角.
* [mp2p_icp](https://github.com/MOLAorg/mp2p_icp) - C++ 中的多基元到基元 (MP2P) ICP 算法库.
* [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) - 基于 LiDAR 的 3D 对象检测工具箱.
* [torch-points3d](https://github.com/nicolas-chaulet/torch-points3d) - 用于对点云进行深度学习的 Pytorch 框架.
...
* [gpd](https://github.com/atenpas/gpd) - 将点云作为输入，并生成可行抓取的姿态估计作为输出.
* [SalsaNext](https://github.com/TiagoCortinhal/SalsaNext) - 用于自动驾驶的 LiDAR 点云的不确定性感知语义分割.
* [Super-Fast-Accurate-3D-Object-Detection](https://github.com/maudzung/Super-Fast-Accurate-3D-Object-Detection) - 基于 3D LiDAR 点云的超快速和准确的 3D 对象检测（PyTorch 实现）.
...
* [SA-SSD](https://github.com/skyhehe123/SA-SSD) - 来自点云的结构感知单阶段 3D 对象检测.
* [cuda-pcl](https://github.com/NVIDIA-AI-IOT/cuda-pcl) - 使用基于 NVIDIA CUDA 的 PCL 加速机器人激光雷达.
* [urban_road_filter](https://github.com/jkk-research/urban_road_filter) - 用于自动驾驶汽车的基于激光雷达的实时城市道路和人行道检测.
* [Removert](https://github.com/irapkaist/removert)  - 删除然后恢复. 通过构建静态地图来构建野外静态地图和动态点删除工具.
...
* [ntripbrowser](https://github.com/emlid/ntripbrowser) - 用于浏览 NTRIP（RTCM 通过 Internet 协议的网络传输）的 Python API.
* [imu_tools](https://github.com/ccny-ros-pkg/imu_tools) - IMU 相关的过滤器和可视化工具.
* [RTKLIB](https://github.com/rtklibexplorer/RTKLIB) - 针对单频和双频低成本 GPS 接收器，尤其是 u-blox 接收器优化的 RTKLIB 版本.
* [gLAB](https://gage.upc.edu/gLAB/) - 在厘米级执行 GNSS 可观测（伪距和载波相位）的精确建模，允许独立 GPS 定位、PPP、SBAS 和 DGNSS.
* [ai-imu-dr](https://github.com/mbrossar/ai-imu-dr) - 包含我们新的精确方法的代码，用于仅基于 IMU 的轮式车辆航位推算.
...
* [mcl_3dl](https://github.com/at-wat/mcl_3dl) - 一个 ROS 节点，用于为具有 3-D 激光雷达的移动机器人执行概率 3-D/6-DOF 定位系统.
...
* [pymap3d](https://github.com/geospace-code/pymap3d) - Pure-Python（Numpy 可选）地理空间 ecef enu eci 的 3D 坐标转换.
* [libRSF](https://github.com/TUC-ProAut/libRSF) - 用于在线本地化的强大传感器融合库.

## Simultaneous Localization and Mapping
### Lidar
* [loam_velodyne](https://github.com/laboshinl/loam_velodyne) - 激光里程计和测绘 (Loam) 是一种使用 3D 激光雷达进行状态估计和测绘的实时方法.
* [lio-mapping](https://github.com/hyye/lio-mapping) - 紧耦合 3D 激光雷达惯性里程计和映射 (LIO-mapping) 的实现.
...
* [LIO_SAM](https://github.com/TixiaoShan/LIO-SAM) - 通过平滑和映射实现紧密耦合的激光雷达惯性里程计.
...
* [semantic_suma](https://github.com/PRBonn/semantic_suma/) - 使用 Surfel 映射和语义分割的语义映射.
* [slam_toolbox](https://github.com/SteveMacenski/slam_toolbox) - Slam 工具箱，用于使用 ROS 在潜在的海量地图中进行终身制图和定位.
* [maplab](https://github.com/ethz-asl/maplab) - 一个开放的视觉惯性映射框架.
* [hdl_graph_slam](https://github.com/koide3/hdl_graph_slam) - 一个使用 3D 激光雷达的实时 6DOF SLAM 开源 ROS 包.
* [interactive_slam](https://github.com/SMRT-AIST/interactive_slam) - 与现有的自动 SLAM 包相比，我们只需最少的人力.
* [LeGO-LOAM](https://github.com/RobustFieldAutonomyLab/LeGO-LOAM) - 轻量级和地面优化的激光雷达里程计和可变地形测绘.
* [pyslam](https://github.com/luigifreda/pyslam) - 包含 Python 中的单目视觉里程计 (VO) 管道.
* [Kitware SLAM](https://gitlab.kitware.com/keu-computervision/slam/) - Kitware 开发的仅限 LiDAR 的视觉 SLAM，以及更易于使用的 ROS 和 ParaView 包装.
* [horizon_highway_slam](https://github.com/Livox-SDK/horizon_highway_slam) - 适用于 Livox Horizo​​n 激光雷达的稳健、低漂移和实时高速公路 SLAM 软件包.
...
* [M-LOAM](https://github.com/gogojjh/M-LOAM) - 具有在线外部校准的多激光雷达系统的稳健里程计和映射.


### Visual
* [orb_slam_2_ros](https://github.com/appliedAI-Initiative/orb_slam_2_ros) - ORB_SLAM2 的 ROS 实现.
* [orbslam-map-saving-extension](https://github.com/TUMFTM/orbslam-map-saving-extension) - 在这个扩展中，ORB 特征图被保存到磁盘中，作为未来沿同一轨道运行的参考.
* [dso](https://github.com/JakobEngel/dso/) - 直接稀疏里程计.
* [viso2](https://github.com/srv/viso2) - libviso2 的 ROS 包装器，一个用于视觉里程计的库.
* [xivo](https://github.com/ucla-vision/xivo) - X 惯性辅助视觉里程计.
* [rovio](https://github.com/ethz-asl/rovio) - 强大的视觉惯性里程计框架.
* [LSD-SLAM](https://github.com/tum-vision/lsd_slam) - 大规模直接单目SLAM是一种实时单目SLAM.
* [CubeSLAM and ORB SLAM](https://github.com/shichaoy/cube_slam) - CubeSLAM 和 ORB SLAM 的单目 3D 对象检测和 SLAM 包.
* [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) - 一种强大且多功能的多传感器视觉惯性状态估计器.
...
* [tagslam](https://github.com/berndpfrommer/tagslam) - 基于 ROS 的软件包，用于使用 AprilTag 基准标记进行同时定位和映射.
* [LARVIO](https://github.com/PetWorm/LARVIO) - 基于多状态约束卡尔曼滤波器的轻量级、准确和鲁棒的单目视觉惯性里程计.
...
* [Atlas](https://github.com/magicleap/Atlas) - 从姿势图像进行端到端 3D 场景重建.
* [vilib](https://github.com/uzh-rpg/vilib) - 这个库专注于使用 CUDA 的 VIO 管道的前端.
* [hloc](https://github.com/cvg/Hierarchical-Localization)  - 用于最先进的 6 自由度视觉定位的模块化工具箱. 它实现了分层定位，利用图像检索和特征匹配，并且快速、准确和可扩展.
* [ESVO](https://github.com/HKUST-Aerial-Robotics/ESVO) - 一种使用基于立体事件的相机进行实时视觉里程计的新颖管道.
* [gradslam](https://github.com/gradslam/gradslam) - 用于 PyTorch 的开源可微密集 SLAM 库.
...
* [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/Lanelet2) - 自动驾驶地图处理框架.
* [barefoot](https://github.com/bmwcarit/barefoot) - 在线和离线地图匹配，可以单独使用和在云中使用.
* [iD](https://github.com/openstreetmap/iD) - JavaScript 中易于使用的 OpenStreetMap 编辑器.
* [RapiD](https://github.com/facebookincubator/RapiD) - iD 的增强版，用于与 Facebook 创建的 AI 进行映射.
* [segmap](https://github.com/ethz-asl/segmap) - 基于 3D 线段的地图表示.
...
* [assuremapingtools](https://github.com/hatem-darweesh/assuremapingtools) - 基于桌面的工具，用于查看、编辑和保存自动车辆平台（如 Autoware）的道路网络地图.
* [geopandas](https://github.com/geopandas/geopandas) - 为 pandas 对象添加地理数据支持的项目.
* [MapToolbox](https://github.com/autocore-ai/MapToolbox) - 在 Unity 中制作 Autoware 矢量地图的插件.
* [imagery-index](https://github.com/ideditor/imagery-index) - 用于制图的航空和卫星图像索引.
...
* [gdal](https://github.com/OSGeo/gdal) - GDAL 是用于栅格和矢量地理空间数据格式的开源 X/MIT 许可转换器库.
* [grass](https://github.com/OSGeo/grass) - GRASS GIS - 免费和开源的地理信息系统 (GIS).
* [3d-tiles](https://github.com/CesiumGS/3d-tiles) - 流式传输海量异构 3D 地理空间数据集的规范.
...
* [RAFCON](https://github.com/DLR-RM/RAFCON) - 使用具有并发状态执行的分层状态机来表示机器人程序.
* [ROSPlan](https://github.com/KCL-Planning/ROSPlan) - ROS系统中任务规划的通用框架.
* [ad-rss-lib](https://github.com/intel/ad-rss-lib) - 实现自动驾驶汽车责任敏感安全模型 (RSS) 的库.
* [FlexBE](https://flexbe.github.io/) - 分层状态机的图形编辑器，基于 ROS 的 smach.
* [sts_bt_library](https://github.com/Autonomous-Logistics/sts_bt_library) - 该库提供了通过使用已定义的树结构（如回退、序列或并行节点）来设置您自己的行为树逻辑的功能.
...
* [pacmod](https://github.com/astuff/pacmod) - 旨在允许用户使用PACMod 线控驱动系统控制车辆.
* [mpcc](https://github.com/alexliniger/MPCC) - 用于自动赛车的模型预测轮廓控制器.
* [rrt](https://github.com/RoboJackets/rrt) - C++ RRT（快速探索随机树）实现.
* [HypridAStarTrailer](https://github.com/AtsushiSakai/HybridAStarTrailer) - 基于 Hybrid A* 的挂车路径规划算法.
...
* [Open Source Car Control](https://github.com/PolySync/oscc) - 软件和硬件设计的组合，能够对现代汽车进行计算机控制，以促进自动驾驶汽车技术的发展.
...
* [steering_functions](https://github.com/hbanzhaf/steering_functions) - 包含一个 C++ 库，该库为具有有限转弯半径的汽车类机器人实现转向功能.
...
* [aikido](https://github.com/personalrobotics/aikido) - 运动学、动力学和优化的人工智能.
* [casADi](https://github.com/casadi/casadi) - 在稀疏矩阵值计算图上实现正向和反向模式自动微分的数值优化符号框架.
...
* [openrave](https://github.com/rdiankov/openrave) - 开放机器人自动化虚拟环境：用于测试、开发和部署机器人运动规划算法的环境.
* [teb_local_planner](https://github.com/rst-tu-dortmund/teb_local_planner) - 考虑基于 Timed-Elastic-Bands 的移动机器人独特拓扑的最佳轨迹规划器.
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) - 刚体动力学算法及其分析导数的快速灵活实现.
* [rmf_core](https://github.com/osrf/rmf_core) - rmf_core 包提供机器人中间件框架 (RMF) 的集中功能.
* [OpEn](https://github.com/alphaville/optimization-engine) - 用于下一代机器人和自主系统的快速和准确嵌入式优化的求解器.
* [autogenu-jupyter](https://github.com/mayataka/autogenu-jupyter) - 该项目为非线性模型预测控制 (NMPC) 提供基于延续/GMRES 方法（C/GMRES 方法）的求解器和用于 NMPC 的自动代码生成器.
* [global_racetrajectory_optimization](https://github.com/TUMFTM/global_racetrajectory_optimization) - 该存储库包含多种生成全球比赛轨迹的方法.
* [toppra](https://github.com/hungpham2511/toppra) - 用于计算受运动学和动态约束的机器人的时间最优路径参数化的库.
* [tinyspline](https://github.com/msteinbeck/tinyspline) - TinySpline 是一个小而强大的库，用于插值、转换和查询任意 NURBS、B 样条和 Bézier 曲线.
* [dual quaternions ros](https://github.com/Achllle/dual_quaternions_ros) - 用于双四元数 SLERP 的 ROS python 包.
* [mb planner](https://github.com/unr-arl/mbplanner_ros)  - 用于狭小空间的飞行器规划器. 用于 DARPA SubT 挑战赛.
...
* [pykep](https://github.com/esa/pykep) - 一个为行星际轨迹设计研究提供基本工具的科学图书馆.
...
* [GraphBasedLocalTrajectoryPlanner](https://github.com/TUMFTM/GraphBasedLocalTrajectoryPlanner) - 在 Roborace Season Alpha 期间用于真正的赛车，并达到 200 公里/小时以上的速度.
* [se2_navigation](https://github.com/leggedrobotics/se2_navigation) - 纯追踪控制器和基于 Reeds-Shepp 采样的规划器，用于在 SE(2) 空间中导航.
* [Ruckig](https://ruckig.com)  - 瞬时运动生成. 即时的. 混蛋受限. 时间最优.


## User Interaction
### Graphical User Interface
* [qtpy](https://github.com/spyder-ide/qtpy) - 提供一个统一的层来支持 PyQt5、PySide2、PyQt4 和 PySide 与单个代码库.
* [mir](https://github.com/MirServer/mir) - Mir 是一组用于构建基于 Wayland 的 shell 的库.
* [rqt](https://wiki.ros.org/rqt)  - 用于 ROS 的 GUI 开发的基于 Qt 的框架. 它由三个部分/元包组成.
* [cage](https://github.com/Hjdskes/cage)  - 这是凯奇，一个 Wayland 售货亭. 信息亭运行一个单一的、最大化的应用程序.
...
* [pencil](https://github.com/evolus/pencil) - 用于制作每个人都可以使用的图表和 GUI 原型的工具.
* [dynamic_reconfigure](https://wiki.ros.org/dynamic_reconfigure) - dynamic_reconfigure 的重点是提供一种标准方法，将节点参数的子集公开给外部重新配置.
...
* [elements](https://github.com/cycfi/elements) - 一个轻量级、细粒度、独立于分辨率的模块化 GUI 库.
* [NanoGUI](https://github.com/wjakob/nanogui) - 适用于 OpenGL 3.x 或更高版本的简约跨平台小部件库.


### Acoustic User Interface
* [pyo](https://github.com/belangeo/pyo) - 一个用 C 语言编写的 Python 模块，包含用于各种音频信号处理类型的类.
* [rhasspy](https://github.com/synesthesiam/rhasspy) - Rhasspy（发音为 RAH-SPEE）是一个离线多语言语音助手工具包，灵感来自 Jasper，可与 Home Assistant、Hass.io 和 Node-RED 配合使用.
* [mycroft-core](https://github.com/MycroftAI/mycroft-core) - Mycroft 是一个可破解的开源语音助手.
* [DDSP](https://github.com/magenta/ddsp) - 通用 DSP 功能（如合成器、波形整形器和滤波器）的可微分版本库.
* [NoiseTorch](https://github.com/lawl/NoiseTorch) - 在任何应用程序中创建抑制噪音的虚拟麦克风.
* [DeepSpeech](https://github.com/mozilla/DeepSpeech) - 一个开源的 Speech-To-Text 引擎，使用基于百度 Deep Speech 研究论文的机器学习技术训练的模型.
* [waveglow](https://github.com/NVIDIA/waveglow) - 基于流的语音合成生成网络.
...
* [asciimatics](https://github.com/peterbrittain/asciimatics) - 一个跨平台的包，用于执行类似诅咒的操作，以及用于创建文本 UI 和 ASCII 艺术动画的更高级别的 API 和小部件.
...
* [tmuxp](https://github.com/tmux-python/tmuxp) - 基于 libtmux 构建的会话管理器.
* [mapscii](https://github.com/rastapasta/mapscii) - 您的控制台的世界地图渲染器.
* [terminator](https://launchpad.net/terminator) - 该项目的目标是制作一个用于安排终端的有用工具.
* [bat](https://github.com/sharkdp/bat) - 带有翅膀的 cat(1) 克隆.
...
* [xdot](https://github.com/jrfonseca/xdot.py) - 以 Graphviz 的点语言编写的图形的交互式查看器.
* [guacamole](https://guacamole.apache.org/)  - 无客户端远程桌面网关. 它支持标准协议，如 VNC、RDP 和 SSH.
...
* [plotly.py](https://github.com/plotly/plotly.py) - 用于 Python 的开源交互式图形库.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) - 您应得的时间序列可视化工具.
...
* [rqt_bag](http://wiki.ros.org/rqt_bag) - 提供用于显示和回放 ROS 包文件的 GUI 插件.
* [kepler.gl](https://github.com/keplergl/kepler.gl) - Kepler.gl 是一个强大的开源地理空间分析工具，适用于大规模数据集.
...
* [RVizWeb](https://github.com/osrf/rvizweb) - 提供一种方便的方式来构建和启动具有类似于 RViz 的功能的 Web 应用程序.
* [marvros](https://github.com/mavlink/mavros) - MAVLink 到带有地面控制站代理的 ROS 网关.
* [octave](https://www.gnu.org/software/octave/) - 提供方便的命令行界面，用于数值求解线性和非线性问题，以及使用与 Matlab 最兼容的语言执行其他数值实验.
* [streetscape.gl](https://github.com/uber/streetscape.gl) - Streetscape.gl 是一个工具包，用于在 XVIZ 协议中可视化自主和机器人数据.
...
* [cvat](https://github.com/opencv/cvat) - 强大高效的计算机视觉注释工具 (CVAT).
* [point_labeler](https://github.com/jbehley/point_labeler) - 用于标记单个点云或点云流的工具.
* [label-studio](https://github.com/heartexlabs/label-studio) - Label Studio 是一个具有标准化输出格式的多类型数据标注和注释工具.
* [napari](https://github.com/napari/napari) - 用于 python 的快速、交互式、多维图像查看器.
* [semantic-segmentation-editor](https://github.com/Hitachi-Automotive-And-Industry-Lab/semantic-segmentation-editor) - 基于网络的标签工具，用于创建 AI 训练数据集（2D 和 3D）.
* [3d-bat](https://github.com/walzimmer/3d-bat) - 用于点云和图像标记的 3D 边界框注释工具.
* [labelme](https://github.com/wkentaro/labelme) - 使用 Python 进行图像多边形注释（多边形、矩形、圆、线、点和图像级标志注释）.
...
* [3d-annotation-tool](https://github.com/StrayRobots/3d-annotation-tool) - 用边界框、矩形、关键点等注释点云的轻量级工具.


### Point Cloud
* [CloudCompare](https://github.com/CloudCompare/CloudCompare) - CloudCompare 是一个 3D 点云（和三角网格）处理软件.
* [Potree](https://github.com/potree/potree) - 用于大型数据集的 WebGL 点云查看器.
* [point_cloud_viewer](https://github.com/googlecartographer/point_cloud_viewer) - 让查看海量点云变得简单方便.
* [LidarView](https://github.com/Kitware/LidarView) - 对来自激光雷达传感器的实时捕获的 3D 激光雷达数据执行实时可视化和轻松处理.
...
### RViz
* [mapviz](https://github.com/swri-robotics/mapviz) - 用于二维数据的模块化 ROS 可视化工具.
...
* [rviz_visual_tools](https://github.com/PickNikRobotics/rviz_visual_tools) - C++ API 包装器，用于在 Rviz 中显示形状和网格.
<!--lint ignore double-link-->
...
* [moveit_visual_tools](https://github.com/ros-planning/moveit_visual_tools)  - 用于显示和调试 MoveIt 的辅助函数！ 通过已发布的标记在 Rviz 中获取数据.
...
* [collectd](https://github.com/collectd/collectd/) - 定期收集系统信息并提供以各种方式存储和监视值的机制的小型守护程序.
...
* [atop](https://github.com/Atoptool/atop) - 具有日志记录和回放功能的 Linux 系统和进程监视器.
* [psutil](https://github.com/giampaolo/psutil) - 在 Python 中用于进程和系统监控的跨平台库.
...
### Database and Record
* [ncdu](https://dev.yorhel.nl/ncdu) - Ncdu 是一个带有 ncurses 界面的磁盘使用分析器.
* [borg](https://github.com/borgbackup/borg) - 使用压缩和经过身份验证的加密对归档器进行重复数据删除.
* [bag-database](https://github.com/swri-robotics/bag-database) - 对包文件进行编目并提供基于 Web 的 UI 来访问它们的服务器.
* [marv-robotics](https://gitlab.com/ternaris/marv-robotics) - MARV Robotics 是一个强大且可扩展的数据管理平台.
* [kitti2bag](https://github.com/tomas789/kitti2bag) - 将 KITTI 数据集转换为 ROS 包文件的简单方法.
* [pykitti](https://github.com/utiasSTARS/pykitti) - 用于处理 KITTI 数据的 Python 工具.
* [rosbag_editor](https://github.com/facontidavide/rosbag_editor) - 使用简单的 GUI 从给定的一个 rosbag 创建一个.
...
* [syncthing](https://github.com/syncthing/syncthing) - 一个连续的文件同步程序.
* [rqt_bag_exporter](https://gitlab.com/InstitutMaupertuis/rqt_bag_exporter) - Qt GUI 将 ROS 包主题导出到文件（CSV 和/或视频）.
* [xviz](https://github.com/uber/xviz) - 自治数据的实时传输和可视化协议.
* [kitti_to_rosbag](https://github.com/ethz-asl/kitti_to_rosbag)  - 用于处理 KITTI 数据集原始数据并将其转换为 ROS 包的数据集工具. 还允许直接访问姿势、velodyne 扫描和图像的库.
* [ros_numpy](https://github.com/eric-wieser/ros_numpy) - 用于将 ROS 消息与 numpy 数组相互转换的工具.
* [kitti_ros](https://github.com/LidarPerception/kitti_ros) - 一个基于 ROS 的播放器，用于回放 KiTTI 数据集.
* [DuckDB](https://github.com/cwida/duckdb) - 一个可嵌入的 SQL OLAP 数据库管理系统.
...
* [polyaxon](https://github.com/polyaxon/polyaxon) - 复制和管理机器学习和深度学习应用程序的整个生命周期的平台.
...
* [graylog2-server](https://github.com/Graylog2/graylog2-server) - 免费和开源的日志管理.
* [ansible](https://github.com/ansible/ansible) - Ansible 是一个极其简单的 IT 自动化平台，使您的应用程序和系统更易于部署.
* [pyinfra](https://github.com/Fizzadar/pyinfra) - 可用于临时命令执行、服务部署、配置管理等.
* [docker-py](https://github.com/docker/docker-py) - 用于 Docker 引擎 API 的 Python 库.
...
* [enroot](https://github.com/NVIDIA/enroot) - 一个简单而强大的工具，可将传统容器/OS 映像转换为非特权沙箱.
* [docker-firefox](https://github.com/jlesage/docker-firefox) - 使用 Firefox 和 noVNC 运行 Docker 容器，以远程访问无头服务器.
* [luigi](https://github.com/spotify/luigi)  - 一个 Python 模块，可帮助您构建复杂的批处理作业管道. 它处理依赖关系解析、工作流管理、可视化等.它还内置了 Hadoop 支持.
* [triton-inference-server](https://github.com/NVIDIA/triton-inference-server) - NVIDIA Triton 推理服务器提供针对 NVIDIA GPU 优化的云推理解决方案.
* [cudf](https://github.com/rapidsai/cudf) - 提供数据工程师和数据科学家熟悉的类似 pandas 的 API，因此他们可以使用它来轻松加速他们的工作流程，而无需深入了解 CUDA 编程的细节.


### Embedded Operation System
* [vxworks7-ros2-build](https://github.com/Wind-River/vxworks7-ros2-build) - 构建系统以自动构建 VxWorks 7 和 ROS2.
* [Yocto](https://git.yoctoproject.org/) - 制作工具和流程，支持为嵌入式软件创建 Linux 发行版，这些发行版独立于嵌入式硬件的底层架构.
* [Automotive Graded Linux](https://www.automotivelinux.org/software) - 一个协作开源项目，它将汽车制造商、供应商和技术公司聚集在一起，为汽车应用程序构建一个基于 Linux 的开放软件平台，该平台可以作为事实上的行业标准.
...
* [Xen](https://wiki.debian.org/Xen) - 一个开源 (GPL) 类型 1 或裸机管理程序.
...
* [rosserial](https://github.com/ros-drivers/rosserial) - 用于小型嵌入式设备（如 Arduino）的 ROS 客户端库.
...
* [micro-ros](https://micro-ros.github.io/) - 与“常规”ROS 2 相比的主要变化是 micro-ROS 使用实时操作系统 (RTOS) 而不是 Linux，以及用于极度资源受限环境的 DDS.
* [nvidia-container-runtime](https://github.com/NVIDIA/nvidia-container-runtime/) - NVIDIA Container Runtime 是一种 GPU 感知容器运行时，与 Docker、CRI-O 和其他流行容器技术使用的 Open Containers Initiative (OCI) 规范兼容.
...
* [Pressed](https://wiki.debian.org/DebianInstaller/Preseed) - 提供一种方法来设置 debian 安装过程中提出的问题的答案，而无需在安装运行时手动输入答案.
* [jetson_stats](https://github.com/rbonghi/jetson_stats) - 用于监控和控制您的 NVIDIA Jetson（Xavier NX、Nano、AGX Xavier、TX1、TX2）的软件包适用于所有 NVIDIA Jetson 生态系统.
* [ros_jetson_stats](https://github.com/rbonghi/ros_jetson_stats)  - ROS jetson-stats 包装器. 诊断消息中的 NVIDIA jetson 状态.
* [OpenCR](https://github.com/ROBOTIS-GIT/OpenCR) - ROS 的开源控制模块.
* [acrn-hypervisor](https://github.com/projectacrn/acrn-hypervisor) - 定义设备管理程序参考堆栈和用于运行多个软件子系统的体系结构，通过虚拟机管理器在统一系统上进行安全管理.
* [jetson-containers](https://github.com/dusty-nv/jetson-containers) - Jetson 和 JetPack 4.4 的机器学习容器.


### Real-Time Kernel
* [ELISA](https://elisa.tech/) - 该项目旨在让公司更容易构建和认证基于 Linux 的安全关键型应用程序——其故障可能导致人员伤亡、重大财产损失或环境破坏的系统.
* [PREEMPT_RT kernel patch](https://wiki.linuxfoundation.org/realtime/documentation/start) - PREEMPT_RT 内核补丁的目的是尽量减少不可抢占的内核代码量.

## Network and Middleware
* [performance_test](https://github.com/ApexAI/performance_test) - 用于测试基于 pub/sub 的通信框架性能的工具.
...
* [Fast-RTPS](https://github.com/eProsima/Fast-RTPS) - 一种协议，它通过对象管理组 (OMG) 联盟定义和维护的不可靠传输（如 UDP）提供发布者-订阅者通信.
...
* [cyclonedds](https://github.com/eclipse-cyclonedds/cyclonedds) - Eclipse Cyclone DDS 是一个非常高性能和强大的开源 DDS 实现.
* [iceoryx](https://github.com/eclipse/iceoryx) - 用于基于 POSIX 的系统的 IPC 中间件.
* [rosbridge_suite](https://github.com/RobotWebTools/rosbridge_suite) - 为 ROS 提供 JSON 接口，允许任何客户端发送 JSON 来发布或订阅 ROS 主题，调用 ROS 服务等.
...
* [ocpp](https://github.com/NewMotion/ocpp) - 开放充电点协议 (OCPP) 是用于电动汽车充电器和中央后台系统之间通信的网络协议.
* [micro-ROS for Arduino](https://github.com/micro-ROS/micro_ros_arduino) - 基于 Arduino IDE 或 Arduino CLI 的裸机项目的实验性微 ROS 库.
* [mqtt_bridge](https://github.com/groove-x/mqtt_bridge) - 提供在 ROS 和 MQTT 之间双向桥接的功能.


### Ethernet and Wireless Networking
* [SOES](https://github.com/OpenEtherCATsociety/SOES) - SOES 是用 C 语言编写的 EtherCAT 从站堆栈.
* [netplan](https://netplan.io/) - 只需创建所需网络接口的 YAML 描述以及每个接口的配置.
...
* [wireless](https://github.com/clearpathrobotics/wireless) - 向 ROS 提供有关无线网络的信息.
* [ptpd](https://github.com/ptpd/ptpd)  - PTP 守护进程 (PTPd) 是“IEEE Std 1588-2008”定义的精确时间协议 (PTP) 版本 2 的实现.  PTP 提供以太网 LAN 连接计算机的精确时间协调.
...
* [pyshark](https://github.com/KimiNewt/pyshark) - tshark 的 Python 包装器，允许使用 wireshark 解析器解析 Python 数据包.
* [pingtop](https://github.com/laixintao/pingtop) - Ping 多个服务器并在类似顶部的终端 UI 中显示结果.
* [termshark](https://github.com/gcla/termshark) - 受 Wireshark 启发的 tshark 终端 UI.
* [udpreplay](https://github.com/rigtorp/udpreplay) - 从 pcap 文件重放 UDP 数据包.
* [openwifi](https://github.com/open-sdr/openwifi) - 基于软件定义无线电的 Linux mac80211 兼容全栈 IEEE802.11/Wi-Fi 设计.

### Controller Area Network
* [awesome CAN](https://github.com/iDoka/awesome-canbus) - 很棒的 CAN 总线工具、硬件和资源的精选列表.
* [AndrOBD](https://github.com/fr3ts0n/AndrOBD) - 使用任何 ELM327 适配器​​进行 Android OBD 诊断.
* [ddt4all](https://github.com/cedricp/ddt4all) - DDT4All 是一个工具，可以创建您自己的 ECU 参数屏幕并使用便宜的 ELM327 接口连接到 CAN 网络.
* [cabana](https://github.com/commaai/cabana) - CAN 可视化工具和 DBC 制造商.
* [opendbc](https://github.com/commaai/opendbc) - 民主化访问汽车解码器环的项目.
* [libuavcan](https://github.com/UAVCAN/libuavcan) - 一种开放的轻量级协议，旨在通过 CAN 总线等强大的车辆网络在航空航天和机器人应用中进行可靠通信.
* [python-can](https://github.com/hardbyte/python-can) - can 包为 Python 开发人员提供控制器局域网支持.
...
* [uds-c](https://github.com/openxc/uds-c) - 统一诊断服务 (UDS) 和 OBD-II（车载诊断）C 库.
* [cantools](https://github.com/eerimoq/cantools) - Python 3 中的 CAN BUS 工具.
* [CANdevStudio](https://github.com/GENIVI/CANdevStudio)  - CANdevStudio 旨在成为具有成本效益的 CAN 仿真软件替代品. 它可以与各种CAN硬件接口一起工作.
* [can-utils](https://github.com/linux-can/can-utils) - Linux-CAN / SocketCAN 用户空间应用程序.
* [ros_canopen](https://github.com/ros-industrial/ros_canopen) - ROS的CANopen驱动框架.
* [decanstructor](https://github.com/JWhitleyAStuff/decanstructor) - 权威的 ROS CAN 分析工具.
* [kvaser_interface](https://github.com/astuff/kvaser_interface) - 该软件包是作为从 ROS 访问 Kvaser CAN 设备的标准化方式而开发的.
...
* [canopen](https://github.com/christiansandberg/canopen)  - CANopen 标准的 Python 实现. 该项目的目的是在 Pythonic 接口中支持 CiA 301 标准中最常见的部分.
* [SavvyCAN](https://github.com/collin80/SavvyCAN) - 基于 Qt5 的跨平台工具，可用于加载、保存和捕获 canbus 帧.
* [Open-Vehicle-Monitoring-System-3](https://github.com/openvehicles/Open-Vehicle-Monitoring-System-3) - 该系统提供对车辆指标的实时监控，如充电状态、温度、轮胎压力和诊断故障条件.


### Sensor and Acuator Interfaces
* [Tesla-API](https://github.com/timdorr/tesla-api) - 提供远程监控和控制 Model S（以及未来的 Tesla 车辆）的功能.
* [flirpy](https://github.com/LJMUAstroecology/flirpy) - 与 FLIR 热成像相机和图像交互的 Python 库.
* [nerian_stereo](https://github.com/nerian-vision/nerian_stereo) - Nerian 的 SceneScan 和 SP1 立体视觉传感器的 ROS 节点.
* [pymmw](https://github.com/m6c7l/pymmw) - 这是一个由 Python 脚本组成的工具箱，用于与用于 IWR1443 毫米波传感设备的 TI 评估模块 (BoosterPack) 进行交互.
* [ti_mmwave_rospkg](https://github.com/radar-lab/ti_mmwave_rospkg) - TI 毫米波雷达 ROS 驱动器（具有传感器融合和混合）.
* [pacmod3](https://github.com/astuff/pacmod3) - 此 ROS 节点旨在允许用户使用 PACMod 线控驱动系统（电路板修订版 3）控制车辆.
* [ros2_intel_realsense](https://github.com/intel/ros2_intel_realsense) - 这些是用于将英特尔实感摄像头（D400 系列）与 ROS2 配合使用的软件包.
...
* [ros2_ouster_drivers](https://github.com/ros-drivers/ros2_ouster_drivers) - 这些是用于 Ouster OS-1 3D 激光雷达的 ROS2 驱动程序的实现.
* [livox_ros_driver](https://github.com/Livox-SDK/livox_ros_driver) - 新的 ROS 包，专门用于连接 Livox 生产的 LiDAR 产品.
* [velodyne](https://github.com/ros-drivers/velodyne) - 支持 Velodyne 高清 3D 激光雷达的 ROS 软件包集合.
...
* [pylon-ros-camera](https://github.com/basler/pylon-ros-camera) - 适用于 Basler GigE Vision 和 USB3 Vision 相机的官方 pylon ROS 驱动程序.
* [ethz_piksi_ros](https://github.com/ethz-asl/ethz_piksi_ros) - 包含 (python) ROS 驱动程序、工具、启动文件和关于如何在 ROS 中使用 Piksi 实时动态 (RTK) GPS 设备的 wiki.
* [sick_safetyscanners](https://github.com/SICKAG/sick_safetyscanners) - 一个 ROS 驱动程序，它从 SICK 安全扫描仪读取原始数据并将数据作为laser_scan msg 发布.
* [bosch_imu_driver](https://github.com/mdrwiega/bosch_imu_driver)  - 传感器 IMU Bosch BNO055 的驱动程序. 它仅实现了 UART 通信接口（应选择正确的传感器模式）.
* [oxford_gps_eth](https://bitbucket.org/DataspeedInc/oxford_gps_eth/) - 使用 NCOM 数据包结构到 OxTS GPS 接收器的以太网接口.
...
* [jetson_csi_cam](https://github.com/peter-moran/jetson_csi_cam) - 一个 ROS 包，使在 Nvidia Jetson TK1、TX1 或 TX2 上使用 CSI 摄像头与 ROS 变得简单.
...
* [TauLidarCamera](https://github.com/OnionIoT/tau-LiDAR-camera) - 用于使用 Tau LiDAR 摄像头构建应用程序的主机端 API.
...
* [brutespray](https://github.com/x90skysn3k/brutespray) - 在找到的服务上自动尝试默认信用.
* [fail2ban](https://github.com/fail2ban/fail2ban) - 禁止导致多个身份验证错误的主机的守护进程.
* [DependencyCheck](https://github.com/jeremylong/DependencyCheck) - 一种软件组合分析实用程序，可检测应用程序依赖项中公开披露的漏洞.
* [Firejail](https://github.com/netblue30/firejail) - 一个 SUID 沙盒程序，通过使用 Linux 命名空间、seccomp-bpf 和 Linux 功能限制不受信任的应用程序的运行环境来降低安全漏洞的风险.
* [RVD](https://github.com/aliasrobotics/RVD)  - 机器人漏洞数据库. 社区贡献的机器人漏洞和弱点档案.
* [ros2_dds_security](http://design.ros2.org/articles/ros2_dds_security.html) - 通过定义服务插件接口 (SPI) 架构、一组 SPI 的内置实现以及 SPI 强制执行的安全模型来添加安全增强功能.
* [Security-Enhanced Linux](https://github.com/SELinuxProject/selinux) - Linux 内核安全模块，提供支持访问控制安全策略的机制，包括强制访问控制 (MAC).
* [OpenTitan](https://github.com/lowRISC/opentitan)  - 将使硅信任根的设计和实施对企业、平台提供商和芯片制造商更加透明、可信和安全.  OpenTitan 作为一个协作项目由 lowRISC CIC 管理，以生产高质量的开放 IP 以作为全功能产品的实例化.
* [bandit](https://github.com/PyCQA/bandit) - 一种旨在查找 Python 代码中常见安全问题的工具.
...
* [legion](https://github.com/GoVanguard/legion) - 一个开源、易于使用、超可扩展和半自动化的网络渗透测试框架，有助于发现、侦察和利用信息系统.
...
* [KITTI-360](https://github.com/autonomousvision/kitti360Scripts) - 这个大规模数据集包含 320k 图像和 100k 激光扫描，行驶距离为 73.7 公里.
* [waymo_ros](https://github.com/YonoHub/waymo_ros) - 这是一个将 Waymo 开放数据集连接到 ROS 的 ROS 包.
* [waymo-open-dataset](https://github.com/waymo-research/waymo-open-dataset) - Waymo 开放数据集由 Waymo 自动驾驶汽车在各种条件下收集的高分辨率传感器数据组成.
* [Ford Autonomous Vehicle Dataset](https://avdata.ford.com/home/default.aspx) - 福特展示了一个具有挑战性的多智能体季节性数据集，该数据集由福特自动驾驶车队在不同的日期和时间收集.
* [awesome-robotics-datasets](https://github.com/sunglok/awesome-robotics-datasets) - 用于机器人和计算机视觉的有用数据集的集合.
* [nuscenes-devkit](https://github.com/nutonomy/nuscenes-devkit) - nuScenes 数据集的开发套件.
* [dataset-api](https://github.com/ApolloScapeAuto/dataset-api) - 这是 ApolloScape 数据集、CVPR 2019 自动驾驶挑战研讨会和 ECCV 2018 挑战的工具包回购.
* [utbm_robocar_dataset](https://github.com/epan-utbm/utbm_robocar_dataset) - 用于自动驾驶的具有多个传感器的欧盟长期数据集.
...
* [DDAD](https://github.com/TRI-ML/DDAD) - 来自 TRI（丰田研究所）的新自动驾驶基准，用于在具有挑战性和多样化的城市条件下进行长距离（高达 250m）和密集深度估计.
* [pandaset-devkit](https://github.com/scaleapi/pandaset-devkit) - Hesa​​i &amp; Scale 提供的自动驾驶公共大规模数据集.
* [a2d2_to_ros](https://gitlab.com/MaplessAI/external/a2d2_to_ros) - 用于将 A2D2 数据集转换为 ROS 包的实用程序.
...
* [h3d](https://usa.honda-ri.com/h3d) - H3D 是来自 Honda 的大规模全环绕 3D 多目标检测和跟踪数据集.
* [Mapillary Vistas Dataset](https://www.mapillary.com/dataset/vistas) - 一个多样化的街道级图像数据集，具有像素精确和特定实例的人类注释，用于了解世界各地的街景.
* [TensorFlow Datasets](https://www.tensorflow.org/datasets/catalog/overview) - TensorFlow Datasets 提供许多公共数据集作为 tf.data.Datasets.
* [racetrack-database](https://github.com/TUMFTM/racetrack-database) - 包含全球 20 多个赛道（主要是 F1 和 DTM）的中心线（x 和 y 坐标）、赛道宽度和赛道线.
* [BlenderProc](https://github.com/DLR-RM/BlenderProc) - 用于生成逼真的训练图像的程序化 Blender 管道.
* [Atlatec Sample Map Data](https://www.atlatec.de/getsampledata.html) - 用于自动驾驶和模拟的 3D 地图，仅由旧金山市中心的两个摄像头和 GPS 创建.
* [Lyft Level 5 Dataset](https://self-driving.lyft.com/level5/data/)  - Level 5 正在为 Lyft 网络开发自动驾驶系统. 我们正在从我们的自主车队收集和处理数据并与您共享.
* [holicity](https://github.com/zhou13/holicity) - 用于学习整体 3D 结构的城市规模数据平台.
* [UTD19](https://utd19.ethz.ch/) - 公开的最大的多城市交通数据集.
