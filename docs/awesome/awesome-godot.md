...
- [AgonesSDK](https://github.com/AndreMicheletti/godot-agones-sdk) - 插件添加 [Agones](https://github.com/googleforgames/agones) SDK functionality to Godot (Godot 3.x).
...
- [EffekseerForGodot3](https://github.com/effekseer/EffekseerForGodot3) - 进口 [Effekseer](https://effekseer.github.io/en/) particle effects (Godot 3.x).
...
- [Qodot](https://github.com/Shfty/qodot-plugin)  - 对 Godot 的 Quake `.map` 文件支持. 让您使用 [TrenchBroom](https://kristianduske.com/trenchbroom/) for level design.
