...
| ★★★ | [E-Maxx (Russian)](http://e-maxx.ru/algo/), [(English)](http://cp-algorithms.com/)  | 在俄语竞争性编程社区中广泛使用和引用的教程网站. 原网站的大部分文章已被翻译成英文，其余的谷歌翻译还可以.  |
| ★★☆ | [Algorithms - GeeksforGeeks](https://www.geeksforgeeks.org/fundamentals-of-algorithms/)  | 一个拥有大量关于不同主题的精美文章存档的网站. 它是算法课程的绝佳免费资源.  |
...
| ★☆☆ | [OLYMPIADS IN INFORMATICS](https://www.mii.lt/olympiads_in_informatics/index.html)  | 一本国际期刊，专注于在教学和学习信息学领域工作的专业人士对有才华的学生的研究和实践.  |
...
| ★★★ | [Mini-Editorials](https://github.com/mostafa-saad/MyCompetitiveProgramming)， 经过 [Mostafa Saad Ibrahim](https://sites.google.com/site/mostafasibrahim/) 学员| 包括UVA/SPOJ/IOI/Olympiad问题在内的许多问题的迷你编辑解决方案|
...
&gt; 考虑通过这些很棒的课程开始您的竞争性编程之旅！
 ...
 |  ☆ | 姓名 | 说明 |
| --- | --- | --- |
| ★★☆ | [Code Monk](https://www.hackerearth.com/practice/codemonk/) , 由 HackerEarth | 关于竞争性编程基本主题的精彩分步教程.  |
...
| ★★☆ | [How to Win Coding Competitions: Secrets of Champions](https://www.edx.org/course/how-to-win-coding-competitions-secrets-of-champions-0)  |  ITMO 大学关于 edX 上的竞争性编码的课程.|
...
| ★★★ | [MIT SMA 5503: Introduction to Algorithms](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-046j-introduction-to-algorithms-sma-5503-fall-2005/)  | 该课程由 Charles Leiserson 教授（算法导论的合著者之一）和 Erik Demaine 教授（一位在数据科学领域取得显着突破的杰出教授）讲授，提供了很好的材料，并伴随着直观而全面的分析.  |
| ★★☆ | [UIUC Algorithm Course](http://jeffe.cs.illinois.edu/teaching/algorithms/)  | 讲义、作业、考试和讨论题涵盖了广泛的算法主题 |
...
| ★★☆ | [Algorithm Design](http://amzn.to/VjhioK) , 作者：Jon Kleinberg 和 Éva Tardos | 本书围绕设计算法的技术展开. 它组织良好，并以清晰易懂的语言编写. 每章都附有实际示例和有用的练习. 网络流量一章得到了很多人的高度评价.  ... 教科书随附的讲座幻灯片可在其上找到 [official website](http://www.cs.princeton.edu/~wayne/kleinberg-tardos/). |
...
| ★★★ | [Algorithms](https://jeffe.cs.illinois.edu/teaching/algorithms/) ，杰夫·埃里克森 | 自行出版的教科书的免费电子版，在 CC by 4.0 下获得许可. 这是一本写得很好的书，来自伊利诺伊大学理论计算机科学课程的讲义. 涵盖回溯、动态规划、贪婪的主要范式，特别是深度图.  |

### Books for Mathematics

 |  ☆ | 姓名 | 说明 |
| --- | --- | --- |
| ★★☆ | [Discrete Mathematics and Its Applications](https://www.amazon.com/Discrete-Mathematics-Applications-Kenneth-Rosen/dp/0072899050) , 肯尼斯 H. 罗森 | 离散数学与竞争性编程密切相关. 本书提供了关于广泛主题的综合材料，包括：逻辑和证明、集合、函数、序列、矩阵、数论、递归、计数、概率、图、树和布尔 Alegra 仅举几例.  |
...
| ★★☆ | [Linear Algebra and Its Applications](https://www.amazon.com/Linear-Algebra-Its-Applications-5th/dp/032198238X/ref=sr_1_1?ie=UTF8&qid=1455475253&sr=8-1&keywords=Linear+Algebra+and+Its+Applications) ，作者：David C. Lay、Steven R. Lay、Judi J. McDonald | 这本书在弥合物理系统（对于科学家和工程师）和抽象系统（对于数学家）之间的差距方面做得非常出色.  |
...
&gt; 良好的在线评委系统/竞赛平台可供练习.
 ...
 |  ☆ | 姓名 | 说明 |
| --- | --- | --- |
| ★★★ | [Codeforces](http://codeforces.com/)  |  Codeforces 是最流行的竞赛平台之一，如果不是的话. 目前由萨拉托夫州立大学维护，它以定期比赛和无数令人敬畏的原创问题为特色. 此外，每场比赛都会提供由作者自己编写的即时有用的教程（通常）.  Codeforces 还拥有一个强大且引人入胜的社区. 总而言之，在这里确实会得到极大的学习和提高.  |
| ★★★ | [Topcoder](https://www.topcoder.com/)  |  Topcoder 成立于 2001 年.历史悠久，被认为是技术竞赛中最负盛名的组织之一. 数百个 SRM 产生了丰富的问题​​集. 这里的问题通常比其他问题更具挑战性，因此 Topcoder 吸引了许多精英程序员. 一年一度的 Topcoder Open (TCO) 也是一个广泛讨论的活动.  |
...
| ★★☆ | [CodeChef](https://www.codechef.com/)  |  CodeChef 是 Directi 的一项非盈利教育计划. 它是一个具有全球竞争力的编程平台，拥有庞大的程序员社区，可帮助学生和专业人士测试和提高他们的编码技能. 其目标是为学生和专业软件开发人员提供一个实践、竞争和改进的平台. 除此之外，它的目的是在学生年轻时接触他们，并在印度灌输编程文化.  |
...
| ★★☆ | [Aizu Online Judge](http://judge.u-aizu.ac.jp/onlinejudge/index.jsp)  | 会津在线评委是会津大学主办的竞赛平台和题库. 它在日本的编程比赛中有很多很大的问题.  |
...
| ★★☆ | [Topcoder problem archive](https://community.topcoder.com/tc?module=ProblemArchive)  | 具有类别和复杂性级别的问题列表 |
...
| ★★☆ | [C++ Tricks - Codeforces](http://codeforces.com/blog/entry/15643) ... [What are some cool C++ tricks to use in a programming contest? - Quora](https://www.quora.com/Competitive-Programming/What-are-some-cool-C++-tricks-to-use-in-a-programming-contest)  | 用于竞争性编程的大量 C++ 技巧. 请注意，有些应谨慎使用.  |
...
| ★☆☆ | [C++11 FAQ (English, Chinese, Russian, Japanese, Korean)](http://www.stroustrup.com/C++11FAQ.html)  | 由 C++ 的创建者 Bjarne Stroustrup 收集和编写的有关 C++11 的常见问题解答列表.  |
...
### IDEs
 ...
 |  ☆ | 姓名 | 平台 | 说明 |
| --- | --- | --- | --- |
| ★★★ | [Vim](https://www.vim.org/download.php)  |  CLI / 跨平台 |  Vim 是高级程序员中最受欢迎的文本编辑器之一. 它允许仅通过击键就可以非常有效地完成文本编辑.  Vim 还具有高度的可配置性、可扩展性，并且与 shell（命令行）集成得非常好.  Vim 唯一的挫折是它对初学者有很高的学习曲线.  |
| ★★★ | [Emacs](https://www.gnu.org/software/emacs/download.html)  |  CLI / 跨平台 |  Emacs 是另一种流行的文本编辑器（或者更准确地说是开发环境）. 由于“Vim 与 Emacs”的流行，关于“Vim 与 Emacs”的争论不断被提起. 基本上 Emacs 不仅仅是一个文本编辑器. 它具有文件管理器、Web 浏览器、邮件客户端和新闻客户端等插件，允许用户直接在 Emacs 中执行这些任务.  Emacs 因此“更重”，但可以说对于初学者来说，它的学习曲线相对容易一些.  |
...
| ★★★ | [IntelliJ IDEA](https://www.jetbrains.com/idea/#chooseYourEdition)  |  GUI / 跨平台 |  IntelliJ IDEA 无疑是 Java 的最佳 IDE 之一. 大多数使用 Java 作为主要语言的竞争程序员都使用它. 一定要退房 [CHelper](https://plugins.jetbrains.com/plugin/7091-chelper) ，一个为编程比赛编写的非常方便的插件.  |
| ★★☆ | [Sublime Text](https://www.sublimetext.com/3)  |  GUI / 跨平台 |  Sublime Text 是一个非凡的文本编辑器. 它拥有强大且创新的功能，例如多个插入符号、小地图和命令面板，吸引了强大且引人入胜的社区.  Sublime Text 是高度可扩展的，所以一定要 [Package Control](https://packagecontrol.io/) 安装并探索可能是最大的插件目录之一！  |
| ★★☆ | [Eclipse](https://www.eclipse.org/downloads/)  |  GUI / 跨平台 |  Eclipse 是另一个很好的 Java IDE. 它是 Intellij IDEA 的一个不错的替代品（按照今天的标准，它比 IDEA 差一点）. 有时竞赛出于某种原因仅提供 Eclipse，因此这可能是尝试和使用 Eclipse 的一个很好的激励.  |
| ★★☆ | [CLion](https://www.jetbrains.com/clion/download/)  |  GUI / 跨平台 | 由 JetBrains 生产的 CLion - 与开发 Intellij IDEA 的公司是同一家公司，是一个强大的 C++ IDE. 提供免费的教育许可证，或者您可以试用它们 [EAP (Early Access Program)](https://confluence.jetbrains.com/display/CLION/Early+Access+Program) 截至 2018 年 4 月，它仍然是免费的.您可能需要关闭其代码检查功能，因为它会导致相当多的延迟.  |
