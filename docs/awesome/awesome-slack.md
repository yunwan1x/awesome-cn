...
## What's Slack
 &gt; Slack 是一个团队交流的平台：一切都集中在一个地方，可立即搜索，无论您走到哪里都可以使用.  *- slack.com*
...
## Contribute
您的贡献和建议是 :heart: 欢迎. 确保阅读 [guidelines](https://github.com/filipelinhares/awesome-slack/blob/master/CONTRIBUTING.md) 第一的.
