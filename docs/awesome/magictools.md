...
- :moneybag: [FilterForge](https://www.filterforge.com/) - Adob​​e Photoshop 插件，可让您构建自己的滤镜。
...
- :free: [NodeBox](https://www.nodebox.net/) - 一系列用于创建衍生式设计的 Python 工具。
...
- :free: [Boardgamizer](http://www.boardgamizer.com/) - 棋盘游戏设计理念生成器。
