...
#### Frameworks
 ...
 - [Mozilla WebThings](https://iot.mozilla.org/) - 一个通过网络监控和控制设备的开放平台.
...
#### Libraries and Tools
 ...
 - [Cylon.js](http://cylonjs.com/)  - Cylon.js 是一个用于机器人、物理计算和物联网的 JavaScript 框架. 它使指挥机器人和设备变得非常容易.
...
可扩展消息和呈现协议 (XMPP) 是一种基于 XML（可扩展标记语言）的面向消息中间件的通信协议.  —— [Wikipedia](https://en.wikipedia.org/wiki/XMPP)
 ...
 &gt; 它支持在任何两个或多个网络实体之间近乎实时地交换结构化但可扩展的数据. 该协议设计为可扩展，还用于发布-订阅系统、VoIP 信令、视频、文件传输、游戏、物联网 (IoT) 应用程序（例如智能电网）和社交网络服务.
