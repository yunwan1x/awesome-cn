...
- [TensorFlow Quantum](https://www.tensorflow.org/quantum) - 一个量子机器学习库，它集成了 Cirq 和 TensorFlow，用于经典或量子数据的混合量子经典模型的原型设计.
...
- [Classical and Quantum Computation](https://books.google.com.au/books/about/Classical_and_Quantum_Computation.html?id=TrMposZZ0MQC&redir_esc=y) - 经典和量子计算的基础介绍.
