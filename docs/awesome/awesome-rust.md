...
* [habitat](https://github.com/habitat-sh/habitat) — 由 [Chef](https://www.chef.io/) 构建、部署和管理应用程序.
...
* [iced-rs/iced](https://github.com/iced-rs/iced)  — Rust 的跨平台 GUI 库，专注于简单性和类型安全. 灵感来自榆树.
