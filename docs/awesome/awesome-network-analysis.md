...
-   [Complex Networks](https://www.uvm.edu/~pdodds/teaching/courses/2016-01UVM-303/)，作者：彼得·谢里丹·多兹（Peter Sheridan Dodds）（佛蒙特大学，2016年；推特： [@networksvox](https://twitter.com/networksvox)).
...
-[用于网络分析和公开挑战的统计模型的简要历史] [fienberg2012]（_计算与图形统计杂志，2012）.
...
&gt;有关更出色的JavaScript库，请参见 [Awesome JavaScript](https://github.com/sorrycc/awesome-javascript) list.
...
-   [statnet](http://statnet.org/) -许多R网路分析套件背后的专案（[mailing-list](https://mailman.u.washington.edu/mailman/listinfo/statnet_help), [wiki](https://statnet.org/trac)).
...
-   [tidygraph](https://CRAN.R-project.org/package=tidygraph)  -建立图表结构的“整洁”方法. 另请参阅：`ggraph` R软件包.
...
-   [xergm](https://CRAN.R-project.org/package=xergm) -扩展了指数随机图模型（ERGM，GERGM，TERGM，TNAM和REM）.
...
-   [SNA with Stata](http://www.rensecorten.org/index.php/category/sna-with-stata/) -博客记录了netplot Stata软件包的使用.

### Syntaxes

&gt;旨在供多个程序使用的通用图语法.

-   [DOT](http://www.graphviz.org/doc/info/lang.html) -Graphviz软件使用的图形绘图语法.
-   [GEXF](https://gephi.org/gexf/format/) -Gephi软件使用的文件格式.
...
-   [PGF/TikZ](http://www.ctan.org/tex-archive/graphics/pgf/) - [Tandem](https://en.wikipedia.org/wiki/PGF/TikZ) 可以用于在图形用户界面中绘制图形的矢量图形语言的集合 [LaTeX](https://latex-project.org/) 排版环境.
    ...
    -   [TKZ](http://altermundus.com/pages/tkz/index.html) -基于TikZ的软件包.
-   [TLP - Tulip Software Graph Format](http://tulip.labri.fr/TulipDrupal/?q=tlp-file-format) -Tulip软件框架使用的图形语法.
-   [Cypher](http://neo4j.com/docs/stable/cypher-query-lang.html) -图查询语言 [Neo4j](http://neo4j.com/).
...
-   [Interactive and Dynamic Network Visualization in R](http://curleylab.psych.columbia.edu/netviz/) 和JavaScript库（2016年）.
...
-   [Static and Dynamic Network Visualization with R](http://kateto.net/network-visualization) -涵盖igraph，network，ggraph，network，networkD3，ndtv，threejs和visNetwork软件包（2019年）.

## Varia

&gt;不属于其他类别的资源.

-   [+100 herramientas para el análisis de redes sociales](http://www.k-government.com/2016/06/28/100-herramientas-analisis-redes-sna-ars/) -网络分析的各种应用的一长串列表，并用西班牙语进行简短描述.
-   [Awesome graph classification](https://github.com/benedekrozemberczki/awesome-graph-classification) -图形嵌入论文的完整列表，包括标题，作者，论文链接和参考实现.
-   [Awesome community detection](https://github.com/benedekrozemberczki/awesome-community-detection) -社区检测论文的完整列表，包括标题，作者，论文链接和参考实现.
-   [Centrality Measures as a Signature of Roles in Rousseau’s _Les Confessions_](http://yro.ch/centrality-measures-signature-roles-rousseaus-les-confessions/) -分析现实世界中的角色网络.
-   [Cheat Sheet: Social Network Analysis for Humanists](https://cvcedhlab.hypotheses.org/106) -组装和处理网络数据时要记住的基本概念.
-   [Computer Technologies for the Historical Research of Intellectual Networks](https://www.youtube.com/playlist?list=PLz79Il7EOvUJxdQ9r2IefFtr--BNkfOa7) -历史学家的一系列视频，其中包括MartenDüring和Scott Weingart.
-   [Convert Between Graph Formats](http://awesome.cs.jhu.edu/graph-services/convert/) -在线服务，可将多种常见图形格式相互转换.
-   [David Knoke on Network Analysis](https://thesocietypages.org/methods/2015/01/30/david-knoke-on-network-analysis/) -长达20分钟的采访，讨论了网络分析的用途和好处，并借鉴了Knoke对恐怖分子网络的研究.
-   [Glossary of Terms for Statistical Network Models](https://statnet.org/trac/raw-attachment/wiki/Resources/glossary.pdf).
-   [Linton C. Freeman’s Social Network Research Publications](http://moreno.ss.uci.edu/pubs.html)，从1955年至今.
-   [Mapping the Republic of Letters](http://republicofletters.stanford.edu/) -早期现代奖学金研究项目（[underlying software](http://www.densitydesign.org/research/knot/)).
-   [Mixed-Method Approaches to Social Network Analysis](https://www.youtube.com/playlist?list=PL3zdEY084WkQD79mR00RSt8j5RuyPwMJE) -在米德尔塞克斯大学法学院举行的会议视频（2014年）.
-   [Modeling Complex Social Networks: Challenges and Opportunities for Statistical Learning and Inference](https://www.youtube.com/watch?v=1xLjYc7EUEU) -普渡大学的詹妮弗·内维尔（Jennifer Neville）的研讨会演讲视频（2011年）.
-   [NetSciEd - Network Science in Education](https://sites.google.com/a/binghamton.edu/netscied/home) -旨在提高网络素养的国际倡议.
-   (@) [Network Fact](https://twitter.com/networkfact) -有关网络，图论和相关主题的Twitter帐户.
-   [Network Map of Knowledge and Art](https://paolonegrini.wordpress.com/2012/11/19/network-map-of-knowledge-and-art/) -使用SPARQL和Gephi，由DBPedia派生的网络受到谁影响了谁的直接联系.
-   (@) [Network Science](https://twitter.com/Ognyanova/lists/network-science/members) -Twitter帐户的主题列表，由策划 [Katherine Ognyanova](https://twitter.com/Ognyanova).
...
-   [The Networks Network](https://groups.google.com/forum/?hl=en-GB#!forum/the-networks-network) -邮件列表（主要是HNR网络的历史学家）.
-   [New Perspectives for Relational Learning](http://www.birs.ca/events/2015/5-day-workshops/15w5080/videos) -班夫国际研究站（BIRS）的一个研讨会的视频（及更多）（2015年）.
-   [Open Graph protocol](http://ogp.me/) -提出的将任何网页变成“社交图对象”的标准.
-   [Periodic Table of Network Centrality](http://schochastics.net/sna/periodic.html) -中心指数的交互式元素周期表.
-   [Picking Sides](https://codeandculture.wordpress.com/2015/04/03/picking-sides/) -各个州和非州大国之间的中东联盟政治网络中的社区发现（[updated version](https://gist.github.com/briatte/c6df2f855afb4eb142e6)).
-   [Plan interactif du métro](http://www.jeromecukier.net/projects/metro/map.html) -使用d3.js以法语绘制的巴黎地铁网络的交互式可视化.
-   [Psych Networks](http://psych-networks.com/) -包含新闻，参考资料和 [tutorials](https://psych-networks.com/tutorials/) 关于心理数据的网络建模.
...
-   [(Psychological) Network Analysis Workshops](http://eiko-fried.com/network-workshop/) -使用R进行的为期3天的心理网络分析研讨会.
-   [Should I do Social Network Analysis?](https://cvcedhlab.hypotheses.org/125).
-   [The Small World of Psychopathology](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0027407) -关于精神病症状如何相互联系的论文（[code, data and graphs](https://sites.google.com/site/dsmgraphs/Home/files)).
-   [Social Network Analysis in DBpedia](http://othes.univie.ac.at/12285/1/2010-10-14_0703857.pdf) -高度讲授硕士的论文，展示了如何使用SPARQL和Pajek.
-   [SNA-DE Mailing-List](https://dlist.server.uni-frankfurt.de/mailman/listinfo/sna-de)， 在德国.
-   [SPARQL for R Tutorial - Hollywood Social Network Analysis](http://semanticweb.cs.vu.nl/R/sparql_hollywood/sparql_hollywood.html) -也使用Gephi.
-   [A Sociology Citation Network](http://nealcaren.web.unc.edu/a-sociology-citation-network/) 和 [A Co-citation Network for Philosophy](https://kieranhealy.org/blog/archives/2013/06/18/a-co-citation-network-for-philosophy/) -科学共引网络的示例.
-   [Using Metadata to Find Paul Revere](https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/) 和 [The Other Ride of Paul Revere: The Brokerage Role in the Making of the American Revolution](http://www.sscnet.ucla.edu/polisci/faculty/chwe/ps269/han.pdf) -网络分析适用于美国革命者.
-   [Visual Complexity. An Exploration on Mapping Complex Networks](http://www.visualcomplexity.com/vc/) -大量漂亮的网络和树形可视化效果（[book](http://www.visualcomplexity.com/vc/book/)，也有中文和法文）.
...
-   [Archaeological Networks](http://archaeologicalnetworks.wordpress.com/) -汤姆·布鲁格曼斯（Tom Brughmans）的博客，主要面向考古学家和历史学家.
-   [Blog Posts About Networks by Aaron Clauset](https://www.cs.unm.edu/~aaron/blog/archives/networks/index.htm).
-   [Blog Posts About Networks by Baptiste Coulmont](http://coulmont.com/index.php?s=r%C3%A9seaux)，法文.
-   [Blog Posts About Networks by Cosma R. Shalizi](http://bactra.org/weblog/cat_networks.html).
-   [Blog Posts About Networks by François Briatte](http://politbistro.hypotheses.org/tag/reseaux)，法文.
-   [Blog Posts About Networks by Katya Ognyanova](http://kateto.net/networks).
-   [Blog Posts About Networks by Pierre Mercklé](http://pierremerckle.fr/category/reseaux/)，法文.
-   [Blog Posts About Networks on the Bad Hessian Blog](http://badhessian.org/category/networks/)，由各种贡献者提供.
-有关以下网络的博客文章： [R-Bloggers](http://www.r-bloggers.com/)，R博客的聚合者：
      -   [Networks](http://www.r-bloggers.com/?s=networks).
      -   [Social Network Analysis](http://www.r-bloggers.com/?s=social+network+analysis).
-   [Cosma R. Shalizi’s Notebooks](http://bactra.org/notebooks) 在与网络相关的主题上，绝对值得在（选择性）详细信息中列出：
...
-丹尼尔·利特尔（Daniel Little）关于社会科学哲学的博客文章：
...
-Martin Grandjean的博客文章（主要是英语和法语）有关（主要是）网络可视化的：
...
-   [Networks Demystified](http://scottbot.net/tag/networks-demystified/)，由Scott B. Weingart撰写的一系列博客文章.
-   [Netze und Netzwerke](http://netzeundnetzwerke.de/)，英语和德语-网络分析历史博客，作者：塞巴斯蒂安·吉斯曼（SebastianGießmann（[old blog](http://www.netzeundnetzwerke.de/old/)).
-   [R / Notes: Networks](http://f.briatte.org/r/category/networks) -弗朗索瓦·布里亚特（FrançoisBriatte）着重于R中的操纵网络的博客文章.
-   [TNT: The Network Thinkers](http://www.thenetworkthinkers.com/) -Valdis Krebs的博客.
-   [Under Roquentin’s Chestnut Tree](https://mboudour.github.io/) -Moses Boudourides的博客，主要是使用Python分析网络.
-Yannick Rochat的英文和法文有关数字人文科学的博客文章：
...
-   [Analyzing Networks of Characters in _Love Actually_](http://varianceexplained.org/r/love-actually-network/) -具有聚类分析和 [Shiny app](https://dgrtwo.shinyapps.io/love-actually-network/) （使用R +闪亮）.
-   [Character Co-Occurrences in Victor Hugo’s _Les Misérables_](http://bokeh.pydata.org/en/latest/docs/gallery/les_mis.html)，以邻接矩阵的形式绘制，以Python（+ Javascript）编写.
-   [Events in the _Game of Thrones_](http://www.jeromecukier.net/projects/agot/events.html) 和 [Places in the _Game of Thrones_](http://www.jeromecukier.net/projects/agot/places.html) - Networked chronologies of character alliances, kills 和 travels in the book series, drawn with d3.js.
-   [Lessons on Exponential Random Graph Modeling from _Grey’s Anatomy_ hook-ups](http://badhessian.org/2012/09/lessons-on-exponential-random-graph-modeling-from-greys-anatomy-hook-ups/) （使用R）.
-   [Network Analysis of Shakespeare’s _Macbeth_](https://mboudour.github.io/2015/10/28/Shakespeare's-Macbeth-Network.html) （使用Python）.
-   [The Network and Trajectories of Transitions among Sentential Co-Occurrences of Characters of Arthur Conan Doyle’s _A Study in Scarlet_](https://mboudour.github.io/2016/04/17/Arthur-Conan-Doyle's-A-Study-in-Scarlet-Network-&-Trajectories.html) （使用Python； [code](https://github.com/mboudour/WordNets/blob/master/ArthurConanDoyle_AStudyInScarlet_Network%26Trajectories.ipynb)).
...
-   [Editing a Normal Science Journal in Social Science](https://journals.openedition.org/bms/595) -创始编辑对_Social Networks_期刊的思考.
-   [The Emergence of Network Science](https://www.cornell.edu/video/emergence-of-network-science) -视频纪录片，史蒂芬·H·斯特罗加兹（Steven H. Strogatz）等人参与.
...
-   [The Invasion of the Physicists](http://www.sciencedirect.com/science/article/pii/S0378873304000309) -如何出现“网络_science_”.
-   [Isolated Social Networkers](http://crookedtimber.org/2005/05/19/isolated-social-networkers/), [Networks 和 Netwars](http://bactra.org/weblog/347.html) 和 [The Inter-Disciplinary Politics of Interdisciplinary Research or, “Hey, That Was My Idea First.”](https://www.cs.unm.edu/~aaron/blog/archives/2005/05/the_interdiscip.htm) -在“网络科学”问世之前流行的一系列博客文章，但涉及与该标题下现在讨论的问题相同的问题.
-   [The ‘New’ Science of Networks](https://www.jstor.org/stable/29737693) -审查2002-2003年出版的网络科学书籍.
-   [Predicting Highly Cited Papers](http://arxiv.org/abs/1310.8220) -对网络科学中下一本高引用论文的预测.
...
-   [A Twenty-First Century Science](http://www.nature.com/nature/journal/v445/n7127/full/445489a.html) -邓肯·沃茨（Duncan J. Watts）的随笔.
-   [What is Network Science?](http://journals.cambridge.org/repo_A88Sa8AHdt4SoI) -最近的_Network Science_期刊的第一篇社论.
...
-   [The Erdös Number Project](http://wwwp.oakland.edu/enp/) -关于数学家之间的合作关系和网络距离的研究项目.
...
-   [The Oracle of Bacon](https://oracleofbacon.org/) -基于 [online game](https://en.wikipedia.org/wiki/Six_Degrees_of_Kevin_Bacon) 导致 [charity](http://www.sixdegrees.org/).
-   [Panel: Six Degrees of Separation](https://www.cornell.edu/video/six-degrees-of-separation-panel) -康奈尔大学会议视频，由邓肯·沃茨，史蒂芬·H·斯特罗加茨，乔恩·克莱恩伯格和其他发言人主持.
-   [Patterns in the Ivy: The Small World of Metal](http://badhessian.org/2013/09/patterns-in-the-ivy-the-small-world-of-metal/) -基于金属艺术家和乐队的双模网络分析的示例.
-   [Six Degrees of Francis Bacon](http://sixdegreesoffrancisbacon.com/) -记录良好的早期现代历史网络的交互式可视化.
...
-   [L’analyse des graphes bipartis](https://halshs.archives-ouvertes.fr/FMR/halshs-00794976)，法文（2013）.
-   [Basic Notions for the Analysis of Large Two-mode Networks](http://www.sciencedirect.com/science/article/pii/S0378873307000494)  ([preprint](https://www-complexnetworks.lip6.fr/~latapy/Publis/socnet07.pdf), [related code](https://www-complexnetworks.lip6.fr/~latapy/Bip/) ;  _Social Networks_，2008年）.
...
在法律允许的范围内，此列表的作者-按时间顺序排列： [François Briatte](http://f.briatte.org/), [Ian McCulloh](https://www.linkedin.com/in/mcculloh), [Aditya Khanna](http://home.uchicago.edu/~khanna7), [Manlio De Domenico](https://comunelab.fbk.eu/manlio/)，帕特里克·卡明斯基（Patrick Kaminski）， [Ericka Menchen-Trevino](http://www.ericka.cc/), [Tam-Kien Duong](https://github.com/taniki), [Jeremy Foote](https://github.com/jdfoote), [Catherine Cramer](http://nysci.org/nysci_people/catherine-cramer/), [Andrej Mrvar](http://mrvar.fdv.uni-lj.si/), [Patrick Doreian](http://patrickdoreian.com/), [Vladimir Batagelj](http://vladowiki.fmf.uni-lj.si/doku.php?id=vlado)，埃里克·琼斯（Eric C. Jones），奥尔登·克洛夫达尔（Alden S.Klovdahl）， [James Fairbanks](http://www.jpfairbanks.net/), [Danielle Varda](http://www.ucdenver.edu/academics/colleges/SPA/FacultyStaff/Faculty/Pages/DanielleVarda.aspx), [Andrew Pitts](https://twitter.com/和pitts), [Roman Bartusiak](http://riomus.ml/), [Koustuv Sinha](http://koustuvsinha.github.io/), [Mohsen Mosleh](http://mohsenmosleh.com/), [S和ro Sousa](https://github.com/s和rofsousa), [Jean-Baptiste Pressac](https://github.com/JBPressac), [Patrick Connolly](https://github.com/patcon), [Hristo Georgiev](http://hristog.github.io/), [Tiago Azevedo](http://github.com/tjiagoM), [Luis Miguel Montilla](https://twitter.com/luismmontilla), [Keith Turner](https://github.com/keith-turner), [S和ra Becker](https://github.com/s和ravizmad), [Benedek Rozemberczki](https://github.com/benedekrozemberczki), [Xing Han Lu](https://xinghanlu.com/), [Vincent Labatut](https://cv.archives-ouvertes.fr/vlabatut), [David Schoch](http://mr.schochastics.net/), [Jaewon Chung](https://github.com/j1c) [Benedek Rozemberczki](https://github.com/benedekrozemberczki) 和 [Alex Loftus](https://github.com/loftusa) – have waived all copyright 和 related or neighboring rights to this work.

谢谢 [Robert J. Ackl和](https://github.com/rjackl和), [Laurent Beauguitte](https://cv.archives-ouvertes.fr/laurent-beauguitte), [Patrick Connolly](http://nodescription.net/), [Michael Dorman](http://geobgu.xyz/), [Colin Fay](https://colinfay.me/), [Marc Fl和reau](http://www.history.upenn.edu/people/faculty/marc-fl和reau), [Eiko Fried](http://eiko-fried.com/), [Christopher Steven Marcum](http://www.chrismarcum.com/), [Wouter de Nooy](https://www.uva.nl/profiel/n/o/w.denooy/w.denooy.html), [Katya Ognyanova](http://kateto.net/), [Camille Roth](http://camille.roth.free.fr/), [Cosma Shalizi](http://www.stat.cmu.edu/~cshalizi/), [Tom A.B. Snijders](https://www.stats.ox.ac.uk/~snijders/), [Chris Watson](https://profiles.bu.edu/Christopher.Watson) 和 [Tim A. Wheeler](https://github.com/tawheeler)，他帮助查找了此列表中的一些很棒的资源.
