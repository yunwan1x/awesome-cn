...
* [Apache Kudu](http://kudu.apache.org/) - Hadoop 的存储层可对快速数据进行快速分析。
...
* [ActorDB](https://github.com/biokoda/actordb) - 分布式 SQL 数据库，具有 KV 存储的可扩展性，同时保持关系数据库的查询能力。
...
* [CartoDB](https://github.com/CartoDB/cartodb) - 用于地理空间数据库的开源或免费增值托管，具有强大的前端编辑功能和强大的 API。
