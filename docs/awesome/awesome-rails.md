...
&gt; 与 Ruby on Rails 相关的精彩内容的精选列表 [![Awesome](https://cdn.combinatronics.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
&gt; 提示：您可以在以下位置找到包括 Rails 工作在内的远程工作板列表 [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards)
...
- [askaway](https://github.com/askaway/askaway) - 专门用于政治的问答应用程序（使用 Rails 4.1）.
- [autolab](https://github.com/autolab/Autolab)  - 课程管理应用程序（使用 Rails 4.2）.  —— [:earth_africa:](https://autolabproject.com/)
- [beatstream](https://github.com/Darep/Beatstream) - 音乐流媒体应用程序 - 使用 Rails 3.2
- [bike_index](https://github.com/bikeindex/bike_index)  - 自行车注册跟踪应用程序（使用 Rails 4.2）.  —— [:earth_africa:](https://bikeindex.org)
- [blackCandy](https://github.com/aidewoode/black_candy) - 音乐流媒体应用程序（使用 Rails 6.0）.
- [brimir](https://github.com/ivaldi/brimir)  - 电子邮件帮助台应用程序（使用 Rails 5.2）.  （存档）.
- [calagator](https://github.com/calagator/calagator) - 社区日历应用程序（使用 Rails 4.2）.
...
- [chatwoot](https://github.com/chatwoot/chatwoot) - 一个简单而优雅的实时聊天软件（使用 Rails 6.0）.
...
- [crabgrass-core](https://0xacab.org/liberate/crabgrass) - 激进团体的协作平台（使用 Rails 4.2）.
- [crowdAI](https://github.com/crowdAI/crowdai)  - 用于数据科学挑战的应用程序（使用 Rails 5.2）.  —— [:earth_africa:](https://www.crowdai.org/)
- [crowdtiltOpen](https://github.com/Crowdtilt/CrowdtiltOpen) - 众筹平台 - 使用 Rails 3.2
- [cw-ovp](https://github.com/x1wins/CW-OVP) - 使用网站上的 FFMPEG（使用 Rails 6.0）将视频打包为 *.m3u8，用于 HLS（HTTP 实时流媒体）.
...
- [dgidb](https://github.com/dgidb/dgidb) - 药物基因交互平台 - 使用 Rails 5.1
...
- [fromthepage](https://github.com/benwbrum/fromthepage)  - 一个类似于 wiki 的应用程序，用于手写文档的众包转录（使用 Rails 4.1）.  —— [:earth_africa:](https://www.fromthepage.com/)
...
- [hitobito](https://github.com/hitobito/hitobito)  - 一个事件组织应用程序（使用 Rails 4.2）.  —— [:earth_africa:](https://hitobito.com/en)
...
- [otwarchive](https://github.com/otwcode/otwarchive) - 一个面向粉丝的社交网络应用程序 - 使用 Rails 5.1 - [:earth_africa:](https://archiveofourown.org)
- [passwordPusher](https://github.com/pglombardo/PasswordPusher)  - 密码传送应用程序（使用 Rails 4.2）.  —— [:earth_africa:](https://pwpush.com)
- [peatio](https://github.com/peatio/peatio) - 加密货币兑换应用程序（使用 Rails 4.0）.
- [planningalerts-app](https://github.com/openaustralia/planningalerts)  - 计划中的应用程序跟踪应用程序（使用 Rails 5.2）.  —— [:earth_africa:](https://www.planningalerts.org.au)
...
- [racing_on_rails](https://github.com/scottwillson/racing_on_rails) - 自行车比赛组织应用程序（使用 Rails 5.2）.
...
- [rubygems.org](https://github.com/rubygems/rubygems.org)  - gem 托管平台（使用 Rails 6.0）.  —— [:earth_africa:](https://rubygems.org)
...
- [activemodel](https://github.com/rails/rails/tree/main/activemodel) - 一个 gem 来定义一组在 Rails 应用程序中的模型类中使用的接口 [:red_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
- [activerecord](https://github.com/rails/rails/tree/main/activerecord) - 在 Rails 应用程序中连接模型类与关系数据库的 gem [:red_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
...
- [aggregate_root](https://github.com/RailsEventStore/rails_event_store/tree/master/aggregate_root) - 处理事件源的宝石. [:red_circle:](https://rubygems.org/gems/aggregate_root)
- [ahoy_email](https://github.com/ankane/ahoy_email) - 提供邮件分析的工具. [:red_circle:](https://rubygems.org/gems/ahoy_email)
- [algoliasearch-rails](https://github.com/algolia/algoliasearch-rails) - 集成 Algolia 搜索的宝石. [:red_circle:](https://rubygems.org/gems/algoliasearch-rails)
- [annotate](https://github.com/ctran/annotate_models) - 使用架构和路由信息注释 rails 类的 gem. [:red_circle:](https://rubygems.org/gems/annotate)
...
- [brakeman](https://github.com/presidentbeef/brakeman) - 针对安全漏洞扫描代码的 gem. [:red_circle:](https://rubygems.org/gems/brakeman)
- [breadcrumbs_on_rails](https://github.com/weppos/breadcrumbs_on_rails) - 创建和管理面包屑式导航的宝石. [:red_circle:](https://rubygems.org/gems/breadcrumbs_on_rails)
...
- [hotwire-rails](https://github.com/hotwired/hotwire-rails) - 在 Rails 应用程序中集成 Hotwire 的宝石. [:red_circle:](https://rubygems.org/gems/hotwire-rails)
- [image_optim_rails](https://github.com/toy/image_optim_rails) - 处理图像优化的宝石. [:red_circle:](https://rubygems.org/gems/image_optim_rails)
- [js-routes](https://github.com/railsware/js-routes) - 将所有 Rails 路由生成为 JavaScript 帮助程序的工具. [:red_circle:](https://rubygems.org/gems/js-routes)
...
- [money-rails](https://github.com/RubyMoney/money-rails) - 在 Rails 应用程序中集成 Money gem 的 gem. [:red_circle:](https://rubygems.org/gems/money-rails)
- [paloma](https://github.com/gnclmorais/paloma) - 在 Rails 应用程序中管理特定于页面的 JavaScript 的 gem. [:red_circle:](https://rubygems.org/gems/paloma)
...
- [reform-rails](https://github.com/trailblazer/reform-rails) - 用 Rails 应用程序包装改革 gem（表单验证工具）的 gem. [:red_circle:](https://rubygems.org/gems/reform-rails)
...
- [rodauth-rails](https://github.com/janko/rodauth-rails) - 用于为 Rails 应用程序包装 Rodauth（一种身份验证处理程序）的 gem. [:red_circle:](https://rubygems.org/gems/rodauth-rails)
...
- [select2-rails](https://github.com/argerim/select2-rails) - 在 Rails 应用程序中集成 Select2 库的 gem. [:red_circle:](https://rubygems.org/gems/select2-rails)
...
- [sorbet-rails](https://github.com/chanzuckerberg/sorbet-rails) - 在 Rails 应用程序中集成 Sorbet gem 的 gem. [:red_circle:](https://rubygems.org/gems/sorbet-rails)
- [spree](https://github.com/spree/spree) - 一个开源的电子商务平台. [:red_circle:](https://rubygems.org/gems/spree)
- [spring](https://github.com/rails/spring) - 预加载 Rails 应用程序的宝石. [:red_circle:](https://rubygems.org/gems/spring)
- [sprockets](https://github.com/rails/sprockets) - 用于编译和提供 Web 资产的 gem. [:red_circle:](https://rubygems.org/gems/sprockets)
- [stimulus-rails](https://github.com/hotwired/stimulus-rails) - 在 Rails 应用程序中集成 Stimulus.js 的 gem. [:red_circle:](https://rubygems.org/gems/stimulus-rails)
- [tinymce-rails](https://github.com/spohlenz/tinymce-rails) - 在 Rails 应用程序中集成 Tinymce 的 gem. [:red_circle:](https://rubygems.org/gems/tinymce-rails)
...
- [view_component](https://github.com/github/view_component) - 引入视图组件的宝石. [:red_circle:](https://rubygems.org/gems/view_component)
...
- [rails-template(TristanToye)](https://github.com/TristanToye/rails-template) - MVP Ready Rails - 您下一个 Rails 应用程序的模板
