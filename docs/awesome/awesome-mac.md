...
Any comments, suggestions? [Let us know!](https://github.com/jaywcjlove/awesome-mac/issues) We love PRs :) Please take a look at the [contributing](https://github.com/jaywcjlove/awesome-mac/blob/master/CONTRIBUTING.md) 打开之前的指南. 跟着 [awesome](https://github.com/sindresorhus/awesome) list.
...
* [WWDC](https://github.com/insidegui/WWDC) <i>- The Mac OS unofficial WWDC app.</i> <b>- Mac OS 非官方 WWDC 应用程序。</b> <i>[![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/insidegui/WWDC)</i> <b>[![开源软件][OSS图标] ![免费软件][免费软件图标]](https://github.com/insidegui/WWDC)</b>
...
* [alacritty](https://github.com/jwilm/alacritty) <i>- A cross-platform, GPU-accelerated terminal emulator.</i> <b>- 一个跨平台、GPU 加速的终端仿真器。</b> <i>[![Open-Source Software][OSS Icon]](https://github.com/jwilm/alacritty) ![Freeware][Freeware Icon]</i> <b>[![开源软件][OSS图标]](https://github.com/jwilm/alacritty) ![免费软件][免费软件图标]</b>
...
* [Tabby (formerly Terminus)](https://github.com/Eugeny/tabby) <i>- Free terminal tool, built with TypeScript, heavily inspired by Hyper.</i> <b>- 免费的终端工具，使用 TypeScript 构建，深受 Hyper 的启发。</b> <i>[![Open-Source Software][OSS Icon]](https://github.com/Eugeny/terminus) ![Freeware][Freeware Icon]</i> <b>[![开源软件][OSS图标]](https://github.com/Eugeny/terminus) ![免费软件][免费软件图标]</b>
...
* [Gitbar](https://github.com/Shikkic/gitbar) <i>- Open-source，display Github contribution statistics on your menu bar.</i> <b>- 开源，在你的菜单栏显示 Github 贡献统计。</b> <i>[![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Shikkic/gitbar)</i> <b>[![开源软件][OSS图标] ![免费软件][免费软件图标]](https://github.com/Shikkic/gitbar)</b>
...
* [GitX-dev](https://rowanj.github.io/gitx/) - 叉子 [Pieter's](https://github.com/pieter/gitx) nice git GUI for OS X. Includes branch/tag sidebar and various fixes. [![Open-Source Software][OSS Icon]](https://github.com/rowanj/gitx) ![Freeware][Freeware Icon]
...
* [Vivaldi](https://vivaldi.com) <i>- The browser that puts you in control.</i> <b>- 让您掌控一切的浏览器。</b> <i>[![Open-Source Software][OSS Icon]](https://vivaldi.com/source) ![Freeware][Freeware Icon]</i> <b>[![开源软件][OSS图标]](https://vivaldi.com/source) ![免费软件][免费软件图标]</b>
...
* [ControlPlane](http://www.controlplaneapp.com/) <i>- Manages configuration profiles for your Mac.</i> <b>- 管理 Mac 的配置文件。</b> <i>Determines where you are or what you are doing based on a number of available evidence sources and then automatically reconfigures your Mac based on your preferences.</i><b>根据大量可用的证据来源确定您在哪里或正在做什么，然后根据您的偏好自动重新配置您的 Mac。</b> <i>[![Open-Source Software][OSS Icon]](https://github.com/dustinrue/ControlPlane) ![Freeware][Freeware Icon]</i> <b>[![开源软件][OSS图标]](https://github.com/dustinrue/ControlPlane) ![免费软件][免费软件图标]</b>
