...
此列表是 1000 多人完成的拉取请求、评论、想法和工作的结果. 您也可以通过发送来提供帮助 [Pull Requests](https://github.com/ripienaar/free-for-dev) 添加更多服务或删除其产品已更改或已停用的服务.
...
## Major Cloud Providers
  ...
  * [Google Cloud Platform](https://cloud.google.com)
    ...
    * Compute Engine - 1 个不可抢占的 e2-micro、30GB 硬盘、5GB 快照存储（仅限某些地区）、每月从北美到所有地区目的地（不包括中国和澳大利亚）的 1 GB 网络出口
    * 云存储 - 5GB、1GB 网络出口
     * Cloud Shell - 基于 Web 的 Linux shell/基本 IDE，具有 5GB 的持久存储. 每周限制 60 小时
...
## Source Code Repos
  ...
  * [Bitbucket](https://bitbucket.org/) — 最多 5 个用户的无限公共和私人 Git 存储库，使用 CI/CD 管道
  ...
  * [GitHub](https://github.com/)  — 无限的公共存储库和无限的私有存储库（与无限的合作者）. 除此之外，还提供了一些其他免费服务（还有更多，但我们在这里列出了主要服务）：
       - [CI/CD](https://github.com/features/actions)（公共回购免费，私人回购免费 2000 分钟/月）
       - [Static Website Hosting](https://pages.github.com) （公共回购免费）
       - [Package Hosting & Container Registry](https://github.com/features/packages) （公共存储库免费，500 MB 存储空间和 1GB 带宽之外的 CI/CD 免费用于私人存储库）
       - 项目管理和问题跟踪.
  ...
  * [ionicframework.com](https://ionicframework.com/appflow) - 使用 Ionic 开发应用程序的回购和工具，您也有一个 ionic 回购
...
## APIs, Data and ML
  ...
  * [Apify](https://www.apify.com/)  — 网页抓取和自动化平台，可为任何网站创建 API 并提取数据. 现成的刮板、集成代理和定制解决方案. 免费计划包含每月 5 美元的平台积分.
  ...
  * [GoodData](https://www.gooddata.com/)  - 数据即服务 - 创建交互式且富有洞察力的仪表板. 免费层带有 5 个工作区和 100 MB/工作区. 
  ...
  * [IPTrace](https://iptrace.io) — 一个非常简单的 API，可为您的企业提供可靠且有用的 IP 地理定位数据.
  ...
  * [microlink.io](https://microlink.io/)  – 它将任何网站转换为数据，例如元标签规范化、美容链接预览、抓取功能或屏幕截图即服务. 每天 100 个请求/天免费.
  ...
  * [Postbacks](https://postbacks.io/)  - 稍后请求 HTTP 回调.  8,000 次免费注册请求.
  * [Postman](https://postman.com)  — 使用 API 开发协作平台 Postman 简化工作流程并更快地创建更好的 API. 永远免费使用 Postman App. 邮递员云功能也永久免费，但有一定的限制.
  ...
  * [RequestBin.com](https://requestbin.com)  — 创建一个免费端点，您可以向其发送 HTTP 请求. 发送到该端点的任何 HTTP 请求都将与关联的有效负载和标头一起记录，以便您可以观察来自 Webhook 和其他服务的请求.
  ...
  * [tamber](https://tamber.com)  — 将深度学习驱动的推荐放入您的应用程序中. 免费 5k 每月活跃用户.
 ...
 * [Artifactory](https://jfrog.com/start-free/)  - 一个工件存储库，支持多种包格式，如 Maven、Docker、Cargo、Helm、PyPI、CocoaPods 和 GitLFS. 包括包扫描工具 XRay 和 CI/CD 工具 Pipelines（以前称为 Shippable），每月免费提供 2,000 CI/CD 分钟.
...
## Tools for Teams and Collaboration
  ...
  * [Fibery](https://fibery.io/)  — 互联工作空间平台. 单用户免费，最多 2 GB 磁盘空间.
  * [Filestash](https://www.filestash.app) — 类似 Dropbox 的文件管理器，可连接到一系列协议和平台：S3、FTP、SFTP、Minio、Git、WebDAV、Backblaze、LDAP 等.
  * [flock.com](https://flock.com)  — 为您的团队提供更快捷的沟通方式. 免费无限消息、渠道、用户、应用程序和集成
  ...
  * [hangouts.google.com](https://hangouts.google.com/) — 所有对话的一个地方，免费，需要一个谷歌帐户
  ...
  * [/meet for Slack](https://meetslack.com)  - 通过在任何频道、群组或 DM 中使用 /meet 直接从 Slack 启动 Google 会议. 免费，没有任何限制. 
  ...
  * [Notion](https://www.notion.so/)  - Notion 是一个笔记和协作应用程序，支持降价，还集成了任务、维基和数据库. 该公司将该应用程序描述为用于记笔记、项目管理和任务管理的多合一工作区. 除了跨平台应用程序外，它还可以通过大多数网络浏览器访问.
  ...
  * [Tugboat](https://tugboat.qa)  - 自动和按需预览每个拉取请求. 所有人免费，非营利组织的免费 Nano 层.
  * [whereby.com](https://whereby.com/) — 一键式视频对话，免费（以前称为出现在）
  ...
  * [robocorp.com](https://robocorp.com)  - 用于支持自动化操作的开源堆栈. 免费试用 Cloud 功能并实施简单的自动化. 机器人工作 240 分钟/月，10 次助手运行，100 MB 存储空间.
...
## CMS
  ...
  * [DatoCMS](https://www.datocms.com/)  - 为小型项目提供免费套餐.  DatoCMS 是一个基于 GraphQL 的 CMS. 在较低级别，您每月有 10 万次通话.
  * [Directus](https://directus.io)  — 无头 CMS. 一个完全免费的开源平台，用于管理本地或云中的资产和数据库内容. 没有限制或付费墙.
  * [Forestry.io/](https://forestry.io/)  — 无头 CMS. 为您的编辑提供 Git 的强大功能. 轻松创建和编辑基于 Markdown 的内容. 附带三个免费站点，其中包括 3 个编辑器、即时预览. 与托管在 Netlify/GitHubpages/ 其他地方的博客集成
  * [FrontAid](https://frontaid.io/)  — Headless CMS，将 JSON 内容直接存储在您自己的 Git 存储库中. 无限制.
  * [kontent.ai](https://www.kontent.ai)  - 一个内容即服务平台，可为您提供所有无头 CMS 的好处，同时为营销人员提供支持. 开发者计划为 2 个用户提供无限的项目，每个项目有 2 个环境、500 个内容项、2 种语言以及交付和管理 API，以及自定义元素支持. 更大的计划可满足您的需求.
  ...
  * [sanity.io](https://www.sanity.io/)  – 使用 React 构建的可定制 MIT 许可编辑器为结构化内容托管后端. 无限项目.  3 个用户、2 个数据集、500k API CDN 请求、每个项目免费 5GB 资产
  ...
  * [GraphCMS](https://graphcms.com/)  - 为小型项目提供免费套餐.  GraphQL 第一个 API. 从传统解决方案转向 GraphQL 原生 Headless CMS - 首先提供全渠道内容 API.
...
## Code Quality
  ...
  * [CodeBeat](https://codebeat.co)  — 适用于多种语言的自动化代码审查平台. 与 Slack 和电子邮件集成的公共存储库永久免费.
  ...
  * [Imgbot](https://github.com/marketplace/imgbot)  — Imgbot 是一个友好的机器人，可以优化您的图像并节省您的时间. 优化的图像意味着在不牺牲质量的情况下更小的文件大小. 它对开源免费.
...
## CI and CD
  ...
  * [AccessLint](https://github.com/marketplace/accesslint)  — AccessLint 将自动化的 Web 可访问性测试带入您的开发工作流程. 它对于开源和教育目的是免费的.
  * [appcircle.io](https://appcircle.io)  — 带有在线设备模拟器的适用于 iOS 和 Android 的自动化移动 CI/CD/CT.  20 分钟构建超时（开源为 60 分钟），单并发免费.
  ...
  * [buddy.works](https://buddy.works/) — 包含 5 个免费项目和 1 个并发运行的 CI/CD（每月 120 次执行）
  ...
  * [deployhq.com](https://www.deployhq.com/) — 1 个项目，每天部署 10 次（每月 30 分钟构建）
  * [drone](https://cloud.drone.io/) - Drone Cloud 使开发人员能够跨多个架构运行持续交付管道 - 包括 x86 和 Arm（32 位和 64 位） - 都在一个地方
  ...
  * [scalr.com](https://scalr.com/)  - Terraform 的远程状态和操作后端，具有完整的 CLI 支持、与 OPA 的集成和分层配置模型. 最多 5 个用户免费.
...
## Testing
  ...
  * [Applitools.com](https://applitools.com/)  — 用于 Web、原生移动和桌面应用程序的智能视觉验证. 与几乎所有自动化解决方案（如 Selenium 和 Karma）和远程运行程序（Sauce Labs、浏览器堆栈）集成. 免费开源. 每周检查点有限的单个用户的免费套餐.
  ...
  * [tesults.com](https://www.tesults.com)  — 测试结果报告和测试用例管理. 与流行的测试框架集成. 开源软件开发人员、个人、教育工作者和小型团队入门可以要求除基本免费项目之外的折扣和免费产品.
...
## Security and PKI
  ...
  * [Bridgecrew](https://bridgecrew.io/) — 由开源工具提供支持的基础设施即代码 (IaC) 安全性 — [Checkov](https://github.com/bridgecrewio/checkov) . 核心 Bridgecrew 平台最多可免费获得 50 个 IaC 资源.
  * [cloudsploit.com](https://cloudsploit.com/) — 亚马逊网络服务 (AWS) 安全与合规审计和监控
  * [Cmd](https://cmd.com/) — 安全平台为您的云或数据中心中的每个 Linux 实例提供实时访问控制和动态策略执行
  * [CodeNotary.io](https://www.codenotary.io/) — 具有不可磨灭的证明的开源平台，可对代码、文件、目录或容器进行公证
  * [crypteron.com](https://www.crypteron.com/) — 云优先、开发人员友好的安全平台可防止 .NET 和 Java 应用程序中的数据泄露
  * [Dependabot](https://dependabot.com/) Ruby、JavaScript、Python、PHP、Elixir、Rust、Java（Maven 和 Gradle）、.NET、Go、Elm、Docker、Terraform、Git 子模块和 GitHub 操作的自动依赖项更新.
...
## Management System
  ...
  * [Miradore](https://miradore.com)  — 设备管理服务. 随时了解您的设备队列并免费保护无限数量的设备. 免费计划提供基本功能.
  * [moss.sh](https://moss.sh)  - 帮助开发人员部署和管理他们的 Web 应用程序和服务器. 每月最多免费 25 个 git 部署
  * [runcloud.io](https://runcloud.io/)  - 主要关注PHP项目的服务器管理. 最多 1 个服务器免费.
...
## Messaging
  ...
  * [scaledrone.com](https://www.scaledrone.com/)  — 实时消息服务. 每天最多 20 个同时连接和 100,000 个事件免费
  * [synadia.com](https://synadia.com/ngs) — [NATS.io](https://nats.io) 作为一种服务. 全球、AWS、GCP 和 Azure. 永久免费，每月 4k 消息大小、50 个活动连接和 5GB 数据.
...
## Monitoring
  ...
  * [Pingmeter.com](https://pingmeter.com/)  - 5 个正常运行时间监视器，间隔为 10 分钟. 监控 SSH、HTTP、HTTPS 和任何自定义 TCP 端口.
  ...
  * [appneta.com](https://www.appneta.com/) — 免费并保留 1 小时数据
  ...
  * [economize.cloud](https://economize.cloud)  — Economize 通过组织云资源、优化和报告这些资源来帮助揭开云基础架构成本的神秘面纱. 每月在 Google Cloud Platform 上消费高达 5000 美元即可免费.
  ...
  * [opsgenie.com](https://www.opsgenie.com/)  — 用于操作永远在线服务的强大警报和随叫随到管理. 最多 5 个用户免费.
  ...
  * [stathat.com](https://www.stathat.com/) — 开始使用 10 项免费统计数据，无到期日
  ...
  * [asayer.io](https://asayer.io/pricing.html)  — openreplay 的托管版本，开源会话重放（替代 FullStory 和 LogRocket）. 每月 1000 次免费会话，保留 14 天
  ...
  * [Squadcast.com](https://squadcast.com)  - Squadcast 是一种端到端事件管理软件，旨在帮助您推广 SRE 最佳实践. 免费永久计划可供多达 10 位用户使用.
...
## Email
  ...
  * [Antideo](https://www.antideo.com)  — 每小时 10 个 API 请求，用于免费级别的电子邮件验证、IP 和电话号码验证. 无需信用卡.
  ...
  * [Buttondown](https://buttondown.email/)  — 通讯服务. 最多 1,000 名订阅者免费
  * [CloudMailin](https://www.cloudmailin.com/) - 通过 HTTP POST 和事务性出站收到的电子邮件 - 每月 10,000 封免费电子邮件
  ...
  * [Email Temporanee](https://emailtemporanee.com/)  - 易于使用的免费无限一次性临时电子邮件地址（临时电子邮件）. 即使您可以设置日期，也会自动过期.
  ...
  * [inboxkitten.com](https://inboxkitten.com/)  - 免费的临时/一次性电子邮件收件箱，最多可自动删除 3 天电子邮件. 开源，可以自托管.
  ...
  * [mailmenot.io](http://mailmenot.io) — 免费的一次性临时电子邮件服务，可以添加多个电子邮件地址
  ...
  * [phplist.com](https://phplist.com/) — 托管版本允许 300 封电子邮件/月免费
  ...
  * [testmail.app](https://testmail.app/)  - 使用无限邮箱和 GraphQL API 自动化端到端电子邮件测试.  100 封电子邮件/月永久免费，无限免费开源.
  ...
  * [Zoho](https://www.zoho.com)  — 最初是电子邮件提供商，但现在提供一套服务，其中一些有免费计划. 有免费计划的服务列表：
     - [Email](https://zoho.com/mail)  5 位用户免费.  5GB/用户和 25 MB 附件限制，1 个域.
     ...
     - [Meeting](https://zoho.com/meeting) — 最多 3 名与会者和 10 名网络研讨会与会者的会议.
     ...
     - [Desk](https://zoho.com/desk) — Customer Support management with 3 agents and private knowledge base, email tickets. Integrates with [Assist](https://zoho.com/assist) 适用于 1 名远程技术人员和 5 台无人值守计算机.
...
## Font
  ...
  * [dafont](https://www.dafont.com/) - 本网站上显示的字体是其作者的财产，可以是免费软件、共享软件、演示版本或公共领域.
  * [Everything Fonts](https://everythingfonts.com/)  - 提供多种工具；  @font-face、单位转换器、字体提示器和字体提交器.
  * [Font Squirrel](https://www.fontsquirrel.com/)  - 获得商业作品许可的免费字体. 手工选择这些字体并以易于使用的格式呈现它们.
  * [Google Fonts](https://fonts.google.com/) - 许多免费字体可通过下载或 Google CDN 链接轻松快速地安装在网站中.
...
## Forms
  ...
  * [99inbound.com](https://www.99inbound.com/)  - 构建表单并在线共享. 每次提交都会收到一封电子邮件或 Slack 消息. 免费计划有 2 个表格，每月 100 个条目，基本电子邮件和 Slack.
  ...
  * [formingo.co](https://www.formingo.co/) - 静态网站的简单 HTML 表单，无需注册帐户即可免费使用. 免费计划允许每月 500 次提交，可自定义回复电子邮件地址.
  ...
  * [Formspree.io](https://formspree.io/)  — 使用 HTTP POST 请求发送电子邮件. 免费等级限制为每个表单每月 50 次提交.
  ...
  * [Hyperforms.app](https://hyperforms.app/)  — 在几秒钟内创建电子邮件表单等，无需后端代码. 个人帐户每月最多可让您免费提交 50 份表格.
  ...
  * [Web3Forms](https://web3forms.com)  - 静态和 JAMStack 网站的联系表格，无需编写后端代码. 免费计划允许每月无限表格、无限域名和 250 次提交.
...
## CDN and Protection
  ...
  * [Microsoft Ajax](https://docs.microsoft.com/en-us/aspnet/ajax/cdn/overview) — Microsoft Ajax CDN 托管流行的第三方 JavaScript 库，例如 jQuery，并使您能够轻松地将它们添加到您的 Web 应用程序
  ...
  * [UNPKG](https://unpkg.com/) — 用于 npm 上所有内容的 CDN
...
## PaaS
  ...
  * [Glitch](https://glitch.com/)  — 免费的公共托管，具有代码共享和实时协作等功能. 免费计划有 1000 小时/月的限制.
  ...
  * [Koyeb](https://www.koyeb.com)  - Koyeb 是一个对开发人员友好的无服务器平台，用于在全球部署应用程序. 通过基于 git 的部署、本机自动缩放、全球边缘网络以及内置服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API.  Koyeb 提供两种 nano 服务，以通过其永久免费层运行您的应用程序，并使用免费资源赞助开源项目.
  * [Railway](https://railway.app)  - 铁路是一个基础设施平台，您可以在其中配置基础设施，在本地使用该基础设施进行开发，然后部署到云端.  1GB 磁盘，512 MB RAM，每月免费使用量限制为 5 美元.
...
## BaaS
  ...
  * [backendless.com](https://backendless.com/) — Mobile 和 Web Baas，免费提供 1 GB 文件存储，推送通知 50000/月，以及表中的 1000 个数据对象.
  ...
  * [darklang.com](https://darklang.com/)  - 托管语言与编辑器和基础设施相结合.  Beta 版期间免费，Beta 版后计划提供慷慨的免费套餐.
  ...
  * [Flutter Flow](https://flutterflow.io)  — 无需编写任何代码即可构建您的 Flutter App UI. 还有一个 Firebase 集成. 免费计划包括对 UI Builder 和免费模板的完全访问.
  * [getstream.io](https://getstream.io/) — 在几小时而不是几周内构建可扩展的新闻源、活动流、聊天和消息传递
  * [hasura.io](https://hasura.io/)  — Hasura 将您现有的数据库扩展到任何托管的位置，并提供即时 GraphQL API，可以安全地访问 Web、移动和数据集成工作负载. 每月 1GB 的数据传输免费.
...
## Web Hosting
  ...
  * [render.com](https://render.com) — 使用免费 SSL、全球 CDN、专用网络、从 Git 自动部署以及完全免费的 Web 服务、数据库和静态网页计划来构建和运行应用程序和站点的统一云.
...
## DNS
  ...
  * [duckdns.org](https://www.duckdns.org/)  — 免费 DDNS，免费层中最多包含 5 个域. 带有各种设置的配置指南.
  ...
  * [selectel.com](https://selectel.com/services/dns/) — 无限记录、任播的免费 DNS 托管
...
## IaaS
  ...
  * [backblaze.com](https://www.backblaze.com/b2/)  — Backblaze B2 云存储. 免费的 10 GB（类 Amazon S3）对象存储无限时间
...
## DBaaS
   ...
   * [bit.io](https://bit.io)  — PostgreSQL 管理的数据库服务. 无限回购，10GB 存储空间，10M 查询行/月.
   ...
   * [redsmin.com](https://www.redsmin.com/) — Redis 在线实时监控和管理服务，免费监控1 个Redis 实例
   ...
   * [Planetscale](https://planetscale.com/) - PlanetScale 是一个兼容 MySQL 的无服务器数据库平台，由 Vitess 提供支持，3 个数据库免费提供 10GB 存储空间，每个数据库每月读取 1 亿行，每个数据库每月写入 1000 万行.
   * [YugabyteDB](http://cloud.yugabyte.com)  - YugabyteDB 是一个与 PostgresSQL 兼容的分布式 SQL 数据库. 云免费层是一个 2 vCPU、4GB RAM、10GB 磁盘.


## Tunneling, WebRTC, Web Socket Servers and Other Routers

   * [conveyor.cloud](https://conveyor.cloud/) — Visual Studio 扩展，用于将 IIS Express 公开到本地网络或通过公共 URL 的隧道公开.
   ...
   * [localtunnel](https://theboroer.github.io/localtunnel-www/)  — 通过隧道将本地运行的服务器暴露给公共 URL. 免费托管版本，以及 [open source](https://github.com/localtunnel/localtunnel).
   * [ngrok.com](https://ngrok.com/) — 通过隧道将本地运行的服务器暴露给公共 URL.
   * [Radmin VPN](https://www.radmin-vpn.com/)  — 通过 VPN 将多台计算机连接在一起，支持类似 LAN 的网络. 无限同行.  （Hamachi 替代品）
   ...
   * [ZeroTier](https://www.zerotier.com)  — FOSS 管理的虚拟以太网即服务. 免费计划的 100 个客户端的无限制端到端加密网络. 桌面/移动/北美客户端； 用于配置自定义路由规则和批准专用网络上的新客户端节点的 Web 界面.
...
## Issue Tracking and Project Management
   ...
   * [Chpokify](https://chpokify.com/)  — 基于团队的规划扑克，可节省冲刺估算的时间. 最多可免费 5 个用户、免费的 Jira 集成、无限制的视频通话、无限制的团队、无限制的会话.
   ...
   * [GForge](https://gforge.com)  — 项目管理和问题跟踪工具集，适用于具有自营和 SaaS 选项的复杂项目.  SaaS 免费计划为开源项目免费提供前 5 位用户.
   ...
   * [Hygger](https://hygger.io)  ——项目管理平台. 免费计划提供无限制的用户、项目和董事会以及 100 MB 的存储空间.
   * [Instabug](https://instabug.com)  — 用于移动应用程序的全面错误报告和应用程序内反馈 SDK. 最多 1 个应用程序和 1 个成员的免费计划.
   * [Ilograph](https://www.ilograph.com/)   — 交互式图表，允许用户从多个角度和详细级别查看他们的基础设施. 图表可以用代码表示. 免费层拥有最多 3 个查看者的无限私人图表.
   * [Issue Embed](https://issueembed.dev/)  - 网站的错误报告工具，可直接进入您的 Github 问题. 个人存储库的免费计划，每月最多 500 个问题和 10,000 次页面浏览量.
   * [Jira](https://www.atlassian.com/software/jira)  — 在许多企业环境中使用的高级软件开发项目管理工具. 免费计划最多 10 个用户.
   * [kanbanflow.com](https://kanbanflow.com/)  — 基于董事会的项目管理. 免费的高级版有更多选择
   ...
   * [Linear](https://linear.app/)  — 具有简化界面的问题跟踪器. 无限会员免费，最大 10MB 文件上传大小，250 期（不包括存档）
   * [MeisterTask](https://www.meistertask.com/)  — 团队的在线任务管理. 最多免费 3 个项目，项目成员不限.
   * [MeuScrum](https://www.meuscrum.com/en) - 带有看板的免费在线 Scrum 工具
   * [nTask](https://www.ntaskmanager.com/)  — 使您的团队能够协作、计划、分析和管理日常任务的项目管理软件. 基本计划永久免费，100 MB 存储空间，5 个用户/团队. 无限的工作空间、会议、任务、时间表和问题跟踪.
   ...
   * [plan.io](https://plan.io/)  — 带有存储库托管和更多选项的项目管理.  2 个用户、10 个客户和 500MB 存储空间免费
   ...
   * [Toggl](https://toggl.com/) — 提供 2 个免费的生产力工具. [Toggl Track](https://toggl.com/track/) 具有免费计划的时间管理和跟踪应用程序可提供专为自由职业者设计的无缝时间跟踪和报告. 它具有无限的跟踪记录、项目、客户、标签、报告等. 和 [Toggl Plan](https://toggl.com/plan/) 为独立开发人员提供免费计划的任务计划，具有无限的任务、里程碑和时间表.
...
## Storage and Media Processing
   ...
   * [embed.ly](https://embed.ly/)  — 提供用于在网页中嵌入媒体、响应式图像缩放、从网页中提取元素的 API. 每月最多 5,000 个 URL，每秒 15 个请求免费
   ...
   * [jsonbin.io](https://jsonbin.io/) — 免费的 JSON 数据存储服务，非常适合小型网络应用程序、网站、移动应用程序.
   * [kraken.io](https://kraken.io/) — 网站性能即服务的图像优化，免费计划最大 1 MB 文件大小
   * [npoint.io](https://www.npoint.io/) — 具有协作模式编辑的 JSON 存储
   * [otixo.com](https://www.otixo.com/)  — 从一处加密、共享、复制和移动您的所有云存储文件. 基本计划提供最大 250 MB 的无限制文件传输. 文件大小并允许 5 个加密文件
...
## Design and UI
  ...
  * [Backlight](https://backlight.dev/) — 以开发人员和设计人员之间的协作为核心，Backlight 是一个非常完整的编码平台，团队可以在其中构建、记录、发布、扩展和维护设计系统.免费计划允许最多 3 名编辑人员在一个设计系统上工作，并且不受限制.
  * [BoxySVG](https://boxy-svg.com/app) — 一个可免费安装的 Web 应用程序，用于绘制 SVG 并以 svg、png、jpeg 和其他格式导出.
  * [clevebrush.com](https://www.cleverbrush.com/) — 免费图形设计/照片拼贴应用程序，他们还提供将其作为组件进行付费集成.
  * [cloudconvert.com](https://cloudconvert.com/)  — 将任何东西转换成任何东西.  208 种支持的格式，包括视频转 gif.
  * [CodeMyUI](https://codemyui.com) - 精心挑选的带有代码片段的网页设计和 UI 灵感集合.
  * [coolors](https://coolors.co/)  - 调色板生成器. 自由.
  * [designer.io](https://www.designer.io/)  — 用于 UI、插图等的设计工具. 有一个原生应用程序. 自由.
  ...
  * [imagebin.ca](https://imagebin.ca/) — 图像的 Pastebin.
  * [Invision App](https://www.invisionapp.com)  - UI 设计和原型制作工具. 桌面和网络应用程序可用. 免费使用 1 个活动原型.
  * [landen.co](https://www.landen.co)  — 为您的初创公司生成、编辑和发布漂亮的网站和登陆页面. 全部无需代码. 免费套餐允许您拥有一个网站，完全可定制并在网络上发布.
  ...
  * [Mindmup.com](https://www.mindmup.com/)  — 免费无限量的思维导图，并存储在云端. 您的思维导图随处可用，可通过任何设备即时使用.
  ...
  * [Proto.io](https://www.proto.io)  - 无需编码即可创建完全交互式的 UI 原型. 免费试用期结束时提供免费套餐. 免费套餐包括：1 个用户、1 个项目、5 个原型、100MB 在线存储和 proto.io 应用程序中的预览.
  ...
  * [Webflow](https://webflow.com)  - 所见即所得的网站建设者动画和网站托管.  2个项目免费.
  * [Updrafts.app](https://updrafts.app)  - WYSIWYG 网站构建器，用于基于 tailwindcss 的设计. 免费用于非商业用途.
  * [whimsical.com](https://whimsical.com/)  - 协作流程图、线框、便签和思维导图. 创建最多 4 个免费板.
  ...
  * [Unicorn Platform](https://unicornplatform.com/)  - 带托管的轻松登陆页面构建器.  1个免费网站.


## Design Inspiration

  * [awwwards.](https://www.awwwards.com/) - [顶级网站] 展示所有设计最好的网站（由设计师投票）.
  * [Behance](https://www.behance.net/)  - [设计展示] 设计师展示作品的地方. 可过滤 UI/UX 项目的类别.
  * [dribbble](https://dribbble.com/) - [设计展示] 独特的设计灵感，一般不是来自实际应用.
  * [Mobbin](https://mobbin.design/) - [移动屏幕截图] 使用我们的 50,000 多个可完全搜索的移动应用程序屏幕截图库，节省数小时的 UI 和 UX 研究.
  * [Mobile Patterns](https://www.mobile-patterns.com/) - [手机截图] 一个设计灵感库，包含最优秀的 UI UX 模式（iOS 和 Android），供设计师、开发人员和产品制造商参考.
  * [Screenlane](https://screenlane.com/)  - [手机屏幕截图] 获得灵感并跟上最新的网络和移动应用程序 UI 设计趋势. 可按模式和应用程序过滤.
  * [scrnshts](https://scrnshts.club/) - [手机截图] 精选精选应用商店设计截图.
  * [UI Garage](https://uigarage.net/) - [移动和网页截图] 每日 UI 灵感和模式，供设计师、开发人员为您的项目寻找灵感、工具和最佳资源.
...
## Data Visualization on Maps
   ...
   * [geoapify.com](https://www.geoapify.com/)  - 矢量和栅格地图图块、地理编码、地点、路线、等值线 API.  3000 个免费请求/天.
...
## IDE and Code Editing
   ...
   * [Paiza](https://paiza.cloud/en/)  — 在浏览器中开发 Web 应用程序，无需进行任何设置. 免费计划提供 1 台具有 24 小时使用寿命和每天 4 小时运行时间的服务器，具有 2 个 CPU 内核、2 GB RAM 和 1 GB 存储空间.
...
## Analytics, Events and Statistics
   ...
   * [indicative.com](https://indicative.com/)  — 客户分析平台，以优化客户参与度、增加转化率并提高保留率. 每月免费最多 5000 万个事件.
   ...
   * [GoatCounter](https://www.goatcounter.com/)  — GoatCounter 是一个开源网络分析平台，可作为托管服务（非商业用途免费）或自托管应用程序提供. 它旨在提供易于使用且有意义的隐私友好型网络分析，作为 Google Analytics 或 Matomo 的替代方案. 免费套餐适用于非商业用途，包括无限数量的网站、6 个月的数据保留期和 10 万次/月的综合浏览量.
   * [Google Analytics](https://analytics.google.com/) - 谷歌分析
   * [Expensify](https://www.expensify.com/) — 费用申报、免费的个人申报审批工作流程
   ...
   * [Mixpanel](https://mixpanel.com/) — 每月跟踪 100,000 名用户、无限数据历史记录和席位、美国或欧盟数据驻留
   ...
   * [Similar Web](https://similarweb.com)  — 网络和移动应用程序分析. 免费计划为每个指标提供 5 个结果、1 个月的移动应用数据和 3 个月的网站数据.
   * [StatCounter](https://statcounter.com/)  — 网站浏览者分析. 免费计划对 500 名最近访问者进行分析.
   * [Tableau Developer Program](https://www.tableau.com/developer)  — 创新、创造并使 Tableau 完美适合您的组织. 免费的开发人员计划为 Tableau Online 提供个人开发沙盒许可证. 该版本是最新的预发布版本，因此数据开发人员可以测试这个卓越平台的每一个功能.
...
## Visitor Session Recording
   ...
   * [Reactflow.com](https://www.reactflow.com/) — 每个站点：每天 1,000 次页面查看、3 个热图、3 个小部件、免费错误跟踪
   ...
   * [Microsoft Clarity](https://clarity.microsoft.com/) - 会话录音完全免费，“无流量限制”、无项目限制、无采样
...
## International Mobile Number Verification API and SDK
  ...
  * [veriphone](https://veriphone.io/)  — 免费、快速、可靠的 JSON API 中的全球电话号码验证.  1000 次请求/月
...
## Payment and Billing Integration
  ...
  * [currencylayer](https://currencylayer.com/) — 为您的企业提供可靠的汇率和货币转换，每月免费 1,000 个 API 请求
  ...
  * [FraudLabsPRO](https://www.fraudlabspro.com)  — 帮助商户防止支付欺诈和退款. 免费微计划可提供 500 次查询/月.
  * [MailPopin](https://mailpop.in) - 通过上下文信息充分利用您的 Stripe 通知.
  * [Nami ML](https://www.namiml.com/)  - 适用于 iOS 和 Android 上的应用内购买和订阅的完整平台，包括无代码付费墙、CRM 和分析. 免费提供所有基本功能来运行 IAP 业务.
  * [RevenueCat](https://www.revenuecat.com/)  — 用于应用内购买和订阅（iOS 和 Android）的托管后端. 每月可免费获得高达 1 万美元的跟踪收入.
  * [vatlayer](https://vatlayer.com/) — 即时增值税号验证和欧盟增值税税率 API，每月免费 100 个 API 请求
  * [Freecurrencyapi.net](https://freecurrencyapi.net/)  — 免费货币换算和汇率数据 API.  10 个请求/小时，无需 API 密钥，免费注册时每月 50 000 个请求.
...
## Dev Blogging Sites
  ...
  * [BearBlog](https://bearblog.dev/) - 极简主义和 Markdown 驱动的博客和网站建设者.
  * [Dev.to](https://dev.to/) - 程序员在这里分享想法并帮助彼此成长.
  * [Hashnode](https://hashnode.com/) — 面向开发人员的无忧博客软件！.
  * [Medium](https://medium.com/) — 更明智地了解对您而言重要的事情.
...
## Miscellaneous
  ...
  * [Blynk](https://blynk.io)  — 带有 API 的 SaaS，用于控制、构建和评估物联网设备. 包含 5 台设备的免费开发者计划、免费云和数据存储. 移动应用程序也可用.
  * [Bricks Note Calculator](https://free.getbricks.app/) - 带有强大的内置多行计算器的笔记应用程序 (PWA).
  * [Carbon.now.sh](https://carbon.now.sh)  - 以美观的截图式图像格式创建和共享代码片段. 通常用于在 Twitter 或博客文章上美观地分享/炫耀代码片段.
...
## Other Free Resources
  ...
  * [Framacloud](https://degooglisons-internet.org/en/list/) — 法国非营利组织的 Free/Libre 开源软件和 SaaS 列表 [Framasoft](https://framasoft.org/en/).
  ...
  * [is-a.dev](https://is-a.dev) — 为开发人员提供免费的 `*.is-a.dev` 子域.
