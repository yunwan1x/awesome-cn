...
&gt; 一个很棒的列表是一个由 Substrate 社区策划的很棒的东西的列表.
...
- [Polkadot Stack](https://github.com/w3f/Grants-Program/blob/master/docs/polkadot_stack.md) - 一个
  由我们的朋友维护的“很棒的列表” [Web3 Foundation](https://web3.foundation/).

## Support

- [Stack Overflow](https://stackoverflow.com/questions/tagged/substrate) - 标记为“基材”
  最适合所有技术问题.
- [`subport`](https://github.com/paritytech/subport/issues) - 支持存储库讨论使用.
...
- [Technical Chat](https://matrix.to/#/#substrate-technical:matrix.org) - 问问题 ＆
...
- [Front-End](https://github.com/substrate-developer-hub/substrate-front-end-template) - Polkadot-JS
  API 和 [React](https://reactjs.org/) 用于为基于 Substrate 的链构建前端的应用程序. 
...
- [Commodities](https://github.com/danforbes/pallet-nft) - 定义和实现一个不可替代
  令牌接口.
- [Chainlink Feed Pallet](https://github.com/smartcontractkit/chainlink-polkadot) - Chainlink 提要
...
- [Substrate .Net API](https://github.com/usetech-llc/polkadot_api_dotnet) - 维护者
  使用技术.
- [Substrate .NET Standard API](https://github.com/dotmog/SubstrateNetApi) - 用于
  ...
  [Unity 3D integration example](https://github.com/darkfriend77/Unity3DExample) - 维护者
...
- [React-Native-Substrate-Sign](https://github.com/paritytech/react-native-substrate-sign) - 锈
  React Native 的库.
- [Polkadot-Dart](https://github.com/Pocket4D/Polkadot-Dart) - Dart 基板 API.
...
- [Polkadot-JS Extension](https://github.com/polkadot-js/extension) - 浏览器扩展
  与基于 Substrate 的链交互.
- [Polkadot Tool Index](https://wiki.polkadot.network/docs/build-tools-index) - 工具列表
...
- [OnFinality](https://onfinality.io) - 基于共享基板的免费和付费服务
  节点.
