...
See also [legochain](https://github.com/defunkydrummer/legochain)，一个简单的教育区块链.
...
See also [Clache](#caching)，可以将任何对象保存在磁盘上.
...
See also [asdf-sbcl](https://github.com/smashedtoatoms/asdf-sbcl)，通用包管理器的插件.
