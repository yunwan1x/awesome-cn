...
- [donut](https://github.com/plowteam/donut) - 重新实现《辛普森一家》：现代 C++ 和现代 OpenGL 中的 Hit &amp; Run.
...
- [OpenMB](https://github.com/cookgreen/OpenMB) - Taleworlds 的 Mount&amp;Blade 系列角色扮演游戏引擎.
- [OpenTomb](https://github.com/opentomb/OpenTomb) - 具有当代更新、功能和添加的原始古墓丽影 1-5 体验.
...
- [Rigel Engine](https://github.com/lethal-guitar/RigelEngine) - 经典 DOS 游戏 Duke Nukem II 在 C++ 中的现代重新实现.
- [San Andreas Unity](https://github.com/GTA-ASM/SanAndreasUnity) - 在 Unity 中重新实现 GTA：San Andreas 游戏引擎.
- [TOMB5](https://github.com/TOMB5/TOMB5) - 古墓丽影：编年史反汇编翻译成 C 源代码.

## Adventure
- [engge](https://github.com/scemino/engge) - 顶针草公园的实验性游戏引擎.
- [raw(gl)](https://github.com/cyxx/rawgl) - 另一个世界的重新实现.
- [ResidualVM](https://github.com/residualvm/residualvm) - 游戏引擎重新实现，可让您玩 3D 冒险游戏，例如 Grim Fandango 和 Escape from Monkey Island.
- [ScummVM](https://github.com/scummvm/scummvm) - 允许您运行某些经典的图形点击冒险游戏，例如疯狂大厦和猴岛.

## Arcade
- [Barbarian](http://barbarian.1987.free.fr/indexEN.htm) - 野蛮人的开源克隆：终极战士.
- [C-Dogs SDL](https://github.com/cxong/cdogs-sdl) - 经典的高架跑枪游戏.
- [Mr.Boom](https://github.com/Javanaise/mrboom-libretro) - RetroArch/Libretro 的 8 玩家 Bomberman 克隆.
- [OpenClonk](https://github.com/openclonk/openclonk) - 多人动作游戏，您可以在其中控制小巧灵活的类人机器人.
...
- [DukeGDX](https://gitlab.com/m210/DukeGDX) - Duke Nukem 3D 端口.
- [ECWolf](https://bitbucket.org/ecwolf/ecwolf/src/master/) - 基于 Wolf4SDL 的德军总部 3D 端口.
- [ezQuake](https://github.com/ezQuake/ezquake-source) - 结合所有现代 QuakeWorld 客户端的功能，ezQuake 使 QuakeWorld 更易于启动和播放.
...
- [ioquake3](https://github.com/ioquake/ioq3) - 免费软件 FPS 引擎，可用于玩 Quake 3，或制作自己的游戏.
- [NBlood](https://github.com/nukeykt/NBlood) - 经典 FPS Blood 的移植.
- [Odamex](https://github.com/odamex/odamex) - 在线多人《DOOM》移植版，非常注重原始游戏玩法，同时提供广泛的增强功能. 
- [OpenSpades](https://github.com/yvt/openspades) - 黑桃 A 的兼容客户端，一个体素 FPS.
- [QuakeSpasm](https://sourceforge.net/projects/quakespasm/) - 一个现代的、跨平台的 Quake 游戏引擎.
...
- [The Force Engine](https://github.com/luciusDXL/TheForceEngine) - 现代系统的绝地引擎和使用该引擎的游戏 - 黑暗力量和亡命之徒.
...
- [vkQuake](https://github.com/Novum/vkQuake) - Quake 端口使用 Vulkan 而不是 OpenGL 进行渲染.
- [Zandronum](https://zandronum.com/)  - 面向多人的端口，基于 Skulltag，用于 Doom 和 Doom II. 还经营异端、妖术和冲突.

## Online
- [2006rebotted](https://github.com/dginovker/2006rebotted) - 2006 Runescape 仿真服务器.
- [FreeSO](https://github.com/riperiperi/FreeSO) - 重新实现模拟人生在线，主要针对移动设备.
- [Meridian 59](https://github.com/Meridian59/Meridian59) - 第一个 3D MMORPG，1996 年发布，2012 年开源.Meridian 59 的原始代码库.
- [Opengate](https://sourceforge.net/projects/opengate/) - 重制 Jumpgate.
...
- [DevilutionX](https://github.com/diasurgical/devilutionX) - 暗黑破坏神为现代操作系统构建.
...
- [FreeFT](https://github.com/nadult/FreeFT) - 受辐射战术启发的实时等距动作游戏引擎.
...
- [Riiablo](https://github.com/collinsmith/riiablo) - 暗黑破坏神 II 使用 Java 和 LibGDX 重制.
- [sfall](https://github.com/phobos2077/sfall) - 经典游戏《辐射 2》的一组引擎修改.
- [Shockolate](https://github.com/Interrupt/systemshock) - 同样伟大的系统冲击，新的伟大品味.
- [UAlbion](https://github.com/csinkers/ualbion) - 1995 年阿尔比恩的翻拍.
- [WitchavenGDX](https://gitlab.com/m210/WitchavenGDX) - 女巫 Java 端口.
- [xoreos](https://github.com/xoreos/xoreos) - BioWare 的 Aurora 引擎及其衍生引擎的实现（被无冬之夜、巫师等使用）.
...
- [Commander Genius](https://gitlab.com/Dringgstein/Commander-Genius) - Commander Keen Games 的现代翻译.
- [Jazz² Resurrection](https://github.com/deathkiller/jazz2) - 重新实现 Jazz Jackrabbit 2.
- [Lionheart Remake](https://github.com/b3dgs/lionheart-remake) - Java 重制 Lionheart Amiga 游戏.
- [NXEngine-evo](https://github.com/nxengine/nxengine-evo) - 重写杰作跳跃和奔跑平台游戏 Doukutsu Monogatari（也称为洞穴物语）.
- [Omnispeak](https://github.com/sulix/omnispeak) - 在再见银河中重新实现指挥官基恩.
...
- [The Secret Chronicles of Dr. M](https://github.com/secretchronicles/TSC) - 改编秘密马里奥编年史.
- [VVVVV](https://github.com/TerryCavanagh/vvvvvv) - VVVVVV 的源代码.

## Racing
- [DreeRally](https://github.com/enriquesomolinos/DreeRally) - 死亡拉力引擎重新实现.
...
## Strategy
- [Antares](https://github.com/arescentral/antares) - 战神重制，一款战术太空战斗游戏.
- [CivOne](https://github.com/SWY1985/CivOne) - Sid Meier 文明的实施.
- [CorsixTH](https://github.com/CorsixTH/CorsixTH) - 克隆主题医院，支持现代操作系统、高分辨率等.
- [Cortex Command Community Project Source](https://github.com/cortex-command-community/Cortex-Command-Community-Project-Source) - 社区推动的努力，以继续开发 Cortex Command.
- [fheroes2](https://github.com/ihhub/fheroes2) - 免费实现《魔法门之英雄无敌II》游戏引擎.
- [FreeCol](https://sourceforge.net/projects/freecol/) - 基于旧游戏殖民化的回合制策略游戏.
- [Jagged Alliance Stracciatella](https://github.com/ja2-stracciatella/ja2-stracciatella) - 使铁血联盟 2 在各种平台上可用.
- [Julius](https://github.com/bvschaik/julius) - 重新实现凯撒三世.
- [KaM Remake](https://github.com/Kromster80/kam_remake) - 从头开始​​用 Delphi 编写的骑士和商人的 RTS 游戏重制.
...
- [OpenSC2K](https://github.com/nicholas-ochoa/OpenSC2K) - Maxis 重制模拟城市 2000.
- [OpenTTD](https://github.com/OpenTTD/OpenTTD) - OpenTTD 是一款基于流行游戏 Transport Tycoon Deluxe 的交通模拟游戏，由 Chris Sawyer 编写.
- [OpenXcom](https://github.com/SupSuper/OpenXcom) - UFO 的克隆：未知的敌人和 X-COM：来自深渊的恐怖.
- [OutpostHD](https://github.com/OutpostUniverse/OPHD) - 重制 Sierra On-Line 的前哨站.
- [Race into Space](https://github.com/raceintospace/raceintospace) - Interplay 的巴兹奥尔德林太空竞赛版本.
- [Return To The Roots](https://github.com/Return-To-The-Roots/s25client) - 用 C++ 编写的 Settlers II 重制版.
- [Seven Kingdoms: Ancient Adversaries](https://github.com/the3dfxdude/7kaa) - GPL 版本的七国：远古对手.
- [Sourcehold](https://github.com/sourcehold/Sourcehold) - Firefly Studios 实施 Stronghold.
- [VCMI](https://github.com/vcmi/vcmi) - 英雄无敌 III 的引擎.
- [Warcraft Remake](https://github.com/b3dgs/warcraft-remake) - Java 重制《魔兽争霸：兽人与人类》.
...
- [Stone Kingdoms](https://gitlab.com/stone-kingdoms/stone-kingdoms) - 基于 Firefly Studios 原版 Stronghold 的实时策略.  
