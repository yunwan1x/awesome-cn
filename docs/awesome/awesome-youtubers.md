...
要更快地找到特定主题，您可以按“Ctrl + F”并输入您要搜索的主题.
建议通过单击鼠标滚轮或右键单击链接并选择“在新选项卡中打开链接”来打开链接，以便将列表保存在单独的选项卡中.


## Programming in general

那里有很多编程语言. 在本节中，您可以找到任何编程语言，包括 Python、C、Java. 此外，许多 YouTubers 教授这些语言的框架. 不仅是编程语言，还有更通用的编程内容. 您可以找到实用教程或理论教程.
...
[**Corey Schafer**](https://www.youtube.com/c/Coreyms) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：Python、后端\
...
内容：后端、渲染、理论课程 \
特色播放列表：`OpenGL`、`Clojure 语言`、`Python 播放列表`、`Pigeon，一种教育编程语言`、`更多有趣的播放列表！`.
...
[**LearningLad**](https://www.youtube.com/c/LearningLad) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
Content about: C, C#, C++ \
精选播放列表：`学习 C 编程语言 | 初学者教程`，`学习C++编程| 初学者视频教程、C++ 面向对象编程以及更多播放列表.
...
内容有关：汇编语言、硬件、计算机科学 \
精选播放列表：`构建 8 位面包板计算机！`、`网络教程`、`数字电子教程`、`大量相关视频`.
...
[**Intellipaat**](https://www.youtube.com/user/intellipaaat) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：DevOps、人工智能 \
精选播放列表：“初学者 DevOps 教程”、“人工智能教程”、“机器学习教程”、“初学者 Python 教程”.
...
[**ProgrammingKnowledge**](https://www.youtube.com/c/ProgrammingKnowledge) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：后端、API \
精选播放列表：“Node.js 初学者教程”、“Python 3 初学者教程”、“C++ 初学者编程教程”、“有关不同编程语言的其他视频”.
...
[**Coding Tech**](https://www.youtube.com/c/CodingTech) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：所有编程，讲座 \
...
[**Smartherd**](https://www.youtube.com/c/smartherd) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
精选播放列表：“Flutter 教程”、“初学者的 Dart 和 Dart”、“Rust 和 Rust 项目介绍”.  \
<br/>
...
[**freeCodeCamp.org**](https://www.youtube.com/channel/UC8butISFwT-Wl7EV0hUK0BQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容涉及：通用编程、计算机科学、Web Dev、DevOps等\
...
内容关于：Spring、Java \
特色播放列表：`Spring 框架课程播放列表`、`Spring Boot 微服务 - 完整课程播放列表`、`Java EE 课程播放列表`.
...
[**CodingEntrepreneurs**](https://www.youtube.com/c/CodingEntrepreneurs) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Python \
精选播放列表：“Python 30 天 ~ Python 3.8+”、“Python 编码”、“Python 3.8 和 Django 3+”、“在 Windows 和 Mac 上安装和设置”.
...
[**Sebastiaan Mathôt**](https://www.youtube.com/c/SebastiaanMath%C3%B4t) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Python \
...
内容关于：编程原理，主要围绕 JavaScript \
特色播放列表：`OOP in js`、`Unit testing`、`TDD`、`Functional Programming in JavaScript`.  \
<br/>
...
内容：数据结构、算法、编码面试 \
特色播放列表：“数组方法迷你课程”、“Javascript 算法 + 数据结构”.  \
<br/>
...
[**The Cherno**](https://www.youtube.com/user/TheChernoProject) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：C++、游戏开发\
精选播放列表：`游戏引擎`、`C++`、`OpenGL`、`Java 中的3D 游戏编程`.  \
<br/>
...
[**Hussein Nasser**](https://www.youtube.com/c/HusseinNasser-software-engineering) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：数据库、网络、后端开发、安全、协议、概念 \
精选播放列表：“高可用性”、“Python 示例”、“HTTP/2”、“消息队列和发布订阅系统”、“代理”、“更多视频教程”.
...
[**NeuralNine**](https://www.youtube.com/c/NeuralNine) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Python、数据结构、数据科学、机器学习、道德黑客 \
...
[**Real Python**](https://www.youtube.com/c/realpython) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Python \
精选播放列表：“Python - 中级和高级功能”、“Python 中的函数式编程”、“有效 Python 开发工具”、“如何建立您的 Python 职业生涯”.
...
精选播放列表：“ASP.NET Core REST API 教程”、“ASP.NET Core 常规教程”、“.NET 中的基本 Nuget 包”、“软件工程基础”.
...
内容关于：黑客\
精选播放列表：“浏览器黑客”、“DevTools 黑客”、“操作系统黑客”、“SerenityOS”、“模拟器黑客”.  \
<br/>
...
内容关于：Python，问题解决 \
精选播放列表：“Hackerrank 问题解决”、“机器/深度学习项目教程”.  \
<br/>
...
内容关于：理论、数据 \
特色播放列表：“数据结构简介”、“排序算法讲座/可视化”、“面向对象编程简介”.
...
[**kudvenkat**](https://www.youtube.com/c/Csharp-video-tutorialsBlogspot) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
## Web development
 ...
 Web 开发包括前端开发：非常基础的（HTML、CSS 和 JavaScript）以及最现代的框架（React.js、Vue.js、Angular）. 它还包括后端开发主题，如 Node.js、GraphQL、SQL 和更基本的东西，如 DNS、URL、部署. 您还可以找到作为 Web 开发人员的自由职业者和其他相关内容.
...
[**Flux**](https://www.youtube.com/c/FluxWithRanSegall) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网页设计、设计、自由职业 \
特色播放列表：“2020 年免费网页设计课程”、“作品集：案例研究和评论”、“如何开始自由职业”、“自由职业技巧：如何寻找客户并发展您的业务”.
...
[**techsith**](https://www.youtube.com/c/Techsithtube) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
[**Omatum**](https://www.youtube.com/c/Omatum) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网页开发、设计 \
特色播放列表：“Live Omatum Bucks 软件项目流”、“软件项目：OmatumBucks”、“Live Omatum.com 网站开发项目流”、“Uncut Live Streams”.
...
[**Punit Chawla**](https://www.youtube.com/c/PunitChawla) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网页设计、Adobe XD \
精选播放列表：“设计周刊”、“设计要点”.  \
<br/>
...
精选播放列表：“网页设计教程（UI 和 UX）”、“React.js 初学者教程”、“CSS 教程”、“JavaScript 教程播放列表”.
...
[**Traversy Media**](https://www.youtube.com/c/TraversyMedia) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：前端、后端\
...
内容关于：网页设计、辅助功能、性能 \
精选播放列表：“辅助功能和性能视频”、“Jekyll 播放列表”、“CSS 动画视频”、“SEO 视频”、“更多关于 Web 开发的视频/播放列表”.
...
内容关于：JavaScript、CSS \
精选播放列表：`CSS Tips and Tricks`、`一些关于 JavaScript 库的播放列表`.  \
<br/>
...
[**Brian Design**](https://www.youtube.com/channel/UCsKsymTY_4BYR-wytLjex7A) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
精选播放列表：“100 秒代码”、“Angular Essentials”、“Flutter”、“Frontend Mini Projects”.  \
<br/>
...
[**Academind**](https://www.youtube.com/c/Academind) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
...
[**Programming with Mosh**](https://www.youtube.com/c/programmingwithmosh) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：前端、后端\
...
[**Raw Coding**](https://www.youtube.com/c/RawCoding) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：ASP.NET、.NET \
精选播放列表：“现代 Web 开发系列”、“ASP.NET Core Vue.js 初学者指南”、“ASP.NET Core 教程”、“更多 .NET 教程！”.
...
[**The Net Ninja**](https://www.youtube.com/c/TheNetNinja) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：前端、后端\
...
[**Kevin Powell**](https://www.youtube.com/kepowob) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：CSS \
精选播放列表：`CSS Grid 视频`、`Flexbox 基础`、`响应式 CSS 教程`、`CSS 动画`、`更多 CSS 视频教程！`.
...
[**Harry Wolff**](https://www.youtube.com/c/hswolff) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：React.js、JavaScript \
精选播放列表：“React 教程”、“构建 React Native 应用程序”、“JavaScript 教程”、“TypeScript 播放列表”.  \
<br/>
...
[**Coding Garden**](https://www.youtube.com/c/CodingGarden) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：JavaScript、JavaScript 框架 \
...
[**Hitesh Choudhary**](https://www.youtube.com/c/HiteshChoudharydotcom) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：前端、后端\
精选播放列表：“JavaScript 课程”、“初学者 Docker”、“MongoDB 和 Mocha”、“Vue JS 速成课程”、“更多播放列表和视频”.
<br/>
...
[**swyx**](https://www.youtube.com/c/swyxTV) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
内容关于：围绕创意编码的实时编码、WebGl（three.js、glsl）JavaScript 动画 \
...
[**Jason Lengstorf**](https://www.youtube.com/c/Lengstorf) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Frontend、Backend、GraphQL、D3、Svelte、其他技术 \
...
特色播放列表：“CSS 动画系列”、“15 分钟内学习 jQuery”、“Webflow From Scratch”、“正则表达式系列”.  \
<br/>
...
特色播放列表：“Css 动画效果”、“从头开始的响应式网站设计”、“Css 按钮悬停效果”、“视差效果”、“Css 教程”等等……
<br/>
...
[**Bitfumes**](https://www.youtube.com/c/Bitfumes/) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：JavaScript、NextJs、NuxtJs、VueJs、ReactJs、SvelteJs、CSS 和 CSS 预处理器、Laravel \
特色播放列表：“Vuejs”、“SvelteJs”、“Laravel Livewire 完整课程”、“学习使用 Nuxt.js”、“ReactJS 基础”、“Laravel PHP 框架教程 - 完整课程 6.5 小时（2020 年）”.
...
[**Web Dev Simplified**](https://www.youtube.com/channel/UCFbNIlppjAuEX4znoulh0Cw) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：一般 Web 开发、JavaScript、React、CSS、最佳实践和设计模式 \
精选播放列表：“小项目”、“谁想成为超级玩家（琐事游戏）”、“CSS 教程”、“Web 应用程序安全/身份验证”.
...
内容关于：Web 开发、JavaScript、TypeScript、React、GraphQL \
...
内容关于：数学 \
特色播放列表：“应用数学”、“数学专业”、“计算机科学/计算机工程”、“电气工程”、“机械工程”.
...
[**Computerphile**](https://www.youtube.com/user/Computerphile) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：软件、硬件 \
特色播放列表：“计算机内存的工作原理”、“迈克·庞德博士的数据分析”、“罗伯·迈尔斯的人工智能”、“远程工作技术”.
...
内容：理论课、讲座\
特色播放列表：“计算机科学与安全”、“工程”、“能源技术”、“领导力与管理”、“深度学习的自然语言处理”.
...
[**MIT OpenCourseWare**](https://www.youtube.com/c/mitocw) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：数学、计算机科学、工程\
...
[**3Blue1Brown**](https://www.youtube.com/c/3blue1brown)[<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：数学和各种数学概念的可视化 \
...
[**Abdul Bari**](https://www.youtube.com/channel/UCZCFT11CWBi3MHNlGf019nw) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：算法\
精选播放列表：`算法`.  \
<br/>
...
内容有关：C/C++语言、数据结构、算法\
特色播放列表：“排序算法”、“数据结构”、“C/C++ 中的指针”、“C 编程简介”.
...
内容关于：概念、理论 \
精选播放列表：`Raspberry Pi`、`Microcontrollers`、`Programming`、`Linux`、`more!`.  \
<br/>
...
内容关于：数据可视化、机器学习、数据操作、神经网络 \
特色播放列表：“线性回归和线性模型”、“机器学习”、“高通量测序”、“统计基础”、“更多！”.
...
[**Eddie Woo**](https://www.youtube.com/channel/UCq0EGvLTyy-LLT1oUSO_0FQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：数学 \
...
[**Professor Leonard**](https://www.youtube.com/channel/UCoHhuummRZaIVX7bD4t2czg) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：数学 \
精选播放列表：“代数”、“统计”、“微积分”.  \
<br/>
...
内容关于：Java OOP、Oracle 数据库、数据结构（印地语）\
...
查找在深度学习、自然语言处理、神经网络以及与此广泛类别相关的更多主题方面经验丰富的 YouTube 用户. 机器学习的一个好处是它可以使用不同的编程语言进行应用，并且核心概念满足不同编程语言的相同结构.
...
[**Abhishek Thakur**](https://www.youtube.com/c/AbhishekThakurAbhi) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容：实用视频、讲座 \
精选播放列表：“应用机器学习框架”、“机器学习的技巧和窍门”、“更多视频！”.  \
<br/>
...
[**Ahlad Kumar**](https://www.youtube.com/c/AhladKumar) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：深度学习、理论\
...
[**Aladdin Persson**](https://www.youtube.com/c/AladdinPersson) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
内容关于：Python、机器学习、理论\
特色播放列表：“机器学习播放列表简介”、“使用 Pandas 在 Python 中进行数据分析”、“其他演讲视频和 Python 视频”.
...
内容关于：深度学习、理论\
特色播放列表：“从基础开始的深度学习”、“编码器机器学习简介”、“编码器的实用深度学习（2018、2019、2020）”.
...
[**Rasa**](https://www.youtube.com/c/RasaHQ) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Rasa、AI、NLP \
...
[**Yannic Kilcher**](https://www.youtube.com/c/YannicKilcher) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：NLP、机器学习、深度学习、理论\
特色播放列表：“自然语言处理”、“通用机器学习”、“深度学习架构”、“计算机视觉”、“机器学习应用”、“更多！”.
...
[**Two Minute Papers**](https://www.youtube.com/c/K%C3%A1rolyZsolnai) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
这是一个广泛的话题. 在本节中，您可以找到教授游戏开发程序（Unity、虚幻引擎等）、不同编程语言（JavaScript、HTML5、Java）的核心概念以及艺术/设计创作、3D 建模等等的 YouTube 用户.
...
[**Brackeys**](https://www.youtube.com/c/Brackeys) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
...
内容关于：GameMaker Studio、提示和规划播放列表 \
精选播放列表：`你会蜗牛吗？  - 完整开发.`，`游戏开发技巧`，`如何开始游戏开发.`.  \
<br/>
...
内容关于：Java、GameMaker Studio \
精选播放列表：“Java 基础编程”、“酷游戏制作教程”、“Java 游戏开发初学者”、“Java 平台游戏编程”.
...
内容关于：游戏设计、动画\
特色播放列表：“几何设计播放列表”、“视频游戏角色动画课程”、“After Effects 动画教程”.
...
[**Chris Courses**](https://www.youtube.com/c/ChrisCourses) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：HTML5 Canvas、JavaScript \
...
[**Zenva**](https://www.youtube.com/c/Zenva) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Unity、虚幻引擎、Godot \
特色播放列表：`Master Unity Game Development`、`Unreal Game Development Mini-Degree`、`Godot Game Development Mini-Degree`、`更多关于游戏开发和设计的播放列表！`.
...
[**Sebastian Lague**](https://www.youtube.com/c/SebastianLague) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
Content about: Unity, C#, Game design \
...
[**DaFluffyPotato**](https://www.youtube.com/c/DaFluffyPotato) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Pygame \
...
内容关于：C++、DirextX、3D \
精选播放列表：`初学者 C++ 游戏编程`、`中级 C++ 游戏编程`、`高级 C++ 游戏编程`、`3D 编程基础`、`C++ 3D DirextX 编程`.
...
内容关于：GODOT \
精选播放列表：“Godot 3 教程”、“Godot 中的 3D 迷宫游戏”、“使用 Godot 制作您的第一个 2D 游戏”、“Godot - 初学者游戏创建教程”.
...
内容关于：GODOT、2D、GameMaker \
特色播放列表：“Godot 引擎教程”、“Godot 中基于资源的库存教程”、“2D Hack-n-Slash 课程（完整课程）”、“GameMaker 平台教程”.
...
内容关于：JavaScript \
精选播放列表：“JavaScript 中的超级马里奥兄弟”、“JavaScript 中的创建俄罗斯方块在线多人游戏”.  \
<br/>
...
[**The DevKing**](https://www.youtube.com/channel/UCS2smVWjNGuRzD6HVWmlWwQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：游戏开发、Robolox脚本\
精选播放列表：`Robolox 脚本`.  \
<br/>
...
内容关于：安全\
精选播放列表：`CompTIA Security+ SY0-501 培训课程`、`CompTIA N10-007 Network+ Study Groups`，以及更多类似的内容！`.
...
[**LiveOverflow**](https://www.youtube.com/c/LiveOverflow) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：道德黑客 \
精选播放列表：“浏览器漏洞利用”、“硬件安全研究/移动”、“二进制漏洞利用”.  \
<br/>
...
[**NullByte**](https://www.youtube.com/channel/UCgTNupxATBfWmfehv21ym-g) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网络和安全、渗透测试工具教程、道德黑客 \
精选播放列表：“使用 Wireshark”、“NodeMCU”、“RaspberryPi”、“网络武器实验室”.  \
<br/>
...
[**Hackersploit**](https://www.youtube.com/channel/UC0ZTPkdxlAKf-V33tqXwi3Q) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：渗透测试、道德黑客、Linux \
...
[**Gerald Auger**](https://www.youtube.com/c/GeraldAuger) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网络安全 \
精选播放列表：“闯入网络安全视频 - 简单的网络”、“网络安全求职 QA 与招聘人员”、“免费渗透测试列表伴侣”.
...
内容关于：网络、网络安全、道德黑客 \
特色播放列表：`Linux - NetworkChuck`、`FREE Security+ SY0-601 // 完整课程 // thisisIT 2020`、`FREE CCNA 200-301 // 完整课程 // NetworkChuck 2020`.
...
[**John Hammond**](https://www.youtube.com/c/JohnHammond010) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网络安全、道德黑客、恶意软件分析 \
...
## Internet/networking
 ...
 Internet 连接和网络是一个广泛的主题，在学习这一点时很容易陷入困境. 获取有关软件和硬件的精彩播放列表和视频，以了解 Internet 连接和网络的工作原理. 如何正确设置调制解调器/路由器以及 IP、DNS 等是什么.
...
[**Net VN**](https://www.youtube.com/c/NetVNbuitronghieu) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：互联网、网络、命令行、硬件 \
特色播放列表：`很多路由器/调制解调器播放列表`，`互联网连接和网络视频的软件管理`.  \
<br/>
...
[**Network Direction**](https://www.youtube.com/channel/UCtuXekfqj-paqsxtqVNCC2A) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网络\
精选播放列表：“网络方向”、“网络基础”、“防火墙和局域网视频”.  \
<br/>
...
内容：将网络硬件与其他具有有用视觉效果的概念连接起来. 还有一个关于 A+ 和 Net+ 的速成课程.  \
...
此类别中列出的 YouTube 用户可能不是编程教程或很酷的设计卡片，而是每个人每天都在使用其他一些有用的软件和应用程序. 掌握您经常使用的套件或了解有关公司为您提供的特定服务的更多信息.
...
关于内容：Google 电子表格 \
精选播放列表：`Google Sheets - Fundamental Skills`、`Google Apps Scripts - Fundamental`.  \
<br/>
...
精选播放列表：“Excel 2020 教程”、“Excel 高级教程”、“Microsoft Visio 教程”、“Windows 10 教程”.  \
<br/>
...
[**Simon Sez IT**](https://www.youtube.com/c/Simonsezit) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Office套件，微软\
...
包括正确管理和理解 Windows、Linux、Mac 和其他操作系统的视频和教程. 了解有用的命令和设置，以使您的操作系统保持最新和安全. 深入了解这些系统是如何工作的，以便您可以使用最佳方法控制它们.
...
[**Riba Linux**](https://www.youtube.com/c/RibaLinux) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Linux\
精选播放列表：“安装和概述”、“Linux 操作指南”.  \
<br/>
...
[**MSFT WebCast**](https://www.youtube.com/c/MSFTWebCast) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Windows \
...
内容关于：Linux 教程、分发评论、Linux 指南 \
精选播放列表：“硬件评论”、“Linux 要点”、“初学者的 Linux 命令”.  \
<br/>


## Digital design

网页设计教程列在 [web development section](#web-development) . 但是，当然，数字设计非常大，包括漂亮的图片和关于名人的绘图或有吸引力的宣传视频. 获得有关如何做这些事情的知识，并成为设计程序的专业人士.
...
特色播放列表：“Adobe Illustrator CC 平面插图教程”、“徽标创建教程播放列表”、“Adobe Illustrator CC 初学者”、“更多 Adob​​e Illustrator 播放列表”.
...
[**ArmaganVideos**](https://www.youtube.com/c/armaganvideos) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：Adobe Illustrator, 插图, 平面设计 \
精选播放列表：“教程 - Illustrator”、“教程 - After Effects”、“教程 - 平面设计”.  \
<br/>
...
[**T&T Tutorials**](https://www.youtube.com/c/TTTutorials) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容有关：Adobe Illustrator、Adobe Photoshop、手绘\
精选播放列表：“Adobe Illustrator 教程”、“人物插图 Illustrator 教程”、“Adobe Illustrator 工具教程”.
...
[**Zakey Design**](https://www.youtube.com/c/ZakeyDesignow) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：Gimp、Inkscape、Adobe Illustrator \
精选播放列表：“Gimp 照片处理”、“Inkscape 播放列表”、“Adobe Illustrator 视频”.  \
<br/>
...
[**Envato Tuts+**](https://www.youtube.com/c/tutsplus) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：所有设计、插图、网页设计\
...
精选播放列表：“标志设计过程”、“Adobe Illustrator 提示和技巧”、“角色设计”、“Illustrator Speedarts”.
...
[**Charli Marie TV**](https://www.youtube.com/channel/UCScRSwdX0t31gjk3MYXIuYQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：网页、平面设计\
精选播放列表：“设计职业”、“工作流程”、“设计聊天”、“设计师自由职业者”.  \
<br/>
...
[**Yes I'm a Designer**](https://www.youtube.com/c/YesImaDesigner) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：设计原理、设计工具教程 \
精选播放列表：“365 天的创造力”、“Illustrator CC”、“Indesing 教程”、“Photoshop CC”.  \
<br/>


## Audio and video

关于音频和视频制作的教程. 包括广泛的主题，例如设计、动画、渲染、硬件等. 使用最流行和最好的软件来创建令人惊叹的视频动画、制作精良的歌曲以及与这些主题相关的东西.
...
[**OBEDIA**](https://www.youtube.com/c/Obedia) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：音频、硬件 \
...
[**Black Mixture**](https://www.youtube.com/c/BlackMixture) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：After Effects，动画 \
精选播放列表：“SPEEDPAINT ANIMATION”、“Motion Design”、“After Effects 教程”.  \
<br/>
...
[**Avnish Parker**](https://www.youtube.com/user/avnishparker) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：动画、设计 \
精选播放列表：“After Effects 教程”、“文本动画 - After Effects 教程”、“徽标介绍 - After Effects 教程”、“动态图形 - After Effects 教程”.
...
[**Deny King**](https://www.youtube.com/c/DenyKingYoutube) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：视频、照片 \
...
[**Blender Guru**](https://www.youtube.com/user/AndrewPPrice) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容关于：搅拌机，3D建模\
精选播放列表：“Blender 初学者教程系列”、“Blender 建模椅教程”、“沙发教程系列”.  \
<br/>
...
[**Grant Abbitt**](https://www.youtube.com/user/mediagabbitt) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：3D建模、Reptology、Blender \
...
内容关于：搅拌机，3D建模\
精选播放列表：“Blender 2.9 初学者教程系列”、“CG 快速通道”.  \
<br/>
...
[**DUCKY 3D**](https://www.youtube.com/channel/UCuNhGhbemBkdflZ1FGJ0lUQ) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：视频、照片 \
...
## Hardware
 ...
 CPU、主板、显示器、键盘、鼠标、PC/笔记本电脑以及所有关于硬件的东西. 在这里还可以找到调制解调器和路由器，以及最新的手机和其他技术设备. 获取有关这些产品的建议和价格/质量比较.
...
[**Teaching Tech**](https://www.youtube.com/c/TeachingTech) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：印刷\
特色播放列表：“初学者 3D 打印”、“3D 打印”、“Ender 播放列表”、“Onshape 3D 建模”、“打印机评论播放列表”.
...
[**Linus Tech Tips**](https://www.youtube.com/c/LinusTechTips) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：所有硬件\
特色播放列表：`构建指南、买家指南和终极指南`、`计算机系统和一体机`、`CPU、主板、内存视频`，`更多`.
...
[**GreatScott!**](https://www.youtube.com/user/greatscottlab) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：树莓派、3D打印、电子\
精选播放列表：“3D 打印”、“DIY 或购买”、“使用 Raspberry Pi 构建您自己的流光溢彩”.  \
<br/>
...
[**ExplainingComputers**](https://www.youtube.com/user/explainingcomputers) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：树莓派、电子、操作系统 \
...
在观看这些教程时，您的专业方面可以得到加强. 重要的是要知道如何管理你的钱并跟踪它，以及获得你想要的工作或自己开始一份工作的技巧. 还可以找到编码/设计/科技公司的面试方法.
...
内容关于：求职、通用技能、生活小窍门\
精选播放列表：“寻找工作”、“经济思维播放列表”、“办公套件教程”、“做出决定”、“生活技能播放列表”、“等等！”.
...
[**mayuko**](https://www.youtube.com/c/hellomayuko) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：工作提示，健康\
精选播放列表：`如何启动你的软件工程职业`、`职业`、`技术`、`健康`.  \
<br/>
...
[**Joshua Fluke**](https://www.youtube.com/user/Tychos1) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容关于：面试、作品集审查、找工作 \
精选播放列表：“创业精神”、“如何申请工作”.  \
<br/>
...
[**Joma Tech**](https://www.youtube.com/c/JomaOppa) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/media/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges.md#verified-youtube-channel) \
内容有关：编程、工作机会、薪水、面试 \
精选播放列表：“软件工程之路”、“技术展示”、“创业系列”、“访谈”、“数据科学分析”.  \
<br/>


## Electronics and communication

市场上所有旧的和新的电子元件的所有教程和视频. 如何开始使用电子产品、每一个有用的资源，以及从在该领域有更多经验的人那里获得建议/推荐使用哪种产品以及为什么.
