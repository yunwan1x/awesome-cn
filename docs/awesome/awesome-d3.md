...
<br />We decided not to list tutorials, resources or concepts here, because there is already a **[very good list of readings](https://github.com/mbostock/d3/wiki/Tutorials)** 在那里你可以签出并做出贡献.
...
- [react-vis](https://github.com/uber/react-vis) - 一组用于呈现可视化的反应组件 [区域、条形、热图、线、散点图]
...
- [semiotic](https://github.com/emeeks/semiotic) - 结合 React 和 D3 [散点、线、区域] 的数据可视化框架
...
- [d3-xray](https://github.com/vijithassar/d3-xray) - 当您将鼠标悬停时，记录数据结果的书签会加入
