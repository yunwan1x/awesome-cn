...
- [**normalize.css**](https://necolas.github.io/normalize.css/) - 现代的、支持 HTML5 的 CSS 重置替代方案.  
...
- [**modern-normalize**](https://github.com/sindresorhus/modern-normalize) - 仅适用于 Chrome、Firefox 和 Safari（不支持 Edge 或 Internet Explorer）.  
...
- [**Marx**](https://mblode.github.io/marx/) - 无类 CSS 重置.  
...
- [**Tacit**](https://yegor256.github.io/tacit/) - 傻瓜的 CSS 框架，没有类.  
...
- [**Pure**](https://purecss.io) - 您可以在每个 Web 项目中使用的一组小型响应式 CSS 模块.  
...
- [**UIkit**](https://getuikit.com) - 轻量级和模块化的前端框架，用于开发快速而强大的 Web 界面.  
...
- [**Carbon Components**](https://www.carbondesignsystem.com/) - IBM 的 Carbon Design System 背后的组件库.  
...
- [**Material Components Web**](https://material.io/components/web/) - 用于 Web 的模块化和可定制的 Material Design UI 组件.  
...
- [**TuiCss**](https://github.com/vinibiavatti1/TuiCss) - 用于创建 MS-DOS 界面的库.  
...
- [**Semantic UI**](https://semantic-ui.com) - 用户界面是网络语言.  
...
- [**mini.css**](https://minicss.org) - 最小的、响应式的、样式无关的 CSS 框架.  
...
- [**Wing**](https://kbrsh.github.io/wing/) - 为极简主义者设计的漂亮 CSS 框架.  
...
- [**Concise CSS**](https://concisecss.com)  - 放弃膨胀. 别被你的课绊倒了. 简明扼要.  
...
- [**Responsive Boilerplate**](https://responsivebp.com) - 用于构建响应式网站的强大、可访问、开发人员友好的框架.  
...
- [**Centurion**](https://www.centurionframework.com) - 基于 Web 的框架，用于快速原型设计和构建更大的 Web 项目.  
...
GitHub star 的图片由 [Shields](https://github.com/badges/shields).
