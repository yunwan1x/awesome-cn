...
- [DotJobs](https://dotjobs.net/) - Substrate 和 Polkadot 生态系统项目的工作板，由维护 [Stateless.Money](https://stateless.money/).
- [Developer Hub GitHub](https://github.com/substrate-developer-hub/) - Substrate 开发者中心存储库.
- [Ecosystem Projects](https://substrate.io/ecosystem/projects/) - 使用 Substrate 构建项目和团队.
...
- [Frontier](https://github.com/paritytech/frontier/tree/master/template) - Fronter 启用了 EVM 和 Ethereum RPC 兼容的 Substrate 节点，准备好进行黑客攻击.
- [Front-End](https://github.com/substrate-developer-hub/substrate-front-end-template) - Polkadot-JS API 和 [React](https://reactjs.org/) 应用程序为基于 Substrate 的链构建前端.
...
- [Cumulus](https://github.com/paritytech/cumulus) - 一组用于编写基于 Substrate 的 Polkadot 平行链的工具.
...
- [Fork Off Substrate](https://github.com/maxsam4/fork-off-substrate) - 帮助以运行链的状态引导新链的脚本.
...
- [OnFinality](https://onfinality.io) - 为基于共享 Substrate 的节点提供免费和付费服务.
