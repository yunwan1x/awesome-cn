...
**Zebrafish** 是一个轻量级、功能齐全、速度极快的 ZSH 微框架，仅包含在一个文件中.
 ...
 **ZI** 是 Zsh Unix shell 的瑞士军刀. 原名zplugin、zinit. 子—— [Wiki Pages](https://z-shell.pages.dev/).

奖励：您可以使用 [zi-console](https://github.com/z-shell/zi-console) 查看和更改 ZSH 会话的状态（例如：列出和卸载插件）并从磁盘中删除插件和片段.
...
* 创建别名、函数和环境变量，并在下一次 shell 启动时提供它们.
...
* [zsh-quickstart-kit](https://github.com/unixorn/zsh-quickstart-kit) - 使用 ZSH 的简单快速入门 [zgenom](https://github.com/jandamm/zgenom) . 这会自动配置 ZSH 以使用 [zgenom](https://github.com/jandamm/zgenom) 加载精选的插件集合并定期自动更新自身、插件和快速入门工具包本身.
...
* [BlaCk-Void-Zsh](https://github.com/black7375/BlaCk-Void-Zsh)  - :crystal_ball：很棒的、可定制的 Zsh 入门套件 :stars::stars:. 包括电力线、`fzf` 集成、在某些终端中查看天气和图像.
...
* [apparix](https://github.com/micans/apparix) - 带有跳转到书签的命令行目录书签、子目录选项卡完成、远程列表等.
...
* [aws](https://github.com/apachler/zsh-aws) - 从原来的 oh-my-zsh 分叉 [aws](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/aws) . 包括“awscli”的补全和一些用于管理 AWS 配置文件并在您的提示中显示它们的实用程序.
...
* [azure-keyvault](https://github.com/milespossing/Azure-Keyvault-Zsh) - 使从 cli 使用 azure keyvaults 变得不那么冗长.
...
* [defer](https://github.com/romkatv/zsh-defer)  - 推迟执行 `zsh` 命令，直到 `zsh` 无事可做并等待用户输入. 它的预期目的是分阶段启动 `zsh`. 它的工作原理类似于 Turbo 模式 [zinit](https://github.com/zdharma-continuum/zinit).
...
* [dev](https://github.com/sbfaulkner/dev-plugin-zsh) - 提供轻量版的 Shopify 内部开发工具
...
* [git-worktree](https://github.com/alexiszamanidis/zsh-git-worktree)  - 包装一些 `git worktree` 操作以实现简单性和生产力. 包括 `fzf` 工具.
...
* [jq (northismirror)](https://github.com/NorthIsMirror/jq-zsh-plugin) - 交互式构建 [jq](https://stedolan.github.io/jq/) 表达给你`jq`超能力.
...
* [magic-enter](https://github.com/zshzoo/magic-enter) - 通过将 ZSH 命令绑定到它，使您的输入键变得神奇.
...
* [noreallyjustfuckingstopalready](https://github.com/eventi/noreallyjustfuckingstopalready) - macOS 用户知道在他们的 macOS 版本上试图找出实际刷新 DNS 缓存的命令的痛苦，而这个插件使这种烦恼消失了.
...
* [web-search (sinetoami)](https://github.com/sinetoami/web-search) - 添加命令以直接从 CLI 运行 bing、google、yahoo 和duckduckgo 搜索.
...
* [zbrowse](https://github.com/zdharma-continuum/zbrowse) - 在做shell工作时，经常会出现多次调用echo $variable，检查循环结果等的情况.使用ZBrowse，你只需要按`Ctrl-B`，它就会调用ZBrowse – Zshell可变浏览器.
...
* [zellij (jaeheonji)](https://github.com/jaeheonji/zsh-zellij-plugin) - 提供一个使用环境 [zellij](https://github.com/zellij-org/zellij) . 需要`tmux`.
...
* [zinit-annex-bin-gem-node](https://github.com/zdharma-continuum/zinit-annex-bin-gem-node) - [zinit](https://github.com/zdharma-continuum/zinit) 在不改变 $PATH 的情况下公开二进制文件的扩展，安装 Ruby gems 和 Node 模块并轻松公开它们的二进制文件，并在更新相关插件或代码片段时更新 gems 和模块.
* [zinit-annex-default-ice](https://github.com/zdharma-continuum/zinit-annex-default-ice) - 允许用户为多个 zinit 命令定义激活的冰.
...
* [zinit-annex-patch-dl](https://github.com/zdharma-continuum/zinit-annex-patch-dl) - [zinit](https://github.com/zdharma-continuum/zinit) 通过提供的`dl`和`patch` zinit ices下载文件和应用补丁的扩展.
* [zinit-annex-readurl](https://github.com/zdharma-continuum/zinit-annex-readurl) - 添加功能以自动下载在网页上托管 URL 的文件的最新版本.
...
* [zinit-annex-test](https://github.com/NorthIsMirror/z-a-test) - [zinit](https://github.com/zdharma-continuum/zinit) 在安装和更新插件或代码片段后运行测试的扩展（例如通过 make test）——如果它找到了其中的任何一个.
...
* [zoxide (ajeetdsouza)](https://github.com/ajeetdsouza/zoxide) - 学习您的习惯的“cd”的快速替代品.
* [zoxide (hermitmaster)](https://github.com/hermitmaster/zsh-zoxide-plugin) - 自动加载 `zoxide` ZSH 设置.
...
* [expressvpn](https://github.com/tk7r/zsh-expressvpn) - 添加选项卡完成 [expressVPN](https://www.expressvpn.com/support/vpn-setup/app-for-linux/) 客户.
...
* [okta](https://github.com/sirhc/okta.plugin.zsh) - 提供命令行完成 [`aws-okta`](https://github.com/segmentio/aws-okta) 和 [okta-awscli](https://github.com/jmhale/okta-awscli) comm和s.
...
* [zstyle-completions](https://github.com/zshzoo/zstyle-completions) - 给予 [prezto-style](https://github.com/sorin-ionescu/prezto) 当你点击标签时完成.
...
* [chinipage](https://github.com/andresemartinez/chinipage-zsh-theme)  - 极简主义主题，包括`git` 装饰. 需要与电力线兼容的字体和 [git-prompt](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/git-prompt) 插入.
...
* [dragon (jeop10)](https://github.com/jeop10/dragon)  - 受 kali linux 的启发. 包括 `git` 状态和工作目录装饰.
...
* [elm](https://github.com/gacallea/elm-zsh-theme) - 包括 `git` 状态、user@host、日期、时间和路径修饰符.
...
* [gal](https://github.com/x6r/gal) - gal 是基于 [gallois](https://github.com/ohmyzsh/ohmyzsh/commits/master/themes/gallois.zsh-theme).
...
* [gimbo](https://github.com/gimbo/gimbo.zsh-theme) - 一个变种 [purepower](https://github.com/romkatv/dotfiles-public/blob/master/.purepower) 具有更多功能，一点点吸引眼球和上下文相关的额外线条. 包括 `git` 状态修饰、历史编号、用户名/主机名上下文、目录状态、最后一个命令的状态（如果存在）以及 Python virtualenv 名称（如果存在）.
...
* [gruvbox (hgaiser)](https://github.com/hgaiser/gruvbox-zsh) - 设置颜色从 [gruvbox](https://github.com/morhetz/gruvbox) “vim”插件.
...
* [hometown](https://github.com/olets/hometown-prompt) - 一个功能丰富、高性能的“git”感知 ZSH 主题，其中包含用户、主机、时间、当前工作目录及其父目录的段，以及 Git 存储库中详细的完整 Git 状态.
...
* [intheloop-powerline](https://github.com/zyphrus/intheloop-powerline) - 扩展 [intheloop](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/intheloop.zsh-theme) theme to use powerline fonts.
...
* [just-around-the-corner](https://github.com/DevinLeamy/just-around-the-corner)  - 倒数直到圣诞节的日子. 包括 `git` 状态装饰.
...
* [laniksj](https://github.com/LanikSJ/laniksj-zsh-theme)  - 在深色背景上效果最佳. 基于大 [ys theme](http://ysmood.org/wp/2013/03/my-ys-terminal-theme/) 和 [Honukai ZSH Theme](https://github.com/oskarkrawczyk/honukai-iterm-zsh). Shows root status 和 `git` status decorations.
...
* [liver](https://github.com/RenoirTan/liver.zsh-theme) - 丰富多彩，包括`git` 状态、用户、主机、当前存储库根装饰的当前和相对路径.
...
* [materialshell](https://github.com/carloscuesta/materialshell) - 一个 [material design](https://material.io/guidelines/style/color.html) 外壳的主题，具有良好的对比度和重要部分的颜色. 专为轻松保护眼睛而设计.
...
* [minima (ednikolenko)](https://github.com/ednikolenko/minima)  - 一个最小的 ZSH 主题，带有 `git`、`docker`、`go`、`node`、`npm`、`python` 和其他指标. 对某些标记使用 unicode 字符.
...
* [nt9](https://github.com/lenguyenthanh/nt9-oh-my-zsh-theme)  - 一个干净、无干扰且以“git”为重点的开发主题. 显示相对于 `git` 根目录（或 ~ 在 `git` 存储库之外）的路径、自上次提交以来的时间、当前 SHA、分支和分支状态.
...
* [oblong](https://github.com/Ansimorph/oblong) - 基于`bash`的简单主题 [gitster](https://github.com/shashankmehta/dotfiles/blob/master/thesetup/zsh/.oh-my-zsh/custom/themes/gitster.zsh-theme) 和 [basher](https://gitlab.com/Spriithy/basher). Includes status decorations to show if user is root, the exit status of last comm和 run, `git` branch 和 its clean/dirty status.
...
* [owi](https://github.com/owitech/zsh-theme/) - 带有 `git` 状态装饰的简约主题.
...
* [pecodez](https://github.com/pecodez/pecodez-zsh-theme)  - 针对暗终端进行了优化. 具有用于 `snyk` 版本、`node` 版本、AWS 配置文件、kubernetes 上下文和 `git` 状态的装饰器.
* [pentesters](https://github.com/sdcampbell/lpha3cho-Oh-My-Zsh-theme-for-pentesters) - 修改后的版本 [intheloop](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/intheloop.zsh-theme) theme for pentesters which includes the date, time, and IP address for pentest logging.
...
* [piboy](https://github.com/sflems/piboy-zsh-theme)  - ZSH 简洁优雅的多行主题. 包括彩色时间戳、`git` 和语法突出显示，以及提升的根主题.
...
* [powerline-hs](https://github.com/rdnetto/powerline-hs) - 一个 [Powerline](https://github.com/powerline/powerline) 用 Haskell 编写的克隆. 它比原始实现快得多，并且使 shell 的响应速度明显更快.
...
* [powerline-shell (banga)](https://github.com/b-ryan/powerline-shell) - 一个 [powerline](https://github.com/Lokaltog/vim-powerline) - 类似 Bash、ZSH 和 Fish 的提示. 显示关于 git/svn/hg/fossil 分支的重要细节，易于定制/扩展.
* [powerline-train](https://github.com/sherubthakur/powerline-train) - 电力线变体.
* [powerline](https://github.com/carlcarl/powerline-zsh) - 一个 [Powerline](https://github.com/Lokaltog/vim-powerline)- 类似提示，基于 [powerline-bash](https://github.com/milkbikis/powerline-bash) . 显示 virtualenv、`git` 状态信息和上次命令运行的退出代码.
...
* [pronto](https://github.com/jthat/zsh-pronto) - 简单快速的主题，带有`git` 装饰和计时信息.
...
* [pure](https://github.com/sindresorhus/pure)  - 漂亮、最小且快速的 ZSH 提示. 包括 `git` 状态装饰，如果上一个命令失败，提示变为红色，在远程会话或容器中时的用户名和主机装饰，以及进程运行时的当前文件夹和命令.
...
* [pustelto](https://github.com/Pustelto/shell_theme) - 灵感来自于的多彩主题 [Spaceship](https://github.com/denysdovhan/spaceship-prompt) 主题，包括 `git` 装饰.
...
* [scythe](https://github.com/kostoskistefan/scythe)  - 电力线让人联想到的主题. 包括`git`、最后一个命令退出状态和目录装饰.
...
* [simple (daopengz)](https://github.com/DaopengZ/simple-zsh-theme)  - 适用于明暗终端主题. 包括 `vcs`、`username` 和 `path` 装饰.
...
* [svs](https://github.com/SvS30/svs-theme) - 带有“git”状态和当前路径装饰的干净和无干扰的主题.
...
* [unicorn](https://github.com/juliuscaesar/unicorn) - 灵感来自 [Wild Cherry](https://github.com/mashaal/wild-cherry) 主题. 有表情符号`git` 状态装饰.
...
* [wade](https://github.com/wadehammes/wade.zsh-theme) - Mashup of the popular ZSH themes [Agnoster](https://gist.github.com/agnoster/3712874) 和 [Fishy](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/fishy.zsh-theme)，进行一些视觉调整.
...
* [xavi](https://github.com/onthedock/xavi.zsh-theme) - 修改后的版本 [gnzh](https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/gnzh.zsh-theme) 带有用于“git”状态和当前目录的表情符号装饰的主题.
...
* [xris47](https://github.com/ivan-ristovic/xris47.zsh-theme)  - 快速、简单和精简的主题. 与 [tmux](https://github.com/tmux/tmux/wiki) 和 [vim-airline](https://github.com/vim-airline/vim-airline).
...
* [zys](https://github.com/ZYSzys/zys-zsh-theme) - 如同 [Agnoster](https://github.com/agnoster/agnoster-zsh-theme)，旨在根据上下文公开信息，具有电力线美学.
...
* [awesome-sysadmin](https://github.com/n1trux/awesome-sysadmin) - 精选的优秀开源系统管理员资源列表
...
- 这 [ZSH Reference Card](http://www.bash2zsh.com/zsh_refcard/refcard.pdf) 和 [zsh-lovers site](https://grml.org/zsh/zsh-lovers.html) 缺一不可.
