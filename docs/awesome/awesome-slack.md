...
- [java-slack-sdk](https://github.com/slackapi/java-slack-sdk) - 用于构建 Slack 应用程序的 Slack 官方 Java 框架
...
- [jinora](https://github.com/sdslabs/jinora) - Slack webhook 应用程序来创建匿名公共频道

### Java

- [simple-slack-api](https://github.com/Ullink/simple-slack-api) - Java 中的 Slack 客户端库
- [tasks-app](https://github.com/slackapi/tasks-app) - Slack 出品的简单任务管理应用
