...
- [VSCoq](https://github.com/coq-community/vscoq) - Visual Studio 代码编辑器的扩展.
...
- [Introduction to Computational Logic](https://cms.sic.saarland/icl_21/2/Resources) - 介绍逻辑原理、构造类型理论和使用 Coq 证明的交互式定理.
