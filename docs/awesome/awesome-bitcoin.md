...
## Utilities
* [Nigiri](https://github.com/vulpemventures/nigiri/)  - CLI 与 Electrs 和 Esplora 一起快速启动比特币 regtest 框. 包括水龙头和推送命令.
* [Nigiri in Travis](https://github.com/vulpemventures/nigiri-travis) - 用于将 Nigiri 添加到 Travis（或 Github Action）管道的 Travis 模板.
...
* [HD Wallet Scanner](https://github.com/alexk111/HD-Wallet-Scanner) - 在您的比特币高清钱包中查找所有使用过的地址，绕过缺口限制.
* [LibreSelery](https://github.com/protontypes/libreselery) - 自动向您的项目贡献者分发比特币，并将依赖项集成到 GitHub Actions 中. 
...
## Market Data API
* [CoinMetrics.io](https://docs.coinmetrics.io/api/v2/) 可访问市场数据的 JSON REST API（免费和付费）. 也可下载 CSV 数据文件.
* [Messari.io](https://messari.io/api) JSON REST API（免费和付费），可访问市场数据、新闻、指标、资料等. 
...
* [Blockstream.info](https://blockstream.info) - 带有 API（主网、测试网和 Liquid）的区块链浏览器.
...
* [QBitNinja](https://github.com/MetacoSA/QBitNinja) - 一个开源且功能强大的区块链 API.
...
## Blockchain dump
* [WebBTC](http://dumps.webbtc.com/bitcoin/) - 这些是 webbtc.com 生成的 bitcoin-ruby-blockchain 数据库的 postgres 数据库转储.
...
* [BitcoinABE](https://github.com/bitcoin-abe/bitcoin-abe) - 安倍：比特币和类似货币的区块浏览器.
...
* [btcinformation.org / Developer Documentation](https://btcinformation.org/en/developer-documentation) - 为开发人员查找有用的资源、指南和参考资料.
...
* [Jameson Lopp Bitcoin Resource List](https://www.lopp.net/bitcoin-information.html) J. Lopp 精心策划的比特币资源列表和元列表
