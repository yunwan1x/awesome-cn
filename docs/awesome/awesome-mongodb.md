...
### Articles
 ...
 - [Tuning MongoDB performance for production systems (Marek Trunkat, Apify)](https://blog.apify.com/tuning-mongodb-performance/) - 调试性能问题和暴露次优查询的技术和 MongoDB Cloud 功能
...
### More
 ...
 - [MongoDB 101 by Academy 3T](https://studio3t.com/academy/) - 面向初学者的免费和自定进度的 MongoDB 课程
...
### Delphi
 - [TMongoWire](https://github.com/stijnsanders/TMongoWire) - 最小的社区德尔福驱动程序
...
### Java
 ...
 - [Hibernate OGM](https://github.com/hibernate/hibernate-ogm) - 适用于 NoSQL 数据存储的 JPA 的强大功能和简单性
...
### JavaScript
 ...
 - [Meteor](https://github.com/meteor/meteor) - 基于 MongoDB 的实时/反应式客户端-服务器框架，具有很多特性
 ...
 - [Moonridge](https://github.com/capaj/Moonridge) - 基于 Mongoose 和 socket.io 的实时查询框架
...
### Lisp
 - [cl-mongo](https://github.com/fons/cl-mongo) - 社区通用 Lisp 界面
...
### PHP
 - [Doctrine MongoDB](https://github.com/doctrine/mongodb) - 围绕原生 PHP Mongo PECL 扩展进行包装，以提供附加功能
 - [eloquent-mongodb-repository](https://github.com/nilportugues/eloquent-mongodb-repository) - 基于 laravel-mongodb 构建的存储库实现
 - [laravel-mongodb](https://github.com/jenssegers/laravel-mongodb) - Laravel 的雄辩模型和查询构建器
 - [mongodb-repository](https://github.com/nilportugues/mongodb-repository) - 存储库实施
...
### Python
 - [Beanie](https://github.com/roman-right/beanie) - 基于异步 ODM [Motor](https://motor.readthedocs.io/en/stable/) 和 [Pydantic](https://pydantic-docs.helpmanual.io/)，它支持开箱即用的迁移
 - [Djongo](https://github.com/nesdis/djongo) - 用于 Django 的 MongoDB 连接器与 Django ORM 兼容
...
### Administration
 ...
 - [mongodb-tools](https://github.com/jwilder/mongodb-tools) - 三个简洁的 Python 脚本，用于处理集合和索引
...
### Data
 ...
 - [mongo_fdw](https://github.com/EnterpriseDB/mongo_fdw) - PostgreSQL 外来数据包装器
...
### Deployment
 ...
 - [puppet-mongodb](https://github.com/voxpupuli/puppet-mongodb) - Puppet 模块（以前的 puppetlabs-mongodb）
...
### Desktop
 ...
 - [dbKoda](https://www.dbkoda.com) - 跨平台和开源的IDE
 ...
 - [TablePlus](https://tableplus.com/) - macOS 上的本机、轻量级 GUI

### Development
 - [mgodatagen](https://github.com/feliixx/mgodatagen) - 随机数据生成器
 - [Mongo Playground](https://mongoplayground.net) - 在线查询游乐场
 - [Mongo Seeding](https://github.com/pkosiec/mongo-seeding) - Node.js 库、CLI 和 Docker 映像，用于使用 JS 和 JSON 文件填充数据库
 - [Mongoeye](https://github.com/mongoeye/mongoeye) - 模式和数据分析器：探索您收藏中的数据
 - [Variety](https://github.com/variety/variety) - 模式分析器：查看您的集合中有哪些字段以及它们的内容是什么
...
### Monitoring
 ...
 - [Percona Monitoring and Management](https://www.percona.com/software/database-tools/percona-monitoring-and-management) - 用于管理和监控数据库性能的免费和开源平台
...
### Shell
 - [mongo-hacker](https://github.com/TylerBrock/mongo-hacker) - MongoDB外壳增强

### Web
 - [adminMongo](https://github.com/mrvautin/adminMongo) - 处理连接和数据库需求的基于 Web 的用户界面
 ...
 - [Mongoku](https://github.com/huggingface/Mongoku) - 用于 Web 的 MongoDB 客户端
...
在法律允许的范围内， [Guillaume Gelin](https://github.com/ramnes) 已放弃本作品的所有版权和相关或邻近权利.
