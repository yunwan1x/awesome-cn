...
## Monitoring
  ...
  * [netdata.cloud](https://www.netdata.cloud/)  — Netdata 是一个开源工具，旨在收集实时指标.伟大的快速增长产品. 它也可以在github中找到！
...
## Forms
  ...
  * [Hyperforms.app](https://hyperforms.app/)  — 在几秒钟内创建电子邮件等表单，无需后端代码. 个人帐户每月最多可让您免费提交 50 份表格.
...
## PaaS
  ...
  * [SUSE Developer Program](https://developer.suse.com)  — 免费体验云原生生产力. 使用您自己的开发人员沙箱亲身体验 SUSE Cloud Application Platform.  1 免费申请. 免费子域与 CLI 的 API 一起提供.  1 GB 的存储和内存配额.
...
## Web Hosting
  ...
  * [Alwaysdata](https://www.alwaysdata.com/)  — 1000 MB 免费虚拟主机，支持 MySQL、PostgreSQL、CouchDB、MongoDB、PHP、Python、Ruby、Node.js、Elixir、Java、Deno、自定义网络服务器，可通过 FTP、WebDAV 和 SSH 访问； 包括邮箱、邮件列表和应用安装程序.
...
## Issue Tracking and Project Management
   ...
   * [Zube](https://zube.io)  — 项目管理，为 4 个项目和 4 个用户提供免费计划.  GitHub 集成可用.
...
## Design and UI
  ...
  * [UI Avatars](https://ui-avatars.com/)  - 用名字的首字母生成头像. 哪些网址可以直接在您的网络/应用程序中热链接. 支持通过 url 配置参数.
...
## Miscellaneous
  ...
  * [Codepng](https://www.codepng.app) - 从您的源代码中创建可在社交媒体上分享的精彩快照.
