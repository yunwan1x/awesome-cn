...
<details>
	...
	<sub>查看<a href="https://github.com/JoseDeFreitas/awesome-youtubers/blob/master/badges/README.md">“徽章”目录中的 README 文件</a>以了解徽章的含义.</sub>  <sub>YouTube 主播的顺序并不意味着质量：下面所有的 YouTube 主播都很棒.</sub>  <sub>YouTuber所在的部分是其主要内容.</sub> <sub>请注意，这<strong>不是</strong>任何形式的促销清单.</sub> <sub>还要检查<a href="https://github.com/JoseDeFreitas/awesome-youtubers/discussions">讨论</a>选项卡.</sub>
	</sub>
</details>
...
那里有很多编程语言. 在本节中，您可以找到任何编程语言，包括 Python、C、Java. 此外，许多 YouTuber 教授这些语言的框架. 不仅是编程语言，还有更通用的编程东西. 您可以找到实用教程或理论教程.
...
关于内容：PowerShell \
精选播放列表：“在一个月的午餐中学习 Windows PowerShell”、“SAPIEN PowerShell 培训”、“PowerShell 提示、技巧和片段”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Brian Will**](https://www.youtube.com/user/briantwill) \
内容：后端、渲染、理论类\
精选播放列表：`OpenGL`、`Clojure 语言`、`Python 播放列表`、`Pigeon，一种教育编程语言`、`更多有趣的播放列表！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Ben Eater**](https://www.youtube.com/c/BenEater) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容：汇编语言、硬件、计算机科学 \
精选播放列表：`构建 8 位面包板计算机！`、`网络教程`、`数字电子教程`、`很多相关视频`.
...
内容：算法，各种编程语言 \
精选播放列表：“代码的本质：使用处理模拟自然系统”、“学习处理：图像、动画和交互编程初学者指南”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Geek's Lesson**](https://www.youtube.com/c/GeeksLesson) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：后端，理论，数据\
精选播放列表：“数据结构播放列表”、“后端编程语言视频”、“数学视频”.  \
<br />
...
内容关于：后端、API \
精选播放列表：`Node.js 初学者教程`、`Python 3 初学者教程`、`C++ 初学者编程教程`、`其他有关不同编程语言的视频`.
...
内容关于：所有编程，会谈\
精选播放列表：`前端开发视频`、`后端开发视频`、`理论视频`、`更多技术主题播放列表！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Simplified Coding**](https://www.youtube.com/c/SimplifiedcodingNetOfficial) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Android，后端\
精选播放列表：`PHP、MySQL 和 Firebase 视频`、`Kotlin 编程教程`、`更多视频和播放列表`.  \
<br />
...
精选播放列表：`大量 Kotlin 和 Android 视频`、`Ruby 初学者教程`、`Dart 初学者教程`、`Java 初学者教程`.
...
精选播放列表：`Flutter Tutorials`、`Dart &amp; Dart for Beginners`、`Intro to Rust &amp; Rust Projects`.  \
<br />
...
内容：通用编程、计算机科学、Web Dev、DevOps 等.\
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**CS Dojo**](https://www.youtube.com/c/CSDojo/) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容：Python 和一般概念 \
精选播放列表：“数据结构和算法”、“绝对初学者的 Python 教程”、“编码面试问题和答案”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**sentdex**](https://www.youtube.com/c/sentdex) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
Content about: Python for AI and Finance \
精选播放列表：`Python Programming for Finance`、`Machine Learning with Python`、`Neural Networks from Scratch in Python`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**WilliamFiset**](https://www.youtube.com/c/WilliamFiset-videos) \
内容：算法，数据结构\
精选播放列表：“网络流播放列表”、“数据结构播放列表”、“图论播放列表”、“树算法”、“动态编程”.
...
内容关于：Python \
精选播放列表：“Python 30 天 ~ Python 3.8+”、“使用 Python 编码”、“Python 3.8 和 Django 3+”、“在 Windows 和 Mac 上安装和设置”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Sebastiaan Mathôt**](https://www.youtube.com/c/SebastiaanMath%C3%B4t) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Python \
精选播放列表：“Python 讲座”、“改进和优化 Python”、“其他一些 Python 播放列表！”.  \
<br />
...
精选播放列表：“用于数据分析的 Python”、“R 简介”、“Python 编程实践”、“Pandas”、“更多播放列表！”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Fun Fun Function**](https://www.youtube.com/channel/UCO1cgjhGzsSYb1rsB4bFe4Q) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
Content about: 编程原理，主要围绕 JavaScript \
精选播放列表：“js 中的 OOP”、“单元测试”、“TDD”、“JavaScript 中的函数式编程”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**KodingKevin**](https://www.youtube.com/channel/UCXpGqiSd3BD0FQ9OP3ziFsw) \
内容：数据结构、算法、编码面试 \
精选播放列表：“数组方法迷你课程”、“Javascript 算法 + 数据结构”.  \
<br />
...
Content about: C++, 游戏开发 \
精选播放列表：`Game Engine`、`C++`、`OpenGL`、`Java 中的 3D 游戏编程`.  \
<br />
...
内容有关：数据库、网络、后端开发、安全、协议、概念 \
精选播放列表：`High Availability`、`Python by Example`、`HTTP/2`、`Message Queues &amp; PubSub Systems`、`Proxies`、`更多视频教程`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Redis University**](https://www.youtube.com/c/RedisUniversity) \
内容关于：Redis \
精选播放列表：`Redis Explained: Learn Redis`.  \
<br />
...
关于内容：Python、数据结构、数据科学、机器学习、道德黑客\
精选播放列表：“算法和数据结构”、“Python 机器学习教程”、“Python AI 项目”、“Python 黑客项目”、“Python 初学者/中级教程”.
...
内容关于：Python \
精选播放列表：`Python - 中级和高级功能`、`Python 中的函数式编程`、`有效 Python 开发的工具`、`如何建立您的 Python 职业生涯`.
...
精选播放列表：“ASP.NET Core REST API 教程”、“ASP.NET Core 通用教程”、“.NET 中的基本 Nuget 包”、“软件工程基础”.
...
内容有关：Python、Java、编程练习 \
精选播放列表：“Python - 练习”、“Java - 练习”、“Numpy 播放列表”、“Pandas - 练习”、“更多播放列表”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Python In 1 Minute**](https://www.youtube.com/c/PythonIn1Minute) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Python \
精选播放列表：`1 分钟教程`、`来自各种 Python 主题的大量 Python 视频`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**NullPointer Exception**](https://www.youtube.com/channel/UCmWDlvMYYEbW42B8JyxFBcA) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：理论，数据\
精选播放列表：“数据结构简介”、“排序算法讲座/可视化”、“面向对象编程简介”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Payload**](https://www.youtube.com/channel/UCOoKt2u-bE1NuELXSFaEdUw) \
Content about: C#, WPF, .NET \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Coding with Efehan**](https://www.youtube.com/c/CodingwithEfehan) \
...
## Web development
 ...
 Web 开发包括前端开发：非常基础的（HTML、CSS 和 JavaScript）以及最现代的框架（React.js、Vue.js、Angular）. 它还包括后端开发主题，如 Node.js、GraphQL、SQL 和更基本的内容，如 DNS、URL、部署. 您还可以找到作为 Web 开发人员和其他相关工作的自由职业者.
...
Content about: 网页设计, 设计, 自由职业者 \
精选播放列表：“2020 年免费网页设计课程”、“作品集：案例研究和评论”、“如何开始自由职业”、“自由职业提示：如何寻找客户和发展业务”.
...
内容：React.js, JavaScript \
精选播放列表：`react js from scratch`、`Node.js 初学者教程`、`JavaScript 中的数据结构`、`面试准备`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Dani Krossing**](https://www.youtube.com/c/TheCharmefis) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Web 开发，后端 \
精选播放列表：`HTML 和 CSS 教程`、`JavaScript 教程`、`PHP 教程`、`jQuery 教程`.  \
<br />
...
内容关于：Web 开发、设计 \
精选播放列表：`Live Omatum Bucks Software Project Streams`、`软件项目：OmatumBucks`、`Live Omatum.com 网站开发项目 Streams`、`Uncut Live Streams`.
...
内容关于：网页设计、JavaScript、React.js \
精选播放列表：`Web 设计教程（UI 和 UX）`、`React.js 初学者教程`、`CSS 教程`、`JavaScript 教程播放列表`.
...
关于内容：网页设计、设计、UI/UX、Adobe XD \
精选播放列表：“Illustrator 教程”、“Adobe XD 教程”、“Photoshop 教程”、“最新开发图”、“最新设计图”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Traversy Media**](https://www.youtube.com/c/TraversyMedia) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：前端，后端\
精选播放列表：`HTML &amp; CSS`、`Vanilla JavaScript`、`Node.js Videos`、`React.js Projects`、`PHP Front To Back`、`更多网络开发播放列表！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Thomas Bradley**](https://www.youtube.com/c/acinteractivedesign) \
内容关于：网页设计、可访问性、性能\
精选播放列表：“可访问性和性能视频”、“Jekyll 播放列表”、“CSS 动画视频”、“SEO 视频”、“更多关于 Web 开发的视频/播放列表”.
...
内容：前端、React.js、网页设计\
精选播放列表：“React.js 教程”、“HTML、CSS 和 JavaScript 教程”、“网页设计视频 (UI/UX)”.  \
<br />
...
关于内容：JavaScript、Flutter、Firebase \
...
内容：前端、JavaScript、网页设计 \
精选播放列表：`React.js + Redux Basics`、`Vue.js 2 - Getting Started`、`Amazon Web Services Basics`.  \
<br />
...
内容：前端、网页设计、CMS \
精选播放列表：“设计教程播放列表”、“CMS 教程播放列表”、“HTML 和 CSS 教程”、“React.js 视频”、“等等！”.
...
内容关于：前端，后端\
精选播放列表：`Flutter 初学者教程`、`React.js 和 React Native 播放列表`、`很多 JavaScript 播放列表，包括 JavaScript 框架`、`GraphQL 教程`、`很多很多！`.
...
内容关于：CSS \
精选播放列表：`CSS Grid 视频`、`Flexbox 基础知识`、`响应式 CSS 教程`、`CSS 动画`、`更多 CSS 视频教程！`.
...
内容关于：前端，后端\
精选播放列表：`JavaScript course`、`Docker for Beginners`、`MongoDB and Mocha`、`Vue JS Crash Course`、`更多播放列表和视频`.
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Yuri Artyukh**](https://www.youtube.com/user/flintyara) \
内容：围绕创意编码的实时编码、WebGl (three.js, glsl) JavaScript 动画 \
精选播放列表：`JavaScript`、`Three.js`、`gsap`、`Pixi.js`、`canvas`、`glsl`、`Shaders`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Jason Lengstorf**](https://www.youtube.com/c/Lengstorf) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: Frontend, Backend, GraphQL, D3, Svelte, other technologies \
精选播放列表：`JavaScript`、`Web development`、`JAMstack`.  \
<br />
...
精选播放列表：`CSS Animations Series`、`Learn jQuery in 15 Minutes`、`Webflow From Scratch`、`Regular Expressions Series`.
...
内容：JavaScript、NextJs、NuxtJs、VueJs、ReactJs、SvelteJs、CSS 和 CSS 预处理器、Laravel \
精选播放列表：`Vuejs`、`SvelteJs`、`Laravel Livewire Full Course`、`Learn to use Nuxt.js`、`ReactJS Basics`、`Laravel PHP Framework Tutorial - Full Course 6.5 Hours (2020)`.
...
内容关于：一般 Web 开发、JavaScript、React、CSS、最佳实践和设计模式 \
精选播放列表：“小项目”、“谁想成为兆比特（琐事游戏）”、“CSS 教程”、“Web 应用安全/身份验证”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Ben Awad**](https://www.youtube.com/c/BenAwad97/) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：Web 开发、JavaScript、TypeScript、React、GraphQL \
精选播放列表：`GraphQL 教程`、`React Hooks`、`Practical React`、`Typescript、Next.js 和 GraphQL 系列`.  \
<br />
...
内容关于：前端，后端\
精选播放列表：`Node.js 播放列表`、`videos de API/REST API`、`frameworks de JavaScript`、`Node.js &amp; Mongodb CRUD 2.0`、`otros videos relacionados`.
...
关于内容：HTML、CSS、JavaScript、Firebase、FastAPI、TypeScript \
...
内容关于：前端，后端\
精选播放列表：`学习 JAVASCRIPT |  BOOTCAMP 全栈 JAVASCRIPT`、`REACT.JS`、`ADVANCED JAVASCRIPT`、`PHP Programming`、`VUE + FIREBASE`.
...
关于内容：JavaScript、TypeScript、HTML、CSS \
...
关于内容：JavaScript、React、React-Native、Next.js、Node.js、Express、GraphQL、无服务器函数 \
...
内容有关：CSS、JavaScript、WordPress、Web 开发 \
精选播放列表：“Wordpress 主题开发”、“学习 CSS”.  \
<br />


## Computer science

计算机科学的核心概念可以在这里找到. 有些频道会教你数学运算，包括很多不同数学主题的播放列表. 与计算机和硬件密切相关的数学和物理也是如此. 如果您想了解最深刻的术语，那就完美了.
...
内容：电子、网络、理论课 \
精选播放列表：`网络理论`、`计算机网络`、`数字电子`、`信号和系统`、`编程语言播放列表`.
...
Content about: 理论课, 讲座 \
精选播放列表：“计算机科学与安全”、“工程”、“能源技术”、“领导与管理”、“深度学习的自然语言处理”.
...
Content about: 计算机科学与通用编程 \
精选播放列表：“CS50 的 Python 人工智能简介 2020”、“CS50 的 Python 和 JavaScript 网络编程 2020”、“CS50 的游戏开发简介 2018”.
...
[<img height="16px" width="16px" alt="Badge for Spanish-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-es.svg?sanitize=true" title="This YouTuber speaks Spanish"/>](badges/README.md#spanish-speaking-youtubers) [**Memorias de un Informático**](https://www.youtube.com/c/memoriasdeuninformatico) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
内容：关于电子、Linux 和项目的课程.  \
精选播放列表：“从 0 开始的 ARM 课程”、“Linux 定制”、“电子课程”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Socratica**](https://www.youtube.com/c/Socratica) \
内容：数学、计算机、普通科学 \
精选播放列表：“抽象代数”、“学习 Python 播放列表”、“学习视频”、“更多科学主题”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Abdul Bari**](https://www.youtube.com/channel/UCZCFT11CWBi3MHNlGf019nw) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容：算法\
精选播放列表：“算法”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**mycodeschool**](https://www.youtube.com/channel/UClEEsT7DkdVO_fkrBw0OTrA) \
内容：C/C++语言、数据结构、算法\
精选播放列表：“排序算法”、“数据结构”、“C/C++ 中的指针”、“C 语言编程简介”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Gary Explains**](https://www.youtube.com/c/GaryExplains) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：概念、理论 \
精选播放列表：“Raspberry Pi”、“微控制器”、“编程”、“Linux”、“更多！”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**StatQuest with Josh Starmer**](https://www.youtube.com/c/joshstarmer) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：数据可视化、机器学习、数据操作、神经网络 \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Eddie Woo**](https://www.youtube.com/channel/UCq0EGvLTyy-LLT1oUSO_0FQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：数学\
精选播放列表：“二项式理论”、“微积分”、“代数”、“复数”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Professor Leonard**](https://www.youtube.com/channel/UCoHhuummRZaIVX7bD4t2czg) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：数学\
精选播放列表：“代数”、“统计”、“微积分”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Learn coding**](https://www.youtube.com/channel/UCV7cZwHMX_0vk8DSYrS7GCg) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：Java OOP、Oracle 数据库、数据结构（IN Hindi Lang）\
精选播放列表：“Java OOP”、“Oracle 数据库”、“C 程序”.  \
<br />


## Machine learning

查找在深度学习、自然语言处理、神经网络以及与这一广泛类别相关的更多主题方面经验丰富的 YouTube 用户. 机器学习的一个好处是它可以使用不同的编程语言来应用，并且核心概念满足不同编程语言的相同结构.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Abhishek Thakur**](https://www.youtube.com/c/AbhishekThakurAbhi) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：实用视频，讲座\
精选播放列表：`Applied Machine Learning Framework`、`Tips &amp; Tricks of machine learning`、`更多视频！`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Ahlad Kumar**](https://www.youtube.com/c/AhladKumar) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: 深度学习, 理论\
精选播放列表：“深度学习”、“卷积神经网络”、“神经网络播放列表”、“更多播放列表！”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Aladdin Persson**](https://www.youtube.com/c/AladdinPersson) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：PyTorch、TensorFlow \
精选播放列表：“PyTorch 教程”、“TensorFlow 2.0 初学者教程”、“机器学习算法”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Andreas Mueller**](https://www.youtube.com/c/AndreasMueller) \
Content about: 机器学习 \
精选播放列表：“应用机器学习 2020”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Data School**](https://www.youtube.com/c/dataschool) \
内容：Python、机器学习、理论\
精选播放列表：“机器学习播放列表简介”、“使用 Pandas 进行 Python 数据分析”、“其他会谈视频和 Python 视频”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Henry AI Labs**](https://www.youtube.com/channel/UCHB9VepY6kYvZjj0Bgxnpbw) \
内容：理论\
精选播放列表：“深度学习论文摘要”、“强化学习”、“生成对抗网络”、“神经网络设计”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Rasa**](https://www.youtube.com/c/RasaHQ) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Rasa、AI、NLP \
精选播放列表：“面向开发人员的 NLP”、“使用 Rasa 工具开发上下文 AI 助手”、“算法白板”、“实时编码”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Yannic Kilcher**](https://www.youtube.com/c/YannicKilcher) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：NLP、机器学习、深度学习、理论\
精选播放列表：“自然语言处理”、“通用机器学习”、“深度学习架构”、“计算机视觉”、“机器学习应用”、“更多！”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**OpenAI**](https://www.youtube.com/channel/UCXZCJLdBC09xxGZ6gcdrc6A) \
内容：NLP、机器学习、AI \
精选播放列表：“事件和会谈”、“研究发布”、“机器人”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Two Minute Papers**](https://www.youtube.com/c/K%C3%A1rolyZsolnai) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：机器学习和人工智能研究，科学论文\
精选播放列表：“两分钟论文”、“AlphaGo”、“流体、布料和头发模拟”、“人工智能和深度学习”、“光传输、光线追踪和全局照明”.
...
[<img height="16px" width="16px" alt="Badge for Spanish-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-es.svg?sanitize=true" title="This YouTuber speaks Spanish"/>](badges/README.md#spanish-speaking-youtubers) [**Ringa Tech**](https://www.youtube.com/c/RingaTech) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekle"/>](badges.md#weekly-video-upload) \
Content about: 人工智能、神经网络 \
精选播放列表：“人工智能”、“使用 Python 和 Tensorflow 从零开始的人工智能”、“人工智能”.
...
[<img height="16px" width="16px" alt="Badge for French-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-fr.svg?sanitize=true" title="This YouTuber speaks French"/>](badges/README.md#french-speaking-youtubers) [**Machine Learnia**](https://www.youtube.com/c/MachineLearnia) \
内容关于：机器学习、Scikit Learn、Python \
精选播放列表：“FORMATION DEEP LEARNING”、“SKLEARN tutorialel français Machine Learning”、“PYTHON SPÉCIAL MACHINE LEARNING”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**ScriptersWar**](https://www.youtube.com/c/ScriptersWar) \
关于内容：JavaScript、HTML5 \
精选播放列表：`如何制作 HTML5 游戏：面向初学者的 JavaScript 教程 JS 指南`，`更多视频`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Brackeys**](https://www.youtube.com/c/Brackeys) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Jonas Tyroller**](https://www.youtube.com/c/JonasTyroller) \
内容关于：GameMaker Studio、提示和计划播放列表 \
精选播放列表：`你会蜗牛吗？  - 全面开发.`、`游戏开发技巧`、`如何开始游戏开发.`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**RealTutsGML**](https://www.youtube.com/c/RealTutsGML) \
内容有关：Java、GameMaker Studio \
精选播放列表：`Java Basic Programming`、`Cool Game Maker Tutorials`、`Beginner Java Game Development`、`Java Platform Game Programming`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Mark Rise**](https://www.youtube.com/channel/UCX4mqbvv5lGqLpI4FYlJt4w) \
Content about: 游戏设计、动画\
精选播放列表：“几何设计播放列表”、“视频游戏角色动画课程”、“After Effects 动画教程”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Chris Courses**](https://www.youtube.com/c/ChrisCourses) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：HTML5 Canvas、JavaScript \
精选播放列表：`HTML5 Canvas 初学者教程 | 成为 Canvas Pro`、`其他 JavaScript 相关视频`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Zenva**](https://www.youtube.com/c/Zenva) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：Unity、虚幻引擎、Godot \
精选播放列表：`Master Unity Game Development`、`Unreal Game Development Mini-Degree`、`Godot Game Development Mini-Degree`、`更多关于游戏开发和设计的播放列表！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Mix and Jam**](https://www.youtube.com/c/MixandJam) \
内容关于：团结\
精选播放列表：“Mix and Jam Recreations”、“Game Jams”、“RE Mix and Jam”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Sebastian Lague**](https://www.youtube.com/c/SebastianLague) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
Content about: Unity, C#, Game design \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**DaFluffyPotato**](https://www.youtube.com/c/DaFluffyPotato) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Pygame \
精选播放列表：`Pygame 教程系列（初学者）`、`Pygame 教程系列（业余）`、`Pygame 教程系列（高级）`、`更多 Pygame 视频！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**ChiliTomatoNoodle**](https://www.youtube.com/c/ChiliTomatoNoodle) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：C++、DirextX、3D \
精选播放列表：`初级 C++ 游戏编程`、`中级 C++ 游戏编程`、`高级 C++ 游戏编程`、`3D 编程基础`、`C++ 3D DirextX 编程`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**GDQuest**](https://www.youtube.com/channel/UCxboW7x0jZqFdvMdCFKTMsQ) \
内容关于：戈多\
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**HeartBeast**](https://www.youtube.com/user/uheartbeast) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: GODOT, 2D, GameMaker \
精选播放列表：“Godot 引擎教程”、“Godot 中基于资源的库存教程”、“2D Hack-n-Slash 课程（完整课程）”、“GameMaker 平台教程”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Meth Meth Method**](https://www.youtube.com/c/MethMethMethod) \
内容关于：JavaScript \
精选播放列表：`用 JavaScript 编写的超级马里奥兄弟`、`用 Javascript 创建俄罗斯方块在线多人游戏`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Clear Code**](https://www.youtube.com/c/ClearCode) \
内容关于：Python \
精选播放列表：“Pygame 基础”、“在 Pygame 中创建 Pong”、“通过制作 Flappy Bird 学习 pygame”、“Godot 中的 Google 恐龙跑者”.
...
如今，我们无法想象没有智能手机的生活，而实现智能手机体验的人是移动应用程序开发人员. 在本节中，您可以了解如何从头开始构建面向消费者的移动应用程序. 了解如何遵循行业最佳实践. 学习 Kotlin 或 Swift 在 Android/iOS 中进行原生开发，或学习 React Native 和 Flutter 等技术进行跨平台移动开发.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Philipp Lackner**](https://www.youtube.com/c/PhilippLackner) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：Android、Kotlin、Jetpack Compose \
精选播放列表：`ANDROID FUNDAMENTALS FOR BEGINNERS`、`KOTLIN NEWBIIE TO PRO`、`Jetpack Compose`.  \
<br />


## Cybersecurity

安全是我们所有人都应该关心的事情. 了解如何保护自己免受攻击者或恶意软件的侵害. 通过道德黑客教程，还可以了解黑客是如何深入了解他们内部发生的事情的.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**David Bombal**](https://www.youtube.com/c/DavidBombal) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：道德黑客，Linux \
精选播放列表：`CCNA 考试：200-125、100-105 和 200-105`、`Cisco 播放列表`、`SDN 视频`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Andreas Kling**](https://www.youtube.com/c/AndreasKling) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：黑客\
精选播放列表：`Browser hacking`、`DevTools hacking`、`OS hacking`、`SerenityOS`、`Emulator hacking`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Professor Messer**](https://www.youtube.com/channel/UCkefXKtInZ9PLsoGRtml2FQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：安全\
精选播放列表：`CompTIA Security+ SY0-501 Training Course`、`CompTIA N10-007 Network+ Study Groups`、`还有更多类似的！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**CodeCommand**](https://www.youtube.com/c/CodeCommand) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：道德黑客，安全 \
精选播放列表：`网络安全 - 渗透测试课程（进攻性安全）`、`Kali Linux 教程 | 渗透测试方法|`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**LiveOverflow**](https://www.youtube.com/c/LiveOverflow) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容关于：道德黑客\
精选播放列表：“浏览器开发”、“硬件安全研究/移动”、“二进制开发”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**NullByte**](https://www.youtube.com/channel/UCgTNupxATBfWmfehv21ym-g) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：网络和安全、渗透测试工具教程、道德黑客\
精选播放列表：`Using Wireshark`、`NodeMCU`、`RaspberryPi`、`Cyber​​ Weapons lab`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Hackersploit**](https://www.youtube.com/channel/UC0ZTPkdxlAKf-V33tqXwi3Q) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：渗透测试、道德黑客攻击、Linux \
精选播放列表：`Metasploit`、`Linux`、`NMap`、`Osint`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Gerald Auger**](https://www.youtube.com/c/GeraldAuger) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: 网络安全 \
精选播放列表：“闯入网络安全视频 - 简单网络”、“网络安全求职 QA 与招聘人员”、“免费 Pentester 列表伴侣”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Network Chuck**](https://www.youtube.com/c/NetworkChuck)[<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：网络、网络安全、道德黑客\
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**John Hammond**](https://www.youtube.com/c/JohnHammond010) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：网络安全、道德黑客攻击、恶意软件分析 \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Sun Knudsen**](https://www.youtube.com/c/SunKnudsen) \
关于内容：隐私指南、比特币\
精选播放列表：“隐私指南”、“比特币系列”.  \
<br />
...
## Internet/networking
 ...
 Internet 连接和网络是一个广泛的话题，在学习这方面经常会遇到困难. 获取有关软件和硬件的精彩播放列表和视频，以了解 Internet 连接和网络的工作原理. 如何正确设置调制解调器/路由器以及 IP、DNS 等.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Net VN**](https://www.youtube.com/c/NetVNbuitronghieu) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：Internet、网络、命令行、硬件 \
精选播放列表：`大量路由器/调制解调器播放列表`、`互联网连接和网络视频的软件管理`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**NetworKing**](https://www.youtube.com/c/NetworKingInc) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容：网络，CCNA \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**PowerCert Animated Videos**](https://www.youtube.com/c/PowerCertAnimatedVideos) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
...
此类别中列出的 YouTuber 可能不是编程教程或炫酷的设计卡片，但其他一些有用的软件和应用程序每天都在为每个人使用. 掌握您经常使用的套件或了解有关公司为您提供的特定服务的更多信息.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Online Training for Everyone**](https://www.youtube.com/c/OnlineTrainingforEveryone) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：Excel、Office 套件\
精选播放列表：“Excel 2020 教程”、“高级 Excel 教程”、“Microsoft Visio 教程”、“Windows 10 教程”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Simon Sez IT**](https://www.youtube.com/c/Simonsezit) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：Office 套件、微软\
精选播放列表：“Excel 播放列表”、“QuickBooks 播放列表”、“Power BI 教程”、“Microsoft Outlook 2019”、“有关 Microsoft 程序的更多视频”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Tom Scott**](https://www.youtube.com/c/TomScottGo) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: 理论视频 \
精选播放列表：“如何构建应用程序”、“基础知识（代码）”、“其他科学视频”.  \
<br />


## Operating systems

包括用于正确管理和理解 Windows、Linux、Mac 和其他操作系统的视频和教程. 了解有用的命令和设置，以使您的操作系统保持最新和安全. 了解这些系统如何深入工作，以便您使用最佳方法控制它们.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Riba Linux**](https://www.youtube.com/c/RibaLinux) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Linux \
精选播放列表：`安装和概述`、`Linux How-to`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**MSFT WebCast**](https://www.youtube.com/c/MSFTWebCast) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Windows \
精选播放列表：“Windows Server 初学者教程”、“管理 Windows Server 中的网络服务”、“管理 Active Directory 基础架构”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**DistroTube**](https://www.youtube.com/c/DistroTube/) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
有关以下内容的内容：Linux、Emacs、CLI、一般隐私.\
精选播放列表：`Privacy &amp; Security`、`The Church of Emacs`、`The command line`、`The Arch way`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Learn LinuxTV**](https://www.youtube.com/channel/UCxQKHvKbmSzGMvUrVtJYnUA) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：Linux 教程、发行版评论、Linux 指南 \
精选播放列表：“硬件评论”、“Linux 要点”、“适合初学者的 Linux 命令”.  \
<br />


## Digital design

网页设计教程列在 [web development section](#web-development) . 但是，当然，数字设计非常大，包括漂亮的图片和关于名人的描绘或有吸引力的宣传视频. 获取有关如何做这些事情的知识，并成为设计程序的专业人士.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**How to Graphic Design**](https://www.youtube.com/c/HowtoGraphicDesign) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：Adobe Illustrator, 插图 \
精选播放列表：`Adobe Illustrator CC Flat Illustration Tutorials`、`Logo Creation Tutorials Playlist`、`Adobe Illustrator CC for Beginners`、`更多 Adob​​e Illustrator 播放列表`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**T&T Tutorials**](https://www.youtube.com/c/TTTutorials) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容有关：Adobe Illustrator、Adobe Photoshop、手绘\
精选播放列表：`Adobe Illustrator 教程`、`字符插图 Illustrator 教程`、`Adobe Illustrator 工具教程`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Pixel & Bracket**](https://www.youtube.com/c/Pixelandbracket) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Zakey Design**](https://www.youtube.com/c/ZakeyDesignow) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：Gimp、Inkscape、Adobe Illustrator \
精选播放列表：`Gimp Photo Manipulation`、`Inkscape 播放列表`、`Adobe Illustrator 视频`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Art with Flo**](https://www.youtube.com/c/ArtwithFlo) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: Procreate, Ipad/平板绘图\
精选播放列表：`PROCREATE TUTORIALS`、`DIGITAL ART TUTORIALS`、`iPad Pro 上的数字绘图 | 简易绘图教程`，`更多播放列表！`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Envato Tuts+**](https://www.youtube.com/c/tutsplus) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：所有设计，插图，网页设计 \
精选播放列表：“学习 Adob​​e Photoshop”、“了解字体”、“照片和视频处理播放列表”、“Figma 视频”、“学习照片效果”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Logos By Nick**](https://www.youtube.com/c/logosbynick) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容关于：Inkscape，Gimp \
精选播放列表：`Inkscape 初学者教程`、`GIMP 教程`、`Inkscape 字体教程`、`Inkscape 标志设计教程`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Charli Marie TV**](https://www.youtube.com/channel/UCScRSwdX0t31gjk3MYXIuYQ) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for YouTubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：网页，平面设计\
精选播放列表：“设计职业”、“工作流程”、“设计聊天”、“作为设计师的自由职业者”.  \
<br />
...
关于音频和视频制作的教程. 包括广泛的主题，例如设计、动画、渲染、硬件等. 使用最流行和最好的软件来创建令人惊叹的视频动画、制作精良的歌曲以及与这些主题相关的内容.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**OBEDIA**](https://www.youtube.com/c/Obedia) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容关于：音频、硬件\
精选播放列表：“PreSonus Studio One 教程”、“Cubase 教程”、“OBEDIA 的 Ableton 教程”、“Cakewalk 声纳教程”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Black Mixture**](https://www.youtube.com/c/BlackMixture) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: After Effects, 动画 \
精选播放列表：`SPEEDPAINT ANIMATION`、`Motion Design`、`After Effects Tutorials`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Avnish Parker**](https://www.youtube.com/user/avnishparker) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
内容：动画、设计\
精选播放列表：`After Effects 教程`、`文本动画 - After Effects 教程`、`Logo Intro - After Effects 教程`、`动态图形 - After Effects 教程`.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Deny King**](https://www.youtube.com/c/DenyKingYoutube) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：视频、照片\
精选播放列表：“视频编辑”、“操作 PicsArt”、“许多其他视频/照片编辑视频”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Blender Guru**](https://www.youtube.com/user/AndrewPPrice) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
Content about: Blender, 3D 建模 \
精选播放列表：`Blender 初学者教程系列`、`Blender 造型椅教程`、`沙发教程系列`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Grant Abbitt**](https://www.youtube.com/user/badgesgabbitt) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: 3D 建模、Reptology、Blender \
精选播放列表：“在 Blender 2.8 中学习雕刻”、“Blender 2.8 初学者完整课程”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**CG Fast Track**](https://www.youtube.com/c/CGFastTrack) \
Content about: Blender, 3D 建模 \
精选播放列表：`Blender 2.9 Beginner Tutorial Series`、`CG Fast Track`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**DUCKY 3D**](https://www.youtube.com/channel/UCuNhGhbemBkdflZ1FGJ0lUQ) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：视频、照片\
精选播放列表：`使用节点着色`.`在 Eevee 引擎中使用 Blender 制作循环动画` \
<br />


## Hardware

 CPU、主板、显示器、键盘、鼠标、PC/笔记本电脑和所有关于硬件的东西. 调制解调器和路由器也可以在这里找到，以及最新的手机和其他技术小工具. 获取有关这些产品的建议和价格/质量比较.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Teaching Tech**](https://www.youtube.com/c/TeachingTech) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：印刷\
精选播放列表：“初学者 3D 打印”、“3D 打印”、“Ender 播放列表”、“Onshape 3D 建模”、“打印机评论播放列表”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Linus Tech Tips**](https://www.youtube.com/c/LinusTechTips) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：所有硬件\
精选播放列表：“构建指南、购买指南和终极指南”、“计算机系统和一体机”、“CPU、主板、内存视频”、“更多”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**educ8s.tv**](https://www.youtube.com/c/Educ8s) \
关于内容：Arduino \
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**GreatScott!**](https://www.youtube.com/user/greatscottlab) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
内容：树莓派、3D 打印、电子产品 \
精选播放列表：“3D 打印”、“DIY 或购买”、“使用 Raspberry Pi 构建自己的流光溢彩”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**RaspberryPiIVBeginners**](https://www.youtube.com/user/RaspberryPiBeginners) \
内容关于：树莓派 \
精选播放列表：“树莓派入门”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**ExplainingComputers**](https://www.youtube.com/user/explainingcomputers) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: Raspberry Pi, 电子产品, 操作系统 \
精选播放列表：“人工智能”、“Pi 零项目”、“迁移到 Linux”、“更多”.  \
<br />


## Life skills and job searching

在观看这些教程时，您的专业方面可以得到加强. 重要的是要知道如何管理你的钱并跟踪它，以及获得你想要的工作或自己开始工作的技巧. 还可以找到编码/设计/技术公司的面试方法.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**GCFLearnFree.org**](https://www.youtube.com/c/GcflearnfreeOrgplus) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
Content about: 求职, 一般技能, 生活小贴士 \
精选播放列表：“寻找工作”、“经济思维播放列表”、“Office 套件教程”、“做出决定”、“生活技能播放列表”、“等等！”.
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Joshua Fluke**](https://www.youtube.com/user/Tychos1) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges/README.md#weekly-video-upload) \
关于内容：面试、投资组合评论、找工作 \
精选播放列表：“创业”、“如何申请工作”.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for English-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-en.svg?sanitize=true" title="This YouTuber speaks English"/>](badges/README.md#english-speaking-youtubers) [**Joma Tech**](https://www.youtube.com/c/JomaOppa) [<img height="16px" width="16px" alt="Badge for verified YouTube channels" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-verified.svg?sanitize=true" title="Is a verified YouTube channel"/>](badges/README.md#verified-youtube-channel) \
关于内容：编程、工作机会、薪水、面试 \
精选播放列表：`Path to Software Engineering`、`Tech Shows`、`Startup Series`、`Interviews`、`Data Science Analytics`.  \
<br />
...
[<img height="16px" width="16px" alt="Badge for French-speaking YouTubers" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-fr.svg?sanitize=true" title="This YouTuber speaks French"/>](badges/README.md#french-speaking-youtubers) [**Benjamin Code**](https://www.youtube.com/c/BenjaminCode/) [<img height="16px" width="16px" alt="Badge for youtubers that upload videos weekly" src="https://raw.githubusercontent.com/JoseDeFreitas/awesome-youtubers/master/badges/badge-weekly.svg?sanitize=true" title="Uploads videos weekly"/>](badges.md#weekly-video-upload) \
Content about: 网络世界普及频道 \
精选播放列表：`AWWWARDS`、`Front End`、`Freelancing`.  \
<br />
...
<details>
	...
	<br />
	徽章/自述文件的创建没有遵循任何设计结构，尽管<a href="/badges/logo.svg">awesome-youtubers 标志</a>的灵感来自于<a href="https://github.com/sindresorhus/awesome/blob/main/badges/logo.svg">awesome 标志</a>和<a href="https://github.com/sindresorhus/awesome-nodejs/blob/master/badges/logo.svg">awesome-nodejs 标志</a>. 这两个播放图标是在<a href="https://lh3.googleusercontent.com/z6Sl4j9zQ88oUKNy0G3PAMiVwy8DzQLh_ygyvBXv0zVNUZ_wQPN_n7EAR2By3dhoUpX7kTpaHjRPni1MHwKpaBJbpNqdEsHZsH4q">YouTube 徽标</a>的播放按钮之后创建的. 这只是一个代表，我没有使用 YouTube 徽标本身.
</details>
