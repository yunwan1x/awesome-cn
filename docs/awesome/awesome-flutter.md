...
<p align="center">
  ...
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-232707-brightgreen.svg" />
  </a>
  <img alt="Entries" src="https://img.shields.io/badge/Items-368-lightgrey.svg" />
...
- [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) [2437⭐] - 为 Flutter 新手提供的包含原则、模式和框架的可视化路线图 [Olexandr Leuschenko](https://github.com/olexale).
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [5690⭐] - 开发者的简单基本隔离应用程序 [Nishant Srivastava](https://github.com/nisrulz).
- [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) [1551⭐] - 展示 Flutter 组件，并排源代码视图，作者 [X-Wei](https://github.com/X-Wei).
- [Generative Art](https://github.com/Solido/flutter-d-art) [379⭐] - Generative Art by [Robert Felker](https://github.com/Solido).


### UI

- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [2182⭐] - 具有可变大小的 GridView [Romain Rastel](https://github.com/letsar).
...
- [Flip Panel](https://github.com/hnvn/flutter_flip_panel) [444⭐] - 带有内置动画的翻转面板 [HungHD](https://github.com/hnvn).
- [Facebook Reactions](https://github.com/duytq94/facebook-reaction-animation) [233⭐] - Facebook 反应小部件 [Duy Tran](https://github.com/duytq94).
...
- [Folding Cell](https://github.com/faob-dev/folding_cell) [402⭐] - 折叠你的小部件 [Faob](https://github.com/faob-dev).
- [Liquid Pull To Refresh](https://github.com/aagarwal1012/Liquid-Pull-To-Refresh) [868⭐] - 一个漂亮的自定义刷新指示器 [Ayush Agarwal](https://github.com/aagarwal1012/).
...
- [Before After](https://github.com/xsahil03x/before_after) [542⭐] - 漂亮的滑块，可以更轻松地显示两个图像之间的差异，通过 [Sahil Kumar](https://github.com/xsahil03x).
- [Scratcher](https://github.com/vintage/scratcher) [284⭐] - 临时隐藏用户内容的刮刮卡小部件，由 [Kamil Rykowski](https://github.com/vintage).
...
- [Flutter Neumorphic](https://github.com/Idean/Flutter-Neumorphic) [1241⭐] - 准备使用具有 ️ 暗模式的 Flutter 的 Neumorphic 套件.
...
- [Timelines](https://github.com/chulwoo-park/timelines) [382⭐] - 强大且易于使用的时间线包 [Chulwoo Park](https://github.com/chulwoo-park).
- [Timeline Tile](https://github.com/JHBitencourt/timeline_tile) [415⭐] - 帮助构建美观且可自定义的时间线的磁贴 [Julio Bitencourt](https://github.com/JHBitencourt).
...
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) [645⭐] - 基于 Sliver 的粘性标题 [Romain Rastel](https://github.com/letsar).
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) [704⭐] - 可配置的粘性标题 [Simon Lightfoot](http://www.devangels.london/).
...
- [Fancy Bottom Navigation](https://github.com/tunitowen/fancy_bottom_navigation) [520⭐] - 动画底部导航 [Tony Owen](https://github.com/tunitowen).
- [Circular Bottom Navigation](https://github.com/imaNNeoFighT/circular_bottom_navigation) [422⭐] - 漂亮的动画底部导航栏 by [Iman Khoshabi](https://github.com/imaNNeoFighT).
...
- [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) [646⭐] - 在 iOS 和 Android 上展示您的应用功能的方式 [Simform](https://github.com/simformsolutions).
...
- [Wave](https://github.com/i-protoss/wave) [664⭐] - 显示一些具有自定义颜色、持续时间、浮动和模糊效果的波浪 [RockerFlower](https://github.com/RockerFlower).
...
- [Clay Containers](https://github.com/mcaubrey/clay_containers) [349⭐] - Neumorphic widget 原语作为您自己设计的基础 [Michael Charles](https://github.com/mcaubrey).
...
- [Table Calendar](https://github.com/aleksanderwozniak/table_calendar) [1097⭐] - 日历整齐地组织成一个表格，垂直自动调整大小 [Aleksander Woźniak](https://github.com/aleksanderwozniak).
...
- [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) [1025⭐] - 用json构建你的动态UI，json格式和flutter小部件代码非常相似 [Denny Deng](https://github.com/dengyin2000).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [1414⭐] - 可扩展的图像视图，通过加载占位符 [Renan C. Araújo](https://github.com/renancaraujo).
...
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [1839⭐] - 显示来自互联网的图像并将它们保存在缓存目录中.
...
- [Bitmap](https://github.com/renancaraujo/bitmap) [119⭐] - 在 Dart FFI 的帮助下执行位图操作（例如对比度和曝光） [Renan C. Araújo](https://github.com/renancaraujo).
- [Crop](https://github.com/xclud/flutter_crop) [145⭐] - 在 Android、iOS、Web 和桌面中裁剪任何小部件/图像 [Mahdi K. Fard](https://github.com/xclud/).
...
- [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) [739⭐] - 微信风格的资产选择器，支持多资产 [Alex Li](https://github.com/AlexV525).
...
- [GeoCoder](https://github.com/aloisdeniel/flutter_geocoder) [158⭐] - 正向和反向地理编码 [Aloïs Deniel](https://aloisdeniel.github.com).
...
- [Charts](https://github.com/google/charts) [2374⭐] - 谷歌图表团队.
...
- [FL Chart](https://github.com/imaNNeoFighT/fl_chart) [3477⭐] - 在 Flutter 中绘制奇妙的图表 by [Iman Khoshabi](http://www.ikhoshabi.com).
...
- [Graphic](https://github.com/entronad/graphic) [221⭐] - 基于 Grammar of Graphics 的数据可视化库 by [LIN Chen](https://github.com/entronad).
...
- [Get](https://github.com/jonataslaw/get) [4503⭐] - 在没有上下文的情况下在屏幕之间导航并显示小吃栏/对话框/bottomSheets [Jonny Borges](https://github.com/jonataslaw).
- [Beamer](https://github.com/slovnicki/beamer) [245⭐] - 使用 Navigator 2.0 API 毫不费力地通过受保护的页面堆栈和 URL [Sandro Lovnički](https://github.com/slovnicki).
...
- [Zefyr](https://github.com/memspace/zefyr) [1983⭐] - 柔软温和的富文本编辑器 [Memspace](https://github.com/memspace/zefyr).
...
- [Flutterial](https://github.com/rxlabz/flutterial) [1400⭐] - Flutter Material Theme explorer by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [AssetsAudioPlayer](https://github.com/florent37/Flutter-AssetsAudioPlayer) [532⭐] 同时播放来自资产/网络/文件的音频并显示通知 [android / ios / web / macos]
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [2558⭐] - 适用于 iOS/Android 的 WebRTC 插件由 [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) [1302⭐] - 提供对视频播放的低级访问 [Brian Egan](https://github.com/brianegan).
- [Video Trimmer](https://github.com/sbis04/video_trimmer) [239⭐] - 可视化和修剪视频 [Souvik Biswas](https://github.com/sbis04).
...
- [Secure Storage](https://github.com/mogol/flutter_secure_storage) [676⭐] - Keychain 和 Keystore 存储由 [German Saprykin](https://github.com/mogol).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [7300⭐] - TODO 应用程序准备好使用不同的风格：Vanilla、Redux、built_redux by [Brian Egan](https://github.com/brianegan).
- [Restaurant Menu](https://github.com/braulio94/menu_flutter) [548⭐] - 餐厅菜单由 [Braulio Cassule](https://github.com/braulio94).
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [1251⭐] - 个人资料、旅行、食品应用程序 [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Dashboard](https://github.com/Ivaskuu/dashboard) [801⭐] - 仪表板和商店项目 [Ivascu Adrian](https://github.com/Ivaskuu).
...
- [The Gorgeous Login](https://github.com/huextrat/TheGorgeousLogin) [1453⭐] - 设计和流畅的登录模板 [Hugo Extrat](https://github.com/huextrat).
...
- [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) [1049⭐] - 美丽的食物应用 UI 模板 by [JideGuru](https://github.com/JideGuru).
- [Flutter Samples](https://github.com/diegoveloper/flutter-samples) [2268⭐] - 收集不错的颤振样本 [Diego Velásquez](https://github.com/diegoveloper).
- [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) [265⭐] - 具有团队开发的生产质量应用程序基本元素的入门应用程序 [Greger Wedel](https://github.com/gregertw).
- [Smart Washing Machine](https://github.com/pawlik92/flutter_whirlpool) [513⭐] - 带有 Box2D 物理引擎的智能洗衣机 UI 挑战应用程序 [Tomasz Pawlikowski](https://github.com/pawlik92).
- [Beautiful Timelines](https://github.com/JHBitencourt/beautiful_timelines) [171⭐] - 一组美丽的时间线 [Julio Bitencourt](https://github.com/JHBitencourt).
...
- [m2cgen](https://github.com/BayesWitnesses/m2cgen) [1892⭐] - 将 ML 模型转换为原生 Dart 代码的 CLI 工具 [BayesWitnesses](https://github.com/BayesWitnesses).

### Vision

- [ML Vision Camera Stream](https://github.com/santetis/flutter_camera_ml_vision) [209⭐]- ML 视觉识别（二维码、人脸、...）与实时摄像头流 [Aumard Jimmy](https://github.com/jaumard) 和 [Santetis](https://github.com/santetis).
...
- [Location](https://github.com/Lyokone/flutterlocation) [805⭐] - 处理位置，处理回调以获取连续位置 [Lyokone](https://github.com/Lyokone).
...
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) [1637⭐] - 显示本地通知的插件 [Michael Bui](https://github.com/MaikuB).
...
- [InAppWebView](https://github.com/pichillilorenzo/flutter_inappwebview) [1561⭐] - 添加内联 WebView 小部件或通过以下方式打开应用内浏览器窗口 [Lorenzo Pichilli](https://github.com/pichillilorenzo).
- [AppAvailability](https://github.com/pichillilorenzo/flutter_appavailability) [75⭐] - 列出、启动和检查已安装的应用程序 [Lorenzo Pichilli](https://github.com/pichillilorenzo).
- [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) [645⭐] - 本地文件资源管理器加载绝对文件路径 [Miguel Ruivo](https://github.com/miguelpruivo).
...
- [Blue](https://github.com/pauldemarco/flutter_blue) [1818⭐] - 蓝牙由 [Paul DeMarco](https://github.com/pauldemarco).
...
- [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) [234⭐] - 通过以下方式处理多个设备的 BLE 操作 [Philips Hue](https://github.com/PhilipsHue).
...
- [Bloc](https://github.com/felangel/bloc) [7719⭐] - 帮助实现 BLoC 设计模式的包的集合 [Felix Angelov](https://github.com/felangel).
...
- [RiverPod](https://github.com/rrousselGit/river_pod) [1941⭐] - 提供者，但不同之处在于 [Remi Rousselet](https://github.com/rrousselGit).
...
- [Redux](https://github.com/brianegan/flutter_redux) [1504⭐] - 专为使用而构建 [redux.dart](https://github.com/johnpryan/redux.dart)，允许您轻松使用 Redux Store 来构建小部件的实用程序.
- [Inject](https://github.com/google/inject.dart) [841⭐] - Google 的编译时依赖注入.
- [Flux](https://github.com/google/flutter_flux) [359⭐] - Google 对 Flux 框架的实现.
- [Fish](https://github.com/alibaba/fish-redux) [7158⭐] - 阿里巴巴 Redux 实现.
- [Async Redux](https://pub.dev/packages/async_redux)  [191⭐] - 没有样板的 Redux. 允许同步和异步减速器 [Marcelo Glasberg](https://github.com/marcglasberg/).

### Widgets

- [Hooks](https://github.com/rrousselGit/flutter_hooks) [1880⭐] - 小部件之间的高级代码共享 [Remi Rousselet](https://github.com/rrousselGit).
- [Functional widget](https://github.com/rrousselGit/functional_widget) [414⭐] - 代码生成器将小部件编写为带有注释的函数 [Remi Rousselet](https://github.com/rrousselGit).
...
- [Graphql](https://github.com/zino-app/graphql-flutter) [2697⭐] - GraphQL 规范的实现 [Zino App B.V.](https://github.com/zino-app).
...
- [Villains](https://github.com/Norbert515/flutter_villains) [323⭐] - 页面过渡动画由 [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) [1206⭐] - 一组很酷的文字动画 [Ayush Agarwal](https://github.com/aagarwal1012/).
- [Drawing Animation](https://github.com/biocarl/drawing_animation) [366⭐] - 基于SVG路径数据创建画线动画 [Carl Hauck](https://twitter.com/cahaucks).
...
- [Staggered Animations](https://github.com/mobiten/flutter_staggered_animations) [918⭐] - 轻松地将交错动画添加到您的 ListView、GridView、Column 和 Row [mobiten](https://mobiten.com/).
...
- [Responsive Framework](https://github.com/Codelessly/ResponsiveFramework)  [634⭐] - 自动调整 UI 以适应不同的屏幕尺寸. 响应变得简单 [Codelessly](https://codelessly.com).
...
- [Flame](https://github.com/flame-engine/flame) [4727⭐] - 极简主义游戏引擎 [Luan Nico](https://github.com/luanpotter).
...
- [Ghost Rigger](https://github.com/Float-like-a-dash-Sting-like-a-dart/GhostRigger) [148⭐] - Ghost Rigger 是一款受赛博朋克启发的益智游戏 [Iain Smith](https://github.com/b099l3) 和 [Julio Ernesto Rodríguez Cabañas](https://github.com/ernestoyaquello).
...
- [History Of Everything](https://github.com/2d-inc/HistoryOfEverything) [5778⭐] - 人类动画垂直时间线 [2D, Inc](https://www.2dimensions.com/).
- [Developer Quest](https://github.com/2d-inc/developer_quest)  [2892⭐] - 成为技术负责人，通过 [2D, Inc](https://www.2dimensions.com/).

### Top

- [Flutter Team Samples](https://github.com/flutter/samples) [10511⭐] - 示例集合（包括地图、json、Material 和 Cupertino）由 [Flutter team](https://github.com/orgs/flutter/people).
- [Flutter Common Widgets](https://github.com/alibaba/flutter-common-widgets-app) [22817⭐] - 官方中文小部件演示和文档合集，帮助开发者快速学习 [Alibaba Auction Frontend Team](https://github.com/alibaba-paimai-frontend).
...
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [698⭐]- 展示丰富 UI 的星球探索 [Sergi Martínez](http://sergiandreplace.com).
...
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [1307⭐] - 全功能音乐播放器 [Pawan Kumar](https://about.me/imthepk).
...
- [FlutterGram](https://github.com/mdanics/fluttergram) [1878⭐] - 基于 Firestore 和 Google Functions 的完整 Instagram 由 [MDanics](https://github.com/mdanics).
...
- [Trace](https://github.com/trentpiercy/trace) [754⭐] - 现代而强大的加密投资组合和市场探索者 [Trent Piercy](https://github.com/trentpiercy).
...
- [Spacex-Go](https://github.com/jesusrp98/spacex-go) [611⭐] - 简单而强大的开源 SpaceX 发射跟踪器. [jesusrp98](https://twitter.com/jesusrp98).
...
- [GitJournal](https://github.com/GitJournal/GitJournal) [1529⭐] - 在 Git Repo 中记录你的数据 [Vishesh Handa](https://github.com/vHanda).
- [AuthPass](https://github.com/authpass/authpass) [900⭐]-Keepass 兼容的移动和桌面密码管理器 by [hpoul](https://github.com/hpoul).
- [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) [1438⭐] - 使用 Firebase 解决方案的完整 Twitter 克隆 [Sonu Sharma](https://github.com/TheAlphamerc).
- [Harpy](https://github.com/robertodoering/harpy) [535⭐] - 功能丰富的 Twitter 客户端 [Roberto Doering](https://github.com/robertodoering).
...
- [FVM](https://github.com/leoafarias/fvm) [2048⭐] - Flutter 版本管理：一个管理 Flutter SDK 版本的简单 cli.
...
- [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) [955⭐] - 非常好的 Dart 命令行界面  [Very Good Ventures](https://github.com/VeryGoodOpenSource).
- [Flutter Sidekick](https://github.com/leoafarias/sidekick)  [482⭐] - 简单的应用程序，使 Flutter 开发更加愉快 [Leo Farias](https://github.com/leoafarias).
- [Dart Code Metrics](https://github.com/dart-code-checker/dart-code-metrics) [309⭐] - 额外的 linter 报告代码指标，检查反模式并为 Dart 分析器提供额外的规则 [Dart Code Checker team](https://github.com/dart-code-checker).
...
- [Enhancement_Suite](https://github.com/marius-h/flutter_enhancement_suite) [185⭐] - Search for pub.dev libraries, update version, Bloc, Snippet, etc you're covered by [Marius Höfler](https://github.com/marius-h).
...
- [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) [4958⭐] - Golang 桌面嵌入器 by [Pierre Champion](https://github.com/pchampio).
...
- [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) [685⭐] - 用于树莓派的轻量级嵌入器 by [Hannes Winkler](https://github.com/ardera).
