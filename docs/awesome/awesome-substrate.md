...
- [New Seminar Crowdcast](https://github.com/substrate-developer-hub/awesome-substrate/blob/master/ https://www.crowdcast.io/e/substrate-seminar-2/) - Upcoming events and
  latest recordings.
...
- [Front-End](https://github.com/substrate-developer-hub/substrate-front-end-template) - Polkadot-JS
  API 和 [React](https://reactjs.org/) app to build front-ends for Substrate-based chains. 
