...
- [Coq-Elpi](https://github.com/LPCIC/coq-elpi) - 可嵌入 Lambda Prolog 解释器的插件.
...
- [Formal Reasoning About Programs](http://adam.chlipala.net/frap/) - 同时对关于程序正确性的形式逻辑推理和为此目的使用 Coq 提供一般性介绍的书.
...
- [The Mathematical Components book](https://math-comp.github.io/mcb/) - 面向具有数学倾向的用户的书籍，重点介绍数学组件库和 SSReflect 证明语言.
