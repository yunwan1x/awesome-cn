...
此特定列表的范围仅限于基础架构开发人员（系统管理员、DevOps 从业人员等）可能会发现有用的内容. 我们喜欢那里的所有免费服务，但最好将其放在主题上. 有时这有点像一条灰线，所以这有点自以为是； 如果我不接受你的贡献，请不要生气.

此列表是 900 多人完成的拉取请求、评论、想法和工作的结果. 您也可以通过发送来提供帮助 [Pull Requests](https://github.com/ripienaar/free-for-dev) 添加更多服务或删除产品已更改或已停用的服务.
...
## Major Cloud Providers
  ...
  * [Google Cloud Platform](https://cloud.google.com)
    ...
    * Compute Engine - 1 个不可抢占的 f1-micro、30GB 硬盘、5GB 快照存储（仅限某些区域）、每月从北美到所有区域目的地（不包括中国和澳大利亚）的 1 GB 网络出站流量
    * 云存储 - 5GB、1GB 网络出口
  ...
  * [Oracle Cloud](https://www.oracle.com/cloud/)
    * 计算 - 2 VM.Standard.E2.1.Micro 1GB RAM、4 个基于 Arm 的 Ampere A1 内核和 24 GB 内存，可用作一个 VM 或最多 4 个 VM
    * 块卷 - 2 个卷，总共 200 GB（用于计算）
    * 对象存储 - 10 GB
    * 负载均衡器 - 1 个 10 Mbps 的实例
    * 数据库 - 2 个 DB，每个 20 GB
    * 监控 - 5 亿个摄取数据点，10 亿个检索数据点
    * 带宽 - 每月 10TB 出站流量，速度限制为 5Mbps
...
## Source Code Repos
  ...
  * [github.com](https://github.com/)  — 无限的公共存储库和无限的私有存储库（与无限的合作者）. 除此之外，提供的其他一些免费服务（还有更多，但我们在这里列出了主要服务）：
       ...
       - [Package Hosting & Container Registry](https://github.com/features/packages) （公共存储库免费，500 MB 存储空间和 1GB 带宽外 CI/CD 免费用于私人存储库）
       - 项目管理和问题跟踪.
...
## APIs, Data and ML
  ...
  * [DeepAR](https://developer.deepar.ai)  — 任何平台的增强现实面部过滤器，只需一个 SDK. 免费计划提供最多 10 个每月活跃用户 (MAU) 并跟踪最多 4 张面孔
  * [Deepnote](https://deepnote.com)  - 一种新型的数据科学笔记本.  Jupyter 兼容实时协作并在云中运行. 免费套餐包括无限制的个人项目、最多 750 小时的标准硬件和最多 3 名编辑的团队.
  ...
  * [Invantive Cloud](https://cloud.invantive.com/)  — 使用 Invantive SQL 或 OData4（通常为 Power BI 或 Power Query）访问 70 多个（云）平台，例如 Exact Online、Twinfield、ActiveCampaign 或 Visma. 包括数据复制和交换. 开发人员和实施顾问的免费计划. 对于数据量有限制的特定平台免费.
  ...
  * [IPinfo](https://ipinfo.io/)  — 快速、准确且免费（最多 10 万/月）IP 地址数据 API. 提供包含地理位置、公司、运营商、IP 范围、域、滥用联系人等详细信息的 API. 所有付费 API 均可免费试用.
  ...
  * [Postman](https://postman.com)  — 使用 API 开发协作平台 Postman 简化工作流程并创建更好的 API——更快. 永远免费使用 Postman App. 邮递员云功能也永久免费，但有一定的限制.
  ...
  * [tamber](https://tamber.com)  — 在您的应用中加入深度学习驱动的推荐. 每月免费 5k 活跃用户.
  ...
  * [Webhook.site](https://webhook.site) - 使用这个即时显示请求的便捷工具轻松测试 HTTP webhook.
  ...
  * [EVA](http://eva.pingutil.com/) - 免费的电子邮件验证器 API，有助于识别电子邮件是否是一次性的并具有有效的 MX 记录.
...
## Tools for Teams and Collaboration
  ...
  * [Discord](https://discordapp.com/)  — 与公共/私人房间聊天.  Markdown 文本、语音、视频和屏幕共享功能. 无限用户免费.
  ...
  * [Notion](https://www.notion.so/)  - Notion 是一个笔记和协作应用程序，支持 Markdown，还集成了任务、wiki 和数据库. 该公司将该应用程序描述为用于记笔记、项目管理和任务管理的多合一工作区. 除了跨平台应用程序外，它还可以通过大多数网络浏览器访问.
...
## Code Quality
  ...
  * [CodeBeat](https://codebeat.co)  — 可用于多种语言的自动化代码审查平台. 与 Slack 和电子邮件集成的公共存储库永久免费.
  * [codeclimate.com](https://codeclimate.com/)  — 自动代码审查，开源免费和无限制的组织拥有的私人存储库（最多 4 个合作者）. 学生和机构也免费.
  ...
  * [SourceLevel](https://sourcelevel.io/)  — 自动代码审查和团队分析. 对开源和最多 5 个合作者的组织免费.
...
## CI and CD
  ...
  * [travis-ci.org](https://travis-ci.org/) — 公共 GitHub 存储库免费
  * [Mergify](https://mergify.io) — GitHub 的工作流自动化和合并队列 — 免费用于公共 GitHub 存储库


## Testing

  * [Applitools.com](https://applitools.com/)  — 用于 Web、原生移动和桌面应用程序的智能视觉验证. 与几乎所有自动化解决方案（如 Selenium 和 Karma）和远程运行程序（Sauce Labs、Browser Stack）集成. 免费开源. 每周检查点有限的单个用户的免费套餐.
  ...
  * [percy.io](https://percy.io)  - 向任何 Web 应用程序、静态站点、样式指南或组件库添加可视化测试. 无限的团队成员，演示应用程序和无限的项目，5,000 个快照/月.
...
## Security and PKI
  ...
  * [CodeNotary.io](https://www.codenotary.io/) — 具有不可磨灭的证据的开源平台，可对代码、文件、目录或容器进行公证
  ...
  * [foxpass.com](https://www.foxpass.com/)  — 托管 LDAP 和 RADIUS. 每个用户都可以轻松登录到服务器、VPN 和无线网络.  10 位用户免费
  ...
  * [Jumpcloud](https://jumpcloud.com/)  — 提供目录即服务，类似于 Azure AD、用户管理、单一登录和 RADIUS 身份验证. 最多 10 个用户免费.
  ...
  * [logintc.com](https://www.logintc.com/) — 通过推送通知进行两因素身份验证 (2FA)，10 个用户免费，VPN、网站和 SSH
  ...
  * [Sqreen](https://www.sqreen.com/)  — 用于 Web 应用程序和 API 的应用程序安全监控和保护（RASP、WAF 等）.  1 个应用程序和 300 万个请求免费.
...
## Messaging
  ...
  * [cloudamqp.com](https://www.cloudamqp.com/)  — RabbitMQ 即服务.  Little Lemur 计划：每月最多 100 万条消息，最多 20 个并发连接，最多 100 个队列，最多 10,000 个排队消息，不同可用区中的多个节点
  ...
  * [pusher.com](https://pusher.com/)  — 实时消息服务. 免费最多 100 个同时连接和 200,000 条消息/天
...
## Monitoring
  ...
  * [amixr.io](https://amixr.io/)  - 开发人员友好的警报和呼叫管理，具有出色的 Slack 集成、API 和 Terraform. 免费电话、短信、电报、Slack 和电子邮件套餐.
  ...
  * [checklyhq.com](https://checklyhq.com)  - 面向开发人员的开源 E2E / 综合监控和深度 API 监控.  5 个用户和 50k+ 检查运行的免费计划.
  ...
  * [opsgenie.com](https://www.opsgenie.com/)  — 强大的警报和随叫随到管理，用于操作永远在线的服务. 最多 5 个用户免费.
  ...
  * [thundra.io/apm](https://www.thundra.io/apm)  — 应用监控和调试. 拥有每月最多 25 万次调用的免费套餐.
...
## Email
  ...
  * [mailinator.com](https://www.mailinator.com/) — 免费、公共的电子邮件系统，您可以在其中使用任何您想要的收件箱
  ...
  * [moosend.com](https://moosend.com/)  — 邮件列表管理服务. 初创公司 6 个月的免费帐户
  ...
  * [Zoho](https://www.zoho.com)  — 最初是电子邮件提供商，但现在提供一套服务，其中一些有免费计划. 有免费计划的服务列表：
     - [Email](https://zoho.com/mail)  5 位用户免费.  5GB/用户和 25MB 附件限制，1 个域.
  ...
  * [EmailJS](https://www.emailjs.com/) – 这不是一个完整的电子邮件服务器，这只是电子邮件客户端，您可以使用它直接从客户端发送电子邮件而不会暴露您的凭据，免费层有：每月 200 个请求，2 个电子邮件模板，请求高达 50Kb，联系人有限历史.
...
## Font
  ...
  * [Font Squirrel](https://www.fontsquirrel.com/)  - 许可用于商业工作的免费软件字体. 手工选择这些字体并以易于使用的格式呈现它们.
...
## Forms
  ...
  * [Kwes.io](https://kwes.io/)  - 功能丰富的表单端点. 适用于静态站点. 免费计划包括最多 1 个网站，每月最多 50 次提交.
...
## CDN and Protection
  ...
  * [cdnjs.com](https://cdnjs.com/)  - 简单的. 快速地. 可靠的. 最好的内容交付.  cdnjs 是一项免费且开源的 CDN 服务，受超过 11% 的网站信任，由 Cloudflare 提供支持.
  ...
  * [netdepot.com](https://www.netdepot.com/cdn/) — 前 100 GB 免费/月
...
## PaaS
  ...
  * [encore.dev](https://encore.dev/)  — 后端框架使用静态分析来提供自动基础设施、无样板代码等. 包括用于业余爱好项目的免费云托管.
  ...
  * [Okteto Cloud](https://okteto.com)  - 专为远程开发设计的托管 Kubernetes 服务. 免费的开发者帐户带有 5 个 Kubernetes 命名空间，3Gi/pod 最大 8Gi/命名空间，1CPU/pod 最大 4CPU/命名空间和 5GB 磁盘空间. 应用程序在 24 小时不活动后休眠.
  * [opeNode](https://openode.io)  — 用于开源项目的免费 Node.js 托管.  100 GB 带宽/月，100 MB 内存和 1000 MB 存储. 使用 CLI 或现有 Git 存储库进行部署.
  * [outsystems.com](https://www.outsystems.com/) — 用于内部部署或云的企业 Web 开发 PaaS，免费的“个人环境”产品允许无限代码和高达 1 GB 的数据库
  ...
  * [pythonanywhere.com](https://www.pythonanywhere.com/)  — 云 Python 应用托管. 初学者帐户是免费的，在 your-username.pythonanywhere.com 域中有 1 个 Python Web 应用程序，512 MB 私有文件存储空间，一个 MySQL 数据库
  ...
  * [Platform9](https://platform9.com/)  - 专为开发人员设计的托管 Kubernetes 服务. 免费的开发者帐户最多可提供 3 个集群和 20 个节点集群.
  * [fly.io](https://fly.io/)  - Fly 是一个适用于需要在全球范围内运行的应用程序的平台. 它在靠近用户的地方运行您的代码，并在您的应用程序最繁忙的城市扩展计算. 编写您的代码，将其打包到 Docker 映像中，将其部署到 Fly 的平台，然后让这些工作完成所有工作，让您的应用程序保持活力. 副项目免费，每月 10 美元的服务信用自动适用于任何付费服务. 如果您运行非常小的虚拟机，积分将大有帮助.
  * [appfleet.com](https://appfleet.com/)  - appfleet 是一个边缘平台，允许其用户同时将容器在全球范围内部署到多个区域. 它提供了一个简单易用的 UI，同时自动化了所有复杂性，如智能路由、集群、故障转移、监控等. 它对开源项目是免费的，所有用户都会自动获得 10 美元来托管他们想要的任何东西.
  * [Divio](https://www.divio.com/)  - 仅使用 Docker 管理云应用程序部署的平台. 可免费订阅开发项目.
  * [Koyeb](https://www.koyeb.com)  - Koyeb 是一个开发人员友好的无服务器平台，用于在全球部署应用程序. 通过基于 git 的部署、本机自动缩放、全球边缘网络以及内置的服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API.  Koyeb 提供两种 nano 服务，以通过其永久免费层运行您的应用程序，并使用免费资源赞助开源项目.
  * [Railway](https://railway.app)  - 铁路是一个基础设施平台，您可以在其中配置基础设施，在本地使用该基础设施进行开发，然后部署到云端. 免费提供 3 个项目、2 个插件/项目、2 个环境/项目、3 个实时部署/环境.
...
## BaaS
  ...
  * [blockspring.com](https://www.blockspring.com/)  — 云功能. 每月运行 500 万次免费
  ...
  * [hasura.io](https://hasura.io/) — 快速构建和部署应用后端的平台，单节点集群免费.
  ...
  * [posthook.io](https://posthook.io/)  — 作业调度服务. 允许您安排特定时间的请求. 每月 500 次预定请求免费.
  ...
  * [streamdata.io](https://streamdata.io/)  — 将任何 REST API 转换为事件驱动的流 API. 免费计划多达 100 万条消息和 10 个并发连接.
...
## Web Hosting
  ...
  * [render.com](https://render.com) — 构建和运行所有应用程序和 Web 应用程序免费 SSL、全球 CDN、专用网络和自动部署的统一平台，可从 Git 中免费部署静态网页.
...
## DNS
  ...
  * [F5](https://www.f5.com/products/ways-to-deploy/cloud-services/dns-cloud-service)  – 主要区域的免费任播 DNS 托管. 每月最多 1 个域和 300 万次请求的辅助区域免费.
...
## DBaaS
   ...
   * [graphenedb.com](https://www.graphenedb.com/) — Neo4j 即服务，最多 1,000 个节点和 10,000 个免费关系
   ...
   * [cockroachlabs.com](https://www.cockroachlabs.com/free-tier/) — 高达 5GB 和 1vCPU 的免费 CockroachDB.
...
## Issue Tracking and Project Management
   ...
   * [kanrails.com](https://kanrails.com/)  — 基于看板的项目管理.  3 个合作者、2 个项目和 5 个曲目免费. 可用于无限协作者、项目和曲目的付费计划.
   * [Kumu.io](https://kumu.io/)   — 带有动画、装饰、过滤器、聚类、电子表格导入等的关系图. 免费层允许无限的公共项目. 图大小无限制. 为学生提供免费的私人项目. 如果您不想将文件公开在线（上传、编辑、下载、丢弃），则可以使用沙盒模式.
   * [LeanBoard](https://www.leanboard.io) - 带有 GitHub 问题便签的协作白板（用于示例映射和其他技术）
...
## Storage and Media Processing
   ...
   * [uploadcare.com](https://uploadcare.com/hub/developers/)  — Uploadcare 为媒体管道提供基于尖端算法的终极工具包. 开发人员可以完全免费使用所有功能：文件上传 API 和 UI、图像 CDN 和源服务、自适应交付和智能压缩.
...
## Design and UI
  ...
  * [CodeMyUI](https://codemyui.com) - 精心挑选的网页设计和 UI 灵感与代码片段集合.
  ...
  * [Mindmup.com](https://www.mindmup.com/)  — 免费无限量的思维导图，并存储在云端. 您的思维导图随处可用，可立即通过任何设备使用.
  ...
  * [Unicorn Platform](https://unicornplatform.com/)  - 轻松的登陆页面构建器与托管.  1个免费网站.
...
## Data Visualization on Maps
   ...
   * [datamaps.world](https://datamaps.world/) — 简单但功能强大的平台，它为您提供免费层级可视化地理空间数据的工具.
   ...
   * [GeocodeAPI](https://geocodeapi.io)  - 地理编码 API：基于 Pelias 的地址到坐标转换和地理解析. 通过 CSV 进行批量地理编码.  350000 次免费请求/月.
...
## IDE and Code Editing
   ...
   * [apiary.io](https://apiary.io/) — 具有即时 API 模拟和生成文档的协作设计 API（对于具有一个管理员帐户和托管文档的无限制 API 蓝图和无限制用户免费）.
...
## Analytics, Events and Statistics
   ...
   * [AO Analytics](https://analytics.ao.gl/) — 永久免费为您的所有网站提供客户分析，每月无限活动
   ...
   * [Clicky](https://clicky.com)  — 网站分析平台. 免费计划 1 个具有 3000 次浏览分析的网站.
   * [Databox](https://databox.com)  — 通过结合其他分析和 BI 平台，获得商业洞察力和分析. 免费计划提供 3 个用户、仪表板和数据源.  11M 历史数据记录.
   * [indicative.com](https://indicative.com/)  — 客户分析平台，以优化客户参与度、增加转化率并提高保留率. 每月免费多达 5000 万个事件.
...
## International Mobile Number Verification API and SDK
  ...
  * [veriphone.io](https://veriphone.io/)  — 免费、快速、可靠的 JSON API 中的全球电话号码验证.  1000 个请求/月
...
## Payment and Billing Integration
  ...
  * [fraudlabspro.com](https://www.fraudlabspro.com)  — 帮助商家防止支付欺诈和退款. 免费微计划可提供 500 次查询/月.
...
## Miscellaneous
  ...
  * [Format Express](https://www.format-express.dev) - 用于 JSON/XML/SQL 的即时在线格式化程序.
