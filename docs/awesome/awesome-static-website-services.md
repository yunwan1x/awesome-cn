...
- [Vercel](https://vercel.com/home#features) - Vercel 允许人们用他们选择的语言编写功能即服务，并作为 monorepo 的一部分进行部署.
- [Azure Static Web Apps](https://azure.microsoft.com/en-us/services/app-service/static/#features) - 全栈静态应用托管，包括无服务器功能、身份验证、CDN 等
- [Qoddi](https://qoddi.com)  - 包含数据存储的全栈应用托管，类似于具有以开发人员为中心的方法的 Heroku. 最多可免费使用 3 个应用程序.
...
- [LiveFyre](http://web.livefyre.com/apps/comments/) - 实时评论，SEO 优化，具有社交功能，在桌面和移动设备上都很漂亮.
...
- [123 Contact Form](http://www.123contactform.com/)  - 连接到其他在线服务，例如 MailChimp、Salesforce 和 Google Drive. 它还与支付处理器集成，包括安全性和分析.
...
- [Wufoo](http://www.wufoo.com/) - 免费或付费 - 可以使用表单设计器构建的表单，包括通知、报告和付款.
...
- [Kontaktify](https://www.kontaktify.com/) - 一个联系小部件，为访问者提供了一种简单的联系方式.
...
- [search-index](https://github.com/fergiemcdowall/search-index) - 用于浏览器和 Node.js 的持久的、网络弹性的、全文搜索库
