...
<details>
  ...
  当我在埃克德学院时，我多次碰到社会企业的概念. 首先，在一个名为_技术、社会和环境_的课程中，然后通过与一家社会企业的 CTO 会面，最后通过一个名为_社会创业_的课程. 一路走来的每一步，我都更加爱上了社会企业的理念. 然而，我从来没有觉得有一种简单的方法可以连接到社会企业的世界. 
  
  最后，我设置了一个 [Google Alert](https://support.google.com/websearch/answer/4815696?hl=en) 每周摘要与“社会企业家”相关的任何内容. 这工作正常，但我仍然觉得我错过了一些东西. 快进几年，我发现自己大量参与了一个名为 [hackNY](https://hackny.org/), working at The New York Times, and having a stronger urge than ever to learn about social enterprises. As such, I've started compiling this list of resources to make it easy for people to connect with the world of social enterprises. See the FAQs at the bottom for some common questions.
