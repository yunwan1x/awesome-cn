...
- [NREL Solar Radiation](https://nsrdb.nrel.gov/) - 国家太阳辐射数据库 (NSRDB) 是气象数据的每小时和半小时值的连续完整集合，以及三种最常见的太阳辐射测量值：全球水平、直接法线和漫射水平辐照度.
...
- [Transitland](https://transit.land) <i>- Transitland is an open data platform that collects GTFS, GTFS Realtime, and other open data feeds from over 2,500 transit operators in over 55 countries.</i> <b>- Transitland 是一个开放数据平台，收集来自超过 55 个国家/地区的 2,500 多家公交运营商的 GTFS、GTFS Realtime 和其他开放数据源。</b> <i>Additional Information:</i><b>附加信息：</b> [Interline](https://www.interline.io/), [GitHub](https://github.com/transitland).
...
- [NJTPA Engage](https://engage.njtpa.org/) <i>- Database of 300 + public engagement tools, techniques, and software.</i> <b>- 300 多种公众参与工具、技术和软件的数据库。</b> <i>Searchable on multiple levels.</i><b>可在多个级别上搜索。</b> 
...
- [UrbanCanvas](https://urbansim.com/urbancanvas) - UrbanCanvas Modeler is a web-based platform designed for planners and modelers to generate long-range, small area socioeconomic forecasts using [UrbanSim](https://github.com/UDST/urbansim) 通知区域交通计划. 
...
We are actively looking for contributions from those interested in urban planning and technology. To find out more, visit the [Contribution](https://github.com/APA-Technology-Division/planning-technology-resources/blob/main/CONTRIBUTING.md) <i>page to see our recommended format.</i><b>页面查看我们推荐的格式。</b> <i>For large contributions, file an issue first.</i><b>对于大额贡献，请先提出问题。</b> <i>The advantage of contributing to the repo in this manner is that your addition to this shared resource will be recorded.</i><b>以这种方式为 repo 做贡献的好处是，您对该共享资源的添加将被记录下来。</b> 
