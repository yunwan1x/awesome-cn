...
- [pasta](http://pasta.phyrama.com/)  - 意大利面！ 是一款“三消”类型的游戏.
...
- [play-2048](https://github.com/mgrojo/play_2048)  - 玩 2048！ 是流行的 2048 游戏的克隆，在 Ada 中实现，使用 ASFML 处理图形，使用 ada-toml 保存状态.
...
- [gneiss](https://github.com/Componolit/gneiss)  - Gneiss 是一个接口集合，可与基于组件的系统的应用程序一起使用. 它旨在易于移植/平台独立，并与 [ada-runtime](https://github.com/Componolit/ada-runtime).
...
- [matreshka](http://forge.ada-ru.org/matreshka)  - Matreshka 是一个用于开发信息系统的 Ada 框架. 它由五个主要组件组成：联盟、XML 处理器、Web 框架、SQL 访问和建模框架.
...
- [ssprep](https://github.com/persan/ssprep.git) - 一个类似于 jinja 但使用的可扩展模板引擎 [template-parser](https://github.com/AdaCore/templates-parser) 并用于命令行使用.
...
- [a2js](http://forge.ada-ru.org/matreshka/wiki/Web/A2JS) - Ada2JS 是实验性的开源编译器，是 Matreshka 的组件.
