...
## Awesome CSS [![Awesome][awesome-badge]][awesome-link] [![Travis Build Status][travis-badge]][travis-link] 
 ...
 &gt; /* 精选好的框架、样式指南和其他用于编写令人惊叹的 CSS 的酷元素的精选列表.  */
...
- [w3c/css-houdini-drafts](https://github.com/w3c/css-houdini-drafts) - Houdini WG Editor 存储库的镜像.
...
* [Chota](https://jenil.github.io/chota/) - 响应式、可定制的微框架 (3kb)，具有有用的实用程序和网格系统.
...
* [Milligram](http://milligram.io) - 极简的 CSS 框架.
...
* [RevengeCSS](https://github.com/Heydon/REVENGE.CSS) - 一个使用选择器查找错误标记的 CSS 书签，在您编写错误 HTML 的任何地方以漫画无衬线字体显示丑陋的粉红色错误消息
...
* [CSS Podcast](https://thecsspodcast.libsyn.com/) - Una Kravets 和 Adam Argyle，来自 Google 的开发倡导者，兴高采烈地将 CSS 的复杂方面分解为可消化的片段，涵盖从可访问性到 z-index 的所有内容.
...
* [The Changelog](https://changelog.com/)  - 变更日志的标语说明了一切：“开源发展迅速. 赶上.” 此播客以及随附的博客旨在让您了解最新的开源技术.
...
* [CSS Commits](https://twitter.com/CSScommits) - 对@CSSWG 公共 Mercurial 存储库的最新提交.
