...
- [LaTeXEqEdit](http://latexeqedit.sourceforge.net/index.php) <i>- LaTeX formula editor for Windows.</i> <b>- 适用于 Windows 的 LaTeX 公式编辑器。</b> <i>![windows] ![foss]</i> <b>![windows] ![foss]</b>
