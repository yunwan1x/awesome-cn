...
很棒的**开源**数据可视化框架、库和软件的精选列表. 灵感来自 [awesome-python](https://github.com/vinta/awesome-python) and originally created by [fasouto](https://github.com/fasouto).
...
- [Chartist.js](https://gionkunz.github.io/chartist-js/) - 具有出色浏览器兼容性的响应式图表.
- [dc.js](https://github.com/dc-js/dc.js) 是一个多维图表，可与交叉过滤器一起使用.
- [Dygraphs](https://dygraphs.com/) - 可处理大量数据集的交互式折线图库.
...
- [G2](https://g2plot.antv.vision/en) - 一个基于图形语法的交互式响应式图表库，由阿里巴巴维护
...
- [Plotly.js](https://github.com/plotly/plotly.js/) - 强大的声明库，支持 20 种图表类型.
...
- [diagram.js](https://github.com/bpmn-io/diagram-js) - 作为 camunda 在线 BPMN 建模器的基础的 Javascript 图表库.
- [Uber React Digraph](https://github.com/uber/react-digraph) - UBER 维护的基于 React.js 的有向图库.
...
- [Dipper](https://github.com/antvis/dipper) - 由阿里巴巴维护的 L7 地图应用开发框架.
...
- [nivo](https://github.com/plouc/nivo) - 具有同构能力的用于 React 的增压 dataviz 组件， [demo](https://nivo.rocks).
...
- [Piecon](https://github.com/lipka/piecon) - 在您的网站图标中使用饼图.
...
- [PNChart](https://github.com/kevinzhow/PNChart) - 在 Piner 和 CoinsMan 中使用的简单漂亮的图表库.
...
- [PyVista](https://github.com/pyvista/pyvista) – 通过可视化工具包 (VTK) 的流线型界面进行 3D 绘图和网格分析
- [seaborn](https://seaborn.pydata.org/) - A library for making attractive and informative statistical graphics.
- [toyplot](https://toyplot.readthedocs.io/en/stable/) - 用于 Python 的儿童大小的绘图工具包，具有成人大小的目标.
- [three.py](https://github.com/stemkoski/three.py/)  - 易于使用的基于 PyOpenGL 的 3D 库. 受 Three.js 的启发.
...
- [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) - 生成具有可视化的统计分析报告以进行快速数据分析.
...
- [plotly](https://github.com/ropensci/plotly) - 交互式图表（包括向 ggplot2 输出添加交互性）、制图和简单的网络图
...
## Books
- [Design for Information](https://www.amazon.com/Design-Information-Introduction-Histories-Visualizations/dp/1592538061) 伊莎贝尔·梅雷勒斯.
...
- [The Wall Street Journal Guide to Information Graphics](https://www.amazon.com/Street-Journal-Guide-Information-Graphics/dp/0393347281) 由 Dona M. Wong
- [Visualization Analysis and Design](https://www.amazon.com/Visualization-Analysis-Design-AK-Peters/dp/1466508914) 塔玛拉·蒙兹纳（Tamara Munzner）.
- [Interactive Data Visualization for the Web](https://chimera.labs.oreilly.com/books/1230000000345) 通过斯科特默里. 可在线阅读. 专注于 D3.
...
- [Junk Charts](https://junkcharts.typepad.com/) - Kaiser Fung 分析了某些数据化工作/不工作的原因
- [Lisa Rost thinks and discusses about why we dataviz](https://lisacharlotterost.github.io/)
- [Makeover Monday](https://www.makeovermonday.co.uk/) 博客 - [#MakeoverMonday](https://twitter.com/search?q=%23makeovermonday) on twitter
...
- [vis4.net](https://www.vis4.net/blog/) - Gregor Aisch 关于可视化和数据新闻的随机想法
