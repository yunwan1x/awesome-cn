...
- [Knockoff Nets: Stealing Functionality of Black-Box Models](https://arxiv.org/abs/1812.02766.pdf) - (CVPR) *询问对手可以在多大程度上窃取这种“受害者”模型的功能，仅基于黑盒交互：图像输入，预测输出.*
- [Opening Up the Black Box:Auditing Google's Top Stories Algorithm](https://par.nsf.gov/servlets/purl/10101277) - (Flairs-32) *对 Google 的热门故事面板进行审核，提供对其算法选择的见解，以选择和排名新闻出版商*
