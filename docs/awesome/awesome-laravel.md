...
* [Laravel Mailbox](https://github.com/beyondcode/laravel-mailbox) -处理传入电子邮件的软件包
...
* [Integrating Front end Components with Web Applications](https://leanpub.com/frontend) 通过Maksim Surguy
