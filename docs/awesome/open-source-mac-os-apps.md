...
- [Xcodes.app](https://github.com/RobotsAndPencils/XcodesApp)  -安装和在多个版本的Xcode之间切换的最简单方法.  ！[swift_icon] 
...
- [Sessions](https://github.com/AlexPerathoner/Sessions) -Safari扩展程序可以保存您的工作会话！[swift_icon] 
- [Speed Reader](https://github.com/LumingYin/SpeedReader)  -借助SpeedReader消除发声功能，使阅读速度更快.  ！[swift_icon] 
...
- [Flying Carpet](https://github.com/spieglt/flyingcarpet) 通过Ad-hoc wifi进行跨平台文件传输，例如AirDrop，但适用于Mac / Windows / Linux.  ！[go_icon] 
...
- [The Blockstack Browser](https://github.com/blockstack/blockstack-browser)  -Blockstack是用于分散应用程序的互联网，用户可以在其中拥有自己的数据.  Blockstack浏览器使您可以浏览Blockstack Internet.  ！[javascript_icon] 
- [ThenGenerator](https://github.com/87kangsw/ThenGenerator) -&#39;Then&#39;的Xcode源代码编辑器扩展！[swift_icon] 
...
- [homebrew-cask](https://github.com/Homebrew/homebrew-cask) -CLI管理工作流，用于管理作为二进制文件分发的macOS应用程序！[ruby_icon] 
...
- [SpechtLite](https://github.com/zhuhaow/SpechtLite)  -适用于macOS的基于规则的代理应用程序.  ！[swift_icon] 
- [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick)  -Tunnelblick是macOS上用于OpenVPN的图形用户界面.  ！[objective_c_icon] 
- [clashX](https://github.com/yichengchen/clashX)  -基于Mac的GUI的基于规则的自定义代理，基于冲突.  ！[swift_icon] 
- [rvc-mac](https://github.com/riboseinc/cryptode-mac)  -Ribose VPN Client macOS菜单应用程序.  ！[swift_icon] 
...
- [Conferences.digital](https://github.com/zagahr/Conferences.digital)  -在Mac上免费观看喜爱的开发者会议上最新和最精彩视频的最佳方法.  ！[swift_icon] 
- [Datamosh](https://github.com/maelswarm/Datamosh)  -在macOS上对视频进行数据删除.  ！[swift_icon] 
- [Face Data](https://github.com/xiaohk/FaceData)  -用于自动注释视频中地标的macOS应用程序.  ！[swift_icon] 
...
- [OpenShot](https://github.com/OpenShot/openshot-qt)  -易于使用，快速学习并且功能强大的视频编辑器.  ！[python_icon] 
- [Quick Caption](https://github.com/LumingYin/Caption)  -转录并生成字幕文件（SRT，ASS和FCPXML），而无需手动输入时间代码.  ！[swift_icon] 
- [QuickLook Video](https://github.com/Marginal/QLVideo)  -此软件包允许macOS Finder显示大多数类型的视频文件的缩略图，静态QuickLook预览，封面和元数据.  ！[objective_c_icon] 
- [Subler](https://bitbucket.org/galad87/subler/src)  -Subler是创建用于多路复用和标记mp4文件的macOS应用.  ！[objective_c_icon] 
- [VLC](https://github.com/videolan/vlc) -VLC是一个免费的开源跨平台多媒体播放器！[c_icon] 
...
- [Yoda](https://github.com/whoisandy/yoda)  -漂亮的macOS应用程序，可让您从YouTube浏览和下载视频.  ！[javascript_icon] 

### Wallpaper
- [500-mac-wallpaper](https://github.com/markcheeky/500-mac-wallpaper)  -状态栏的简单macOS应用程序，可将照片从500px.com自动下载到可以设置为墙纸来源的本地文件夹中.  ！[swift_icon] 
- [ArtWall](https://github.com/JustinFincher/ASWP-for-macOS) -ArtStation设置为来自的壁纸 [artwork.rss](https://www.artstation.com/community/channels) .  ！[objective_c_icon] 
- [Artify](https://github.com/NghiaTranUIT/artify-macos) -一个macOS应用程序，专门为每个人带来18世纪的艺术！[swift_icon] 
...
- [pyDailyChanger](https://github.com/IngoMeyer441/pyDailyChanger)  -pyDailyChanger是一个每天更改墙纸的程序.  ！[python_icon] 

### Window Management
- [Amethyst](https://github.com/ianyh/Amethyst)  -适用于macOS的自动平铺窗口管理器.  ！[swift_icon] 
- [AppGrid](https://github.com/mjolnirapp/AppGrid)  -适用于macOS的基于网格的键盘窗口管理器.  ！[objective_c_icon] 
- [Desktop Profiles](https://github.com/mamiksik/Desktop-Profiles) -适用于macOS的创新型桌面/窗口管理器！[swift_icon] 
- [Hammerspoon](https://github.com/Hammerspoon/hammerspoon)  -使用Lua的功能惊人的macOS桌面自动化.  ！[lua_icon]！[objective_c_icon] 
- [Phoenix](https://github.com/kasper/phoenix)  -轻巧的macOS窗口和可通过JavaScript编写脚本的应用程序管理器.  ！[objective_c_icon] 
- [Rectangle](https://github.com/rxhanson/Rectangle)  -Rectangle是一个很大程度上基于Spectacle的窗口管理器，使用Swift编写.  ！[swift_icon] 
- [ShiftIt](https://github.com/fikovnik/ShiftIt)  -管理窗口的大小和位置.  ！[objective_c_icon] 
- [Slate](https://github.com/jigish/slate) -Slate是类似于Divvy和SizeUp的窗口管理应用程序！[objective_c_icon] 
- [Spectacle](https://github.com/eczarny/spectacle)  -眼镜让您无需使用鼠标即可组织窗口.  ！[objective_c_icon] 
- [Yabai](https://github.com/koekeishiya/yabai)  -基于二进制空间分区的macOS切片窗口管理器.  ！[c_icon]！[objective_c_icon] 
...
[c_icon]：./ icons / c-16.png&#39;C语言&#39;.
[cpp_icon]：./icons/cpp-16.png&#39;C ++语言&#39;.
[c_sharp_icon]: ./icons/csharp-16.png 'C# Language'
[clojure_icon]：./icons/clojure-16.png&#39;Clojure语言&#39;
[coffee_script_icon]：./icons/coffeescript-16.png&#39;CoffeeScript语言&#39;.
...
[rust_icon]：./ icons / rust-16.png“粗俗语言”.
[swift_icon]：./icons/swift-16.png“快捷语言”.
[type_script_icon]：./icons/typescript-16.png&#39;TypeScript语言&#39;.
