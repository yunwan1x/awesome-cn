...
|[Free Beginner Red Team Path](#-free-beginner-red-team-path)   |（在此处添加您的徽章.徽章代码隐藏在此 repo 中）|
|[Free Beginner Blue Team Path](#-free-beginner-blue-team-path)  |（在此处添加您的徽章.徽章代码隐藏在此 repo 中）|
|[Bonus CTF practice & Latest CVEs](#-bonus-ctf-practice-and-latest-cves)|(已完成/进行中)|
|[Bonus Windows](#-bonus-windows)|(已完成/进行中)|
|[Extremely Hard Rooms to do](#-extremely-hard-rooms-to-do)     |(已完成/进行中) |  --&gt;

## About

网络安全大学是一个精选的很棒的免费教育资源列表，专注于边做边学.

这有6个部分. 介绍和预安全、免费的初学者红队路径、免费的初学者蓝队路径、奖励实践/最新的 CVE 和极其困难的工作空间. 这些任务在难度上是线性的. 所以建议按顺序进行. 但是如果你发现你已经熟悉了这些概念，你仍然可以跳来跳去跳过一些房间.
...
<!--lint disable double-link-->
* [OpenVPN](https://github.com/brootware/awesome-cyber-security-university/blob/master/<https://tryhackme.com/room/openvpn>) - 了解如何使用 OpenVPN 连接到虚拟专用网络.<!--lint enable double-link-->
...
**介绍性 CTF 让您的脚湿透**<!-- markdownlint-enable MD036 -->
...
<!-- markdownlint-disable MD036 -->
**红队介绍 CTF**<!-- markdownlint-enable MD036 -->
...
* [Kenobi](https://github.com/brootware/awesome-cyber-security-university/blob/master/<https://tryhackme.com/room/kenobi>)  - 演练利用 Linux 机器. 枚举 Samba 以获取共享，操作易受攻击的 proftpd 版本，并通过路径变量操作提升您的权限.
