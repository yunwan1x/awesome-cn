<div class="github-widget" data-repo="ayr-ton/awesome-geek-podcasts"></div>
...
* [.NET Rocks!](https://www.dotnetrocks.com/) - Carl Franklin 和 Richard Campbell 为 .NET 开发人员提供的互联网音频脱口秀节目.
* [/dev/hell](http://devhell.info/)  - Chris Hartjes 和 Ed Finkler 陷入了开发地狱，在那里他们主要谈论 PHP、Web、他们的开发经验，还与特别嘉宾交谈.  （2020年停产）
* [a16z Podcast](https://a16z.com/podcasts/) - 播客讨论技术和文化趋势、新闻和未来.
* [Accidental Tech Podcast](http://atp.fm/) - 三个书呆子讨论技术、苹果、编程和松散相关的问题.
* [Ada Lovelace Day](https://findingada.com/) [iTunes](https://podcasts.apple.com/gb/podcast/ada-lovelace-day-podcast/id1119310112) - 女性在科学、技术、工程和数学 (STEM) 领域的成就.
* [AdminAdmin Podcast](https://adminadminpodcast.co.uk) - 关于系统管理和（越来越多）DevOps 和云操作的播客.
* [Android Developers Backstage](http://androidbackstage.blogspot.com/)  - Android Backstage，由 Android 开发人员提供的播客. 该节目由 Android 工程团队的开发人员主持，涵盖了 Android 程序员感兴趣的主题，并与 Google Android 团队的工程师进行了深入讨论和采访.
* [Around IT In 256 Seconds](https://256.nurkiewicz.com/)  - 面向开发人员、测试人员、SRE ……及其经理的播客. 我以清晰的方式解释复杂和令人费解的技术，避免流行语和炒作. 永远不要超过 4 分 16 秒.
* [Ask Noah](https://www.jupiterbroadcasting.com/show/asknoah/) - Noah 回答有关技术、商业、社区和 Linux 的问题
* [Away From The Keyboard](http://awayfromthekeyboard.com/category/podcasts/) - Away From The Keyboard 是技术专家讲述他们如何开始、如何成长、如何学习以及如何放松的故事的地方.
* [Away from Keyboard](https://changelog.com/afk) – 探索创造性工作的人性化一面.
* [Azure Friday](https://channel9.msdn.com/Shows/Azure-Friday)  - Scott Hanselman 与构建 Azure 的实际工程师坐下来学习如何对云进行编程. 没有营销，没有 BS，只有两个工程师和一台笔记本电脑.
* [Base.cs](https://www.codenewbie.org/basecs) - 基于 Vaidehi Joshi 的 base.cs 博客系列的初学者友好型计算机科学课程，由 CodeNewbie 制作.
...
* [BSDTalk](http://bsdtalk.blogspot.com/) - 谈论 BSD 系列的免费操作系统.
* [Build Phase](http://buildphase.fm/) - Build Phase 是一个每周讨论 iOS 开发和设计的技术播客.
* [Choose Linux](https://chooselinux.show/)  - 捕捉发现 Linux 的兴奋的节目.  （2020年停产）
* [Citizen Cosmos](https://www.citizencosmos.space/) - 一个发现 Cosmos 区块链生态系统和 web3 策划者的播客. 
...
* [Darknet Diaries](https://darknetdiaries.com)  - 来自黑客或被攻击者的故事. 他们是如何进来的以及发生了什么.
* [Data Stories](http://datastori.es/) - Enrico Bertini 和 Moritz Stefaner 讨论数据分析、可视化和相关主题的最新发展.
* [Defensive Security Podcast](https://defensivesecurity.org/category/podcast/) - Defensive Security 是一个网络安全播客，涵盖漏洞和防御策略.
* [Design vs Dev](https://agileleague.com/) - 从设计师和开发人员的不同角度讲述 Web 开发的播客.
...
* [DevelopersHangout](http://www.developershangout.io/)  - 两位开发人员每两周谈论一次他们发现的挑战、文章、新闻、书籍和其他播客.  Laravel、PHP 是两个关键主题，还有其他很棒的播客，比如上面列出的那些.
...
* [DevOps Cafe](http://devopscafe.org/) - 在这个采访驱动的节目中，John Willis 和 Damon Edwards 务实地审视了新兴 DevOps 运动背后的技术、工具和业务发展.
* [Digital Human](https://www.bbc.co.uk/programmes/b01n7094) - BBC 系列探索 Aleks Krotoski 呈现的数字世界.
* [Disruptive](https://soundcloud.com/wyssinstitute/sets/disruptive)  - Wyss 仿生工程研究所的研究人员利用大自然的设计原则开发仿生材料和设备，这些材料和设备将改变医学并创造一个更可持续的世界. 在这个播客系列中，Terrence McNally 直接与研究所的研究人员交谈，探讨他们的动机以及他们如何展望我们的未来，因为它可能会受到他们的颠覆性技术的影响.
* [Eat Sleep Code Podcast](https://soundcloud.com/esc-podcast) - 在节目中，我们将与充满激情的人们讨论各种与开发人员相关的话题.
* [Elixir Foundation](http://feeds.soundcloud.com/users/soundcloud:users:24638646/sounds.rss) - 您的每周播客，来自 Elixirlang 社区的新闻和采访.
* [Elixir Outlaws](https://elixiroutlaws.com) - Elixir 开发中及相关主题的小组讨论.
...
* [Entreprogrammers](http://entreprogrammers.com/)  - 从 4 位开发人员转为企业家的角度了解他们的实际情况，因为他们在业务中挣扎并以艰难的方式吸取教训. 这是 entreprogrammers 的每周策划小组.
...
* [Founders Talk](https://changelog.com/founderstalk)  – 与创始人、CEO 和制造商进行深入的一对一对话. 旅程，经验教训和斗争. 我们开工吧！
* [Fragmented](https://fragmentedpodcast.com/) - Android 开发者播客.
* [Full Stack Radio](http://www.fullstackradio.com/) - 为有兴趣构建出色软件产品的开发人员提供的播客.
* [Functional Geekery](https://www.functionalgeekery.com/) - 功能极客，功能极客.
* [Future of Coding](https://futureofcoding.org/) - 每月采访.
* [Get Up and Code](https://simpleprogrammer.com/)  - Get Up and Code 是一个关于适合程序员和软件开发人员的播客. 每周，John Sonmez 都会帮助您减轻体重、调整饮食并保持体形.
* [GitMinutes](http://www.gitminutes.com/) - 为熟练的 Git 用户准备的节目.
* [Google Cloud Platform Podcast](https://www.gcppodcast.com/)  - Google Cloud Platform 播客，每周为您呈现. 讨论从 Google Cloud Platform 从 App Engine 到 Big Query 的所有内容.
...
* [HTTP 203](https://developers.google.com/web/shows/http203/) - 在每个节目中，Jake 和 Paul 都选择了 Web 开发领域的热门话题，并讨论了它的各个方面，同时介绍了生活小窍门、课程和一些相当诚实的事实.
* [Iron Sysadmin](https://www.ironsysadmin.com/) - 现实世界的系统管理员为现实世界的系统管理员提供的播客.
* [IRL: Because Online Life Is Real Life](https://irlpodcast.org/)  - 主持人 Veronica Belmont 分享在线生活的真实故事以及关于网络未来的真实谈话.  IRL 是 Mozilla 的原创播客.
...
* [Mastering Embedded Systems](https://embeddedsuccess.com/podcast/)  - 我发现了掌握嵌入式系统的四大问题： 1. 专家不够；  2.设计不足，故障检测不力；  3. 强制多站点方法失败；  4. 管理虚拟团队的错误我将教你克服这些挑战的诀窍和工具.
* [Mind the Cloud Podcast](http://mindthecloud.com) - 关于开发人员和公司使用云来创造未来的播客.
* [MS Dev Show](https://msdevshow.com/)  - 面向 Microsoft 开发人员的播客.  Jason Young 和 Carl Schweitzer 讨论了最新的开发人员新闻，涵盖了 Azure 云、Windows、Windows Phone、Visual Studio 和使用 Microsoft 平台进行跨平台开发等主题.
* [New Rustacean](https://newrustacean.com/) - 这是一个关于从头开始学习编程语言 Rust 的播客.
* [Note To Self](https://www.wnycstudios.org/shows/notetoself) - 主持人 Manoush Zomorodi 与从大牌技术人员到小学教师的所有人讨论技术对我们生活的影响，寻求能够帮助您思考和生活得更好的明智选择.
* [Office 365 Developer Podcast](https://www.microsoft.com/en-us/microsoft-365/blog/) - 唯一一个专注于 Office 365 开发的节目，我们与来自全球各地的 Office 365 平台编码专家进行交流.
...
* [Our Ludicrous Future](https://ourludicrousfuture.com/) - 主要谈论空间、技术和埃隆马斯克.
...
* [Reasonably Sound](http://reasonablysound.com/) - 背景、解释和一点点庆祝音频的复杂性和令人敬畏，以及围绕它发展的各种文化.
* [Reply All](https://www.gimletmedia.com/reply-all) - 全部回复是一个关于互联网的节目.
* [Risky Business](https://risky.biz/netcasts/risky-business/) - Risky Business 成立于 2007 年 2 月.它以轻松的方式看待信息安全新闻和功能.
* [Rocket Ranch](https://www.nasa.gov/kennedy/rocketranch/) - 来自 NASA 肯尼迪航天中心的官方播客.
* [Rocket Talk](https://www.tor.com/features/series/rocket-talk-podcast/) - Rocket Talk 是 Tor.com 的科幻/奇幻播客，将讨论风格的谈话广播与 Tor.com 获奖短篇小说的音频叙述相结合.
* [Ruby5](https://www.pluralsight.com/search?q=ruby) - Ruby 和 Rails 社区的最新消息.
* [RunAs Radio](http://www.runasradio.com/) - 面向使用 Microsoft 产品的 IT 专业人员的每周一次互联网音频脱口秀.
* [Second Career Devs](https://secondcareerdevs.com/) - Second Career Devs 播客的每一集都关注一位在上一个职业生涯后成为软件工程师的嘉宾.
...
* [Semaphore Uncut](https://semaphoreci.com/podcast) - 软件行业专家讨论他们目前正在使用他们正在开发的产品解决的问题.
* [Self Hosted](https://selfhosted.show/)  - 发现新的软件和硬件，以充分利用您的网络、控制智能设备并保护您在云服务上的数据.  Self-Hosted 是 Chris 和 Alex 两位长期“自我托管”之间的聊天节目，他们分享他们的课程并带您踏上新课程的旅程.  Linux Academy 播客展示了您可以自己主持的免费和开源技术.
* [ShopTalk Show](https://shoptalkshow.com/) - 关于前端网页设计、开发和用户体验的播客.
* [Software Engineering Daily](https://softwareengineeringdaily.com/) - 一个播客，每日采访针对专业软件开发人员的技术软件主题.
* [Software Engineering Radio](http://www.se-radio.net/) - 面向专业软件开发人员的播客.
* [Software Sessions](https://www.softwaresessions.com/) - 关于构建软件的实用对话.
* [Soft Skills Engineering](https://softskills.audio/)  - 面向软件开发人员的每周建议播客. 要成为一名出色的开发人员，需要的不仅仅是出色的代码.
* [Sound Of Symfony](https://www.soundofsymfony.com/) - 非官方的 Symfony 播客.
* [StarTalk Radio](https://www.startalkradio.net/?sfid=22493&post_types=show) - 致力于宇宙万物的计划，由著名的天体物理学家尼尔·德格拉斯·泰森主持.
* [Surveillance Report](https://techlore.tech)  - 每周安全和隐私新闻综述，让您及时了解我们数字世界的重要更新. 每个周末上传！
* [Sword & Laser](http://swordandlaser.com/) - The Sword and Laser (S&amp;L) 是一个以科幻和奇幻为主题的读书俱乐部、视频节目和播客，由 Veronica Belmont 和 Tom Merritt 创办.
* [SYFY25 Origin Stories](https://www.syfy.com/syfywire/syfy25/podcast-episodes)  - Adam Savage 与创作者、思想领袖和名人粉丝坐下来讨论永远改变流派世界的时刻、人物和里程碑； 对科幻小说中所有事物的怀旧庆典.
* [Syntax FM](https://syntax.fm/) - 面向 Web 开发人员的美味点心播客.
* [Sysadministrivia](https://sysadministrivia.com/) - Linux、贮藏啤酒和深夜.
* [Syscast Podcast](http://podcast.sysca.st/) - 会说话的 Linux、开源、Web 开发和系统管理 (DevOps).
* [Talking Kotlin](http://talkingkotlin.com/) - 关于 Kotlin 的双月播客和更多由 Hadi Hariri 主持的播客.
...
* [TechStuff](https://www.stuffmedia.com/techstuff-podcast.htm)  - TechStuff 处理从基本电子到大型强子对撞机以及介于两者之间的所有主题.  TechStuff 致力于揭开技术及其在我们社会和文化中的作用的神秘面纱.
...
* [The CyberWire Daily](https://thecyberwire.com/podcasts/daily-podcast)  - 每日网络安全新闻和分析行业领导者所依赖的. 该计划在每个工作日发布，还包括对来自世界各地的工业、学术界和研究机构的广泛专家的采访.
* [The Cybrary Podcast](https://www.cybrary.it/info/cybrary-podcast/) - 它讨论了网络安全和 IT 领域各个方面的行业领导者和专业人士，深入了解他们如何取得今天的成就以及我们应该注意哪些新兴技术.
* [The Five-Minute Geek Show](http://www.fiveminutegeekshow.com)  - Matt Stauffer，毫不掩饰的极客，5 分钟，每周两次. 前端开发、后端开发、音频、设计、播客——所有公平的游戏.
...
* [The Life Scientific](https://www.bbc.co.uk/programmes/b015sqc7) - Jim Al-Khalili 教授与顶尖科学家谈论他们的生活和工作，找出激励和激励他们的因素，并询问他们的发现可能对人类有什么影响.
...
* [The Web Ahead](http://5by5.tv/webahead)  - 与世界专家就不断变化的技术和网络的未来进行对话.  Web Ahead 是您跟上步伐的捷径.
...
* [Thoughtbot](https://thoughtbot.com/podcasts) - 我们每周录制和发布来自thoughtbot 的关于设计、Ruby on Rails、iOS、运行软件公司以及保持工作/生活平衡的播客.
* [ThoughtWorks](https://soundcloud.com/thoughtworks) - 一个充满激情的个人社区，其目的是彻底改变软件设计、创建和交付，同时倡导积极的社会变革.
* [Three Devs and a Maybe](https://threedevsandamaybe.com/)  - 每周讨论所有关于 Web 开发的播客. 主题包括日常开发人员生活、PHP、框架、测试、良好的软件设计以及我们使用许多其他编程语言的经验.
* [Toolsday Podcast](https://spec.fm/podcasts/toolsday) - 每周二 2 点播放 20 分钟的播客，介绍最新的技术工具、提示和技巧！
* [Ubuntu Podcast](http://ubuntupodcast.org)  - 由 Ubuntu UK LoCo 成员制作的活泼乐观的播客，包括来自 Ubuntu 和开源社区的新闻、讨论和采访.  （2021年停产）
...
* [Watch Out for Fireballs!](https://www.watchoutforfireballs.com/) - 一个游戏俱乐部播客，专注于复古和非当前游戏.
* [Why Are Computers](https://whyarecomputers.com/) - 关于计算机和计算机程序及其原因的播客.
* [WIRED's Webmonkey Podcast](https://www.wired.com/series/webmonkey/) - 与技术团队一起了解 WIRED.com 的幕后故事.
...
* [Amarelo Criativo](https://soundcloud.com/amarelocriativo)  - Yellow Creative 的所有播客. 整个星期的不同节目带来关于创意市场、极客世界和非常黄色的心情的信息.
* [CapyCast](https://soundcloud.com/rdshipit/) - 与结果数字产品团队一起播客，讲述他们在开发和设计方面的学习.
...
* [Enciclopédia do Teatro Impossível](https://open.spotify.com/show/36EnYAg6C1szSmbryeavXb?si=Htx1pbzGSp61pqyVvxbrRw)  - The Impossible Theatre Encyclopedia 是巴西戏剧的平行历史，从它的失败中可以看出. 它们部分是虚构的，部分是对不可能的戏剧作品的现实描述.
* [FalaDev](https://anchor.fm/faladev) - 大部分时间都在编写代码，是时候聚在一起讨论编程世界了.
...
* [Lambda3 Podcast](https://www.lambda3.com.br/category/podcast/) - 使用 Lambda3 播客
...
* [NautilusLink](https://soundcloud.com/nautiluslink) - 关于视频游戏的播客.
* [NerdCast](https://jovemnerd.com.br/nerdcast/) - JovemNerd 门户播客，谈论书呆子、理论和角色扮演游戏
* [PHP Do Jeito Certo](http://phpdojeitocerto.tumblr.com/) - 为有经验的开发人员和初学者提供有关 PHP 新功能的新闻.
* [Pizza de Dados](https://pizzadedados.com/) - Pizza de Dados 是一项以有趣和轻松的方式提出与数据科学相关的问题的倡议.
* [PODebug](http://www.podebug.com/) - 软件开发和技术一般，但以一种温和而轻松的方式.
* [PodProgramar](https://podprogramar.com.br/) - Jessi Zanelato 和 Ana Eliza 的技术开发命令播客，涵盖初级和高级主题.
* [PodTag](https://podtag.com.br/) - 由 Luiz Gonçalves 主持的播客，与几位不同的嘉宾一起讨论从职业到技术本身的各种技术主题.
* [Podtrash](http://www.td1p.com/) - 由垃圾爱好者制作的关于垃圾电影的播客.
* [Quebradev](https://quebradev.com.br/) - 外设来源和面向来源的播客.
...
* [Zeno Overflow](https://soundcloud.com/zenorocha) - 一系列关于巴西以外的技术、职业和生活的实时问答.
* [Zone Of Front-Enders](https://zofe.com.br/) - 专注于前端 Web 开发的播客.  
* [Dragões de Garagem](http://dragoesdegaragem.com/) - 一个科普播客，希望以一种易于理解和轻松的方式谈论科学，鼓励好奇心和批判性思维.
* [Opencast](https://anchor.fm/opencast) - 技术、自由软件和创新，在充满类 Unix 世界的轻松聊天中进行.
...
* [CAChemE](https://cacheme.org/podcast/) - 科学和工程应用程序（主要是 Python）.
...
* [Nación Lumpen](https://www.nacionlumpen.com/) - 类似于“吃够了”.
* [Python en español](https://podcast.jcea.es/python/) - 使用您的语言的 Python
* [WeDevelopers](http://wedevelopers.com/) - 播客开发者（一些英语剧集/一些英语播客）.
...
* [GNU/Linux Valencia](https://gnulinuxvalencia.org/category/podcasts) - 从图里亚首都进入 GNU/Linux 世界.
...
* [Podcast Linux](https://avpodcast.net/podcastlinux) - 适用于家庭桌面用户的 GNU/Linux 世界播客.
...
* [SDCast](http://sdcast.ksdaemon.ru) — 软件开发播客. 与开发人员的访谈，讨论开发、开源和相关的 IT 主题.
...
* [HangOps.Ru](https://www.youtube.com/channel/UCr5mwN4AKxiYxysr8PeQdaA/feed) - 在 YouTube 上播客 + 现场讨论 DevOps.
* [Podlodka](http://podlodka.io)  - 每周关于软件开发的音频节目. 采访软件开发行业和其他相关领域的专业人士.
* [UnderJS Podcast](https://underjs.ru/) - 关于 JS、React Native、Nodejs 的播客.
* [linkmeup](https://linkmeup.ru/) - 关于网络、电信和其他 IT 的播客.
* [RadioDotNet](https://radio.dotnet.ru) - 关于 .NET 相关的所有内容的播客：新闻、文章、库、事件.
...
* [RadioGeek](https://jadi.net/2012/07/podcast-haye-jadi/) - 又一个为社会和技术交汇处的流浪极客提供的播客.
* [Shir Ya Khat](http://shiryakhat.net/)  - 第一个专门针对伊朗人和波斯语社区的区块链播客. 我们谈论比特币、区块链资产和去中心化思想.

## In Swedish

* [Kodsnack](https://kodsnack.se/)  - 每周瑞典播客关于所有事物的代码，为编码人员. 由 Fredrik Björeman、Tobias Hieta 和 Kristoffer Grönlund 主持，偶尔会有客人.
...
* [Le comptoir sécu](https://www.comptoirsecu.fr/)  — 关于安全性的双月播客，欢迎每个主题的专家. 由 Justin Ganivet、Morgan Hotonnier、Youenn Piolet、Loïs Samain 主持.
...
* [Electro Monkeys](https://electro-monkeys.fr/)  - 每周法语播客，Electro Monkeys 是地球上最另类的云原生技术播客！ 由 Stéphane Beuret 主持.
* [Dev Café](https://dev-cafe.fr/)  - 每周一，找开发者看到的科技新闻！ 由爱德华·马尔克斯主持.

## In German

* [Apfelfunk](https://apfelfunk.com/) - 有关与 Apple 相关的所有内容的每周播客.
...
* [Teahour](http://teahour.fm/) - 由主持的播客 [Terry Tai](https://github.com/poshboytl), [Dingding Ye](https://github.com/sishen) 和 [Daniel Lv](https://github.com/lgn21st), 大多数主题都是关于软件开发、创业等.

## In Polish

* [DevTalk](https://devtalk.pl/)  - 面向热情开发者的技术播客. 与开发相关的所有主题：架构、语言、工具、库、会议、社区、职业规划......由 Maciej Aniserowicz 主持.
* [Just4Fun](https://just4fun.io/)  - 由 Rafal Warzycha 和 Piotr Leszczynski 主持的双周技术播客. 主要主题是 JavaScript 和前端.
* [ChwastIT](https://chwast.it//)  - 波兰最糟糕的编程播客. 随便，难以忍受甚至轻率地谈论软件工程. 和 [@kwasniew](https://twitter.com/kwasniew), [@kubek2k](https://twitter.com/kubek2k), [@peel](https://twitter.com/peel) 和他们的客人——波兰IT的杂草.

## In Turkish

* [devPod](https://devpod.org/) - 土耳其播客谈论现代软件技术、编程语言、会议、Linux、Unix、iOS、MacOS、Python、Ruby、Git 等.主办方 [Uğur Özyılmazel(Vigo)](https://github.com/vigo) 和 [Üstün Özgür](https://github.com/ustun).

## In Finnish

* [Frontend Friday](http://frontendfriday.fi/)  – 关于 HTML、Web 和相关主题的播客和会议. 来自芬兰奥卢.
...
* [De Appels en Peren Show](http://appelsenperenshow.nl/)  - 一个关于未来的脱口秀节目. 技术、媒体、文化和其他一切使未来成为可能.
* [Tech45](https://tech45.eu/)  - Tech45 是每周一次的技术播客. 在大约 45 分钟内，一组极客将引导您浏览过去一周最有趣的科技新闻.
* [TechSnacks](https://techsnacks.nl/) - 唯一的零食播客技术播客！
* [Met Nerds om Tafel](https://www.metnerdsomtafel.nl/)  - 每周播客，极客喝 Spa Red 并谈论科技话题. 常客书呆子和常客书呆子 Daniel Kegel、Floris Diemel、Joost Schellevis、Jurian Ubachs 和 Randal Peelen.
