...
-   [Complex Networks](https://www.uvm.edu/~pdodds/teaching/courses/2016-01UVM-303/)，由 Peter Sheridan Dodds（佛蒙特大学，2016 年；推特： [@networksvox](https://twitter.com/networksvox)).
...
-   [Palladio](http://palladio.designhumanities.org/) - 基于 Web 的空间网络可视化工具由 [Humanities + Design research lab at Stanford University](http://hdlab.stanford.edu/projects/palladio/).
...
-   [qgraph](https://CRAN.R-project.org/package=qgraph)  - 建模和可视化心理测量网络的工具； 还针对加权图形模型）.
...
-   [relevent](https://CRAN.R-project.org/package=relevent) - 适合关系事件模型 (REM) 的工具.
    -   [informR](https://cran.r-project.org/package=informR) - 从事件列表中创建序列统计信息的工具，以在“相关”中使用.
-   [rem](https://CRAN.R-project.org/package=rem) - 估计事件序列中的内生网络效应并拟合关系事件模型 (REM)，该模型衡量网络如何随着时间的推移而形成和演变.
...
-   [RSiena](http://r-forge.r-project.org/R/?group_id=461)  - 经验网络分析的模拟调查； 将模型拟合到纵向网络数据.
-   [signnet](https://github.com/schochastics/signnet) 分析签名网络的方法（结构平衡、块建模、中心性等）
-   [sna](https://CRAN.R-project.org/package=sna) - 基本的网络构建器、测量和可视化工具.
-   [snahelper](https://CRAN.R-project.org/package=snahelper) - RStudio 插件，它提供了一个 GUI 来可视化和分析网络
...
-   [spectralGOF](http://people.bu.edu/jccs/spectralGOF.html) - 计算光谱拟合优度 (SGOF)，这是衡量网络模型对观察网络结构的解释程度的一种度量.
...
-   [tidygraph](https://CRAN.R-project.org/package=tidygraph)  - 构建图结构的“整洁”方法. 另请参阅：`ggraph` R 包.
...
-   [tnam](https://CRAN.R-project.org/package=tnam) - 拟合时间和横截面网络自相关模型 (TNAM) 的工具.
-   [tnet](https://CRAN.R-project.org/package=tnet) - 加权、双模式和纵向网络的网络测量.
...
-   [JGraphT](http://jgrapht.org/) - 用于图形数据结构和算法的 Java 图形库（[example algorithms](https://github.com/agouge/Java-Network-Analyzer)).
-   [JUNG - Java Universal Network/Graph Framework](http://jung.sourceforge.net/) - 表示网络对象的可扩展库.
-   [PGF/TikZ](http://www.ctan.org/tex-archive/graphics/pgf/) - [Tandem](https://en.wikipedia.org/wiki/PGF/TikZ) 可用于绘制图形的矢量图形语言 [LaTeX](https://latex-project.org/) 排版环境.
...
-   [Interactive and Dynamic Network Visualization in R](http://curleylab.psych.columbia.edu/netviz/) 和 JavaScript 库（2016 年）.
...
-   [Awesome graph classification](https://github.com/benedekrozemberczki/awesome-graph-classification) - 带有标题、作者、论文链接和参考实现的图嵌入论文的综合列表.
-   [Awesome community detection](https://github.com/benedekrozemberczki/awesome-community-detection) - 带有标题、作者、论文链接和参考实现的社区检测论文的综合列表.
-   [Centrality Measures as a Signature of Roles in Rousseau’s _Les Confessions_](http://yro.ch/centrality-measures-signature-roles-rousseaus-les-confessions/) - 分析现实世界的人物网络.
-   [Cheat Sheet: Social Network Analysis for Humanists](https://cvcedhlab.hypotheses.org/106) - 组装和操作网络数据时要记住的基本概念.
-   [Computer Technologies for the Historical Research of Intellectual Networks](https://www.youtube.com/playlist?list=PLz79Il7EOvUJxdQ9r2IefFtr--BNkfOa7) - 历史学家制作的一系列视频，其中包括 Marten Düring 和 Scott Weingart.
-   [Convert Between Graph Formats](http://awesome.cs.jhu.edu/graph-services/convert/) - 从/到许多不同的常见图形格式的在线服务.
-   [David Knoke on Network Analysis](https://thesocietypages.org/methods/2015/01/30/david-knoke-on-network-analysis/) - 20 分钟的采访，讨论了网络分析的用途和好处，借鉴了 Knoke 对恐怖网络的研究.
-   [Glossary of Terms for Statistical Network Models](https://statnet.org/trac/raw-attachment/wiki/Resources/glossary.pdf).
-   [Linton C. Freeman’s Social Network Research Publications](http://moreno.ss.uci.edu/pubs.html)，从 1955 年到今天.
-   [Mapping the Republic of Letters](http://republicofletters.stanford.edu/) - 近代学术研究项目（[underlying software](http://www.densitydesign.org/research/knot/)).
-   [Mixed-Method Approaches to Social Network Analysis](https://www.youtube.com/playlist?list=PL3zdEY084WkQD79mR00RSt8j5RuyPwMJE) - 米德尔塞克斯大学法学院会议的视频（2014 年）.
-   [Modeling Complex Social Networks: Challenges and Opportunities for Statistical Learning and Inference](https://www.youtube.com/watch?v=1xLjYc7EUEU) - 詹妮弗·内维尔 (Jennifer Neville) 在普渡大学 (2011) 的研讨会演讲视频.
-   [NetSciEd - Network Science in Education](https://sites.google.com/a/binghamton.edu/netscied/home) - 旨在提高网络素养的国际倡议.
-   (@) [Network Fact](https://twitter.com/networkfact) - 关于网络、图论和相关主题的 Twitter 帐户.
-   [Network Map of Knowledge and Art](https://paolonegrini.wordpress.com/2012/11/19/network-map-of-knowledge-and-art/) - 使用 SPARQL 和 Gephi 的 DBPedia 派生的受谁影响的直接关系网络.
-   (@) [Network Science](https://twitter.com/Ognyanova/lists/network-science/members) - Twitter 帐户的主题列表，由策划 [Katherine Ognyanova](https://twitter.com/Ognyanova).
-   [The Networks Network](https://groups.google.com/forum/?hl=en-GB#!forum/the-networks-network) - 邮件列表（主要是来自 HNR 网络的历史学家）.
-   [New Perspectives for Relational Learning](http://www.birs.ca/events/2015/5-day-workshops/15w5080/videos) - 班夫国际研究站 (BIRS) (2015) 研讨会的视频（及更多）.
-   [Open Graph protocol](http://ogp.me/) - 将任何网页变成“社交图对象”的拟议标准.
-   [Periodic Table of Network Centrality](http://schochastics.net/sna/periodic.html) - 中心性指数的交互式周期表.
-   [Picking Sides](https://codeandculture.wordpress.com/2015/04/03/picking-sides/) - 在各种国家和非国家权力之间的中东联盟政治网络中的社区检测（[updated version](https://gist.github.com/briatte/c6df2f855afb4eb142e6)).
-   [Plan interactif du métro](http://www.jeromecukier.net/projects/metro/map.html) - 巴黎地铁网络的交互式可视化，用 d3.js 绘制，法语.
...
-   [(Psychological) Network Analysis Workshops](http://eiko-fried.com/network-workshop/) - 为期 3 天的使用 R 进行心理网络分析的研讨会.
-   [Should I do Social Network Analysis?](https://cvcedhlab.hypotheses.org/125).
-   [The Small World of Psychopathology](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0027407) - 关于精神症状如何相互联系的论文（[code, data and graphs](https://sites.google.com/site/dsmgraphs/Home/files)).
-   [Social Network Analysis in DBpedia](http://othes.univie.ac.at/12285/1/2010-10-14_0703857.pdf) - 具有高度教学意义的硕士论文，展示了如何使用 SPARQL 和 Pajek.
...
-   [A Sociology Citation Network](http://nealcaren.web.unc.edu/a-sociology-citation-network/) 和 [A Co-citation Network for Philosophy](https://kieranhealy.org/blog/archives/2013/06/18/a-co-citation-network-for-philosophy/) - 科学共引网络的例子.
-   [Using Metadata to Find Paul Revere](https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/) 和 [The Other Ride of Paul Revere: The Brokerage Role in the Making of the American Revolution](http://www.sscnet.ucla.edu/polisci/faculty/chwe/ps269/han.pdf) - 应用于美国革命者的网络分析.
-   [Visual Complexity. An Exploration on Mapping Complex Networks](http://www.visualcomplexity.com/vc/) - 大量精美的网络和树形可视化（[book](http://www.visualcomplexity.com/vc/book/)，还有中文和法文）.
-   [Visualizing Historical Networks](https://www.fas.harvard.edu/~histecon/visualizing/index.html) - 哈佛大学历史网络研究项目.
...
-   [Archaeological Networks](http://archaeologicalnetworks.wordpress.com/) - Tom Brughmans 的博客，面向考古学家和历史学家.
-   [Blog Posts About Networks by Aaron Clauset](https://www.cs.unm.edu/~aaron/blog/archives/networks/index.htm).
-   [Blog Posts About Networks by Baptiste Coulmont](http://coulmont.com/index.php?s=r%C3%A9seaux), 法语.
-   [Blog Posts About Networks by Cosma R. Shalizi](http://bactra.org/weblog/cat_networks.html).
-   [Blog Posts About Networks by François Briatte](http://politbistro.hypotheses.org/tag/reseaux), 法语.
-   [Blog Posts About Networks by Katya Ognyanova](http://kateto.net/networks).
-   [Blog Posts About Networks by Pierre Mercklé](http://pierremerckle.fr/category/reseaux/), 法语.
-   [Blog Posts About Networks on the Bad Hessian Blog](http://badhessian.org/category/networks/)，由各种贡献者.
- 关于网络的博客文章 [R-Bloggers](http://www.r-bloggers.com/)，R 博客的聚合器：
      -   [Networks](http://www.r-bloggers.com/?s=networks).
      -   [Social Network Analysis](http://www.r-bloggers.com/?s=social+network+analysis).
-   [Cosma R. Shalizi’s Notebooks](http://bactra.org/notebooks) 关于网络相关主题，绝对值得在（选择性）细节中列出：
...
- Martin Grandjean 关于（主要是）网络可视化的英文和法文博客文章：
...
-   [Networks Demystified](http://scottbot.net/tag/networks-demystified/)，Scott B. Weingart 的一系列博客文章.
-   [Netze und Netzwerke](http://netzeundnetzwerke.de/), 英语和德语 - 关于网络分析历史的博客，由 Sebastian Gießmann ([old blog](http://www.netzeundnetzwerke.de/old/)).
-   [R / Notes: Networks](http://f.briatte.org/r/category/networks) - 由 François Briatte 撰写的专注于在 R 中操作网络的博客文章.
-   [TNT: The Network Thinkers](http://www.thenetworkthinkers.com/) - Valdis Krebs 的博客.
-   [Under Roquentin’s Chestnut Tree](https://mboudour.github.io/) - Moses Boudourides 关于使用 Python 分析（主要是）网络的博客.
- Yannick Rochat 关于数字人文的博客文章，英文和法文：
...
-   [Analyzing Networks of Characters in _Love Actually_](http://varianceexplained.org/r/love-actually-network/) - 具有聚类分析和 [Shiny app](https://dgrtwo.shinyapps.io/love-actually-network/) （使用 R + Shiny）.
-   [Character Co-Occurrences in Victor Hugo’s _Les Misérables_](http://bokeh.pydata.org/en/latest/docs/gallery/les_mis.html)，绘制为邻接矩阵，用 Python (+ Javascript) 编写.
...
-   [Lessons on Exponential Random Graph Modeling from _Grey’s Anatomy_ hook-ups](http://badhessian.org/2012/09/lessons-on-exponential-random-graph-modeling-from-greys-anatomy-hook-ups/) （使用 R）.
-   [Network Analysis of Shakespeare’s _Macbeth_](https://mboudour.github.io/2015/10/28/Shakespeare's-Macbeth-Network.html) （使用 Python）.
-   [The Network and Trajectories of Transitions among Sentential Co-Occurrences of Characters of Arthur Conan Doyle’s _A Study in Scarlet_](https://mboudour.github.io/2016/04/17/Arthur-Conan-Doyle's-A-Study-in-Scarlet-Network-&-Trajectories.html) （使用 Python； [code](https://github.com/mboudour/WordNets/blob/master/ArthurConanDoyle_AStudyInScarlet_Network%26Trajectories.ipynb)).
...
-   [Editing a Normal Science Journal in Social Science](https://journals.openedition.org/bms/595) - 创始编辑对 _Social Networks_ 期刊的反思.
-   [The Emergence of Network Science](https://www.cornell.edu/video/emergence-of-network-science) - 视频纪录片，由 Steven H. Strogatz 和许多其他人主演.
...
-   [The Invasion of the Physicists](http://www.sciencedirect.com/science/article/pii/S0378873304000309) - “网络_科学_”是如何出现的.
-   [Isolated Social Networkers](http://crookedtimber.org/2005/05/19/isolated-social-networkers/), [Networks 和 Netwars](http://bactra.org/weblog/347.html) 和 [The Inter-Disciplinary Politics of Interdisciplinary Research or, “Hey, That Was My Idea First.”](https://www.cs.unm.edu/~aaron/blog/archives/2005/05/the_interdiscip.htm) - 在作为流行词的“网络科学”出现之前的一系列博客文章，但所涉及的问题与现在在该标题下讨论的问题相同.
-   [The ‘New’ Science of Networks](https://www.jstor.org/stable/29737693) - 2002-2003年出版的网络科学书籍评论.
-   [Predicting Highly Cited Papers](http://arxiv.org/abs/1310.8220) - 预测下一篇网络科学高被引论文.
...
-   [A Twenty-First Century Science](http://www.nature.com/nature/journal/v445/n7127/full/445489a.html) - Duncan J. Watts 的文章.
-   [What is Network Science?](http://journals.cambridge.org/repo_A88Sa8AHdt4SoI) - 近期_网络科学_期刊的第一篇社论.

### Small Worlds

&gt; 链接重点（类比） [Stanley Milgram’s small-world experiment](https://en.wikipedia.org/wiki/Small-world_experiment).
...
-   [The Oracle of Bacon](https://oracleofbacon.org/) - 基于 [online game](https://en.wikipedia.org/wiki/Six_Degrees_of_Kevin_Bacon) 这导致了 [charity](http://www.sixdegrees.org/).
-   [Panel: Six Degrees of Separation](https://www.cornell.edu/video/six-degrees-of-separation-panel) - 康奈尔大学会议视频，其中包括 Duncan J. Watts、Steven H. Strogatz、Jon Kleinberg 和其他演讲者.
...
-   [Six Degrees of Francis Bacon](http://sixdegreesoffrancisbacon.com/) - 有据可查的早期现代历史网络的交互式可视化.
-   [Six Degrees of Separation](https://en.wikipedia.org/wiki/Six_degrees_of_separation) - 维基百科英文词条.

### Two-Mode Networks

&gt; 也称为二分图.

-   [L’analyse des graphes bipartis](https://halshs.archives-ouvertes.fr/FMR/halshs-00794976), 法语 (2013).
-   [Basic Notions for the Analysis of Large Two-mode Networks](http://www.sciencedirect.com/science/article/pii/S0378873307000494)  ([preprint](https://www-complexnetworks.lip6.fr/~latapy/Publis/socnet07.pdf), [related code](https://www-complexnetworks.lip6.fr/~latapy/Bip/) ;  _社交网络_，2008 年）.
...
在法律允许的范围内，此列表的作者 - 按时间顺序： [François Briatte](http://f.briatte.org/), 
...
[Benedek Rozemberczki](https://github.com/benedekrozemberczki), 
[Alex Loftus](https://github.com/loftusa) 和 
[Arun](https://github.com/arunppsg) – 已放弃本作品的所有版权和相关或邻接权.

谢谢 [Robert J. Ackland](https://github.com/rjackland), 
...
[Chris Watson](https://profiles.bu.edu/Christopher.Watson) 和 [Tim A. Wheeler](https://github.com/tawheeler)，他帮助找到了这个列表中的一些很棒的资源.
