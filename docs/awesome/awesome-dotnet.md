...
* [Bundle Transformer](https://github.com/Taritsyn/BundleTransformer) - Modular extension for [Microsoft ASP.NET Web Optimization Framework](https://www.nuget.org/packages/Microsoft.AspNet.Web.Optimization) . 它的模块支持 LESS、Sass、CoffeeScript、TypeScript、Mustache、Handlebars、Autoprefixer 以及一堆不同的 JS 和 CSS 缩小器.
...
* [ASP.NET Identity](https://github.com/aspnet/Identity/) - 新的 ASP.NET 应用程序会员系统
...
* [Pro .NET Memory Management](https://link.springer.com/book/10.1007/978-1-4842-4027-4)  - 深入了解 .NET 内存管理，包括全面介绍 .NET 内存的工作原理、实现细节、可能的陷阱以及解决方法.  **[$]**
* [Pro .NET Benchmarking](https://link.springer.com/book/10.1007/978-1-4842-4941-3)  - 深入了解软件基准测试，以实现准确的性能测量. 通过识别和定位正确的瓶颈，帮助您获得最大的性能影响. 包括最新的编译器和处理器.  **[$]**
* [Pro .NET Framework with the Base Class Library](https://link.springer.com/book/10.1007/978-1-4842-4191-2)  - 展示有助于正确使用管理类型的宝贵提示和示例，包括如何避免装箱/拆箱以及更好地使用内存资源.  **[$]**
...
* [Pro ASP.NET Core 6](https://link.springer.com/book/10.1007/978-1-4842-7957-1)  - 全彩 ASP.NET Core 6 上最全面的覆盖范围. 详细的解释和大量的工作代码来学习新功能. 提供功能齐全的 ASP.NET Core 6 应用程序，可用作项目的模板.  **[$]**
...
* [yuniql](https://github.com/rdagumampan/yuniql)  - 使用 .NET Core 制作的免费和开源架构版本控制和迁移工具. 使用纯 SQL 运行迁移，在普通文件夹中排列版本，并通过独立 CLI（无需 CLR）、Azure Pipelines、Docker 或 ASP.NET Core 代码从 CSV 中播种数据.  https://yuniql.io
## DirectX
...
* [Mediator.Net](https://github.com/mayuanyang/Mediator.Net) - 一个简单的 .NET 调解器，用于发送命令、发布事件和请求响应，支持管道
...
* [FluentEmail](https://github.com/lukencode/FluentEmail) - 具有 Razor 模板支持的 System.Net.Mail 的流畅包装.
...
* [Humanizer](https://github.com/Humanizr/Humanizer) - Humanizer 满足您所有 .NET 对操作和显示字符串、枚举、日期、时间、时间跨度、数字和数量的需求
...
* [UpdateControls](https://updatecontrols.net/cs/)  - 更新控件不需要您实现“INotifyPropertyChanged”或声明“DependencyProperty”. 它将控件直接连接到 CLR 属性. 这使其非常适合模型/视图/视图模型模式.
...
* [Toms Toolbox](https://github.com/tom-englert/TomsToolbox) - Visual Composition 框架，可轻松构建基于 [Managed Extensibility Framework (MEF)](https://docs.microsoft.com/en-us/dotnet/framework/mef/).
* [MVVM Dialogs](https://github.com/FantasticFiasco/mvvm-dialogs) - 在 WPF 或 UWP 中使用 MVVM 时，框架简化了从视图模型打开对话框的概念.
...
* [EPPlus](https://github.com/JanKallman/EPPlus) - EPPlus 是一个 .NET 库，它使用 Open Office XML 格式 (xlsx) 读写 Excel 2007/2010 文件.
...
* [NetOffice](https://github.com/NetOfficeFw/NetOffice) - 用于 Microsoft Office 应用程序的 .NET 包装程序集.
* [GemBox.Bundle](https://www.gemboxsoftware.com/bundle)  - 一个 .NET 组件包，可以快速、简单和高效地处理办公文件（Excel、Word、PowerPoint、PDF 和电子邮件）.  **[$]****[免费精简版]**
* [Outlook Redemption](http://www.dimastr.com/redemption/home.htm)  - 使用 Outlook 对象模型和（扩展）MAPI 的库. 支持 Outlook 98 - 2019.在 Exchange 和 Outlook 中使用对象/邮件/帐户/文件夹.  **[$]**
* [ShapeCrawler](https://github.com/ShapeCrawler/ShapeCrawler) - 一个流利的 API，用于在没有安装 Microsoft Office 的情况下处理 PowerPoint 演示文稿.
* [MiniExcel](https://github.com/shps951023/MiniExcel) - 微型 Excel 助手可避免 OOM 和高性能创建/映射/模板填充数据.
...
* [Dapper](https://github.com/StackExchange/Dapper) - 一个简单的.NET对象映射器 [StackExchange](https://stackexchange.github.io/)
...
* [LINQ to DB](https://github.com/linq2db/linq2db) - 最快的 LINQ 数据库访问库，在 POCO 对象和数据库之间提供简单、轻量、快速和类型安全的层.
* [MicroLite ORM](https://github.com/MicroLite-ORM/MicroLite)  MicroLite ORM 是一个用于 .NET 框架的微对象关系映射器. 它被设计为易于使用、可扩展和可测试.
* [PetaPoco](https://github.com/CollaboratingPlatypus/PetaPoco) - 为您的 POCO 准备的一个小小的 ORM-ish
* [AsyncPoco](https://github.com/tmenier/AsyncPoco) - 一个期待已久的完全异步 PetaPoco 分叉
...
* [MongoFramework](https://github.com/TurnerSoftware/MongoFramework) - MongoDB 的类似“实体框架”的界面

## Package Management

* [NuGet](https://www.nuget.org/) - .NET 包管理器
* [BaGet](https://github.com/loic-sharma/BaGet/) - 一个跨平台、轻量级的 NuGet 和 Symbol 服务器
* [Cloudsmith](https://cloudsmith.com/nuget-feed/)  - 完全托管的包管理 SaaS，支持 NuGet、Npm、Docker 等.  **[公众免费/OSS]** **[$]**
...
* [Kevsoft.PDFtk](https://github.com/kevbite/Kevsoft.PDFtk) - 驱动令人敬畏的 pdftk 二进制文件的包装器，它可以填写 PDF 表单、获取字段信息、连接多个文档或页面、拆分文档、添加或替换图章，并且可以将文件附加到页面或从页面下载文件.
...
* [SSH.NET](https://github.com/sshnet/SSH.NET)  - 用于 .NET 的 Secure Shell (SSH) 库，针对并行性进行了优化. 提供 SSH 命令、SFTP/SCP 上传和下载以及 SOCKS4/SOCKS5/HTTP 代理.
...
* [Hangfire](https://github.com/HangfireIO/Hangfire) - 在 ASP.NET 应用程序中执行即发即弃、延迟和重复任务的极其简单的方法
...
* [MassTransit](https://github.com/MassTransit/MassTransit) - MassTransit 是精益服务总线实现，用于使用 .NET 框架构建松散耦合的应用程序.
* [Rebus](https://github.com/rebus-org/Rebus) - Rebus 是 .NET 的精简服务总线实现，本质上类似于 NServiceBus 和 MassTransit，只是更精简
...
* [EasyNetQ](https://github.com/EasyNetQ/EasyNetQ) - 一个易于使用的 RabbitMQ .NET API
* [Warewolf ESB](https://github.com/Warewolf-ESB/Warewolf)  - 一个易于使用的服务总线和微服务平台. 在可视化 IDE 中轻松构建应用程序和服务.
* [Confluent's .NET Client](https://github.com/confluentinc/confluent-kafka-dotnet) - 用于 Apache Kafka 的 Confluent .NET 客户端.
* [Foundatio](https://github.com/FoundatioFx/Foundatio#queues) - 内存中、Redis 和 Azure 实现的通用接口.
...
* [Rx.NET](https://github.com/dotnet/reactive) - Reactive Extensions (Rx) 是一个库，用于使用可观察序列和 LINQ 样式的查询运算符组成异步和基于事件的程序
...
* [SolrExpress](https://github.com/solr-express/solr-express) - 一个简单轻量级的 Solr 查询 .NET 库，以可控、可构建和快速失败的方式
...
* [Ceras](https://github.com/rikimaru0345/Ceras)  - Ceras 是一个二进制序列化器. 它将任何对象转换为 byte[] 并返回. 它在功能、速度和舒适度方面都超越了. 支持引用循环、大型/复杂的继承链、将对象拆分为多个部分等.
...
* [Bond](https://github.com/Microsoft/bond)  - 用于处理模式化数据的跨平台框架. 它支持跨语言反序列化和强大的通用机制以有效地操作数据.
...
* [FsPickler](https://github.com/mbraceproject/FsPickler) - 用于 .NET 的快速多格式消息序列化程序
...
* [C# Style Guide](https://stackoverflow.com/questions/4678178/style-guide-for-c) - StackOverflow 风格指南问答
...
* [C# Async Guidance](https://github.com/davidfowl/AspNetCoreDiagnosticScenarios/blob/master/AsyncGuidance.md) - .NET Core 有问题的异步模式列表，并说明如何解决这些问题

## Template Engine

* [RazorEngine](https://github.com/Antaris/RazorEngine) - 基于微软 Razor 解析引擎的开源模板引擎
* [RazorLight](https://github.com/toddams/RazorLight) - 基于支持 .NET Standard 2.0 的微软 Razor 解析引擎的开源模板引擎
* [Nustache](https://github.com/jdiamond/Nustache) - 用于无逻辑模板的开源库
* [Stubble](https://github.com/stubbleorg/stubble)  - 修剪 .NET 中的 {{mustache}} 模板.  Nustache 的继任者.
...
* [AutoFixture](https://github.com/AutoFixture/AutoFixture) - AutoFixture 是一个用于 .NET 的开源框架，旨在最大限度地减少单元测试的“排列”阶段
...
* [xBehave.net](https://github.com/xbehave/xbehave.net) - 一个 xUnit.net 扩展，用于使用自然语言描述您的测试.
* [xUnit.net](https://github.com/xunit/xunit) - 一个免费的、开源的、以社区为中心的 .NET Framework 单元测试工具.
...
* [ReportPortal](https://reportportal.io)  - 人工智能驱动的测试自动化仪表板. 获取、汇总和分析测试报告以确定发布健康状况.
...
* [Downloader](https://github.com/bezzad/Downloader) - 快速可靠的多部分下载器，带有 .NET 应用程序的异步进度事件.
* [Fiddler](https://www.telerik.com/fiddler) - 适用于任何浏览器、系统或平台的免费网络调试代理
* [Open Live Writer](https://github.com/OpenLiveWriter/OpenLiveWriter)  - 与 WordPress、Blogger 等集成的博客作者. 人.  Open Live Writer 可让您轻松编写、预览和发布到您的博客.
* [CodeHub](https://github.com/CodeHubApp/CodeHub) - CodeHub 是在任何 iOS 设备上浏览和维护 GitHub 存储库的最佳方式！
* [ShareX](https://github.com/ShareX/ShareX)  - ShareX 是一个免费的开源程序，可让您捕获或记录屏幕的任何区域，只需按一下键即可共享. 它还允许将图像、文本或其他类型的文件上传到您可以选择的 80 多个受支持的目的地.
...
* [JSON Formatter and Validator](https://elmah.io/tools/json-formatter/) - 超快的 JSON 格式化程序和验证程序，不会与服务器共享 JSON.
* [CSharpier](https://github.com/belav/csharpier) - An opinionated code formatter for c# that is based on the [Prettier](https://github.com/prettier/prettier) 印刷工艺.
* [UnitsNet](https://github.com/angularsen/UnitsNet) - 使用测量单位让生活变得更好一点.
...
* [Managed Windows API](http://mwinapi.sourceforge.net/) - 自省和自动化第三方 Windows / VC++ 应用程序，无需其源代码.
* [FlaUI](https://github.com/FlaUI/FlaUI) - FlaUI 是一个 .NET 库，有助于对 Windows 应用程序（Win32、WinForms、WPF、商店应用程序等）进行自动化 UI 测试.
...
* [Productivity Power Tools](https://marketplace.visualstudio.com/items?itemName=VisualStudioPlatformTeam.ProductivityPowerTools) - 一组 Visual Studio Professional（及更高版本）的扩展，可提高开发人员的工作效率.
...
* [OzCode](https://marketplace.visualstudio.com/items?itemName=CodeValueLtd.OzCode)  - OzCode 是一个 Visual Studio 扩展，它通过检测和隔离错误来减少调试时间并提高生产力，使它们易于修复.  **[$]**
...
* [FubuMVC](https://github.com/DarthFubuMVC/fubumvc) - 用于 .NET 的前端控制器样式 MVC 框架
* [NancyFx](https://github.com/NancyFx/Nancy) - 用于在 .NET 和 Mono 上构建基于 HTTP 的服务的轻量级、低仪式框架
...
* [EmbedIO](https://github.com/unosquare/embedio) - 基于 Mono 和跨平台的 Web 服务器
* [XSP](https://github.com/mono/xsp)  - Mono 的 ASP.NET 托管服务器. 该模块包括一个 Apache 模块，一个可以连接到其他 Web 服务器的 FastCGI 模块以及一个用于测试的独立服务器（类似于 Microsoft 的 Cassini）

## WebSocket

* [Fleck](https://github.com/statianzo/Fleck) - Fleck is a WebSocket server implementation in C#. Branched from the Nugget project
* [SignalR](https://github.com/SignalR/SignalR) - 为 ASP.NET 开发人员提供的库，可以非常简单地将实时 Web 功能添加到您的应用程序中
...
* [WPF](https://github.com/dotnet/wpf) - WPF 是一个 .NET Core UI 框架，用于构建 Windows 桌面应用程序.
...
* [FParsec](https://github.com/stephan-tolksdorf/fparsec) - F 的解析器组合库#
...
* [awesome-LINQ](https://github.com/aloisdg/awesome-linq) - 精选的 LINQ 库、工具等的精选集合.
* [awesome-analyzers](https://github.com/Cybermaxs/awesome-analyzers) - .NET 编译器平台（“Roslyn”）诊断分析器和代码修复的精选列表.
* [C# Algorithms, Data Structures](https://github.com/aalhour/C-Sharp-Algorithms) - 算法和数据结构实现列表.
...
* [Awesome Unity](https://github.com/RyanNielson/awesome-unity) - 分类社区驱动的高质量 Unity 资产、项目和资源的集合.
...
* [.NET Open Source Developer Projects](https://github.com/Microsoft/dotnet/blob/master/dotnet-developer-projects.md) - 这个社区维护的列表展示了对开发过程的任何方面都很有用的 .NET 开源项目.
* [Awesome Microservices .NET Core](https://github.com/mjebrahimi/Awesome-Microservices-NetCore) - 一系列精彩的培训系列、文章、视频、书籍、课程、示例项目和 .NET Core 中的微服务工具.
...
* [NuGet Trends](https://nugettrends.com) - 查看 NuGet 包的采用情况以及 NuGet 的趋势.
* [Weekly C# Digest](https://csharpdigest.net/) - 每周电子邮件通讯，其中包含来自 .NET 社区的手动策划的前 5 个链接.
