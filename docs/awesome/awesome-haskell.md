...
真棒哈斯克尔 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
=============
...
* [Hackage](http://hackage.haskell.org/) - Haskell 社区的中央包档案.
* [Haddock](https://www.haskell.org/haddock/) - 从带注释的 Haskell 源代码自动生成文档的工具.
* [Happy](https://www.haskell.org/happy/) - Haskell 的解析器生成器.
* [Hayoo](http://hayoo.fh-wedel.de/) - 将搜索来自 Hackage 的所有包，包括所有功能和类型定义.
* [Hoogle](https://www.haskell.org/hoogle/) - Haskell API 搜索引擎，允许您通过函数名称或近似类型签名搜索许多标准 Haskell 库.
* [hsenv](https://github.com/Paczesiowa/hsenv/)  - 创建隔离 Haskell 环境的工具. 这允许项目使用与当前安装不同的 GHC 版本.
* [Stack](https://github.com/commercialhaskell/stack)  - 帮助构建 Haskell 项目的跨平台工具. 它包括支持创建隔离的 Haskell 环境和自动管理项目的依赖关系.
...
* [SMT](http://hackage.haskell.org/packages/#cat:SMT) - 可满足性模理论 (SMT) 的协作黑客列表.
...
* [IHP: Integrated Haskell Platform](https://ihp.digitallyinduced.com/) - 开始使用 haskell 网络开发的最佳方式.
    ---
* [Web](http://hackage.haskell.org/packages/#cat:Web) - 框架、库、...的协作黑客列表
...
* [.NET](http://hackage.haskell.org/packages/#cat:.NET) - 协作黑客列表.
...
* [Conduit](https://github.com/snoyberg/conduit) - 流式数据库. [Resources](http://hackage.haskell.org/packages/#cat:Conduit).
...
* [Neil Mitchell](https://neilmitchell.blogspot.com/) - 尼尔米切尔的 Haskell 博客.
...
* [LearnYouHaskell](http://learnyouahaskell.com/chapters) - 学习 Haskell for Great Good！
* [Happy Learn Haskell Tutorial](http://happylearnhaskelltutorial.com/) - 带卡通机器人的无痛、渐进式 Haskell 教程！
...
* [Conferences](https://wiki.haskell.org/Conferences) - 会议正式名单
...
* [Hackage](http://hackage.haskell.org/) - 是 Haskell 社区的中央包档案.
