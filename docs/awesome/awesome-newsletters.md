...
- [Best in Visual Storytelling](https://us16.list-manage.com/subscribe?u=5c12dabe1e59a9fbde1174b8c&id=e27a48af53) . 周一汇总过去一周最好的数据新闻. 付费版本还包括数据可视化职位发布.
...
- [CSS-Tricks](https://css-tricks.com) . 注册位于页面底部 **Get the newsletter** 标题下方！.
...
- [Weekly Dev Tips](https://ardalis.com/tips) . 每周三的每周电子邮件，其中包含来自 [Steve "ardalis" Smith](https://twitter.com/ardalis) . 主题范围从 git 到职业到 Web 开发再到个人发展和团队合作.
...
- [Awesome Swift Newsletter](https://swift.libhunt.com/newsletter) . 一个很棒的 swift 库和资源的精选列表.
...
- [Awesome Ruby Newsletter](https://ruby.libhunt.com/newsletter) . 一系列很棒的 Ruby gem、工具、框架和软件.
...
- [Pycoders Weekly](https://pycoders.com/) . 免费的每周电子邮件时事通讯，周五，面向对 Python 开发和 Python 相关的各种主题感兴趣的人.
...
- [Awesome Java Newsletter](https://java.libhunt.com/newsletter) . 一个很棒的 Java 框架、库和软件的精选列表.
- [Baeldung Weekly Review](https://www.baeldung.com/category/weekly-review/) . 通过这个每周指南了解 Java 世界的主要发展.

### Kotlin

- [Awesome Kotlin Newsletter](https://kotlin.libhunt.com/newsletter) . 最受欢迎的 Kotlin 新闻、文章和库的每周概览.
...
- [SRE Weekly](http://sreweekly.com/) .  SRE Weekly 是一份时事通讯，专门介绍与尽可能一致地保持网站或服务可用相关的所有内容.
...
- [LWKD](http://lwkd.info) .  LWKD 是一份每周通讯，总结了 Kubernetes 项目中的代码活动：合并、PR、弃用、版本更新、发布时间表和每周社区会议.
...
- [Flutter Weekly](https://flutterweekly.net/) . 由颤振爱好者为颤振爱好者提供的每周通讯.
- [Mobile Developers Cafe](https://mobiledeveloperscafe.com) . 移动开发人员每周通讯 - iOS、Android、Flutter 和 React Native.
...
- [Four Short Links](https://www.oreilly.com/radar/topics/four-short-links/) . 每个工作日有 4 个关于（主要是研究型）技术的短链接.
...
- [FBA monthly](https://www.fbamonthly.com/) .  FBA Monthly 是本月最重要的关于亚马逊业务的新闻文章和博客文章的全面摘要. 只有真实的新闻、解决方案、策略、卖家对卖家的提示等等.
...
- [Software Lead Weekly](http://softwareleadweekly.com/) . 免费的每周电子邮件，适用于关心人、文化和领导力的忙碌人士.
