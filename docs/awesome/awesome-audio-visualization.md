...
- [Triangles](https://willianjusten.com.br/audio-experiments/triangles/) -在“画布”中使用三角形的实验.
- [Adventure Machine](http://www.madeon.fr/adventuremachine/) -Campaign for Madeon的“冒险”专辑.
- [BBNG](https://uberviz.io/viz/bbng/) -BADBADNOTGOOD的“ Confessions”（专栏：Leland Whitty）的WebGL可视化工具.
...
- [DENNIS](http://www.dennis.video/) -popcorn_10制作的“ Dennis”交互式音频响应音乐视频.
- [Fluctus](http://jojo.ninja/fluctus/) -Jordan Machado的实验性3D音频可视化器.
- [George & Jonathan III](http://www.georgeandjonathan.com/) -竞选乔治和乔纳森（George＆Jonathan）的“ III”专辑.
...
- [Nero](https://www.uberviz.io/viz/nero/) -Nero的“在路上”的WebGL可视化工具.
...
- [Typatone](http://www.typatone.com/) -在写音乐的同时做音乐.
...
- [Here Comes The Sun](http://shiz.co/beatlescode/)  -披头士乐队的歌曲“ Here Comes The Sun”的视觉表示，该动态由使用Processing和Processing.js开发的算法动态生成. 玛西奥·里贝罗（Marcio Ribeiro）.
- [Audio Cloud](http://ma77os.cc/lab/audio-cloud/) -基于快速傅立叶变换频谱的音频分析的反应粒子系统.
- [Glitch](http://naivesound.com/glitch/) -一种算法合成器，可通过数学制作音乐.
- [105 Birthday Clara Rockmore](http://www.google.com/doodles/clara-rockmores-105th-birthday) -克拉拉·罗克莫尔（Clara Rockmore）诞辰纪念日的涂鸦.
...
- [Glowsynth - just amazing!](http://outputchannel.com/glowsynth/) -使用鼠标，Qwerty键键盘或MIDI键盘进行播放，并观察灯光随着音乐而舞动的情况.
...
- [Music Cube](http://www.808cube.com/) -结合了Roland TR-808滚筒机器和Rubik&#39;s Cube的Chrome实验.
...
- [Draw and Music](http://rugs.grindselect.com/) -萨姆·格林斯（Sam Greens）的“地毯运动”新专辑.
...
- [Dancing Torus](http://dancing-torus.s3-website-us-east-1.amazonaws.com/)  -跳舞圆环是一种WebGL Audio Reactive体验. 在Soundcloud上选择您喜欢的歌曲，然后开始跳舞！
...
- [Andantino](https://alpcanaydin.github.io/andantino/) 听一些音符，然后尝试在键盘上找到相同的音符.
- [Vissonance](https://tariqksoliman.github.io/Vissonance/) THREE.js中内置的音频可视化工具的集合.
- [M A I L M A N](http://mailman.acervo.io/) Bruno Imbrizi的互动音乐视频，其中包括Soundgarden的一首名为Mailman的歌曲.
- [HTML5 Audio Visualizer Video Maker](https://isaiah658.github.io/) 挑选您的音乐，背景图像，以所需的方式自定义可视化工具，并在Web浏览器中正确记录可视化工具.
- [3d Particles Music Visualiser](https://chardos.github.io/music_viz/) 理查德·坦（Richard Tan）在Three.js中制作的音乐可视化工具
- [ShowCQTBar](https://mfcc64.github.io/html5-showcqtbar/) -带有音乐等级的音频频谱可视化.
...
- [YouTube Musical Spectrum](https://github.com/mfcc64/youtube-musical-spectrum) -一个浏览器扩展程序，可在您的YouTube页面上提供带有生动音符的音频可视化.
- [Just Dance](http://hiteshsahu.com/AudioAnalysis) -使用3D音频可视化 [BabylonJS](http://babylonjs.com/) ＆2D Perlin噪声.
- [audioMotion](https://audiomotion.me)  -高分辨率的实时音频频谱分析仪和用JavaScript编写的功能齐全的音乐播放器. 包括适用于Windows，Linux和macOS的二进制文件.
- [p5.js Audio Visualizer](https://amandayehh.github.io/audio-visualizer/) -使用以下功能创建的功能强大的节拍和振幅响应音频可视化器 [p5.sound](https://github.com/processing/p5.js-sound)，在Amanda Yeh撰写的HTML5 Canvas上.
...
- [Audio Visualizer](http://codepen.io/Francext/full/yIogq/) -Francesco Trillini编写的使用Three.js的抽象音频可视化工具
...
- [Gooey Effect Audio](http://codepen.io/enjikaka/full/QbJmRJ/) -上传您的mp3，并通过杰里米·卡尔森（Jeremy Karlsson）的疯狂效果将歌曲形象化.
...
- [web-media-playback](https://github.com/hughsk/web-media-playback) -检索有关浏览器中播放的音频或视频的播放和缓冲信息.
- [Pizzicato.js](https://alemangui.github.io/pizzicato/) -简化了通过Web Audio API创建和处理声音的方式.
- [ThreeAudio.js](https://github.com/unconed/ThreeAudio.js) -帮助您在Three.js或tQuery中创建音乐可视化效果.
- [Beeplay.js](https://watilde.github.io/beeplay/) -用JavaScript写一首歌.
- [MIDI.js](https://github.com/mudcube/MIDI.js/) -让生活轻松在网络上创建MIDI应用程序.
- [Beep.js](https://github.com/stewdio/beep.js) -一个JavaScript工具包，用于构建基于浏览器的合成器.
...
- [meyda](https://github.com/meyda/meyda) -JavaScript的音频特征提取.


## Libraries Visualization

- [p5.js](http://p5js.org/) -一个基于库的核心原理的JavaScript库，用于创建图形和交互式体验.
...
- [Cinder](https://libcinder.org/) -社区开发的免费和开放源代码库，用于使用C ++进行专业质量的创意编码.
...
- [Hylogen](https://github.com/sleexyz/hylogen) -嵌入在Haskell中的纯功能语言，用于片段着色器的实时编码（带有音频输入）.
...
- [Jason Sigal](https://github.com/therewasaguy) -在纽约大学居住的Creative Coder，并且是p5.js的网络音频库的创建者.
- [Shawn Lawson](http://shawnlawson.com/) -一位经验丰富的媒体艺术家，创造了卓越的计算能力.
- [Matt DesLauriers](https://github.com/mattdesl) -Jam 3的创意编码器.
- [Patrick Heng](http://hengpatrick.fr/)  -富有创造力的前端开发人员. 在Hetic和Gobelins学习，并在Grouek工作.
