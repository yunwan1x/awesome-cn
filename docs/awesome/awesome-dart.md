...
精选的 Dart 框架、库和软件的精选列表. 列表中的项目得到积极维护，有据可查，并且在 Dart 社区中很受欢迎. 灵感来自 [awesome](https://github.com/sindresorhus/awesome) lists.

### Contributing

请快速浏览 [contribution guidelines](https://github.com/yissachar/awesome-dart/blob/master//CONTRIBUTING.md) 第一的. 如果您在此处看到不再维护或不合适的包或项目，请提交拉取请求以改进此文件. 谢谢你们 [contributors](https://github.com/yissachar/awesome-dart/graphs/contributors); you rock!
...
* [VueDart](https://refi64.com/vuedart) - 使用 Dart 创建 Vue Web 应用程序，这是一种用于构建 Web UI 的渐进式、可增量采用的框架.
...
有很多很棒的库被添加到 [Pub](https://pub.dartlang.org/) 每时每刻. 如果您在此列表中找不到满足您需求的库，请继续在 Pub 上搜索. 如果你最终找到了一个很棒的库，我们会喜欢一个带有信息的拉取请求，以便其他人也可以发现它. 只要确保阅读 [contributing guidelines](https://github.com/yissachar/awesome-dart/blob/master/CONTRIBUTING.md) first.
