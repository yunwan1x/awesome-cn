...
[Digital product design](https://en.wikipedia.org/wiki/Digital_product_design) 是一个迭代设计过程，用正式的解决方案来解决功能问题. 数字产品设计师发现了一个真正的问题，提供了最好的解决方案，并将其推向了对该特定解决方案有需求的市场.
...
###### User Interview
- [NN Group](https://www.nngroup.com/articles/interviewing-users/) - 尽管存在许多弱点，但访谈是探索性用户研究的宝贵方法.
...
- [Hootsuite](https://blog.hootsuite.com/the-ultimate-competitive-analysis-template/) - 竞争分析模板，助您智胜竞争.
###### Job to be Done
...
###### Personas
- [Usability.Gov](https://www.usability.gov/how-to-and-tools/methods/personas.html) - 角色的目的是为您的主要受众创建可靠和逼真的表示.
- [UX Mag](https://uxmag.com/articles/personas-the-foundation-of-a-great-user-experience) - 角色：卓越用户体验的基础.
...
- [Full Story](https://www.fullstory.com/) - 您想了解有关您的客户体验的哪些信息？
- [Desinion](https://www.desinion.com/) - 为您的公司或客户的公司做出明智而明智的设计决策.
...
- [Gamestorming](https://gamestorming.com/) - Gamestorming 是一套被世界各地的创新者使用的共创工具.
#### Articles
- [UX Magazine](https://uxmag.com/) - UX 杂志是一个免费的社区资源，探索体验设计的各个方面.
- [UX Both](https://www.uxbooth.com/) - UX Booth 是用户体验社区的出版物.
- [UX Mastery](https://uxmastery.com/) - 我们帮助用户体验专业人士入门并变得更好.
- [UX Myths](https://uxmyths.com/) - 基于证据而非错误信念构建您的产品.
...
- [UXDesign.cc](https://uxdesign.cc/)  - 用户体验、可用性、产品设计. 遵循 UXDesign.cc.
- [UX Reactions](https://uxreactions.com/) - 好玩的东西.
#### Tools
- [UX Recipe](https://uxrecipe.github.io/) - 该项目是反对“用户体验”一词客观化的个人宣言.
- [UX Checklist](https://uxchecklist.github.io/) - UX 项目清单.
...
- [Facebook Design](https://facebook.design/) - 收集 Facebook 设计师制作的文章、视频和资源.
...
- [Android Niceties](https://androidniceties.tumblr.com/) - 旨在提供灵感和洞察 Android UI 约定.
...
- [Sketch Bootstrap 5 UI Kit](https://themeselection.com/products/free-sketch-bootstrap-ui-kit/) - UI 套件包含 300 多个有组织的 Bootstrap 5 组件，使用原子设计系统和智能布局构建.

## Visual
#### Resources
- [Design Principles FTW](https://www.designprinciplesftw.com/) - 互联网上最大的设计原则合集.
- [Awesome Design Systems](https://github.com/alexpate/awesome-design-systems) - 设计系统、模式库以及介于两者之间的所有内容的精选列表.
- [Awesome Sketch](https://github.com/diessica/awesome-sketch) - 为设计师、开发人员或两者都设计的精彩 Sketch 视频、文章、插件等精选列表.
#### Icons
...
- [Use & Modify](https://usemodify.com/) - 提供一套现代字体，以自由或开源许可证分发，由排版和自由文化爱好者手工挑选.
...
- [Color Hunt](https://colorhunt.co/) - Color Hunt 是一个适合所有热爱色彩的人的社交平台.
- [Brand Colors](https://brand-colors.com/) - sass、less、stylus 和 css 中提供 1100 多种颜色集合.
#### Stock Images
...
- [Get Refe](https://getrefe.tumblr.com/) - 免版税、高质量的真实生活照片.
...
#### Stock Videos
- [Vimeo](https://vimeo.com/channels/freestockfootage/) - 免版税库存视频供免费个人、公司或商业用途.
#### Tools
- [Polarr](https://photoeditor.polarr.co/) - 照片编辑器.
- [Licecap](https://www.cockos.com/licecap/) - 简单的动画屏幕截图.
- [Hand Brake](https://handbrake.fr/) - HandBrake 是一种将视频从几乎任何格式转换为一系列现代、广泛支持的编解码器的工具.
...
#### Softwares
- [Pop](https://marvelapp.com/pop/) - POP 可帮助您将您的笔和纸创意转变为交互式 iPhone 或 Android 原型.
- [Invision](https://www.invisionapp.com/) - 世界领先的原型设计、协作和工作流平台.
- [Marvel](https://marvelapp.com/) - 简单的设计、原型制作和协作.
- [Flinto](https://www.flinto.com/) - Flinto 可让设计师快速制作其移动、桌面或 Web 应用程序的交互式原型.
- [Origami Studio](https://origami.design/) - 探索、迭代和测试您的想法.
- [Framer](https://framer.com/) - 多合一设计工作流程.
...
#### Tools
- [Lottie](https://airbnb.design/lottie/) - 轻松地将高质量动画添加到任何本机应用程序.
- [Keynotopia](https://keynotopia.com/) - Keynotopia 将 Keynote 和 PowerPoint 转变为最佳的快速原型制作工具，用于创建移动、Web 和桌面 UI 模型.
...
- [Smashing Magazine](https://www.smashingmagazine.com/2014/10/color-contrast-tips-and-tools-for-accessibility/) - 颜色对比度以及为什么你应该重新考虑它.
...
## IoT
#### Articles
- [IoT Weekly News](https://iotweeklynews.com/) - 订阅 Justin Grammens 在物联网上精心挑选的文章.
...
- [IoT For All](https://iot-for-all.com/designing-the-internet-of-things/) - 设计物联网 – 5 项关键原则.
#### Tools
