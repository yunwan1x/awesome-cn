...
- [Adobe Brackets](https://github.com/adobe/brackets/issues?q=is%3Aopen+is%3Aissue+label%3A%22starter+bug%22)  _（标签：初学者错误）_<br> 一个开源的网络代码编辑器，用 JavaScript、HTML 和 CSS 编写.
...
- [Pybee/batavia](https://github.com/pybee/batavia/labels/first-timers-only)  _（标签：仅限初学者）_<br>  Python 虚拟机的 Javascript 实现.
...
- [Pytest](https://github.com/pytest-dev/pytest/labels/status%3A%20easy)  _（标签：状态：简单）_<br>  pytest 框架使编写小型测试变得容易，但可扩展以支持复杂的功能测试.
