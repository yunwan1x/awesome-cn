...
* [bruse](https://github.com/aubreypwd/zsh-plugin-bruse) - 可以轻松地“酿造链接”不同版本的软件包.
...
大多数这些插件都可以通过在您正在执行其他 `zgenom load` 调用的同一函数中将 `zgenom load githubuser/reponame` 添加到您的 .zshrc 文件中来安装.
